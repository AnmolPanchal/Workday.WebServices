...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Check_Print_Layout_AbstractObjectType : INotifyPropertyChanged
	{
		private Check_Print_Layout_AbstractObjectIDType[] idField;
		...
		public Check_Print_Layout_AbstractObjectIDType[] ID
		{
			get
			{
				return this.idField;
