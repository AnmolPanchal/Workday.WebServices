...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Investment_Statement_Line_TypeObjectType : INotifyPropertyChanged
	{
		private Investment_Statement_Line_TypeObjectIDType[] idField;
		...
		public Investment_Statement_Line_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
