...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Investment_Pool_PayoutObjectType : INotifyPropertyChanged
	{
		private Investment_Pool_PayoutObjectIDType[] idField;
		...
		public Investment_Pool_PayoutObjectIDType[] ID
		{
			get
			{
				return this.idField;
