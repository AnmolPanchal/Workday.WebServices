...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Auto_Recon_Initiation_TypeObjectType : INotifyPropertyChanged
	{
		private Auto_Recon_Initiation_TypeObjectIDType[] idField;
		...
		public Auto_Recon_Initiation_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
