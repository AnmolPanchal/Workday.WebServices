...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Bank_Statement_FormatObjectType : INotifyPropertyChanged
	{
		private Bank_Statement_FormatObjectIDType[] idField;
		...
		public Bank_Statement_FormatObjectIDType[] ID
		{
			get
			{
				return this.idField;
