...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Investment_ProfileObjectType : INotifyPropertyChanged
	{
		private Investment_ProfileObjectIDType[] idField;
		...
		public Investment_ProfileObjectIDType[] ID
		{
			get
			{
				return this.idField;
