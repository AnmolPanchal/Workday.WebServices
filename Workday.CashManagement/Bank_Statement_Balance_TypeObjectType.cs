...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Bank_Statement_Balance_TypeObjectType : INotifyPropertyChanged
	{
		private Bank_Statement_Balance_TypeObjectIDType[] idField;
		...
		public Bank_Statement_Balance_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
