...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Petty_Cash_AccountObjectType : INotifyPropertyChanged
	{
		private Petty_Cash_AccountObjectIDType[] idField;
		...
		public Petty_Cash_AccountObjectIDType[] ID
		{
			get
			{
				return this.idField;
