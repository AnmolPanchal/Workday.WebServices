...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Intraday_Bank_Statement_Summary_DataType : INotifyPropertyChanged
	{
		private Intraday_Bank_Statement_Balance_Type_ReferenceType intraday_Bank_Statement_Balance_Type_ReferenceField;
		...
		[XmlElement(Order = 0)]
		public Intraday_Bank_Statement_Balance_Type_ReferenceType Intraday_Bank_Statement_Balance_Type_Reference
		{
			get
			{
				return this.intraday_Bank_Statement_Balance_Type_ReferenceField;
			}
			set
			{
				this.intraday_Bank_Statement_Balance_Type_ReferenceField = value;
				this.RaisePropertyChanged("Intraday_Bank_Statement_Balance_Type_Reference");
			}
		}
