...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Get_Payments_ResponseType : INotifyPropertyChanged
	{
		private Reporting_TransactionObjectType[] request_ReferencesField;

		private Payments_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Payments_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private PaymentsType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Payment_WWS_Reference", IsNullable = false)]
		public Reporting_TransactionObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Payments_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Payments_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Payment", IsNullable = false)]
		public PaymentsType[] Response_Data
		{
			get
			{
