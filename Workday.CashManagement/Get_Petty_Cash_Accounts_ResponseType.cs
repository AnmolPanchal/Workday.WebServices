...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Get_Petty_Cash_Accounts_ResponseType : INotifyPropertyChanged
	{
		private Petty_Cash_AccountObjectType[] request_ReferencesField;

		private Petty_Cash_Account_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Petty_Cash_Account_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Petty_Cash_AccountType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Petty_Cash_Account_Reference", IsNullable = false)]
		public Petty_Cash_AccountObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Petty_Cash_Account_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Petty_Cash_Account_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Petty_Cash_Account", IsNullable = false)]
		public Petty_Cash_AccountType[] Response_Data
		{
			get
			{
