...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Taxpayer_ID_Number_TypeObjectType : INotifyPropertyChanged
	{
		private Taxpayer_ID_Number_TypeObjectIDType[] idField;
		...
		public Taxpayer_ID_Number_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
