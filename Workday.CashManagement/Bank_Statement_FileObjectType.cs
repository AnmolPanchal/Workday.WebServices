...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Bank_Statement_FileObjectType : INotifyPropertyChanged
	{
		private Bank_Statement_FileObjectIDType[] idField;
		...
		public Bank_Statement_FileObjectIDType[] ID
		{
			get
			{
				return this.idField;
