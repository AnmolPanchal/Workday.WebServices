...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Get_Bank_Branches_ResponseType : INotifyPropertyChanged
	{
		private Bank_BranchObjectType[] request_ReferencesField;

		private Bank_Branch_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Bank_Branch_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Bank_BranchType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Bank_Branch_Reference", IsNullable = false)]
		public Bank_BranchObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Bank_Branch_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Bank_Branch_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Bank_Branch", IsNullable = false)]
		public Bank_BranchType[] Response_Data
		{
			get
			{
