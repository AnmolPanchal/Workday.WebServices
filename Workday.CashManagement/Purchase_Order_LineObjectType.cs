...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Purchase_Order_LineObjectType : INotifyPropertyChanged
	{
		private Purchase_Order_LineObjectIDType[] idField;
		...
		public Purchase_Order_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
