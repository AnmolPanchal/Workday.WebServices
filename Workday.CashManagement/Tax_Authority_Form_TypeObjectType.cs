...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Tax_Authority_Form_TypeObjectType : INotifyPropertyChanged
	{
		private Tax_Authority_Form_TypeObjectIDType[] idField;
		...
		public Tax_Authority_Form_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
