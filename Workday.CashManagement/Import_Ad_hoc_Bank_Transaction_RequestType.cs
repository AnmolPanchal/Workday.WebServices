...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Import_Ad_hoc_Bank_Transaction_RequestType : INotifyPropertyChanged
	{
		...
		private Ad_hoc_Bank_Transaction__HV__DataType ad_hoc_Bank_Transaction_DataField;
		...
		[XmlElement(Order = 2)]
		public Ad_hoc_Bank_Transaction__HV__DataType Ad_hoc_Bank_Transaction_Data
		{
			get
			{
