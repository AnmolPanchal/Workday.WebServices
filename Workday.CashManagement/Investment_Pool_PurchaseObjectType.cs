...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Investment_Pool_PurchaseObjectType : INotifyPropertyChanged
	{
		private Investment_Pool_PurchaseObjectIDType[] idField;
		...
		public Investment_Pool_PurchaseObjectIDType[] ID
		{
			get
			{
				return this.idField;
