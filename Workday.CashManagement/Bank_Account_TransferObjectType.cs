...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Bank_Account_TransferObjectType : INotifyPropertyChanged
	{
		private Bank_Account_TransferObjectIDType[] idField;
		...
		public Bank_Account_TransferObjectIDType[] ID
		{
			get
			{
				return this.idField;
