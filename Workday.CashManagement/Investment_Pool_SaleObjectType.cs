...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Investment_Pool_SaleObjectType : INotifyPropertyChanged
	{
		private Investment_Pool_SaleObjectIDType[] idField;
		...
		public Investment_Pool_SaleObjectIDType[] ID
		{
			get
			{
				return this.idField;
