...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Reconciliation_Rule_SetObjectType : INotifyPropertyChanged
	{
		private Reconciliation_Rule_SetObjectIDType[] idField;
		...
		public Reconciliation_Rule_SetObjectIDType[] ID
		{
			get
			{
				return this.idField;
