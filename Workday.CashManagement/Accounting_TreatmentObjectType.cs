...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Accounting_TreatmentObjectType : INotifyPropertyChanged
	{
		private Accounting_TreatmentObjectIDType[] idField;
		...
		public Accounting_TreatmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
