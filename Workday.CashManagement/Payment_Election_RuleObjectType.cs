...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Payment_Election_RuleObjectType : INotifyPropertyChanged
	{
		private Payment_Election_RuleObjectIDType[] idField;
		...
		public Payment_Election_RuleObjectIDType[] ID
		{
			get
			{
				return this.idField;
