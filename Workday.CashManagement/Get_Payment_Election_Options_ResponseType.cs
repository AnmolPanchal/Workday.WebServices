...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Get_Payment_Election_Options_ResponseType : INotifyPropertyChanged
	{
		private Unique_IdentifierObjectType[] request_ReferencesField;

		private Payment_Election_Option_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Payment_Election_Option_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Payment_Election_OptionType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Payment_Election_Option_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Payment_Election_Option_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Payment_Election_Option_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Payment_Election_Option", IsNullable = false)]
		public Payment_Election_OptionType[] Response_Data
		{
			get
			{
