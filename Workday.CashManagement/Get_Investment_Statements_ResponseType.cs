...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Get_Investment_Statements_ResponseType : INotifyPropertyChanged
	{
		private Investment_StatementObjectType[] request_ReferencesField;

		private Investment_Statement_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Investment_Statement_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Investment_StatementType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Investment_Statement_Reference", IsNullable = false)]
		public Investment_StatementObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Investment_Statement_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Investment_Statement_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Investment_Statement", IsNullable = false)]
		public Investment_StatementType[] Response_Data
		{
			get
			{
