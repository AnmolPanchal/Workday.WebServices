...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Intraday_Bank_StatementObjectType : INotifyPropertyChanged
	{
		private Intraday_Bank_StatementObjectIDType[] idField;
		...
		public Intraday_Bank_StatementObjectIDType[] ID
		{
			get
			{
				return this.idField;
