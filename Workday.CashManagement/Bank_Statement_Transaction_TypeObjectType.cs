...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Bank_Statement_Transaction_TypeObjectType : INotifyPropertyChanged
	{
		private Bank_Statement_Transaction_TypeObjectIDType[] idField;
		...
		public Bank_Statement_Transaction_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
