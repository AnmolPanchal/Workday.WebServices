...
namespace WorkdayWebServices.Professional_Services_AutomationService
{
	...
	[Serializable]
	public class Expense_Report_Add_UpdateType : INotifyPropertyChanged
	{
		private Expense_Report_DataType expense_Report_DataField;
		...
		[XmlElement(Order = 0)]
		public Expense_Report_DataType Expense_Report_Data
		{
			get
			{
