...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Dispose_Asset_RequestType : INotifyPropertyChanged
	{
		private Financials_Business_Process_ParametersType business_Process_ParametersField;

		private Dispose_Asset_DataType dispose_Asset_DataField;
		...
		[XmlElement(Order = 1)]
		public Dispose_Asset_DataType Dispose_Asset_Data
		{
			get
			{
				return this.dispose_Asset_DataField;
			}
			set
			{
				this.dispose_Asset_DataField = value;
				this.RaisePropertyChanged("Dispose_Asset_Data");
			}
		}
