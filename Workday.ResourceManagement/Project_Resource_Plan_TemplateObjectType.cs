...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Project_Resource_Plan_TemplateObjectType : INotifyPropertyChanged
	{
		private Project_Resource_Plan_TemplateObjectIDType[] idField;
		...
		public Project_Resource_Plan_TemplateObjectIDType[] ID
		{
			get
			{
				return this.idField;
