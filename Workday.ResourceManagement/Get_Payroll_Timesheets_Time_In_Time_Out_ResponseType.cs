...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Payroll_Timesheets_Time_In_Time_Out_ResponseType : INotifyPropertyChanged
	{
		private Payroll_Timesheet_Time_In_Time_OutObjectType[] request_ReferencesField;

		private Payroll_Timesheet_Time_In_Time_Out_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Payroll_Timesheet_Time_In_Time_Out_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Payroll_Timesheet_Time_In_Time_OutType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Payroll_Timesheet_Time_In_Time_Out_Reference", IsNullable = false)]
		public Payroll_Timesheet_Time_In_Time_OutObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Payroll_Timesheet_Time_In_Time_Out_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Payroll_Timesheet_Time_In_Time_Out_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Payroll_Timesheet_Time_In_Time_Out", IsNullable = false)]
		public Payroll_Timesheet_Time_In_Time_OutType[] Response_Data
		{
			get
			{
