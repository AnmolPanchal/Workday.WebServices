...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Business_Entity_Contacts_ResponseType : INotifyPropertyChanged
	{
		private Business_Entity_ContactObjectType[] request_ReferencesField;

		private Business_Entity_Contact_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Business_Entity_Contact_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Business_Entity_ContactType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Business_Entity_Contact_Reference", IsNullable = false)]
		public Business_Entity_ContactObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Business_Entity_Contact_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Business_Entity_Contact_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Business_Entity_Contact", IsNullable = false)]
		public Business_Entity_ContactType[] Response_Data
		{
			get
			{
