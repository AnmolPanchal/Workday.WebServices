...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Supplier_Contract_TypeObjectType : INotifyPropertyChanged
	{
		private Supplier_Contract_TypeObjectIDType[] idField;
		...
		public Supplier_Contract_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
