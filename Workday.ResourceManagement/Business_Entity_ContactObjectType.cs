...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Business_Entity_ContactObjectType : INotifyPropertyChanged
	{
		private Business_Entity_ContactObjectIDType[] idField;
		...
		public Business_Entity_ContactObjectIDType[] ID
		{
			get
			{
				return this.idField;
