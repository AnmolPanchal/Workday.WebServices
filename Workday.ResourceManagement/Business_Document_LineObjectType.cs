...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Business_Document_LineObjectType : INotifyPropertyChanged
	{
		private Business_Document_LineObjectIDType[] idField;
		...
		public Business_Document_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
