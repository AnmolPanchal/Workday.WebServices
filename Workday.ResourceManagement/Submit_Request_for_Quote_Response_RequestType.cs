...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Submit_Request_for_Quote_Response_RequestType : INotifyPropertyChanged
	{
		...
		private RFQ_Response_Data_InboundType request_for_Quote_Response_DataField;
		...
		[XmlElement(Order = 2)]
		public RFQ_Response_Data_InboundType Request_for_Quote_Response_Data
		{
			get
			{
