...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Project_Phases_ResponseType : INotifyPropertyChanged
	{
		private Project_PhaseObjectType[] request_ReferencesField;

		private Project_Phase_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Project_Phase_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Project_PhaseType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Project_Phase_Reference", IsNullable = false)]
		public Project_PhaseObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Project_Phase_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Project_Phase_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Project_Phase", IsNullable = false)]
		public Project_PhaseType[] Response_Data
		{
			get
			{
