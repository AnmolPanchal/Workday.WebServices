...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Expense_Items_ResponseType : INotifyPropertyChanged
	{
		private Expense_ItemObjectType[] request_ReferencesField;

		private Expense_Item_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Expense_Item_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Expense_ItemType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Expense_Item_Reference", IsNullable = false)]
		public Expense_ItemObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Expense_Item_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Expense_Item_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Expense_Item", IsNullable = false)]
		public Expense_ItemType[] Response_Data
		{
			get
			{
