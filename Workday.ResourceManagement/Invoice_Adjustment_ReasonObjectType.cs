...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Invoice_Adjustment_ReasonObjectType : INotifyPropertyChanged
	{
		private Invoice_Adjustment_ReasonObjectIDType[] idField;
		...
		public Invoice_Adjustment_ReasonObjectIDType[] ID
		{
			get
			{
				return this.idField;
