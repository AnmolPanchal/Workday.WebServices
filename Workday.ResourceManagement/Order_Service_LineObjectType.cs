...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Order_Service_LineObjectType : INotifyPropertyChanged
	{
		private Order_Service_LineObjectIDType[] idField;
		...
		public Order_Service_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
