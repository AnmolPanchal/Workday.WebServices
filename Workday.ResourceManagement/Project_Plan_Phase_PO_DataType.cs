...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Project_Plan_Phase_PO_DataType : INotifyPropertyChanged
	{
		private Project_Plan_PhaseObjectType project_Plan_Phase_ReferenceField;

		private Project_Plan_Task_PO_DataType[] project_Plan_Task_DataField;
		...
		public Project_Plan_Task_PO_DataType[] Project_Plan_Task_Data
		{
			get
			{
