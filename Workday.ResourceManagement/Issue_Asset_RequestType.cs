...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Issue_Asset_RequestType : INotifyPropertyChanged
	{
		...
		private Asset_Issue_DataType asset_Issue_DataField;
		...
		[XmlElement(Order = 2)]
		public Asset_Issue_DataType Asset_Issue_Data
		{
			get
			{
				return this.asset_Issue_DataField;
			}
			set
			{
				this.asset_Issue_DataField = value;
				this.RaisePropertyChanged("Asset_Issue_Data");
			}
		}
