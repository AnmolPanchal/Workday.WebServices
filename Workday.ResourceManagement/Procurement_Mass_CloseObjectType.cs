...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Procurement_Mass_CloseObjectType : INotifyPropertyChanged
	{
		private Procurement_Mass_CloseObjectIDType[] idField;
		...
		public Procurement_Mass_CloseObjectIDType[] ID
		{
			get
			{
				return this.idField;
