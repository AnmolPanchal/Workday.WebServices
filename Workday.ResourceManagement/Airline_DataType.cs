...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Airline_DataType : INotifyPropertyChanged
	{
		private string spend_Data_IDField;

		private string airline_ValueField;
		...
		[XmlElement(Order = 1)]
		public string Airline_Value
		{
			get
			{
				return this.airline_ValueField;
			}
			set
			{
				this.airline_ValueField = value;
				this.RaisePropertyChanged("Airline_Value");
			}
		}
