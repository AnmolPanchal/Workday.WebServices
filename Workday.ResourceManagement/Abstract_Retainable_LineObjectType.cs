...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Abstract_Retainable_LineObjectType : INotifyPropertyChanged
	{
		private Abstract_Retainable_LineObjectIDType[] idField;
		...
		public Abstract_Retainable_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
