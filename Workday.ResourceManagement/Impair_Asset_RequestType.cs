...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Impair_Asset_RequestType : INotifyPropertyChanged
	{
		private Financials_Business_Process_ParametersType business_Process_ParametersField;

		private Impair_Asset_WWS_DataType impair_Asset_DataField;
		...
		[XmlElement(Order = 1)]
		public Impair_Asset_WWS_DataType Impair_Asset_Data
		{
			get
			{
				return this.impair_Asset_DataField;
			}
			set
			{
				this.impair_Asset_DataField = value;
				this.RaisePropertyChanged("Impair_Asset_Data");
			}
		}
