...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Catalog_Loads_ResponseType : INotifyPropertyChanged
	{
		private Unique_IdentifierObjectType[] request_ReferencesField;

		private Catalog_Load_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Catalog_Load_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Catalog_LoadType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Catalog_Load_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Catalog_Load_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Catalog_Load_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Catalog_Load", IsNullable = false)]
		public Catalog_LoadType[] Response_Data
		{
			get
			{
