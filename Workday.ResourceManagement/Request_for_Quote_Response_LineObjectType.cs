...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Request_for_Quote_Response_LineObjectType : INotifyPropertyChanged
	{
		private Request_for_Quote_Response_LineObjectIDType[] idField;
		...
		public Request_for_Quote_Response_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
