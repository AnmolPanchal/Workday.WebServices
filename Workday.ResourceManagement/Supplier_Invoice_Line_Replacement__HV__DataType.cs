...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Supplier_Invoice_Line_Replacement__HV__DataType : INotifyPropertyChanged
	{
		...
		[XmlElement("Worktags_Reference", Order = 23)]
		...
		[XmlElement("Supplier_Invoice_Split_Line_Data", Order = 24)]
