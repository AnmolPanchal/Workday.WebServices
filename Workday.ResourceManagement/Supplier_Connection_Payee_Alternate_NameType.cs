...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Supplier_Connection_Payee_Alternate_NameType : INotifyPropertyChanged
	{
		private string payee_Alternate_NameField;
		...
		[XmlElement(Order = 0)]
		public string Payee_Alternate_Name
		{
			get
			{
