...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Credit_Card_Transaction_FileObjectType : INotifyPropertyChanged
	{
		private Credit_Card_Transaction_FileObjectIDType[] idField;
		...
		public Credit_Card_Transaction_FileObjectIDType[] ID
		{
			get
			{
				return this.idField;
