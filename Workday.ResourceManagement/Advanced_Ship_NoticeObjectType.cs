...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Advanced_Ship_NoticeObjectType : INotifyPropertyChanged
	{
		private Advanced_Ship_NoticeObjectIDType[] idField;
		...
		public Advanced_Ship_NoticeObjectIDType[] ID
		{
			get
			{
				return this.idField;
