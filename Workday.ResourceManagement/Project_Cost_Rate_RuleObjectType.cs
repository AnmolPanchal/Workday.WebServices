...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Project_Cost_Rate_RuleObjectType : INotifyPropertyChanged
	{
		private Project_Cost_Rate_RuleObjectIDType[] idField;
		...
		public Project_Cost_Rate_RuleObjectIDType[] ID
		{
			get
			{
				return this.idField;
