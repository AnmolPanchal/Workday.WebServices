...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Expense_Report_Line_WWS_DataType : INotifyPropertyChanged
	{
		...
		private Itemized_Expense_Report_Line_WWS_DataType[] itemized_Expense_Report_Lines_DataField;
		...
		[XmlElement("Itemized_Expense_Report_Lines_Data", Order = 21)]
		public Itemized_Expense_Report_Line_WWS_DataType[] Itemized_Expense_Report_Lines_Data
		{
			get
			{
