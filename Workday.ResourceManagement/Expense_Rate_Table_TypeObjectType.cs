...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Expense_Rate_Table_TypeObjectType : INotifyPropertyChanged
	{
		private Expense_Rate_Table_TypeObjectIDType[] idField;
		...
		public Expense_Rate_Table_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
