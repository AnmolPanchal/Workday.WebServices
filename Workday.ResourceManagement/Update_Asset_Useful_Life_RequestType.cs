...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Update_Asset_Useful_Life_RequestType : INotifyPropertyChanged
	{
		...
		private Business_Asset_Useful_Life_Update_DataType business_Asset_Useful_Life_Update_DataField;
		...
		[XmlElement(Order = 2)]
		public Business_Asset_Useful_Life_Update_DataType Business_Asset_Useful_Life_Update_Data
		{
			get
			{
				return this.business_Asset_Useful_Life_Update_DataField;
			}
			set
			{
				this.business_Asset_Useful_Life_Update_DataField = value;
				this.RaisePropertyChanged("Business_Asset_Useful_Life_Update_Data");
			}
		}
