...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Supplier_Invoice_Request_CriteriaType : INotifyPropertyChanged
	{
		...
		[XmlElement("Created_By_Worker_Reference", Order = 12)]
		...
		[XmlElement("Approving_Worker_Reference", Order = 13)]
