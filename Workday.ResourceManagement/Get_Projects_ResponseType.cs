...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Projects_ResponseType : INotifyPropertyChanged
	{
		private Project_AbstractObjectType[] request_ReferencesField;

		private Project_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Project_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private ProjectType[] response_DataField;
		...
		public Project_AbstractObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Project_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Project_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Project", IsNullable = false)]
		public ProjectType[] Response_Data
		{
			get
			{
