...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Expense_Credit_Cards_ResponseType : INotifyPropertyChanged
	{
		private Worker_Credit_CardObjectType[] request_ReferencesField;

		private Expense_Credit_Card_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Expense_Credit_Card_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Expense_Credit_CardType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Expense_Credit_Card_Reference", IsNullable = false)]
		public Worker_Credit_CardObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Expense_Credit_Card_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Expense_Credit_Card_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Expense_Credit_Card", IsNullable = false)]
		public Expense_Credit_CardType[] Response_Data
		{
			get
			{
