...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Card_Holder_Listing_Files_ResponseType : INotifyPropertyChanged
	{
		private Cardholder_Listing_FileObjectType[] request_ReferencesField;

		private Card_Holder_Listing_File_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Card_Holder_Listing_File_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Card_Holder_Listing_FileType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Card_Holder_Listing_File_Reference", IsNullable = false)]
		public Cardholder_Listing_FileObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Card_Holder_Listing_File_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Card_Holder_Listing_File_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Card_Holder_Listing_File", IsNullable = false)]
		public Card_Holder_Listing_FileType[] Response_Data
		{
			get
			{
