...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Asset_Cost_Adjustment_ReasonObjectType : INotifyPropertyChanged
	{
		private Asset_Cost_Adjustment_ReasonObjectIDType[] idField;
		...
		public Asset_Cost_Adjustment_ReasonObjectIDType[] ID
		{
			get
			{
				return this.idField;
