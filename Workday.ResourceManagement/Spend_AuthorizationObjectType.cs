...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Spend_AuthorizationObjectType : INotifyPropertyChanged
	{
		private Spend_AuthorizationObjectIDType[] idField;
		...
		public Spend_AuthorizationObjectIDType[] ID
		{
			get
			{
				return this.idField;
