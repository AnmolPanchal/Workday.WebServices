...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Recurring_Supplier_InvoiceObjectType : INotifyPropertyChanged
	{
		private Recurring_Supplier_InvoiceObjectIDType[] idField;
		...
		public Recurring_Supplier_InvoiceObjectIDType[] ID
		{
			get
			{
				return this.idField;
