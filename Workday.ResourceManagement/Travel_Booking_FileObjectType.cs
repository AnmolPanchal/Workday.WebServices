...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Travel_Booking_FileObjectType : INotifyPropertyChanged
	{
		private Travel_Booking_FileObjectIDType[] idField;
		...
		public Travel_Booking_FileObjectIDType[] ID
		{
			get
			{
				return this.idField;
