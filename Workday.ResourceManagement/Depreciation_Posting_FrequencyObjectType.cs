...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Depreciation_Posting_FrequencyObjectType : INotifyPropertyChanged
	{
		private Depreciation_Posting_FrequencyObjectIDType[] idField;
		...
		public Depreciation_Posting_FrequencyObjectIDType[] ID
		{
			get
			{
				return this.idField;
