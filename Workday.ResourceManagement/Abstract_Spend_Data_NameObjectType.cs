...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Abstract_Spend_Data_NameObjectType : INotifyPropertyChanged
	{
		private Abstract_Spend_Data_NameObjectIDType[] idField;
		...
		public Abstract_Spend_Data_NameObjectIDType[] ID
		{
			get
			{
				return this.idField;
