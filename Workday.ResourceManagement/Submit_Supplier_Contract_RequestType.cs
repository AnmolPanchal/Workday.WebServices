...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Submit_Supplier_Contract_RequestType : INotifyPropertyChanged
	{
		...
		private Supplier_Contract_DataType supplier_Contract_DataField;
		...
		[XmlElement(Order = 2)]
		public Supplier_Contract_DataType Supplier_Contract_Data
		{
			get
			{
				return this.supplier_Contract_DataField;
			}
			set
			{
				this.supplier_Contract_DataField = value;
				this.RaisePropertyChanged("Supplier_Contract_Data");
			}
		}
