...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Corporate_Payment_ResponsibilityObjectType : INotifyPropertyChanged
	{
		private Corporate_Payment_ResponsibilityObjectIDType[] idField;
		...
		public Corporate_Payment_ResponsibilityObjectIDType[] ID
		{
			get
			{
				return this.idField;
