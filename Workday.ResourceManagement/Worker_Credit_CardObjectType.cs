...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Worker_Credit_CardObjectType : INotifyPropertyChanged
	{
		private Worker_Credit_CardObjectIDType[] idField;
		...
		public Worker_Credit_CardObjectIDType[] ID
		{
			get
			{
				return this.idField;
