...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Asset_Pooling_RuleObjectType : INotifyPropertyChanged
	{
		private Asset_Pooling_RuleObjectIDType[] idField;
		...
		public Asset_Pooling_RuleObjectIDType[] ID
		{
			get
			{
				return this.idField;
