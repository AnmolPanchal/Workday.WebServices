...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Customer_Invoice_LineObjectType : INotifyPropertyChanged
	{
		private Customer_Invoice_LineObjectIDType[] idField;
		...
		public Customer_Invoice_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
