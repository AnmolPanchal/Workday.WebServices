...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Project_Asset_Response_GroupType : INotifyPropertyChanged
	{
		private bool include_ReferenceField;

		private bool include_ReferenceFieldSpecified;

		private string include_Project_Asset_DataField;
		...
		[XmlElement(Order = 1)]
		public string Include_Project_Asset_Data
		{
			get
			{
				return this.include_Project_Asset_DataField;
			}
			set
			{
				this.include_Project_Asset_DataField = value;
				this.RaisePropertyChanged("Include_Project_Asset_Data");
			}
		}
