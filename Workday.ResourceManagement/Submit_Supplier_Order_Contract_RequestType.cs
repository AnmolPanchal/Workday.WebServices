...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Submit_Supplier_Order_Contract_RequestType : INotifyPropertyChanged
	{
		...
		private Supplier_Order_Contract_DataType supplier_Order_Contract_DataField;
		...
		[XmlElement(Order = 2)]
		public Supplier_Order_Contract_DataType Supplier_Order_Contract_Data
		{
			get
			{
