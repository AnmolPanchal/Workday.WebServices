...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Register_Asset_RequestType : INotifyPropertyChanged
	{
		...
		private Business_Asset_for_Register_WWS_DataType business_Asset_DataField;
		...
		[XmlElement(Order = 2)]
		public Business_Asset_for_Register_WWS_DataType Business_Asset_Data
		{
			get
			{
				return this.business_Asset_DataField;
			}
			set
			{
				this.business_Asset_DataField = value;
				this.RaisePropertyChanged("Business_Asset_Data");
			}
		}
