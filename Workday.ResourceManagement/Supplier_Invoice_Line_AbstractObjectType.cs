...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Supplier_Invoice_Line_AbstractObjectType : INotifyPropertyChanged
	{
		private Supplier_Invoice_Line_AbstractObjectIDType[] idField;
		...
		public Supplier_Invoice_Line_AbstractObjectIDType[] ID
		{
			get
			{
				return this.idField;
