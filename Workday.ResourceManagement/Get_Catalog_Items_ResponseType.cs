...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Catalog_Items_ResponseType : INotifyPropertyChanged
	{
		private Catalog_ItemObjectType[] request_ReferencesField;

		private Catalog_Item_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Catalog_ItemType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Catalog_Item_Reference", IsNullable = false)]
		public Catalog_ItemObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Catalog_Item_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Catalog_Item", IsNullable = false)]
		public Catalog_ItemType[] Response_Data
		{
			get
			{
