...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Project_Worker_Roles_ResponseType : INotifyPropertyChanged
	{
		private Project_RoleObjectType[] request_ReferencesField;

		private Project_Worker_Role_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Project_Worker_Role_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Project_Worker_RoleType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Project_Worker_Role_Reference", IsNullable = false)]
		public Project_RoleObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Project_Worker_Role_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Project_Worker_Role_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Project_Worker_Role", IsNullable = false)]
		public Project_Worker_RoleType[] Response_Data
		{
			get
			{
