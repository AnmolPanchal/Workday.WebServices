...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Internal_Service_DeliveryObjectType : INotifyPropertyChanged
	{
		private Internal_Service_DeliveryObjectIDType[] idField;
		...
		public Internal_Service_DeliveryObjectIDType[] ID
		{
			get
			{
				return this.idField;
