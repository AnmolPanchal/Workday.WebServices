...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Hotel_DataType : INotifyPropertyChanged
	{
		private string spend_Data_IDField;

		private string hotel_ValueField;
		...
		[XmlElement(Order = 1)]
		public string Hotel_Value
		{
			get
			{
				return this.hotel_ValueField;
			}
			set
			{
				this.hotel_ValueField = value;
				this.RaisePropertyChanged("Hotel_Value");
			}
		}
