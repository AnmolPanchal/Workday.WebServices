...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Abstract_Procurement_CatalogObjectType : INotifyPropertyChanged
	{
		private Abstract_Procurement_CatalogObjectIDType[] idField;
		...
		public Abstract_Procurement_CatalogObjectIDType[] ID
		{
			get
			{
				return this.idField;
