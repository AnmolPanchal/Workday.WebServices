...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Document_Payment_StatusObjectType : INotifyPropertyChanged
	{
		private Document_Payment_StatusObjectIDType[] idField;
		...
		public Document_Payment_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
