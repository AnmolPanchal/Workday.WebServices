...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Request_for_Quote_Awards_ResponseType : INotifyPropertyChanged
	{
		private Request_for_Quote_AwardObjectType[] request_ReferencesField;

		private Request_for_Quote_Award_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Request_for_Quote_Award_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Request_for_Quote_Award_OutboundType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Request_for_Quote_Award_Reference", IsNullable = false)]
		public Request_for_Quote_AwardObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Request_for_Quote_Award_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Request_for_Quote_Award_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Request_for_Quote_Award", IsNullable = false)]
		public Request_for_Quote_Award_OutboundType[] Response_Data
		{
			get
			{
