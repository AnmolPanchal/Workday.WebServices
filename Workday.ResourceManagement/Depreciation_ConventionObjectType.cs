...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Depreciation_ConventionObjectType : INotifyPropertyChanged
	{
		private Depreciation_ConventionObjectIDType[] idField;
		...
		public Depreciation_ConventionObjectIDType[] ID
		{
			get
			{
				return this.idField;
