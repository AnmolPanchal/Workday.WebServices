...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Project_Standard_Cost_Rate_Sheets_ResponseType : INotifyPropertyChanged
	{
		private Project_Standard_Cost_Rate_Sheet_Request_ReferencesType request_ReferenceField;

		private Project_Standard_Cost_Rate_Sheet_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Project_Standard_Cost_Rate_Sheet_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Project_Standard_Cost_Rate_SheetType[] response_DataField;
		...
		[XmlElement(Order = 0)]
		public Project_Standard_Cost_Rate_Sheet_Request_ReferencesType Request_Reference
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Project_Standard_Cost_Rate_Sheet_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Project_Standard_Cost_Rate_Sheet_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Project_Standard_Cost_Rate_Sheet", IsNullable = false)]
		public Project_Standard_Cost_Rate_SheetType[] Response_Data
		{
			get
			{
