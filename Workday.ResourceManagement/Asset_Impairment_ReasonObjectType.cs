...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Asset_Impairment_ReasonObjectType : INotifyPropertyChanged
	{
		private Asset_Impairment_ReasonObjectIDType[] idField;
		...
		public Asset_Impairment_ReasonObjectIDType[] ID
		{
			get
			{
				return this.idField;
