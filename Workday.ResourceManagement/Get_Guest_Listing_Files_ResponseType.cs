...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Guest_Listing_Files_ResponseType : INotifyPropertyChanged
	{
		private Guest_Listing_FileObjectType[] request_ReferencesField;

		private Guest_Listing_File_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Guest_Listing_File_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Guest_Listing_File_WWSType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Guest_Listing_File_Reference", IsNullable = false)]
		public Guest_Listing_FileObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Guest_Listing_File_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Guest_Listing_File_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Guest_Listing_File", IsNullable = false)]
		public Guest_Listing_File_WWSType[] Response_Data
		{
			get
			{
