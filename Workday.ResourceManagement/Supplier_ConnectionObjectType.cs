...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Supplier_ConnectionObjectType : INotifyPropertyChanged
	{
		private Supplier_ConnectionObjectIDType[] idField;
		...
		public Supplier_ConnectionObjectIDType[] ID
		{
			get
			{
				return this.idField;
