...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Purchase_Order_Change_OrderObjectType : INotifyPropertyChanged
	{
		private Purchase_Order_Change_OrderObjectIDType[] idField;
		...
		public Purchase_Order_Change_OrderObjectIDType[] ID
		{
			get
			{
				return this.idField;
