...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Procurement_Mass_Close_ResponseType : INotifyPropertyChanged
	{
		private Procurement_Mass_CloseObjectType[] request_ReferencesField;

		private Procurement_Mass_Close_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Procurement_Mass_Close_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Procurement_Mass_CloseType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Procurement_Mass_Close_Reference", IsNullable = false)]
		public Procurement_Mass_CloseObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Procurement_Mass_Close_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Procurement_Mass_Close_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Procurement_Mass_Close", IsNullable = false)]
		public Procurement_Mass_CloseType[] Response_Data
		{
			get
			{
