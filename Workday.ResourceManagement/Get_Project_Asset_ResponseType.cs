...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Project_Asset_ResponseType : INotifyPropertyChanged
	{
		private Project_AssetObjectType[] request_ReferencesField;

		private Project_Asset_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Project_Asset_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Project_AssetType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Project_Asset_Reference", IsNullable = false)]
		public Project_AssetObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Project_Asset_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Project_Asset_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Project_Asset", IsNullable = false)]
		public Project_AssetType[] Response_Data
		{
			get
			{
