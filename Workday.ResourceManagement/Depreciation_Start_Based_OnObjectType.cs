...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Depreciation_Start_Based_OnObjectType : INotifyPropertyChanged
	{
		private Depreciation_Start_Based_OnObjectIDType[] idField;
		...
		public Depreciation_Start_Based_OnObjectIDType[] ID
		{
			get
			{
				return this.idField;
