...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Request_for_Quote_AwardObjectType : INotifyPropertyChanged
	{
		private Request_for_Quote_AwardObjectIDType[] idField;
		...
		public Request_for_Quote_AwardObjectIDType[] ID
		{
			get
			{
				return this.idField;
