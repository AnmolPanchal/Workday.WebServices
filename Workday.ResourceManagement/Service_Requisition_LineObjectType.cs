...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Service_Requisition_LineObjectType : INotifyPropertyChanged
	{
		private Service_Requisition_LineObjectIDType[] idField;
		...
		public Service_Requisition_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
