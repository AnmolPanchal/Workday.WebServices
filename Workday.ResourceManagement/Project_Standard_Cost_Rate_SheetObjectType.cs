...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Project_Standard_Cost_Rate_SheetObjectType : INotifyPropertyChanged
	{
		private Project_Standard_Cost_Rate_SheetObjectIDType[] idField;
		...
		public Project_Standard_Cost_Rate_SheetObjectIDType[] ID
		{
			get
			{
				return this.idField;
