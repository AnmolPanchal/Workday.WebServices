...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Credit_Card_TransactionObjectType : INotifyPropertyChanged
	{
		private Credit_Card_TransactionObjectIDType[] idField;
		...
		public Credit_Card_TransactionObjectIDType[] ID
		{
			get
			{
				return this.idField;
