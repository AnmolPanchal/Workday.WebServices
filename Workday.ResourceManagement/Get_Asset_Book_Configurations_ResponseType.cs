...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Asset_Book_Configurations_ResponseType : INotifyPropertyChanged
	{
		private Unique_IdentifierObjectType[] request_ReferencesField;

		private Asset_Book_Configurations_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Asset_Depreciation_ScheduleType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Asset_Book_Configuration_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Asset_Book_Configurations_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Asset_Depreciation_Schedule", IsNullable = false)]
		public Asset_Depreciation_ScheduleType[] Response_Data
		{
			get
			{
