...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Request_for_Quote_Award_LineObjectType : INotifyPropertyChanged
	{
		private Request_for_Quote_Award_LineObjectIDType[] idField;
		...
		public Request_for_Quote_Award_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
