...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Reinstate_Asset_RequestType : INotifyPropertyChanged
	{
		private Financials_Business_Process_ParametersType business_Process_ParametersField;

		private Reinstate_Asset_WWS_DataType reinstate_Asset_DataField;
		...
		[XmlElement(Order = 1)]
		public Reinstate_Asset_WWS_DataType Reinstate_Asset_Data
		{
			get
			{
				return this.reinstate_Asset_DataField;
			}
			set
			{
				this.reinstate_Asset_DataField = value;
				this.RaisePropertyChanged("Reinstate_Asset_Data");
			}
		}
