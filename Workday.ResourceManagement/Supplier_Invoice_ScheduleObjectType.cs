...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Supplier_Invoice_ScheduleObjectType : INotifyPropertyChanged
	{
		private Supplier_Invoice_ScheduleObjectIDType[] idField;
		...
		public Supplier_Invoice_ScheduleObjectIDType[] ID
		{
			get
			{
				return this.idField;
