...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Reason_for_Supplier_Status_ChangeObjectType : INotifyPropertyChanged
	{
		private Reason_for_Supplier_Status_ChangeObjectIDType[] idField;
		...
		public Reason_for_Supplier_Status_ChangeObjectIDType[] ID
		{
			get
			{
				return this.idField;
