...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Purchase_Order_Line_SplitObjectType : INotifyPropertyChanged
	{
		private Purchase_Order_Line_SplitObjectIDType[] idField;
		...
		public Purchase_Order_Line_SplitObjectIDType[] ID
		{
			get
			{
				return this.idField;
