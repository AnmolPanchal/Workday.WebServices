...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Arithmetic_OperatorObjectType : INotifyPropertyChanged
	{
		private Arithmetic_OperatorObjectIDType[] idField;
		...
		public Arithmetic_OperatorObjectIDType[] ID
		{
			get
			{
				return this.idField;
