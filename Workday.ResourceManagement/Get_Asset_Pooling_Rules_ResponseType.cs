...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Asset_Pooling_Rules_ResponseType : INotifyPropertyChanged
	{
		private Asset_Pooling_RuleObjectType[] request_ReferencesField;

		private Asset_Pooling_Rule_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Asset_Pooling_Rule_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Asset_Pooling_RuleType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Asset_Pooling_Rule_Reference", IsNullable = false)]
		public Asset_Pooling_RuleObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Asset_Pooling_Rule_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Asset_Pooling_Rule_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Asset_Pooling_Rule", IsNullable = false)]
		public Asset_Pooling_RuleType[] Response_Data
		{
			get
			{
