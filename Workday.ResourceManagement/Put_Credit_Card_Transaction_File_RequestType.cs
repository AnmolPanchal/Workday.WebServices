...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Put_Credit_Card_Transaction_File_RequestType : INotifyPropertyChanged
	{
		private Credit_Card_Transaction_FileObjectType expense_Credit_Card_Transaction_File_ReferenceField;

		private Credit_Card_Transaction_File_DataType expense_Credit_Card_Transaction_File_DataField;
		...
		[XmlElement(Order = 1)]
		public Credit_Card_Transaction_File_DataType Expense_Credit_Card_Transaction_File_Data
		{
			get
			{
