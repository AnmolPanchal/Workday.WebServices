...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Credit_Card_Transaction_Files_ResponseType : INotifyPropertyChanged
	{
		private Credit_Card_Transaction_FileObjectType[] request_ReferencesField;

		private Credit_Card_Transaction_File_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Credit_Card_Transaction_File_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Credit_Card_Transaction_FileType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Expense_Credit_Card_Transaction_File_Reference", IsNullable = false)]
		public Credit_Card_Transaction_FileObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Credit_Card_Transaction_File_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Credit_Card_Transaction_File_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Credit_Card_Transaction_File", IsNullable = false)]
		public Credit_Card_Transaction_FileType[] Response_Data
		{
			get
			{
