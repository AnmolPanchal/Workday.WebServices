...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Cardholder_Listing_FileObjectType : INotifyPropertyChanged
	{
		private Cardholder_Listing_FileObjectIDType[] idField;
		...
		public Cardholder_Listing_FileObjectIDType[] ID
		{
			get
			{
				return this.idField;
