...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Request_for_Quote_Award_TypeObjectType : INotifyPropertyChanged
	{
		private Request_for_Quote_Award_TypeObjectIDType[] idField;
		...
		public Request_for_Quote_Award_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
