...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Requirements_for_Resource_Plan_ResponseType : INotifyPropertyChanged
	{
		private Project_Resource_PlanObjectType[] request_ReferencesField;

		private Resource_Plan_Request_CriteriaType[] request_CriteriaField;

		private Response_FilterType[] response_FilterField;

		private Resource_Plan_Response_GroupType[] response_GroupField;

		private Response_ResultsType[] response_ResultsField;

		private Resource_Plan_for_RequirementsType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Resource_Plan_Reference", typeof(Project_Resource_PlanObjectType), IsNullable = false)]
		public Project_Resource_PlanObjectType[] Request_References
		{
			get
			{
		...
		public Resource_Plan_Request_CriteriaType[] Request_Criteria
		{
			get
			{
		...
		public Resource_Plan_Response_GroupType[] Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Resource_Plan_Requirement", typeof(Resource_Plan_for_RequirementsType), IsNullable = false)]
		public Resource_Plan_for_RequirementsType[] Response_Data
		{
			get
			{
