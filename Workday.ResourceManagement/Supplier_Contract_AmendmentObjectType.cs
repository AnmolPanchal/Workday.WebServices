...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Supplier_Contract_AmendmentObjectType : INotifyPropertyChanged
	{
		private Supplier_Contract_AmendmentObjectIDType[] idField;
		...
		public Supplier_Contract_AmendmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
