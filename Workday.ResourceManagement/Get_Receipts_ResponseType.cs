...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Receipts_ResponseType : INotifyPropertyChanged
	{
		private ReceiptObjectType[] request_ReferencesField;

		private Receipt_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Receipt_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private ReceiptType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Receipt_Reference", IsNullable = false)]
		public ReceiptObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Receipt_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Receipt_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Receipt", IsNullable = false)]
		public ReceiptType[] Response_Data
		{
			get
			{
