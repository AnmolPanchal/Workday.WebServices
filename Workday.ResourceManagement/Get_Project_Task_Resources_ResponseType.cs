...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Project_Task_Resources_ResponseType : INotifyPropertyChanged
	{
		private ProjectObjectType[] request_ReferencesField;

		private Project_Task_Resources_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Project_Task_Resources_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Project_Task_ResourcesType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Project_Reference", IsNullable = false)]
		public ProjectObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Project_Task_Resources_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Project_Task_Resources_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Project_Task_Resources", IsNullable = false)]
		public Project_Task_ResourcesType[] Response_Data
		{
			get
			{
