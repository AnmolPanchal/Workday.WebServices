...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Project_Member_ResourceObjectType : INotifyPropertyChanged
	{
		private Project_Member_ResourceObjectIDType[] idField;
		...
		public Project_Member_ResourceObjectIDType[] ID
		{
			get
			{
				return this.idField;
