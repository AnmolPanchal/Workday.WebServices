...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Travel_Cities_ResponseType : INotifyPropertyChanged
	{
		private Travel_CityObjectType[] request_ReferencesField;

		private Travel_City_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Travel_City_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Travel_CityType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Travel_City_Reference", IsNullable = false)]
		public Travel_CityObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Travel_City_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Travel_City_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Travel_City", IsNullable = false)]
		public Travel_CityType[] Response_Data
		{
			get
			{
