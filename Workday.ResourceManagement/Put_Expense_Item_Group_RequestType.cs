...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Put_Expense_Item_Group_RequestType : INotifyPropertyChanged
	{
		private Expense_Item_GroupObjectType expense_Item_Group_ReferenceField;

		private Expense_Item_Group_DataType expense_Item_Group_DataField;
		...
		[XmlElement(Order = 1)]
		public Expense_Item_Group_DataType Expense_Item_Group_Data
		{
			get
			{
				return this.expense_Item_Group_DataField;
			}
			set
			{
				this.expense_Item_Group_DataField = value;
				this.RaisePropertyChanged("Expense_Item_Group_Data");
			}
		}
