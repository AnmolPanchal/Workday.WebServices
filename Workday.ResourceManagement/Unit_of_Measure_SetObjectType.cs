...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Unit_of_Measure_SetObjectType : INotifyPropertyChanged
	{
		private Unit_of_Measure_SetObjectIDType[] idField;
		...
		public Unit_of_Measure_SetObjectIDType[] ID
		{
			get
			{
				return this.idField;
