...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Spend_Authorization_Response_GroupType : INotifyPropertyChanged
	{
		private bool include_ReferenceField;

		private bool include_ReferenceFieldSpecified;

		private bool include_Spend_Authorization_DataField;

		private bool include_Spend_Authorization_DataFieldSpecified;
		...
		[XmlElement(Order = 1)]
		public bool Include_Spend_Authorization_Data
		{
			get
			{
				return this.include_Spend_Authorization_DataField;
			}
			set
			{
				this.include_Spend_Authorization_DataField = value;
				this.RaisePropertyChanged("Include_Spend_Authorization_Data");
			}
		}

		[XmlIgnore]
		public bool Include_Spend_Authorization_DataSpecified
		{
			get
			{
				return this.include_Spend_Authorization_DataFieldSpecified;
			}
			set
			{
				this.include_Spend_Authorization_DataFieldSpecified = value;
				this.RaisePropertyChanged("Include_Spend_Authorization_DataSpecified");
			}
		}
