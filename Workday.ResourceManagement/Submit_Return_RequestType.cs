...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Submit_Return_RequestType : INotifyPropertyChanged
	{
		...
		private Submit_Return_DataType submit_Return_DataField;
		...
		[XmlElement(Order = 2)]
		public Submit_Return_DataType Submit_Return_Data
		{
			get
			{
				return this.submit_Return_DataField;
			}
			set
			{
				this.submit_Return_DataField = value;
				this.RaisePropertyChanged("Submit_Return_Data");
			}
		}
