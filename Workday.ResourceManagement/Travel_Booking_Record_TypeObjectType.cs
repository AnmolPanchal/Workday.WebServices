...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Travel_Booking_Record_TypeObjectType : INotifyPropertyChanged
	{
		private Travel_Booking_Record_TypeObjectIDType[] idField;
		...
		public Travel_Booking_Record_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
