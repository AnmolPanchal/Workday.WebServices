...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Purchase_Order_Change_Order_OutboundType : INotifyPropertyChanged
	{
		private Purchase_Order_Change_OrderObjectType purchase_Order_Change_Order_ReferenceField;

		private Purchase_Order_Change_Order_Outbound_DataType[] purchase_Order_Change_Order_DataField;
		...
		[XmlElement("Purchase_Order_Change_Order_Data", Order = 1)]
		public Purchase_Order_Change_Order_Outbound_DataType[] Purchase_Order_Change_Order_Data
		{
			get
			{
