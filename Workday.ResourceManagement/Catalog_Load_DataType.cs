...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Catalog_Load_DataType : INotifyPropertyChanged
	{
		...
		private Catalog_Load_Item_DataType[] catalog_Load_Item_DataField;
		...
		[XmlElement("Catalog_Load_Item_Data", Order = 4)]
		public Catalog_Load_Item_DataType[] Catalog_Load_Item_Data
		{
			get
			{
