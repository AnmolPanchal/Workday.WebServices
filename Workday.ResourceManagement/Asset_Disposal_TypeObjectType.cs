...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Asset_Disposal_TypeObjectType : INotifyPropertyChanged
	{
		private Asset_Disposal_TypeObjectIDType[] idField;
		...
		public Asset_Disposal_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
