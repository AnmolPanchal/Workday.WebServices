...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Internal_Catalogs_ResponseType : INotifyPropertyChanged
	{
		private Internal_Service_CatalogObjectType[] request_ReferencesField;

		private Internal_Catalog_Request_CriteriaType[] request_CriteriaField;

		private Response_FilterType[] response_FilterField;

		private Internal_Catalog_Response_GroupType[] response_GroupField;

		private Response_ResultsType[] response_ResultsField;

		private Internal_CatalogType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Internal_Catalog_Reference", typeof(Internal_Service_CatalogObjectType), IsNullable = false)]
		public Internal_Service_CatalogObjectType[] Request_References
		{
			get
			{
		...
		public Internal_Catalog_Request_CriteriaType[] Request_Criteria
		{
			get
			{
		...
		public Internal_Catalog_Response_GroupType[] Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Internal_Catalog", typeof(Internal_CatalogType), IsNullable = false)]
		public Internal_CatalogType[] Response_Data
		{
			get
			{
