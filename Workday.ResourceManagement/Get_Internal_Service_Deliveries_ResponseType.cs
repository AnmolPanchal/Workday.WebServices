...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Internal_Service_Deliveries_ResponseType : INotifyPropertyChanged
	{
		private Internal_Service_DeliveryObjectType[] request_ReferencesField;

		private Internal_Service_Delivery_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Internal_Service_Delivery_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Internal_Service_Delivery_OutboundType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Internal_Service_Delivery_Reference", IsNullable = false)]
		public Internal_Service_DeliveryObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Internal_Service_Delivery_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Internal_Service_Delivery_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Internal_Service_Delivery", IsNullable = false)]
		public Internal_Service_Delivery_OutboundType[] Response_Data
		{
			get
			{
