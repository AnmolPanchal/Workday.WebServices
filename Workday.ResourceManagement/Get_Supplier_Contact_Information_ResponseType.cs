...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Supplier_Contact_Information_ResponseType : INotifyPropertyChanged
	{
		private SupplierObjectType[] request_ReferencesField;

		private Supplier_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Supplier_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Supplier_Contact_InformationType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Supplier_Reference", IsNullable = false)]
		public SupplierObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Supplier_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Supplier_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Supplier_Contact_Information", IsNullable = false)]
		public Supplier_Contact_InformationType[] Response_Data
		{
			get
			{
