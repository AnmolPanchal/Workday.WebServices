...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Expense_Item_Attribute_TypeObjectType : INotifyPropertyChanged
	{
		private Expense_Item_Attribute_TypeObjectIDType[] idField;
		...
		public Expense_Item_Attribute_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
