...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Inventory_ABC_ClassificationObjectType : INotifyPropertyChanged
	{
		private Inventory_ABC_ClassificationObjectIDType[] idField;
		...
		public Inventory_ABC_ClassificationObjectIDType[] ID
		{
			get
			{
				return this.idField;
