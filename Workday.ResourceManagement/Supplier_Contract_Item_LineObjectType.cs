...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Supplier_Contract_Item_LineObjectType : INotifyPropertyChanged
	{
		private Supplier_Contract_Item_LineObjectIDType[] idField;
		...
		public Supplier_Contract_Item_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
