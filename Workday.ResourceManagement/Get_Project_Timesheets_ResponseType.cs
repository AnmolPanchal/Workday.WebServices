...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Project_Timesheets_ResponseType : INotifyPropertyChanged
	{
		private Project_TimesheetObjectType[] request_ReferencesField;

		private Project_Timesheet_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Project_TimesheetType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Project_Timesheet_Reference", IsNullable = false)]
		public Project_TimesheetObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Project_Timesheet_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Project_Timesheet", IsNullable = false)]
		public Project_TimesheetType[] Response_Data
		{
			get
			{
