...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Travel_Profiles_ResponseType : INotifyPropertyChanged
	{
		private Unique_IdentifierObjectType[] request_ReferencesField;

		private Travel_Profile_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Travel_Profile_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Travel_ProfileType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Travel_Profile_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Travel_Profile_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Travel_Profile_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Travel_Profile", IsNullable = false)]
		public Travel_ProfileType[] Response_Data
		{
			get
			{
