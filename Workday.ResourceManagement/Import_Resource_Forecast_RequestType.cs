...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Import_Resource_Forecast_RequestType : INotifyPropertyChanged
	{
		private Resource_ForecastObjectType resource_Forecast_ReferenceField;

		private Resource_Forecast__HV__DataType resource_Forecast_DataField;
		...
		[XmlElement(Order = 1)]
		public Resource_Forecast__HV__DataType Resource_Forecast_Data
		{
			get
			{
				return this.resource_Forecast_DataField;
			}
			set
			{
				this.resource_Forecast_DataField = value;
				this.RaisePropertyChanged("Resource_Forecast_Data");
			}
		}
