...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Supplier_Contract_BaseObjectType : INotifyPropertyChanged
	{
		private Supplier_Contract_BaseObjectIDType[] idField;
		...
		public Supplier_Contract_BaseObjectIDType[] ID
		{
			get
			{
				return this.idField;
