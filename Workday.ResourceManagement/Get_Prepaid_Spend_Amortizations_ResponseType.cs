...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Prepaid_Spend_Amortizations_ResponseType : INotifyPropertyChanged
	{
		private Prepaid_Spend_Amortization_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Prepaid_Spend_Amortization_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Prepaid_Spend_AmortizationType[] response_DataField;
		...
		[XmlElement(Order = 0)]
		public Prepaid_Spend_Amortization_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 2)]
		public Prepaid_Spend_Amortization_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Prepaid_Spend_Amortization", IsNullable = false)]
		public Prepaid_Spend_AmortizationType[] Response_Data
		{
			get
			{
