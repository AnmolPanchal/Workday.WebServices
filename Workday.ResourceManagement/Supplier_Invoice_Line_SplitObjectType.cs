...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Supplier_Invoice_Line_SplitObjectType : INotifyPropertyChanged
	{
		private Supplier_Invoice_Line_SplitObjectIDType[] idField;
		...
		public Supplier_Invoice_Line_SplitObjectIDType[] ID
		{
			get
			{
				return this.idField;
