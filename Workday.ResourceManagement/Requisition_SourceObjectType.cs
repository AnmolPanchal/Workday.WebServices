...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Requisition_SourceObjectType : INotifyPropertyChanged
	{
		private Requisition_SourceObjectIDType[] idField;
		...
		public Requisition_SourceObjectIDType[] ID
		{
			get
			{
				return this.idField;
