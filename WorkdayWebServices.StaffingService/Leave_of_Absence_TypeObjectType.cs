...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Leave_of_Absence_TypeObjectType : INotifyPropertyChanged
	{
		private Leave_of_Absence_TypeObjectIDType[] idField;
		...
		public Leave_of_Absence_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
