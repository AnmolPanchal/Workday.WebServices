...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Change_Job_SubcategoryObjectType : INotifyPropertyChanged
	{
		private Change_Job_SubcategoryObjectIDType[] idField;
		...
		public Change_Job_SubcategoryObjectIDType[] ID
		{
			get
			{
				return this.idField;
