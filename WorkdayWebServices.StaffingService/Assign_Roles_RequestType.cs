...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Assign_Roles_RequestType : INotifyPropertyChanged
	{
		private Business_Process_ParametersType business_Process_ParametersField;

		private Assign_Roles_Event_DataType assign_Roles_Event_DataField;
		...
		[XmlElement(Order = 1)]
		public Assign_Roles_Event_DataType Assign_Roles_Event_Data
		{
			get
			{
				return this.assign_Roles_Event_DataField;
			}
			set
			{
				this.assign_Roles_Event_DataField = value;
				this.RaisePropertyChanged("Assign_Roles_Event_Data");
			}
		}
