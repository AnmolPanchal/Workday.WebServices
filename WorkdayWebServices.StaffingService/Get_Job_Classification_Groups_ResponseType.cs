...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Get_Job_Classification_Groups_ResponseType : INotifyPropertyChanged
	{
		private Job_Classification_GroupObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Job_Classification_Group_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Job_Classification_Group_NewType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Job_Classification_Group_Reference", IsNullable = false)]
		public Job_Classification_GroupObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 2)]
		public Job_Classification_Group_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Job_Classification_Group", IsNullable = false)]
		public Job_Classification_Group_NewType[] Response_Data
		{
			get
			{
