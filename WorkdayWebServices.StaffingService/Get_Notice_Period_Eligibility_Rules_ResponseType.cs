...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Get_Notice_Period_Eligibility_Rules_ResponseType : INotifyPropertyChanged
	{
		...
		private Notice_Period_Eligibility_RuleType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Notice_Period_Eligibility_Rule_Reference", IsNullable = false)]
		...
		[XmlArray(Order = 3), XmlArrayItem("Notice_Period_Eligibility_Rule", IsNullable = false)]
		public Notice_Period_Eligibility_RuleType[] Response_Data
		{
			get
			{
