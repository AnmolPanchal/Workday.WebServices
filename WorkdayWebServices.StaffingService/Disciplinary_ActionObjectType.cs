...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Disciplinary_ActionObjectType : INotifyPropertyChanged
	{
		private Disciplinary_ActionObjectIDType[] idField;
		...
		public Disciplinary_ActionObjectIDType[] ID
		{
			get
			{
				return this.idField;
