...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Close_Position_RequestType : INotifyPropertyChanged
	{
		private Business_Process_ParametersType business_Process_ParametersField;

		private Close_Position_DataType close_Restriction_DataField;
		...
		[XmlElement(Order = 1)]
		public Close_Position_DataType Close_Restriction_Data
		{
			get
			{
				return this.close_Restriction_DataField;
			}
			set
			{
				this.close_Restriction_DataField = value;
				this.RaisePropertyChanged("Close_Restriction_Data");
			}
		}
