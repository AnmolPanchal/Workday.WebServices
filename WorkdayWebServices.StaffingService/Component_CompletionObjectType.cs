...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Component_CompletionObjectType : INotifyPropertyChanged
	{
		private Component_CompletionObjectIDType[] idField;
		...
		public Component_CompletionObjectIDType[] ID
		{
			get
			{
				return this.idField;
