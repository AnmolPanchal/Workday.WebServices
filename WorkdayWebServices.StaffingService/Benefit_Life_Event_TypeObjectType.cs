...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Benefit_Life_Event_TypeObjectType : INotifyPropertyChanged
	{
		private Benefit_Life_Event_TypeObjectIDType[] idField;
		...
		public Benefit_Life_Event_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
