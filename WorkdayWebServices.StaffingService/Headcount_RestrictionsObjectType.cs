...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Headcount_RestrictionsObjectType : INotifyPropertyChanged
	{
		private Headcount_RestrictionsObjectIDType[] idField;
		...
		public Headcount_RestrictionsObjectIDType[] ID
		{
			get
			{
				return this.idField;
