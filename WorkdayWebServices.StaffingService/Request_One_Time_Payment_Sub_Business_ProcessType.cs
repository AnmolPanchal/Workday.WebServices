...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Request_One_Time_Payment_Sub_Business_ProcessType : INotifyPropertyChanged
	{
		private Business_Sub_Process_ParametersType business_Sub_Process_ParametersField;

		private OneTime_Payment_DataType[] request_One_Time_Payment_DataField;
		...
		[XmlElement("Request_One_Time_Payment_Data", Order = 1)]
		public OneTime_Payment_DataType[] Request_One_Time_Payment_Data
		{
			get
			{
				return this.request_One_Time_Payment_DataField;
			}
			set
			{
				this.request_One_Time_Payment_DataField = value;
				this.RaisePropertyChanged("Request_One_Time_Payment_Data");
			}
		}
