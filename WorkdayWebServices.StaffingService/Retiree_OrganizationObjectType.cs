...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Retiree_OrganizationObjectType : INotifyPropertyChanged
	{
		private Retiree_OrganizationObjectIDType[] idField;
		...
		public Retiree_OrganizationObjectIDType[] ID
		{
			get
			{
				return this.idField;
