...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Military_Information_DataType : INotifyPropertyChanged
	{
		private Military_Service_Information_DataType[] military_Service_Information_DataField;
		...
		public Military_Service_Information_DataType[] Military_Service_Information_Data
		{
			get
			{
