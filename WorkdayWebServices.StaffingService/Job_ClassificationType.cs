...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Job_ClassificationType : INotifyPropertyChanged
	{
		private Job_ClassificationObjectType job_Classification_ReferenceField;

		private Job_Classification_DataType job_Classification_DataField;
		...
		[XmlElement(Order = 1)]
		public Job_Classification_DataType Job_Classification_Data
		{
			get
			{
