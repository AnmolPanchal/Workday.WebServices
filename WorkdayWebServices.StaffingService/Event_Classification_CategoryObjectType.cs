...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Event_Classification_CategoryObjectType : INotifyPropertyChanged
	{
		private Event_Classification_CategoryObjectIDType[] idField;
		...
		public Event_Classification_CategoryObjectIDType[] ID
		{
			get
			{
				return this.idField;
