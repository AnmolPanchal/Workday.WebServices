...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Academic_Appointment_TrackObjectType : INotifyPropertyChanged
	{
		private Academic_Appointment_TrackObjectIDType[] idField;
		...
		public Academic_Appointment_TrackObjectIDType[] ID
		{
			get
			{
				return this.idField;
