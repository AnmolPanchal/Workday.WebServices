...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Onboarding_Setup_Sub_Business_ProcessType : INotifyPropertyChanged
	{
		private Business_Sub_Process_ParametersType business_Sub_Process_ParametersField;

		private Onboarding_Setup_DataType onboarding_Setup_DataField;
		...
		[XmlElement(Order = 1)]
		public Onboarding_Setup_DataType Onboarding_Setup_Data
		{
			get
			{
				return this.onboarding_Setup_DataField;
			}
			set
			{
				this.onboarding_Setup_DataField = value;
				this.RaisePropertyChanged("Onboarding_Setup_Data");
			}
		}
