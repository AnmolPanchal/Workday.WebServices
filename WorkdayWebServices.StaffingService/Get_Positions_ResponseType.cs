...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Get_Positions_ResponseType : INotifyPropertyChanged
	{
		private Position_Request_ReferencesType[] request_ReferencesField;

		private Position_Request_CriteriaType[] request_CriteriaField;

		private Response_FilterType[] response_FilterField;

		private Position_Response_GroupType[] response_GroupField;

		private Response_ResultsType[] response_ResultsField;

		private Position_RestrictionType[] response_DataField;
		...
		public Position_Request_ReferencesType[] Request_References
		{
			get
			{
		...
		public Position_Request_CriteriaType[] Request_Criteria
		{
			get
			{
		...
		public Position_Response_GroupType[] Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Position", typeof(Position_RestrictionType), IsNullable = false)]
		public Position_RestrictionType[] Response_Data
		{
			get
			{
