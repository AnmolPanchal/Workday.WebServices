...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Employee_Allowance_Unit_Plan_Assignment_DataType : INotifyPropertyChanged
	{
		private Allowance_Unit_PlanObjectType compensation_Plan_ReferenceField;
		...
		[XmlElement(Order = 0)]
		public Allowance_Unit_PlanObjectType Compensation_Plan_Reference
		{
			get
			{
