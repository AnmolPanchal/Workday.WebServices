...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Employee_Base_Pay_Plan_Assignment_DataType : INotifyPropertyChanged
	{
		private Salary_Pay_PlanObjectType compensation_Plan_ReferenceField;
		...
		[XmlElement(Order = 0)]
		public Salary_Pay_PlanObjectType Compensation_Plan_Reference
		{
			get
			{
