...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Get_Worker_Documents_ResponseType : INotifyPropertyChanged
	{
		private Worker_DocumentObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Worker_Document_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Worker_DocumentType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Worker_Document_Reference", IsNullable = false)]
		public Worker_DocumentObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 2)]
		public Worker_Document_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Worker_Document", IsNullable = false)]
		public Worker_DocumentType[] Response_Data
		{
			get
			{
