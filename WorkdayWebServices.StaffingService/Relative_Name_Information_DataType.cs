...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Relative_Name_Information_DataType : INotifyPropertyChanged
	{
		private Relative_Name_DataType[] relative_Name_DataField;
		...
		[XmlElement("Relative_Name_Data", Order = 0)]
		public Relative_Name_DataType[] Relative_Name_Data
		{
			get
			{
				return this.relative_Name_DataField;
			}
			set
			{
				this.relative_Name_DataField = value;
				this.RaisePropertyChanged("Relative_Name_Data");
			}
		}
