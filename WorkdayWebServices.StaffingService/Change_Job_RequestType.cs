...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Change_Job_RequestType : INotifyPropertyChanged
	{
		private Business_Process_ParametersType business_Process_ParametersField;

		private Change_Job_DataType change_Job_DataField;
		...
		[XmlElement(Order = 1)]
		public Change_Job_DataType Change_Job_Data
		{
			get
			{
				return this.change_Job_DataField;
			}
			set
			{
				this.change_Job_DataField = value;
				this.RaisePropertyChanged("Change_Job_Data");
			}
		}
