...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Hierarchic_AssignerObjectType : INotifyPropertyChanged
	{
		private Hierarchic_AssignerObjectIDType[] idField;
		...
		public Hierarchic_AssignerObjectIDType[] ID
		{
			get
			{
				return this.idField;
