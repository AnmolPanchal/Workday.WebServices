...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Request_Stock_Sub_Business_ProcessType : INotifyPropertyChanged
	{
		private Business_Sub_Process_ParametersType business_Sub_Process_ParametersField;

		private Request_Stock_Grant_SubdataType request_Stock_Grant_DataField;
		...
		[XmlElement(Order = 1)]
		public Request_Stock_Grant_SubdataType Request_Stock_Grant_Data
		{
			get
			{
				return this.request_Stock_Grant_DataField;
			}
			set
			{
				this.request_Stock_Grant_DataField = value;
				this.RaisePropertyChanged("Request_Stock_Grant_Data");
			}
		}
