...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Get_Citizenship_Statuses_RequestType : INotifyPropertyChanged
	{
		private Citizenship_Status_Request_ReferencesType itemField;
		...
		public Citizenship_Status_Request_ReferencesType Item
		{
			get
			{
