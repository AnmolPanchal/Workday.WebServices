...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Political_AffiliationObjectType : INotifyPropertyChanged
	{
		private Political_AffiliationObjectIDType[] idField;
		...
		public Political_AffiliationObjectIDType[] ID
		{
			get
			{
				return this.idField;
