...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Organization_Role_for_Worker_DataType : INotifyPropertyChanged
	{
		private Assignable_RoleObjectType organization_Role_ReferenceField;

		private Organization_Role_Assignment_for_Worker_DataType[] organization_Role_DataField;
		...
		public Organization_Role_Assignment_for_Worker_DataType[] Organization_Role_Data
		{
			get
			{
