...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Get_Student_Employment_Eligibility_Data_ResponseType : INotifyPropertyChanged
	{
		private Student_Employment_Eligibility_EventObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Student_Employment_Eligibility_Event_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Student_Employment_Eligibility_EventType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Student_Employment_Eligibility_Event_Reference", IsNullable = false)]
		public Student_Employment_Eligibility_EventObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 2)]
		public Student_Employment_Eligibility_Event_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Student_Employment_Eligibility_Event", IsNullable = false)]
		public Student_Employment_Eligibility_EventType[] Response_Data
		{
			get
			{
