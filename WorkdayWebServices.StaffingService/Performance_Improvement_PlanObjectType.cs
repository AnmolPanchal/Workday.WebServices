...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Performance_Improvement_PlanObjectType : INotifyPropertyChanged
	{
		private Performance_Improvement_PlanObjectIDType[] idField;
		...
		public Performance_Improvement_PlanObjectIDType[] ID
		{
			get
			{
				return this.idField;
