...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Hire_Employee_RequestType : INotifyPropertyChanged
	{
		private Business_Process_ParametersType business_Process_ParametersField;

		private Hire_Employee_Business_Process_DataType hire_Employee_DataField;
		...
		[XmlElement(Order = 1)]
		public Hire_Employee_Business_Process_DataType Hire_Employee_Data
		{
			get
			{
				return this.hire_Employee_DataField;
			}
			set
			{
				this.hire_Employee_DataField = value;
				this.RaisePropertyChanged("Hire_Employee_Data");
			}
		}
