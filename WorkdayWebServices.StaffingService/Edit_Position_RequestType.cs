...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Edit_Position_RequestType : INotifyPropertyChanged
	{
		private Business_Process_ParametersType business_Process_ParametersField;

		private Edit_Position_DataType edit_Position_DataField;
		...
		[XmlElement(Order = 1)]
		public Edit_Position_DataType Edit_Position_Data
		{
			get
			{
				return this.edit_Position_DataField;
			}
			set
			{
				this.edit_Position_DataField = value;
				this.RaisePropertyChanged("Edit_Position_Data");
			}
		}
