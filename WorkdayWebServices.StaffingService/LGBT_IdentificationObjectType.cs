...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class LGBT_IdentificationObjectType : INotifyPropertyChanged
	{
		private LGBT_IdentificationObjectIDType[] idField;
		...
		public LGBT_IdentificationObjectIDType[] ID
		{
			get
			{
				return this.idField;
