...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Onboarding_Setup_TemplateObjectType : INotifyPropertyChanged
	{
		private Onboarding_Setup_TemplateObjectIDType[] idField;
		...
		public Onboarding_Setup_TemplateObjectIDType[] ID
		{
			get
			{
				return this.idField;
