...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Academic_Tenure_StatusObjectType : INotifyPropertyChanged
	{
		private Academic_Tenure_StatusObjectIDType[] idField;
		...
		public Academic_Tenure_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
