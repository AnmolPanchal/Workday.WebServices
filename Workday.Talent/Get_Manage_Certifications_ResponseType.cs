...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Manage_Certifications_ResponseType : INotifyPropertyChanged
	{
		...
		private Manage_Certifications_for_RoleType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Role_Reference", IsNullable = false)]
		...
		[XmlArray(Order = 3), XmlArrayItem("Manage_Certifications", IsNullable = false)]
		public Manage_Certifications_for_RoleType[] Response_Data
		{
			get
			{
