...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Fields_Of_Study_ResponseType : INotifyPropertyChanged
	{
		...
		[XmlArray(Order = 0), XmlArrayItem("Field_Of_Study_Reference", IsNullable = false)]
		...
		[XmlArray(Order = 3), XmlArrayItem("Field_Of_Study", IsNullable = false)]
