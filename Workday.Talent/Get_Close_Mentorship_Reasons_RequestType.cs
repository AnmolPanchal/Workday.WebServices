...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Close_Mentorship_Reasons_RequestType : INotifyPropertyChanged
	{
		private Close_Mentorship_Reason_Request_ReferencesType itemField;
		...
		public Close_Mentorship_Reason_Request_ReferencesType Item
		{
			get
			{
