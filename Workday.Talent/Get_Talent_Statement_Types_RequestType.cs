...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Talent_Statement_Types_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Talent_Statement_Type_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Talent_Statement_Type_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
