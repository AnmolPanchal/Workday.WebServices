...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Mentorships_ResponseType : INotifyPropertyChanged
	{
		private MentorshipObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private MentorshipType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Mentorship_Reference", IsNullable = false)]
		public MentorshipObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Mentorship", IsNullable = false)]
		public MentorshipType[] Response_Data
		{
			get
			{
