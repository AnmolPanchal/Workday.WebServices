...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Mentorships_RequestType : INotifyPropertyChanged
	{
		private Mentorship_Request_ReferencesType itemField;
		...
		public Mentorship_Request_ReferencesType Item
		{
			get
			{
