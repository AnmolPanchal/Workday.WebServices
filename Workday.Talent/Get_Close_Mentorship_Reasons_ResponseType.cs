...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Close_Mentorship_Reasons_ResponseType : INotifyPropertyChanged
	{
		private Close_Mentorship_ReasonObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Close_Mentorship_ReasonType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Close_Mentorship_Reason_Reference", IsNullable = false)]
		public Close_Mentorship_ReasonObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Close_Mentorship_Reason", IsNullable = false)]
		public Close_Mentorship_ReasonType[] Response_Data
		{
			get
			{
