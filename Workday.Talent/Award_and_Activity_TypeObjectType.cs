...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Award_and_Activity_TypeObjectType : INotifyPropertyChanged
	{
		private Award_and_Activity_TypeObjectIDType[] idField;
		...
		public Award_and_Activity_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
