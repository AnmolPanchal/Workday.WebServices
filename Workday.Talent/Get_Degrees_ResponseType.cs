...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Degrees_ResponseType : INotifyPropertyChanged
	{
		...
		[XmlArray(Order = 0), XmlArrayItem("Degree_Reference", IsNullable = false)]
		...
		[XmlArray(Order = 3), XmlArrayItem("Degree", IsNullable = false)]
