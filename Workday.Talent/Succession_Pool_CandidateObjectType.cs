...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Succession_Pool_CandidateObjectType : INotifyPropertyChanged
	{
		private Succession_Pool_CandidateObjectIDType[] idField;
		...
		public Succession_Pool_CandidateObjectIDType[] ID
		{
			get
			{
				return this.idField;
