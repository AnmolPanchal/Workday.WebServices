...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Succession_Strategies_ResponseType : INotifyPropertyChanged
	{
		private Succession_StrategyObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Succession_StrategyType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Succession_Strategy_Reference", IsNullable = false)]
		public Succession_StrategyObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Succession_Strategy", IsNullable = false)]
		public Succession_StrategyType[] Response_Data
		{
			get
			{
