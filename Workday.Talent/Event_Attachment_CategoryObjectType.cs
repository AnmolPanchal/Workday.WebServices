...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Event_Attachment_CategoryObjectType : INotifyPropertyChanged
	{
		private Event_Attachment_CategoryObjectIDType[] idField;
		...
		public Event_Attachment_CategoryObjectIDType[] ID
		{
			get
			{
				return this.idField;
