...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Worker_Contact_ConnectionObjectType : INotifyPropertyChanged
	{
		private Worker_Contact_ConnectionObjectIDType[] idField;
		...
		public Worker_Contact_ConnectionObjectIDType[] ID
		{
			get
			{
				return this.idField;
