...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Subspecialties_ResponseType : INotifyPropertyChanged
	{
		private Specialty_ChildObjectType[] request_ReferencesField;

		private Subspecialty_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private SubspecialtyType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Subspecialty_Reference", IsNullable = false)]
		public Specialty_ChildObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Subspecialty_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Subspecialty", IsNullable = false)]
		public SubspecialtyType[] Response_Data
		{
			get
			{
