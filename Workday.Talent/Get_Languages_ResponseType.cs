...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Languages_ResponseType : INotifyPropertyChanged
	{
		private LanguageObjectType[] request_ReferencesField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Language_Reference", IsNullable = false)]
		public LanguageObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Language", IsNullable = false)]
