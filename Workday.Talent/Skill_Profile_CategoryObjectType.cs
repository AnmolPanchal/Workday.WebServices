...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Skill_Profile_CategoryObjectType : INotifyPropertyChanged
	{
		private Skill_Profile_CategoryObjectIDType[] idField;
		...
		public Skill_Profile_CategoryObjectIDType[] ID
		{
			get
			{
				return this.idField;
