...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_School_Types_RequestType : INotifyPropertyChanged
	{
		private School_Type_Request_ReferencesType itemField;
		...
		public School_Type_Request_ReferencesType Item
		{
			get
			{
