...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Work_Experiences_ResponseType : INotifyPropertyChanged
	{
		private Work_Experience_SkillObjectType[] request_ReferencesField;

		private Work_Experience_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Work_Experience_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Work_Experience_SkillType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Work_Experience_Reference", IsNullable = false)]
		public Work_Experience_SkillObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Work_Experience_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Work_Experience_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Work_Experience_Skill", IsNullable = false)]
		public Work_Experience_SkillType[] Response_Data
		{
			get
			{
