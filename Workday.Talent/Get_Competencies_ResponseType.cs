...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Competencies_ResponseType : INotifyPropertyChanged
	{
		...
		[XmlArray(Order = 0), XmlArrayItem("Competency_Reference", IsNullable = false)]
		...
		[XmlArray(Order = 5), XmlArrayItem("Competency", IsNullable = false)]
