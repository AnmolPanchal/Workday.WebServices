...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Subspecialties_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Subspecialty_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Subspecialty_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
