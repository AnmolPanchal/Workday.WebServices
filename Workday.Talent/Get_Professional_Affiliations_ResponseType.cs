...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Professional_Affiliations_ResponseType : INotifyPropertyChanged
	{
		private Professional_Affiliation_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Professional_AffiliationType[] response_DataField;
		...
		[XmlElement(Order = 0)]
		public Professional_Affiliation_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 2), XmlArrayItem("Professional_Affiliation", IsNullable = false)]
		public Professional_AffiliationType[] Response_Data
		{
			get
			{
