...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Contact_Connections_ResponseType : INotifyPropertyChanged
	{
		private Worker_Contact_ConnectionObjectType[] request_ReferencesField;

		private Worker_Contact_Connection_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Worker_Contact_Connection_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Worker_Contact_ConnectionType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Worker_Contact_Connection_Reference", IsNullable = false)]
		public Worker_Contact_ConnectionObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Worker_Contact_Connection_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Worker_Contact_Connection_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Worker_Contact_Connection", IsNullable = false)]
		public Worker_Contact_ConnectionType[] Response_Data
		{
			get
			{
