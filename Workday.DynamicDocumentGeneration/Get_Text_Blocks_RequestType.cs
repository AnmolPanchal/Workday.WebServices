...
namespace WorkdayWebServices.Dynamic_Document_GenerationService
{
	...
	[Serializable]
	public class Get_Text_Blocks_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Text_Block_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Text_Block_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
