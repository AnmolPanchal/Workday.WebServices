...
namespace WorkdayWebServices.Dynamic_Document_GenerationService
{
	...
	[Serializable]
	public class Get_Text_Blocks_ResponseType : INotifyPropertyChanged
	{
		private Text_BlockObjectType[] request_ReferencesField;

		private Text_Block_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Text_BlockType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Text_Block_Reference", IsNullable = false)]
		public Text_BlockObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Text_Block_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Text_Block", IsNullable = false)]
		public Text_BlockType[] Response_Data
		{
			get
			{
