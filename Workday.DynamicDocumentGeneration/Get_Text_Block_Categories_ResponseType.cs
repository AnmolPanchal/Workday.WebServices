...
namespace WorkdayWebServices.Dynamic_Document_GenerationService
{
	...
	[Serializable]
	public class Get_Text_Block_Categories_ResponseType : INotifyPropertyChanged
	{
		private Text_Block_CategoryObjectType[] request_ReferencesField;

		private Text_Block_Category_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Text_Block_Category_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Text_Block_CategoryType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Text_Block_Category_Reference", IsNullable = false)]
		public Text_Block_CategoryObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Text_Block_Category_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Text_Block_Category_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Text_Block_Category", IsNullable = false)]
		public Text_Block_CategoryType[] Response_Data
		{
			get
			{
