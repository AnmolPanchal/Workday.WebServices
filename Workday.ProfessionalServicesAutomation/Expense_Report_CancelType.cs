...
namespace WorkdayWebServices.Professional_Services_AutomationService
{
	...
	[Serializable]
	public class Expense_Report_CancelType : INotifyPropertyChanged
	{
		private Expense_Report_ReferenceType expense_Report_ReferenceField;
		...
		[XmlElement(Order = 0)]
		public Expense_Report_ReferenceType Expense_Report_Reference
		{
			get
			{
