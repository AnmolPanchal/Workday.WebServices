...
namespace WorkdayWebServices.Absence_ManagementService
{
	...
	[Serializable]
	public class Coordinated_Time_Off_TypeObjectType : INotifyPropertyChanged
	{
		private Coordinated_Time_Off_TypeObjectIDType[] idField;
		...
		public Coordinated_Time_Off_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
