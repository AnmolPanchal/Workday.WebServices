...
namespace WorkdayWebServices.Absence_ManagementService
{
	...
	[Serializable]
	public class Absence_Plan__All_ObjectType : INotifyPropertyChanged
	{
		private Absence_Plan__All_ObjectIDType[] idField;
		...
		public Absence_Plan__All_ObjectIDType[] ID
		{
			get
			{
				return this.idField;
