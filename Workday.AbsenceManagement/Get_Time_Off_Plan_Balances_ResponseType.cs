...
namespace WorkdayWebServices.Absence_ManagementService
{
	...
	[Serializable]
	public class Get_Time_Off_Plan_Balances_ResponseType : INotifyPropertyChanged
	{
		private Time_Off_Plan_Balance_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Time_Off_Plan_Balance_Response_GroupType response_GroupField;

		private Response_ResultsType[] response_ResultsField;

		private Time_Off_Plan_BalanceType[] response_DataField;
		...
		[XmlElement(Order = 0)]
		public Time_Off_Plan_Balance_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 2)]
		public Time_Off_Plan_Balance_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Time_Off_Plan_Balance", typeof(Time_Off_Plan_BalanceType), IsNullable = false)]
		public Time_Off_Plan_BalanceType[] Response_Data
		{
			get
			{
