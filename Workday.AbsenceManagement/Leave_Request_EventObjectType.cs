...
namespace WorkdayWebServices.Absence_ManagementService
{
	...
	[Serializable]
	public class Leave_Request_EventObjectType : INotifyPropertyChanged
	{
		private Leave_Request_EventObjectIDType[] idField;
		...
		public Leave_Request_EventObjectIDType[] ID
		{
			get
			{
				return this.idField;
