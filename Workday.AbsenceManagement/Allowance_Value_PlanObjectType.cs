...
namespace WorkdayWebServices.Absence_ManagementService
{
	...
	[Serializable]
	public class Allowance_Value_PlanObjectType : INotifyPropertyChanged
	{
		private Allowance_Value_PlanObjectIDType[] idField;
		...
		public Allowance_Value_PlanObjectIDType[] ID
		{
			get
			{
				return this.idField;
