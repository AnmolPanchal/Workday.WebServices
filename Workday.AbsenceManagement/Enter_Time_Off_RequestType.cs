...
namespace WorkdayWebServices.Absence_ManagementService
{
	...
	[Serializable]
	public class Enter_Time_Off_RequestType : INotifyPropertyChanged
	{
		private Business_Process_ParametersType business_Process_ParametersField;

		private Enter_Time_Off_DataType enter_Time_Off_DataField;
		...
		[XmlElement(Order = 1)]
		public Enter_Time_Off_DataType Enter_Time_Off_Data
		{
			get
			{
				return this.enter_Time_Off_DataField;
			}
			set
			{
				this.enter_Time_Off_DataField = value;
				this.RaisePropertyChanged("Enter_Time_Off_Data");
			}
		}
