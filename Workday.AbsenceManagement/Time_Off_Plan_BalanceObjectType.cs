...
namespace WorkdayWebServices.Absence_ManagementService
{
	...
	[Serializable]
	public class Time_Off_Plan_BalanceObjectType : INotifyPropertyChanged
	{
		private Time_Off_Plan_BalanceObjectIDType[] idField;
		...
		public Time_Off_Plan_BalanceObjectIDType[] ID
		{
			get
			{
				return this.idField;
