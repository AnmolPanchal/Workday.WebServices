...
namespace WorkdayWebServices.Absence_ManagementService
{
	...
	[Serializable]
	public class Leave_Request_DataType : INotifyPropertyChanged
	{
		private string request_Leave_of_Absence_IDField;
		...
		private Leave_Type_ReasonObjectType leave_Reason_ReferenceField;

		private Position_ElementObjectType position_ReferenceField;

		private DateTime first_Day_of_LeaveField;

		private DateTime last_Day_of_WorkField;

		private bool last_Day_of_WorkFieldSpecified;

		private DateTime estimated_Last_Day_of_LeaveField;
		...
		[XmlElement(Order = 0)]
		public string Request_Leave_of_Absence_ID
		{
			get
			{
				return this.request_Leave_of_Absence_IDField;
			}
			set
			{
				this.request_Leave_of_Absence_IDField = value;
				this.RaisePropertyChanged("Request_Leave_of_Absence_ID");
			}
		}
		...
		[XmlElement(Order = 3)]
		public Leave_Type_ReasonObjectType Leave_Reason_Reference
		{
			get
			{
				return this.leave_Reason_ReferenceField;
			}
			set
			{
				this.leave_Reason_ReferenceField = value;
				this.RaisePropertyChanged("Leave_Reason_Reference");
			}
		}
		...
		public DateTime First_Day_of_Leave
		{
			get
			{
				return this.first_Day_of_LeaveField;
			}
			set
			{
				this.first_Day_of_LeaveField = value;
				this.RaisePropertyChanged("First_Day_of_Leave");
			}
		}
		...
		public DateTime Estimated_Last_Day_of_Leave
		{
			get
			{
				return this.estimated_Last_Day_of_LeaveField;
			}
			set
			{
				this.estimated_Last_Day_of_LeaveField = value;
				this.RaisePropertyChanged("Estimated_Last_Day_of_Leave");
			}
		}
