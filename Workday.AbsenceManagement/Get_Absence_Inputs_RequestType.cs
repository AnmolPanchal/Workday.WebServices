...
namespace WorkdayWebServices.Absence_ManagementService
{
	...
	[Serializable]
	public class Get_Absence_Inputs_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Absence_Input_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Absence_Input_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
