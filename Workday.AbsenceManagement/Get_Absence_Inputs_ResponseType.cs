...
namespace WorkdayWebServices.Absence_ManagementService
{
	...
	[Serializable]
	public class Get_Absence_Inputs_ResponseType : INotifyPropertyChanged
	{
		private Absence_InputObjectType[] request_ReferencesField;

		private Absence_Input_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Absence_Input_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Absence_InputType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Absence_Input_Reference", IsNullable = false)]
		public Absence_InputObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Absence_Input_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Absence_Input_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Absence_Input", IsNullable = false)]
		public Absence_InputType[] Response_Data
		{
			get
			{
