...
namespace WorkdayWebServices.Absence_ManagementService
{
	...
	[Serializable]
	public class Adjust_Time_Off_RequestType : INotifyPropertyChanged
	{
		private Business_Process_ParametersType business_Process_ParametersField;

		private Adjust_Time_Off_DataType adjust_Time_Off_DataField;
		...
		[XmlElement(Order = 1)]
		public Adjust_Time_Off_DataType Adjust_Time_Off_Data
		{
			get
			{
				return this.adjust_Time_Off_DataField;
			}
			set
			{
				this.adjust_Time_Off_DataField = value;
				this.RaisePropertyChanged("Adjust_Time_Off_Data");
			}
		}
