...
namespace WorkdayWebServices.Workday_ConnectService
{
	...
	[Serializable]
	public class Notification_CategoryObjectType : INotifyPropertyChanged
	{
		private Notification_CategoryObjectIDType[] idField;
		...
		public Notification_CategoryObjectIDType[] ID
		{
			get
			{
				return this.idField;
