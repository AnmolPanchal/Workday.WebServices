...
namespace WorkdayWebServices.AdmissionsService
{
	...
	[Serializable]
	public class Recruitable_CertificationObjectType : INotifyPropertyChanged
	{
		private Recruitable_CertificationObjectIDType[] idField;
		...
		public Recruitable_CertificationObjectIDType[] ID
		{
			get
			{
				return this.idField;
