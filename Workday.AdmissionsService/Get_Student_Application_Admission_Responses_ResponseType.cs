...
namespace WorkdayWebServices.AdmissionsService
{
	...
	[Serializable]
	public class Get_Student_Application_Admission_Responses_ResponseType : INotifyPropertyChanged
	{
		private Student_ApplicationObjectType[] request_ReferencesField;

		private Student_Application_Admission_Response_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Student_Application_Admission_ResponseType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Student_Application_Admission_Response_Reference", IsNullable = false)]
		public Student_ApplicationObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Student_Application_Admission_Response_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Student_Application_Admission_Response", IsNullable = false)]
		public Student_Application_Admission_ResponseType[] Response_Data
		{
			get
			{
