...
namespace WorkdayWebServices.AdmissionsService
{
	...
	[Serializable]
	public class Student_Residency_StatusObjectType : INotifyPropertyChanged
	{
		private Student_Residency_StatusObjectIDType[] idField;
		...
		public Student_Residency_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
