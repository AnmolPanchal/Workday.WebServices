...
namespace WorkdayWebServices.AdmissionsService
{
	...
	[Serializable]
	public class Get_Student_Applications_ResponseType : INotifyPropertyChanged
	{
		private Student_ApplicationObjectType[] request_ReferencesField;

		private Student_Application_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Student_Application_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Student_ApplicationType[] response_DataField;
		...
		[XmlElement(Order = 1)]
		public Student_Application_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Student_Application_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Student_Application", IsNullable = false)]
		public Student_ApplicationType[] Response_Data
		{
			get
			{
