...
namespace WorkdayWebServices.AdmissionsService
{
	...
	[Serializable]
	public class Student_Applicant_Person_DataType : INotifyPropertyChanged
	{
		...
		private Student_Application_Details_Personal_Information_Subedit_DataType[] personal_Information_DataField;
		...
		[XmlElement("Personal_Information_Data", Order = 4)]
		public Student_Application_Details_Personal_Information_Subedit_DataType[] Personal_Information_Data
		{
			get
			{
