...
namespace WorkdayWebServices.AdmissionsService
{
	...
	[Serializable]
	public class Student_Application_Data_LoadObjectType : INotifyPropertyChanged
	{
		private Student_Application_Data_LoadObjectIDType[] idField;
		...
		public Student_Application_Data_LoadObjectIDType[] ID
		{
			get
			{
				return this.idField;
