...
namespace WorkdayWebServices.AdmissionsService
{
	...
	[Serializable]
	public class Association_to_ApplicantObjectType : INotifyPropertyChanged
	{
		private Association_to_ApplicantObjectIDType[] idField;
		...
		public Association_to_ApplicantObjectIDType[] ID
		{
			get
			{
				return this.idField;
