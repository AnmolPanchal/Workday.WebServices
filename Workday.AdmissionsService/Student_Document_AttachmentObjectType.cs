...
namespace WorkdayWebServices.AdmissionsService
{
	...
	[Serializable]
	public class Student_Document_AttachmentObjectType : INotifyPropertyChanged
	{
		private Student_Document_AttachmentObjectIDType[] idField;
		...
		public Student_Document_AttachmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
