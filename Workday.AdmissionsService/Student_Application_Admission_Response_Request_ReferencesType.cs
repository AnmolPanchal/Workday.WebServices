...
namespace WorkdayWebServices.AdmissionsService
{
	...
	[Serializable]
	public class Student_Application_Admission_Response_Request_ReferencesType : INotifyPropertyChanged
	{
		...
		[XmlElement("Student_Application_Admission_Response_Reference", Order = 0)]
