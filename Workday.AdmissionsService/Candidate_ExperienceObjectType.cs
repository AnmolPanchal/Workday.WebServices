...
namespace WorkdayWebServices.AdmissionsService
{
	...
	[Serializable]
	public class Candidate_ExperienceObjectType : INotifyPropertyChanged
	{
		private Candidate_ExperienceObjectIDType[] idField;
		...
		public Candidate_ExperienceObjectIDType[] ID
		{
			get
			{
				return this.idField;
