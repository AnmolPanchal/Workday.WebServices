...
namespace WorkdayWebServices.AdmissionsService
{
	...
	[Serializable]
	public class Get_Student_Application_Requirement_Assignments_ResponseType : INotifyPropertyChanged
	{
		private Student_Application_Action_Item_AssignmentObjectType[] request_ReferencesField;

		private Engagement_Action_Item_Assignment_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Engagement_Action_Item_AssignmentType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Engagement_Action_Item_Assignment_Reference", IsNullable = false)]
		public Student_Application_Action_Item_AssignmentObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Engagement_Action_Item_Assignment_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Engagement_Action_Item_Assignment", IsNullable = false)]
		public Engagement_Action_Item_AssignmentType[] Response_Data
		{
			get
			{
