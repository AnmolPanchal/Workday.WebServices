...
namespace WorkdayWebServices.AdmissionsService
{
	...
	[Serializable]
	public class Sexual_OrientationObjectType : INotifyPropertyChanged
	{
		private Sexual_OrientationObjectIDType[] idField;
		...
		public Sexual_OrientationObjectIDType[] ID
		{
			get
			{
				return this.idField;
