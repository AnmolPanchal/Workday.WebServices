...
namespace WorkdayWebServices.AdmissionsService
{
	...
	[Serializable]
	public class Get_External_Student_Transcripts_ResponseType : INotifyPropertyChanged
	{
		private Student_External_TranscriptObjectType[] request_ReferencesField;

		private External_Student_Transcript_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Student_External_Transcript_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private External_Student_TranscriptType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("External_Student_Transcript_Reference", IsNullable = false)]
		public Student_External_TranscriptObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public External_Student_Transcript_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Student_External_Transcript_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Student_External_Transcript", IsNullable = false)]
		public External_Student_TranscriptType[] Response_Data
		{
			get
			{
