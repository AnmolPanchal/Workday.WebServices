...
namespace WorkdayWebServices.AdmissionsService
{
	...
	[Serializable]
	public class Student_AttachmentObjectType : INotifyPropertyChanged
	{
		private Student_AttachmentObjectIDType[] idField;
		...
		public Student_AttachmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
