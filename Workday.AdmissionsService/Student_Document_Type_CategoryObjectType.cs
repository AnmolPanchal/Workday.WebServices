...
namespace WorkdayWebServices.AdmissionsService
{
	...
	[Serializable]
	public class Student_Document_Type_CategoryObjectType : INotifyPropertyChanged
	{
		private Student_Document_Type_CategoryObjectIDType[] idField;
		...
		public Student_Document_Type_CategoryObjectIDType[] ID
		{
			get
			{
				return this.idField;
