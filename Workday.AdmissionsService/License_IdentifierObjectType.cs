...
namespace WorkdayWebServices.AdmissionsService
{
	...
	[Serializable]
	public class License_IdentifierObjectType : INotifyPropertyChanged
	{
		private License_IdentifierObjectIDType[] idField;
		...
		public License_IdentifierObjectIDType[] ID
		{
			get
			{
				return this.idField;
