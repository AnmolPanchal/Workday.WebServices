...
namespace WorkdayWebServices.AdmissionsService
{
	...
	[Serializable]
	public class Application_Action_ItemObjectType : INotifyPropertyChanged
	{
		private Application_Action_ItemObjectIDType[] idField;
		...
		public Application_Action_ItemObjectIDType[] ID
		{
			get
			{
				return this.idField;
