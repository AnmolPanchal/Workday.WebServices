...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Academic_Date_RangeObjectType : INotifyPropertyChanged
	{
		private Academic_Date_RangeObjectIDType[] idField;
		...
		public Academic_Date_RangeObjectIDType[] ID
		{
			get
			{
				return this.idField;
