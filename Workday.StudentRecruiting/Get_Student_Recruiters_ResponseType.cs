...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Get_Student_Recruiters_ResponseType : INotifyPropertyChanged
	{
		private Admissions_CounselorObjectType[] request_ReferencesField;

		private Student_Recruiter_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Student_RecruiterType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Student_Recruiter_Reference", IsNullable = false)]
		public Admissions_CounselorObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Student_Recruiter_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Student_Recruiter", IsNullable = false)]
		public Student_RecruiterType[] Response_Data
		{
			get
			{
