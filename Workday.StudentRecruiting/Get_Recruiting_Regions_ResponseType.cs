...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Get_Recruiting_Regions_ResponseType : INotifyPropertyChanged
	{
		private RegionObjectType[] request_ReferencesField;

		private Recruiting_Region_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Recruiting_RegionType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Recruiting_Region_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Recruiting_Region_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Recruiting_Region", IsNullable = false)]
		public Recruiting_RegionType[] Response_Data
		{
			get
			{
