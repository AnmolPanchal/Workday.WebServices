...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Get_Ad_Hoc_Locations_ResponseType : INotifyPropertyChanged
	{
		private Student_Recruiting_Event_Ad_Hoc_LocationObjectType[] request_ReferencesField;

		private Ad_Hoc_Location_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Ad_Hoc_LocationType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Ad_Hoc_Location_Reference", IsNullable = false)]
		public Student_Recruiting_Event_Ad_Hoc_LocationObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Ad_Hoc_Location_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Ad_Hoc_Location", IsNullable = false)]
		public Ad_Hoc_LocationType[] Response_Data
		{
			get
			{
