...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Get_Student_Recruitments_ResponseType : INotifyPropertyChanged
	{
		private Student_RecruitmentObjectType[] request_ReferencesField;

		private Student_Recruitment_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Student_Recruitment_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Student_RecruitmentType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Student_Recruitment_Reference", IsNullable = false)]
		public Student_RecruitmentObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Student_Recruitment_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Student_Recruitment_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Student_Recruitment", IsNullable = false)]
		public Student_RecruitmentType[] Response_Data
		{
			get
			{
