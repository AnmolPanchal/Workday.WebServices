...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Get_Student_Recruiting_Campaigns_ResponseType : INotifyPropertyChanged
	{
		private Student_Recruiting_CampaignObjectType[] request_ReferencesField;

		private Student_Recruiting_Campaign_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Student_Recruiting_CampaignType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Student_Recruiting_Campaign_Reference", IsNullable = false)]
		public Student_Recruiting_CampaignObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Student_Recruiting_Campaign_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Student_Recruiting_Campaign", IsNullable = false)]
		public Student_Recruiting_CampaignType[] Response_Data
		{
			get
			{
