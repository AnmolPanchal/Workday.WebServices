...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Recruiting_Region_CriteriaObjectType : INotifyPropertyChanged
	{
		private Recruiting_Region_CriteriaObjectIDType[] idField;
		...
		public Recruiting_Region_CriteriaObjectIDType[] ID
		{
			get
			{
				return this.idField;
