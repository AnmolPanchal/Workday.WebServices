...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Student_Prospect_SourceObjectType : INotifyPropertyChanged
	{
		private Student_Prospect_SourceObjectIDType[] idField;
		...
		public Student_Prospect_SourceObjectIDType[] ID
		{
			get
			{
				return this.idField;
