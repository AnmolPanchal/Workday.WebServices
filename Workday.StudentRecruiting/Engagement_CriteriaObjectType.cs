...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Engagement_CriteriaObjectType : INotifyPropertyChanged
	{
		private Engagement_CriteriaObjectIDType[] idField;
		...
		public Engagement_CriteriaObjectIDType[] ID
		{
			get
			{
				return this.idField;
