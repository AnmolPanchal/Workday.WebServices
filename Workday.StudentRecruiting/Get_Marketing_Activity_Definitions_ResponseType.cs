...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Get_Marketing_Activity_Definitions_ResponseType : INotifyPropertyChanged
	{
		private Marketing_Activity_DefinitionObjectType[] request_ReferencesField;

		private Marketing_Activity_Definition_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Marketing_Activity_DefinitionType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Marketing_Activity_Definition_Reference", IsNullable = false)]
		public Marketing_Activity_DefinitionObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Marketing_Activity_Definition_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Marketing_Activity_Definition", IsNullable = false)]
		public Marketing_Activity_DefinitionType[] Response_Data
		{
			get
			{
