...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Student_Recruiting_CycleObjectType : INotifyPropertyChanged
	{
		private Student_Recruiting_CycleObjectIDType[] idField;
		...
		public Student_Recruiting_CycleObjectIDType[] ID
		{
			get
			{
				return this.idField;
