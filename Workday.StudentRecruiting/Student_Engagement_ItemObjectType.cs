...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Student_Engagement_ItemObjectType : INotifyPropertyChanged
	{
		private Student_Engagement_ItemObjectIDType[] idField;
		...
		public Student_Engagement_ItemObjectIDType[] ID
		{
			get
			{
				return this.idField;
