...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Organization_SubtypeObjectType : INotifyPropertyChanged
	{
		private Organization_SubtypeObjectIDType[] idField;
		...
		public Organization_SubtypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
