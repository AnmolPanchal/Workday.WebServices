...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Student_Preliminary_AwardObjectType : INotifyPropertyChanged
	{
		private Student_Preliminary_AwardObjectIDType[] idField;
		...
		public Student_Preliminary_AwardObjectIDType[] ID
		{
			get
			{
				return this.idField;
