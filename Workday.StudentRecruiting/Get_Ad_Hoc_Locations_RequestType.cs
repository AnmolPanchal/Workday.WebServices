...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Get_Ad_Hoc_Locations_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Ad_Hoc_Location_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Ad_Hoc_Location_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
