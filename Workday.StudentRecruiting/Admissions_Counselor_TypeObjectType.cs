...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Admissions_Counselor_TypeObjectType : INotifyPropertyChanged
	{
		private Admissions_Counselor_TypeObjectIDType[] idField;
		...
		public Admissions_Counselor_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
