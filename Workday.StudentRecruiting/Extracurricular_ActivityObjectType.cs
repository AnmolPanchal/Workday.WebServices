...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Extracurricular_ActivityObjectType : INotifyPropertyChanged
	{
		private Extracurricular_ActivityObjectIDType[] idField;
		...
		public Extracurricular_ActivityObjectIDType[] ID
		{
			get
			{
				return this.idField;
