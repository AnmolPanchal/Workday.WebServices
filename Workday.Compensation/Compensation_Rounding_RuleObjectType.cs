...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Compensation_Rounding_RuleObjectType : INotifyPropertyChanged
	{
		private Compensation_Rounding_RuleObjectIDType[] idField;
		...
		public Compensation_Rounding_RuleObjectIDType[] ID
		{
			get
			{
				return this.idField;
