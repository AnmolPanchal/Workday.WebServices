...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Future_Payment_PlanObjectType : INotifyPropertyChanged
	{
		private Future_Payment_PlanObjectIDType[] idField;
		...
		public Future_Payment_PlanObjectIDType[] ID
		{
			get
			{
				return this.idField;
