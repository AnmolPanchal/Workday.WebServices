...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Get_Previous_System_Compensation_History_ResponseType : INotifyPropertyChanged
	{
		...
		private Previous_System_Compensation_History_Get_DataType[] response_DataField;
		...
		[XmlArray(Order = 4), XmlArrayItem("Previous_System_Compensation_History", typeof(Previous_System_Compensation_History_Get_DataType), IsNullable = false)]
		public Previous_System_Compensation_History_Get_DataType[] Response_Data
		{
			get
			{
