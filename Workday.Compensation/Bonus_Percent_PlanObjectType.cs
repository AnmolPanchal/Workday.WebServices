...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Bonus_Percent_PlanObjectType : INotifyPropertyChanged
	{
		private Bonus_Percent_PlanObjectIDType[] idField;
		...
		public Bonus_Percent_PlanObjectIDType[] ID
		{
			get
			{
				return this.idField;
