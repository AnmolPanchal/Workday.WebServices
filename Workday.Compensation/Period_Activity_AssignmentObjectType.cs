...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Period_Activity_AssignmentObjectType : INotifyPropertyChanged
	{
		private Period_Activity_AssignmentObjectIDType[] idField;
		...
		public Period_Activity_AssignmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
