...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Review_Rating_ScaleObjectType : INotifyPropertyChanged
	{
		private Review_Rating_ScaleObjectIDType[] idField;
		...
		public Review_Rating_ScaleObjectIDType[] ID
		{
			get
			{
				return this.idField;
