...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Compensation_Assignable_PlanObjectType : INotifyPropertyChanged
	{
		private Compensation_Assignable_PlanObjectIDType[] idField;
		...
		public Compensation_Assignable_PlanObjectIDType[] ID
		{
			get
			{
				return this.idField;
