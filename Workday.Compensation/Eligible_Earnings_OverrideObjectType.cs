...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Eligible_Earnings_OverrideObjectType : INotifyPropertyChanged
	{
		private Eligible_Earnings_OverrideObjectIDType[] idField;
		...
		public Eligible_Earnings_OverrideObjectIDType[] ID
		{
			get
			{
				return this.idField;
