...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Period_Activity_TaskObjectType : INotifyPropertyChanged
	{
		private Period_Activity_TaskObjectIDType[] idField;
		...
		public Period_Activity_TaskObjectIDType[] ID
		{
			get
			{
				return this.idField;
