...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Compensation_GradeObjectType : INotifyPropertyChanged
	{
		private Compensation_GradeObjectIDType[] idField;
		...
		public Compensation_GradeObjectIDType[] ID
		{
			get
			{
				return this.idField;
