...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Expense_AccumulatorObjectType : INotifyPropertyChanged
	{
		private Expense_AccumulatorObjectIDType[] idField;
		...
		public Expense_AccumulatorObjectIDType[] ID
		{
			get
			{
				return this.idField;
