...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Compensation_BasisObjectType : INotifyPropertyChanged
	{
		private Compensation_BasisObjectIDType[] idField;
		...
		public Compensation_BasisObjectIDType[] ID
		{
			get
			{
				return this.idField;
