...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Eligibility_Waiting_PeriodObjectType : INotifyPropertyChanged
	{
		private Eligibility_Waiting_PeriodObjectIDType[] idField;
		...
		public Eligibility_Waiting_PeriodObjectIDType[] ID
		{
			get
			{
				return this.idField;
