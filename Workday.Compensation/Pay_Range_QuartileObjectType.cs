...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Pay_Range_QuartileObjectType : INotifyPropertyChanged
	{
		private Pay_Range_QuartileObjectIDType[] idField;
		...
		public Pay_Range_QuartileObjectIDType[] ID
		{
			get
			{
				return this.idField;
