...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Get_Compensation_Matrices_RequestType : INotifyPropertyChanged
	{
		...
		[XmlArray(Order = 0), XmlArrayItem("Compensation_Matrices_Reference", IsNullable = false)]
