...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Pay_Range_Segment_TypeObjectType : INotifyPropertyChanged
	{
		private Pay_Range_Segment_TypeObjectIDType[] idField;
		...
		public Pay_Range_Segment_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
