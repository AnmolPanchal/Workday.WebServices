...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Time_Proration_RuleObjectType : INotifyPropertyChanged
	{
		private Time_Proration_RuleObjectIDType[] idField;
		...
		public Time_Proration_RuleObjectIDType[] ID
		{
			get
			{
				return this.idField;
