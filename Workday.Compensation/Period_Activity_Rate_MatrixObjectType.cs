...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Period_Activity_Rate_MatrixObjectType : INotifyPropertyChanged
	{
		private Period_Activity_Rate_MatrixObjectIDType[] idField;
		...
		public Period_Activity_Rate_MatrixObjectIDType[] ID
		{
			get
			{
				return this.idField;
