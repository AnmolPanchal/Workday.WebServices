...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Relational_OperatorObjectType : INotifyPropertyChanged
	{
		private Relational_OperatorObjectIDType[] idField;
		...
		public Relational_OperatorObjectIDType[] ID
		{
			get
			{
				return this.idField;
