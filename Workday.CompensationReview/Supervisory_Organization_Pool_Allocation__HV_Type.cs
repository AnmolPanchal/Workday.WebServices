...
namespace WorkdayWebServices.Compensation_ReviewService
{
	...
	[Serializable]
	public class Supervisory_Organization_Pool_Allocation__HV_Type : INotifyPropertyChanged
	{
		...
		[XmlChoiceIdentifier("ItemElementName"), XmlElement("Pool_Amount", typeof(decimal), Order = 1), XmlElement("Unit_Pool_Allocated", typeof(decimal), Order = 1)]
		public decimal Item
		{
			get
			{
