...
namespace WorkdayWebServices.Compensation_ReviewService
{
	...
	[Serializable]
	public class Compensation_Review_EventObjectType : INotifyPropertyChanged
	{
		private Compensation_Review_EventObjectIDType[] idField;
		...
		public Compensation_Review_EventObjectIDType[] ID
		{
			get
			{
				return this.idField;
