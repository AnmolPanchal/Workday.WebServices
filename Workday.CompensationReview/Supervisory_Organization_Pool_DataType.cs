...
namespace WorkdayWebServices.Compensation_ReviewService
{
	...
	[Serializable]
	public class Supervisory_Organization_Pool_DataType : INotifyPropertyChanged
	{
		private Supervisory_OrganizationObjectType supervisory_Organization_ReferenceField;

		private Supervisory_Organization_Pool_AllocationType[] budget_PoolField;

		private Supervisory_Organization_HoldbackType[] holdbackField;
		...
		public Supervisory_Organization_Pool_AllocationType[] Budget_Pool
		{
			get
			{
		...
		public Supervisory_Organization_HoldbackType[] Holdback
		{
			get
			{
