...
namespace WorkdayWebServices.Compensation_ReviewService
{
	...
	[Serializable]
	public class Compensation_Review_Employee_Adjustment_Identification_Information_DataType : INotifyPropertyChanged
	{
		private WorkerObjectType employee_ReferenceField;

		private PositionObjectType position_ReferenceField;

		private Supervisory_OrganizationObjectType organization_Reference_ReferenceField;
		...
		[XmlElement(Order = 2)]
		public Supervisory_OrganizationObjectType Organization_Reference_Reference
		{
			get
			{
				return this.organization_Reference_ReferenceField;
			}
			set
			{
				this.organization_Reference_ReferenceField = value;
				this.RaisePropertyChanged("Organization_Reference_Reference");
			}
		}
