...
namespace WorkdayWebServices.Compensation_ReviewService
{
	...
	[Serializable]
	public class Get_Budget_Pools_ResponseType : INotifyPropertyChanged
	{
		private Budget_Pools_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Budget_Pools_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Budget_Pools_Response_DataType response_DataField;
		...
		[XmlElement(Order = 0)]
		public Budget_Pools_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 2)]
		public Budget_Pools_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlElement(Order = 4)]
		public Budget_Pools_Response_DataType Response_Data
		{
			get
			{
