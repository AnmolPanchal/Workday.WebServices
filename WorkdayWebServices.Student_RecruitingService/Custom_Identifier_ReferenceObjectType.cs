...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Custom_Identifier_ReferenceObjectType : INotifyPropertyChanged
	{
		private Custom_Identifier_ReferenceObjectIDType[] idField;
		...
		public Custom_Identifier_ReferenceObjectIDType[] ID
		{
			get
			{
				return this.idField;
