...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Student_Recruiting_EventObjectType : INotifyPropertyChanged
	{
		private Student_Recruiting_EventObjectIDType[] idField;
		...
		public Student_Recruiting_EventObjectIDType[] ID
		{
			get
			{
				return this.idField;
