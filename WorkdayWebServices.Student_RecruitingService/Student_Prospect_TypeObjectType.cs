...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Student_Prospect_TypeObjectType : INotifyPropertyChanged
	{
		private Student_Prospect_TypeObjectIDType[] idField;
		...
		public Student_Prospect_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
