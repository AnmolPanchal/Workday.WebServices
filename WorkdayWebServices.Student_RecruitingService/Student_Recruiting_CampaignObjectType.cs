...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Student_Recruiting_CampaignObjectType : INotifyPropertyChanged
	{
		private Student_Recruiting_CampaignObjectIDType[] idField;
		...
		public Student_Recruiting_CampaignObjectIDType[] ID
		{
			get
			{
				return this.idField;
