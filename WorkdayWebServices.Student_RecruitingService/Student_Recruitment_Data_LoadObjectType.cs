...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Student_Recruitment_Data_LoadObjectType : INotifyPropertyChanged
	{
		private Student_Recruitment_Data_LoadObjectIDType[] idField;
		...
		public Student_Recruitment_Data_LoadObjectIDType[] ID
		{
			get
			{
				return this.idField;
