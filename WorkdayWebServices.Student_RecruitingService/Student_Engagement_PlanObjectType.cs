...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Student_Engagement_PlanObjectType : INotifyPropertyChanged
	{
		private Student_Engagement_PlanObjectIDType[] idField;
		...
		public Student_Engagement_PlanObjectIDType[] ID
		{
			get
			{
				return this.idField;
