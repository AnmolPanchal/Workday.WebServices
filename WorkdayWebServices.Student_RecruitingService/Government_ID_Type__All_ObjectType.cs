...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Government_ID_Type__All_ObjectType : INotifyPropertyChanged
	{
		private Government_ID_Type__All_ObjectIDType[] idField;
		...
		public Government_ID_Type__All_ObjectIDType[] ID
		{
			get
			{
				return this.idField;
