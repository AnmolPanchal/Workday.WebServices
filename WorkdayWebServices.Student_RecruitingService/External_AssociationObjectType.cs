...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class External_AssociationObjectType : INotifyPropertyChanged
	{
		private External_AssociationObjectIDType[] idField;
		...
		public External_AssociationObjectIDType[] ID
		{
			get
			{
				return this.idField;
