...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Get_Search_Service_Definitions_ResponseType : INotifyPropertyChanged
	{
		private Search_Service_DefinitionObjectType[] request_ReferencesField;

		private Search_Service_Definition_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Search_Service_DefinitionType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Search_Service_Definition_Reference", IsNullable = false)]
		public Search_Service_DefinitionObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Search_Service_Definition_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Search_Service_Definition", IsNullable = false)]
		public Search_Service_DefinitionType[] Response_Data
		{
			get
			{
