...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Student_Recruiting_Event_TypeObjectType : INotifyPropertyChanged
	{
		private Student_Recruiting_Event_TypeObjectIDType[] idField;
		...
		public Student_Recruiting_Event_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
