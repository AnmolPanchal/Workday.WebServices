...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Marketing_Activity_DefinitionObjectType : INotifyPropertyChanged
	{
		private Marketing_Activity_DefinitionObjectIDType[] idField;
		...
		public Marketing_Activity_DefinitionObjectIDType[] ID
		{
			get
			{
				return this.idField;
