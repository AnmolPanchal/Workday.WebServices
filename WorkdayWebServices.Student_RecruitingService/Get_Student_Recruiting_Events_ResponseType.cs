...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Get_Student_Recruiting_Events_ResponseType : INotifyPropertyChanged
	{
		private Student_Recruiting_EventObjectType[] request_ReferencesField;

		private Student_Recruiting_Event_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Student_Recruiting_EventType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Student_Recruiting_Event_Reference", IsNullable = false)]
		public Student_Recruiting_EventObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Student_Recruiting_Event_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Student_Recruiting_Event", IsNullable = false)]
		public Student_Recruiting_EventType[] Response_Data
		{
			get
			{
