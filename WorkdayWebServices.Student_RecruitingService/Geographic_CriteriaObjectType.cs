...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Geographic_CriteriaObjectType : INotifyPropertyChanged
	{
		private Geographic_CriteriaObjectIDType[] idField;
		...
		public Geographic_CriteriaObjectIDType[] ID
		{
			get
			{
				return this.idField;
