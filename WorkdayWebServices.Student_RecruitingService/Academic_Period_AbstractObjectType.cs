...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Academic_Period_AbstractObjectType : INotifyPropertyChanged
	{
		private Academic_Period_AbstractObjectIDType[] idField;
		...
		public Academic_Period_AbstractObjectIDType[] ID
		{
			get
			{
				return this.idField;
