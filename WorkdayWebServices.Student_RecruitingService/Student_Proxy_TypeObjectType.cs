...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Student_Proxy_TypeObjectType : INotifyPropertyChanged
	{
		private Student_Proxy_TypeObjectIDType[] idField;
		...
		public Student_Proxy_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
