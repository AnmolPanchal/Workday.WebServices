...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Social_Network_Meta_TypeObjectType : INotifyPropertyChanged
	{
		private Social_Network_Meta_TypeObjectIDType[] idField;
		...
		public Social_Network_Meta_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
