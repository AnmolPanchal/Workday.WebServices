...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Get_Student_Recruiting_Cycles_ResponseType : INotifyPropertyChanged
	{
		private Student_Recruiting_CycleObjectType[] request_ReferencesField;

		private Student_Recruiting_Cycle_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Student_Recruiting_CycleType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Student_Recruiting_Cycle_Reference", IsNullable = false)]
		public Student_Recruiting_CycleObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Student_Recruiting_Cycle_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Student_Recruiting_Cycle", IsNullable = false)]
		public Student_Recruiting_CycleType[] Response_Data
		{
			get
			{
