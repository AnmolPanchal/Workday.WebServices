...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Educational_InstitutionObjectType : INotifyPropertyChanged
	{
		private Educational_InstitutionObjectIDType[] idField;
		...
		public Educational_InstitutionObjectIDType[] ID
		{
			get
			{
				return this.idField;
