...
namespace WorkdayWebServices.Student_RecruitingService
{
	...
	[Serializable]
	public class Search_Service_DefinitionObjectType : INotifyPropertyChanged
	{
		private Search_Service_DefinitionObjectIDType[] idField;
		...
		public Search_Service_DefinitionObjectIDType[] ID
		{
			get
			{
				return this.idField;
