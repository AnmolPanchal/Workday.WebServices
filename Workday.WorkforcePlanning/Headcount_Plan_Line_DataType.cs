...
namespace WorkdayWebServices.Workforce_PlanningService
{
	...
	[Serializable]
	public class Headcount_Plan_Line_DataType : INotifyPropertyChanged
	{
		private Headcount_Plan_LineObjectType headcount_Plan_Line_ReferenceField;

		private Headcount_Plan_Line_Detail_DataType headcount_Plan_Line_Detail_DataField;
		...
		[XmlElement(Order = 1)]
		public Headcount_Plan_Line_Detail_DataType Headcount_Plan_Line_Detail_Data
		{
			get
			{
				return this.headcount_Plan_Line_Detail_DataField;
			}
			set
			{
				this.headcount_Plan_Line_Detail_DataField = value;
				this.RaisePropertyChanged("Headcount_Plan_Line_Detail_Data");
			}
		}
