...
namespace WorkdayWebServices.Workforce_PlanningService
{
	...
	[Serializable]
	public class Get_Headcount_Plan_Templates_ResponseType : INotifyPropertyChanged
	{
		private Headcount_Plan_TemplateObjectType[] request_ReferencesField;

		private Headcount_Plan_Template_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Headcount_Plan_TemplateType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Headcount_Plan_Template_Reference", IsNullable = false)]
		public Headcount_Plan_TemplateObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Headcount_Plan_Template_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Headcount_Plan_Template", IsNullable = false)]
		public Headcount_Plan_TemplateType[] Response_Data
		{
			get
			{
