...
namespace WorkdayWebServices.Workforce_PlanningService
{
	...
	[Serializable]
	public class Get_Headcount_Plans_ResponseType : INotifyPropertyChanged
	{
		private Headcount_Plan_VersionObjectType[] request_ReferencesField;

		private Headcount_Plan_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Headcount_Plan_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Headcount_Plan_VersionType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Headcount_Plan_Version_Reference", IsNullable = false)]
		public Headcount_Plan_VersionObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Headcount_Plan_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Headcount_Plan_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Headcount_Plan_Version", IsNullable = false)]
		public Headcount_Plan_VersionType[] Response_Data
		{
			get
			{
