...
namespace WorkdayWebServices.Workforce_PlanningService
{
	...
	[Serializable]
	public class Get_Headcount_Plan_Structures_ResponseType : INotifyPropertyChanged
	{
		private Headcount_Plan_StructureObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Headcount_Plan_StructureType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Headcount_Plan_Structure_Reference", IsNullable = false)]
		public Headcount_Plan_StructureObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Headcount_Plan_Structure", IsNullable = false)]
		public Headcount_Plan_StructureType[] Response_Data
		{
			get
			{
