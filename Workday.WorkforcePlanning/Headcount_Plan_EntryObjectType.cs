...
namespace WorkdayWebServices.Workforce_PlanningService
{
	...
	[Serializable]
	public class Headcount_Plan_EntryObjectType : INotifyPropertyChanged
	{
		private Headcount_Plan_EntryObjectIDType[] idField;
		...
		public Headcount_Plan_EntryObjectIDType[] ID
		{
			get
			{
				return this.idField;
