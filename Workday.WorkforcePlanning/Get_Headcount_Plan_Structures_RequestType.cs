...
namespace WorkdayWebServices.Workforce_PlanningService
{
	...
	[Serializable]
	public class Get_Headcount_Plan_Structures_RequestType : INotifyPropertyChanged
	{
		private Headcount_Plan_Structure_Request_ReferencesType itemField;
		...
		public Headcount_Plan_Structure_Request_ReferencesType Item
		{
			get
			{
