...
namespace WorkdayWebServices.Campus_EngagementService
{
	...
	[Serializable]
	public class Student_Engagement_ContainerObjectType : INotifyPropertyChanged
	{
		private Student_Engagement_ContainerObjectIDType[] idField;
		...
		public Student_Engagement_ContainerObjectIDType[] ID
		{
			get
			{
				return this.idField;
