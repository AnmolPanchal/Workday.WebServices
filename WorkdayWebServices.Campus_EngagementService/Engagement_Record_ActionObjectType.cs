...
namespace WorkdayWebServices.Campus_EngagementService
{
	...
	[Serializable]
	public class Engagement_Record_ActionObjectType : INotifyPropertyChanged
	{
		private Engagement_Record_ActionObjectIDType[] idField;
		...
		public Engagement_Record_ActionObjectIDType[] ID
		{
			get
			{
				return this.idField;
