...
namespace WorkdayWebServices.Campus_EngagementService
{
	...
	[Serializable]
	public class Get_Engagement_External_Items_ResponseType : INotifyPropertyChanged
	{
		private Engagement_External_ItemObjectType[] request_ReferencesField;

		private Engagement_External_Item_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Engagement_External_Item_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Engagement_External_ItemType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Engagement_External_Item_Reference", IsNullable = false)]
		public Engagement_External_ItemObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Engagement_External_Item_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Engagement_External_Item_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Engagement_External_Item", IsNullable = false)]
		public Engagement_External_ItemType[] Response_Data
		{
			get
			{
