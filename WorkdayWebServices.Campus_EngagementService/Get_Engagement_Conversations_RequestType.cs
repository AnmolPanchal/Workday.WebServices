...
namespace WorkdayWebServices.Campus_EngagementService
{
	...
	[Serializable]
	public class Get_Engagement_Conversations_RequestType : INotifyPropertyChanged
	{
		private Engagement_Conversation_Request_ReferencesType itemField;
		...
		public Engagement_Conversation_Request_ReferencesType Item
		{
			get
			{
