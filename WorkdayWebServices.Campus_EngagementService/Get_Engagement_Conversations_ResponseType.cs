...
namespace WorkdayWebServices.Campus_EngagementService
{
	...
	[Serializable]
	public class Get_Engagement_Conversations_ResponseType : INotifyPropertyChanged
	{
		private Engagement_ConversationObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Engagement_Conversation_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Engagement_ConversationType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Engagement_Conversation_Reference", IsNullable = false)]
		public Engagement_ConversationObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 2)]
		public Engagement_Conversation_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Engagement_Conversation", IsNullable = false)]
		public Engagement_ConversationType[] Response_Data
		{
			get
			{
