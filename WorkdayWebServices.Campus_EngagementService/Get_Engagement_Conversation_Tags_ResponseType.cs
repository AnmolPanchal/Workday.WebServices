...
namespace WorkdayWebServices.Campus_EngagementService
{
	...
	[Serializable]
	public class Get_Engagement_Conversation_Tags_ResponseType : INotifyPropertyChanged
	{
		private Engagement_Conversation_TagObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Engagement_Conversation_TagType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Engagement_Conversation_Tag_Reference", IsNullable = false)]
		public Engagement_Conversation_TagObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Engagement_Conversation_Tag", IsNullable = false)]
		public Engagement_Conversation_TagType[] Response_Data
		{
			get
			{
