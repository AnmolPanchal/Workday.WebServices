...
namespace WorkdayWebServices.Campus_EngagementService
{
	...
	[Serializable]
	public class Engagement_Conversation_TagObjectType : INotifyPropertyChanged
	{
		private Engagement_Conversation_TagObjectIDType[] idField;
		...
		public Engagement_Conversation_TagObjectIDType[] ID
		{
			get
			{
				return this.idField;
