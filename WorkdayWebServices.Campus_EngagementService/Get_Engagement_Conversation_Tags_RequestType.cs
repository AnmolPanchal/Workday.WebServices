...
namespace WorkdayWebServices.Campus_EngagementService
{
	...
	[Serializable]
	public class Get_Engagement_Conversation_Tags_RequestType : INotifyPropertyChanged
	{
		private Engagement_Conversation_Tag_Request_ReferencesType itemField;
		...
		public Engagement_Conversation_Tag_Request_ReferencesType Item
		{
			get
			{
