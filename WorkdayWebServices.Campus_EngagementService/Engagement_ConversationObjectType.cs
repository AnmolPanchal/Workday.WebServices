...
namespace WorkdayWebServices.Campus_EngagementService
{
	...
	[Serializable]
	public class Engagement_ConversationObjectType : INotifyPropertyChanged
	{
		private Engagement_ConversationObjectIDType[] idField;
		...
		public Engagement_ConversationObjectIDType[] ID
		{
			get
			{
				return this.idField;
