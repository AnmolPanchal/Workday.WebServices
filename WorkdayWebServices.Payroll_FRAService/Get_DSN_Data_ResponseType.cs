...
namespace WorkdayWebServices.Payroll_FRAService
{
	...
	public class Get_DSN_Data_ResponseType : INotifyPropertyChanged
	{
		...
		public DSNObjectType[] Request_Filters
		{
			get
			{
				return this.request_FiltersField;
			}
			set
			{
				this.request_FiltersField = value;
				this.RaisePropertyChanged("Request_Filters");
			}
		}
		...
		[XmlArray(Order = 4), XmlArrayItem("DSN_Data", IsNullable = false)]
		public DSN_DataType[] Response_Data
		{
			get
			{
