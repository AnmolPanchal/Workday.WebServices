...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Close_Mentorship_ReasonObjectType : INotifyPropertyChanged
	{
		private Close_Mentorship_ReasonObjectIDType[] idField;
		...
		public Close_Mentorship_ReasonObjectIDType[] ID
		{
			get
			{
				return this.idField;
