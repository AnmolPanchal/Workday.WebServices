...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Skill_Source_Precedences_ResponseType : INotifyPropertyChanged
	{
		...
		[XmlArray(Order = 0), XmlArrayItem("Skill_Source_Precedence_Request_Reference", IsNullable = false)]
		...
		[XmlArray(Order = 3), XmlArrayItem("Skill_Source_Precedence", IsNullable = false)]
