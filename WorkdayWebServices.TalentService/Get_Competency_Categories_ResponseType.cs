...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Competency_Categories_ResponseType : INotifyPropertyChanged
	{
		private Competency_CategoryObjectType[] request_ReferencesField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Competency_Category_Reference", IsNullable = false)]
		public Competency_CategoryObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Competency_Category", IsNullable = false)]
