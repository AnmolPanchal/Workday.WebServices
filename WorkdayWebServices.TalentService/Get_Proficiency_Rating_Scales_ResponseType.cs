...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Proficiency_Rating_Scales_ResponseType : INotifyPropertyChanged
	{
		private Proficiency_Rating_ScaleObjectType[] request_ReferencesField;

		private Proficiency_Rating_Scale_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Proficiency_Rating_Scale_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Proficiency_Rating_ScaleType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Proficiency_Rating_Scale_Reference", IsNullable = false)]
		public Proficiency_Rating_ScaleObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Proficiency_Rating_Scale_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Proficiency_Rating_Scale_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Proficiency_Rating_Scale", IsNullable = false)]
		public Proficiency_Rating_ScaleType[] Response_Data
		{
			get
			{
