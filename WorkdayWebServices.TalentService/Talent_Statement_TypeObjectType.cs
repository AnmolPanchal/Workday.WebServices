...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Talent_Statement_TypeObjectType : INotifyPropertyChanged
	{
		private Talent_Statement_TypeObjectIDType[] idField;
		...
		public Talent_Statement_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
