...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Professional_AffiliationObjectType : INotifyPropertyChanged
	{
		private Professional_AffiliationObjectIDType[] idField;
		...
		public Professional_AffiliationObjectIDType[] ID
		{
			get
			{
				return this.idField;
