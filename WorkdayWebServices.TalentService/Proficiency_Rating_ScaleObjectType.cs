...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Proficiency_Rating_ScaleObjectType : INotifyPropertyChanged
	{
		private Proficiency_Rating_ScaleObjectIDType[] idField;
		...
		public Proficiency_Rating_ScaleObjectIDType[] ID
		{
			get
			{
				return this.idField;
