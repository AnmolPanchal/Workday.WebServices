...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Skill_Profiles_ResponseType : INotifyPropertyChanged
	{
		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Skill_ProfileType[] response_DataField;
		...
		[XmlArray(Order = 2), XmlArrayItem("Skill_Profile", IsNullable = false)]
		public Skill_ProfileType[] Response_Data
		{
			get
			{
