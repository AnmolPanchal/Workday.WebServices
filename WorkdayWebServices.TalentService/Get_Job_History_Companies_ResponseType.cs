...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Job_History_Companies_ResponseType : INotifyPropertyChanged
	{
		private Job_History_CompanyObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Job_History_CompanyType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Job_History_Company_Reference", IsNullable = false)]
		public Job_History_CompanyObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Job_History_Company", IsNullable = false)]
		public Job_History_CompanyType[] Response_Data
		{
			get
			{
