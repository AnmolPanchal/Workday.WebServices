...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Skill_Profile_Categories_ResponseType : INotifyPropertyChanged
	{
		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Skill_Profile_CategoryType[] response_DataField;
		...
		[XmlArray(Order = 2), XmlArrayItem("Skill_Profile_Category", IsNullable = false)]
		public Skill_Profile_CategoryType[] Response_Data
		{
			get
			{
