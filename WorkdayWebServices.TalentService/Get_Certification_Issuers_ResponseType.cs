...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Certification_Issuers_ResponseType : INotifyPropertyChanged
	{
		...
		[XmlArray(Order = 0), XmlArrayItem("Certification_Issuer_Reference", IsNullable = false)]
		...
		[XmlArray(Order = 5), XmlArrayItem("Certification_Issuer", IsNullable = false)]
