...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Professional_Affiliation_Types_ResponseType : INotifyPropertyChanged
	{
		private Professional_Affiliation_TypeObjectType[] request_ReferencesField;

		private Professional_Affiliation_Type_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Professional_Affiliation_Type_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Professional_Affiliation_TypeType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Professional_Affiliation_Type_Reference", IsNullable = false)]
		public Professional_Affiliation_TypeObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Professional_Affiliation_Type_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Professional_Affiliation_Type_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Professional_Affiliation_Type", IsNullable = false)]
		public Professional_Affiliation_TypeType[] Response_Data
		{
			get
			{
