...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Job_History_IndustryObjectType : INotifyPropertyChanged
	{
		private Job_History_IndustryObjectIDType[] idField;
		...
		public Job_History_IndustryObjectIDType[] ID
		{
			get
			{
				return this.idField;
