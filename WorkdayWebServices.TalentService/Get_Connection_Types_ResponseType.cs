...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Connection_Types_ResponseType : INotifyPropertyChanged
	{
		private Mentor_TypeObjectType[] request_ReferencesField;

		private Connection_Type_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Connection_Type_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Connection_TypeType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Connection_Type_Reference", IsNullable = false)]
		public Mentor_TypeObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Connection_Type_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Connection_Type_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Connection_Type", IsNullable = false)]
		public Connection_TypeType[] Response_Data
		{
			get
			{
