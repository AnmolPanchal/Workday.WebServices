...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Talent_Management_PoolObjectType : INotifyPropertyChanged
	{
		private Talent_Management_PoolObjectIDType[] idField;
		...
		public Talent_Management_PoolObjectIDType[] ID
		{
			get
			{
				return this.idField;
