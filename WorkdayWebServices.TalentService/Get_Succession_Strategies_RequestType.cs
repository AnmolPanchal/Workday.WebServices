...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Succession_Strategies_RequestType : INotifyPropertyChanged
	{
		private Succession_Strategy_Request_ReferencesType itemField;
		...
		public Succession_Strategy_Request_ReferencesType Item
		{
			get
			{
