...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Schools_ResponseType : INotifyPropertyChanged
	{
		...
		[XmlArray(Order = 0), XmlArrayItem("School_Reference", IsNullable = false)]
		...
		[XmlArray(Order = 5), XmlArrayItem("School", IsNullable = false)]
