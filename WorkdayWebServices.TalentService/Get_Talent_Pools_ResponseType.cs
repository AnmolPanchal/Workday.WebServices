...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Talent_Pools_ResponseType : INotifyPropertyChanged
	{
		private Talent_Management_PoolObjectType[] request_ReferencesField;

		private Talent_Pool_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Talent_Pool_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Talent_PoolType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Static_Talent_Pool_Reference", IsNullable = false)]
		public Talent_Management_PoolObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Talent_Pool_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Talent_Pool_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Talent_Pool", IsNullable = false)]
		public Talent_PoolType[] Response_Data
		{
			get
			{
