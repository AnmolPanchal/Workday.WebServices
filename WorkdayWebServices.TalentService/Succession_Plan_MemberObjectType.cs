...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Succession_Plan_MemberObjectType : INotifyPropertyChanged
	{
		private Succession_Plan_MemberObjectIDType[] idField;
		...
		public Succession_Plan_MemberObjectIDType[] ID
		{
			get
			{
				return this.idField;
