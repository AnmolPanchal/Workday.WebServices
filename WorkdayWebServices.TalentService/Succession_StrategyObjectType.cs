...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Succession_StrategyObjectType : INotifyPropertyChanged
	{
		private Succession_StrategyObjectIDType[] idField;
		...
		public Succession_StrategyObjectIDType[] ID
		{
			get
			{
				return this.idField;
