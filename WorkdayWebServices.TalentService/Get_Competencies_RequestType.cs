...
namespace WorkdayWebServices.TalentService
{
	...
	[Serializable]
	public class Get_Competencies_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Competency_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Competency_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
