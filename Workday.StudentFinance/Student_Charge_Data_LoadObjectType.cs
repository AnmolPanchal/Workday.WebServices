...
namespace WorkdayWebServices.Student_FinanceService
{
	...
	[Serializable]
	public class Student_Charge_Data_LoadObjectType : INotifyPropertyChanged
	{
		private Student_Charge_Data_LoadObjectIDType[] idField;
		...
		public Student_Charge_Data_LoadObjectIDType[] ID
		{
			get
			{
				return this.idField;
