...
namespace WorkdayWebServices.Student_FinanceService
{
	...
	[Serializable]
	public class Get_Student_Charges_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Student_Charge_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Student_Charge_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
