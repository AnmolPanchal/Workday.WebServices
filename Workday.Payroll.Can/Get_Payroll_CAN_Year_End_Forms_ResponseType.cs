...
namespace WorkdayWebServices.Payroll_CANService
{
	...
	[Serializable]
	public class Get_Payroll_CAN_Year_End_Forms_ResponseType : INotifyPropertyChanged
	{
		private Unique_IdentifierObjectType[] request_ReferencesField;

		private Payroll_CAN_Year_End_Form_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Payroll_CAN_Year_End_Form_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Payroll_Year_End_FormType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Payroll_CAN_Year_End_Form_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Payroll_CAN_Year_End_Form_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Payroll_CAN_Year_End_Form_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Payroll_Year_End_Form", IsNullable = false)]
		public Payroll_Year_End_FormType[] Response_Data
		{
			get
			{
