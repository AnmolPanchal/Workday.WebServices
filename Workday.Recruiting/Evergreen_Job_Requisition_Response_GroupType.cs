...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Evergreen_Job_Requisition_Response_GroupType : INotifyPropertyChanged
	{
		...
		private bool create_Job_Requisition_Restrictions_DataField;

		private bool create_Job_Requisition_Restrictions_DataFieldSpecified;
		...
		[XmlElement(Order = 2)]
		public bool Create_Job_Requisition_Restrictions_Data
		{
			get
			{
				return this.create_Job_Requisition_Restrictions_DataField;
			}
			set
			{
				this.create_Job_Requisition_Restrictions_DataField = value;
				this.RaisePropertyChanged("Create_Job_Requisition_Restrictions_Data");
			}
		}

		[XmlIgnore]
		public bool Create_Job_Requisition_Restrictions_DataSpecified
		{
			get
			{
				return this.create_Job_Requisition_Restrictions_DataFieldSpecified;
			}
			set
			{
				this.create_Job_Requisition_Restrictions_DataFieldSpecified = value;
				this.RaisePropertyChanged("Create_Job_Requisition_Restrictions_DataSpecified");
			}
		}
