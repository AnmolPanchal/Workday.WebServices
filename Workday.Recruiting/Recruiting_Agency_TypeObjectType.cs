...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Recruiting_Agency_TypeObjectType : INotifyPropertyChanged
	{
		private Recruiting_Agency_TypeObjectIDType[] idField;
		...
		public Recruiting_Agency_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
