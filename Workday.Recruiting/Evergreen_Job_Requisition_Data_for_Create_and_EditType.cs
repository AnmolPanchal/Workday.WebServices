...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Evergreen_Job_Requisition_Data_for_Create_and_EditType : INotifyPropertyChanged
	{
		...
		private Job_ProfileObjectType[] additional_Job_Profiles_ReferenceField;
		...
		private Job_RequisitionObjectType[] job_Requisition_Links_to_Add_ReferenceField;

		private Job_RequisitionObjectType[] job_Requisition_Links_to_Remove_ReferenceField;
		...
		private Evergreen_Job_Requisition_Organizations_Data_for_Business_ProcessType organization_DataField;
		...
		[XmlElement("Additional_Job_Profiles_Reference", Order = 12)]
		public Job_ProfileObjectType[] Additional_Job_Profiles_Reference
		{
			get
			{
				return this.additional_Job_Profiles_ReferenceField;
			}
			set
			{
				this.additional_Job_Profiles_ReferenceField = value;
				this.RaisePropertyChanged("Additional_Job_Profiles_Reference");
			}
		}
		...
		[XmlElement("Job_Requisition_Links_to_Add_Reference", Order = 22)]
		public Job_RequisitionObjectType[] Job_Requisition_Links_to_Add_Reference
		{
			get
			{
				return this.job_Requisition_Links_to_Add_ReferenceField;
			}
			set
			{
				this.job_Requisition_Links_to_Add_ReferenceField = value;
				this.RaisePropertyChanged("Job_Requisition_Links_to_Add_Reference");
			}
		}

		[XmlElement("Job_Requisition_Links_to_Remove_Reference", Order = 23)]
		public Job_RequisitionObjectType[] Job_Requisition_Links_to_Remove_Reference
		{
			get
			{
				return this.job_Requisition_Links_to_Remove_ReferenceField;
			}
			set
			{
				this.job_Requisition_Links_to_Remove_ReferenceField = value;
				this.RaisePropertyChanged("Job_Requisition_Links_to_Remove_Reference");
			}
		}
		...
		[XmlElement(Order = 26)]
		public Evergreen_Job_Requisition_Organizations_Data_for_Business_ProcessType Organization_Data
		{
			get
			{
