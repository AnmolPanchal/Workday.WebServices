...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Recruiting_Assessment_StatusObjectType : INotifyPropertyChanged
	{
		private Recruiting_Assessment_StatusObjectIDType[] idField;
		...
		public Recruiting_Assessment_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
