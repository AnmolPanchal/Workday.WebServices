...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Recruiting_Agency_SiteObjectType : INotifyPropertyChanged
	{
		private Recruiting_Agency_SiteObjectIDType[] idField;
		...
		public Recruiting_Agency_SiteObjectIDType[] ID
		{
			get
			{
				return this.idField;
