...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Armed_Forces_StatusObjectType : INotifyPropertyChanged
	{
		private Armed_Forces_StatusObjectIDType[] idField;
		...
		public Armed_Forces_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
