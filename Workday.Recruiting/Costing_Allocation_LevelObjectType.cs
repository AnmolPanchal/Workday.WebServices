...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Costing_Allocation_LevelObjectType : INotifyPropertyChanged
	{
		private Costing_Allocation_LevelObjectIDType[] idField;
		...
		public Costing_Allocation_LevelObjectIDType[] ID
		{
			get
			{
				return this.idField;
