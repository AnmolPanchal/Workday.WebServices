...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Post_Job_Sub_Business_ProcessType : INotifyPropertyChanged
	{
		private Business_Sub_Process_ParametersType business_Sub_Process_ParametersField;

		private Job_Posting_Site_DataType[] post_Job_DataField;
		...
		[XmlElement("Post_Job_Data", Order = 1)]
		public Job_Posting_Site_DataType[] Post_Job_Data
		{
			get
			{
				return this.post_Job_DataField;
			}
			set
			{
				this.post_Job_DataField = value;
				this.RaisePropertyChanged("Post_Job_Data");
			}
		}
