...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Get_Job_Application_Additional_Data_ResponseType : INotifyPropertyChanged
	{
		private Job_ApplicationObjectType[] request_ReferencesField;

		private Job_Application_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Job_Application_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Job_ApplicationType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Job_Application_Reference", IsNullable = false)]
		public Job_ApplicationObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Job_Application_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Job_Application_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Job_Application_Custom_Object_Data", IsNullable = false)]
		public Job_ApplicationType[] Response_Data
		{
			get
			{
