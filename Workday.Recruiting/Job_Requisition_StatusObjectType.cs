...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Job_Requisition_StatusObjectType : INotifyPropertyChanged
	{
		private Job_Requisition_StatusObjectIDType[] idField;
		...
		public Job_Requisition_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
