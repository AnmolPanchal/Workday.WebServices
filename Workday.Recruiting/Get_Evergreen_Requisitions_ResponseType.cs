...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Get_Evergreen_Requisitions_ResponseType : INotifyPropertyChanged
	{
		private Evergreen_Job_Requisition_Request_ReferencesType request_ReferencesField;

		private Evergreen_Job_Requisition_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Evergreen_Job_Requisition_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Evergreen_Job_RequisitionType[] response_DataField;
		...
		[XmlElement(Order = 0)]
		public Evergreen_Job_Requisition_Request_ReferencesType Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Evergreen_Job_Requisition_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Evergreen_Job_Requisition_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Evergreen_Job_Requsition", IsNullable = false)]
		public Evergreen_Job_RequisitionType[] Response_Data
		{
			get
			{
