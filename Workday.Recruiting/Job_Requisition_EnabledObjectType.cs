...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Job_Requisition_EnabledObjectType : INotifyPropertyChanged
	{
		private Job_Requisition_EnabledObjectIDType[] idField;
		...
		public Job_Requisition_EnabledObjectIDType[] ID
		{
			get
			{
				return this.idField;
