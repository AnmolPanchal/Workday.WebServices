...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Candidate_AttachmentObjectType : INotifyPropertyChanged
	{
		private Candidate_AttachmentObjectIDType[] idField;
		...
		public Candidate_AttachmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
