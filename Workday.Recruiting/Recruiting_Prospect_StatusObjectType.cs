...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Recruiting_Prospect_StatusObjectType : INotifyPropertyChanged
	{
		private Recruiting_Prospect_StatusObjectIDType[] idField;
		...
		public Recruiting_Prospect_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
