...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Position_Worker_TypeObjectType : INotifyPropertyChanged
	{
		private Position_Worker_TypeObjectIDType[] idField;
		...
		public Position_Worker_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
