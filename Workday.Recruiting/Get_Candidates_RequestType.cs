...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Get_Candidates_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Candidate_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Candidate_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
