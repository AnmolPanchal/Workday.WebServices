...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Recruiting_Agency_Fee_TypeObjectType : INotifyPropertyChanged
	{
		private Recruiting_Agency_Fee_TypeObjectIDType[] idField;
		...
		public Recruiting_Agency_Fee_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
