...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Referral_RelationshipObjectType : INotifyPropertyChanged
	{
		private Referral_RelationshipObjectIDType[] idField;
		...
		public Referral_RelationshipObjectIDType[] ID
		{
			get
			{
				return this.idField;
