...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Recruiting_AssessmentObjectType : INotifyPropertyChanged
	{
		private Recruiting_AssessmentObjectIDType[] idField;
		...
		public Recruiting_AssessmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
