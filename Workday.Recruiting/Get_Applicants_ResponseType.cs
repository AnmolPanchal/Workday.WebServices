...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Get_Applicants_ResponseType : INotifyPropertyChanged
	{
		private ApplicantObjectType[] request_ReferencesField;

		private Applicant_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Applicant_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Applicant_WWSType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Applicant_Reference", IsNullable = false)]
		public ApplicantObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Applicant_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Applicant_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Applicant", IsNullable = false)]
		public Applicant_WWSType[] Response_Data
		{
			get
			{
