...
namespace WorkdayWebServices.Tenant_Data_TranslationService
{
	...
	[Serializable]
	public class Get_Translatable_Tenant_Data_Public_ResponseType : INotifyPropertyChanged
	{
		...
		private Translatable_Class_Attribute_DataType[] response_DataField;
		...
		[XmlArray(Order = 3), XmlArrayItem("Translatable_Tenant_Data_Public", IsNullable = false), XmlArrayItem("Translatable_Tenant_Data_Public_Data", IsNullable = false, NestingLevel = 1)]
		public Translatable_Class_Attribute_DataType[] Response_Data
		{
			get
			{
