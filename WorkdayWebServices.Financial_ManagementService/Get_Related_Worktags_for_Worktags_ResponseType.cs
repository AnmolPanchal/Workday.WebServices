...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Related_Worktags_for_Worktags_ResponseType : INotifyPropertyChanged
	{
		private Worktag_with_Related_WorktagsObjectType[] request_ReferencesField;

		private Worktag_Type_Configuration_SetObjectType[] request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Related_Worktag_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Related_WorktagsType[] response_DataField;
		...
		[XmlArray(Order = 1), XmlArrayItem("Worktag_Type_Configuration_Set_Reference", IsNullable = false)]
		public Worktag_Type_Configuration_SetObjectType[] Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Related_Worktag_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Related_Worktags", IsNullable = false)]
		public Related_WorktagsType[] Response_Data
		{
			get
			{
