...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Integration_Worktag_Mapping_Source_Systems_RequestType : INotifyPropertyChanged
	{
		private Integration_Worktag_Mapping_Source_System_Request_ReferencesType itemField;
		...
		public Integration_Worktag_Mapping_Source_System_Request_ReferencesType Item
		{
			get
			{
