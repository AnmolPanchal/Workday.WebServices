...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Position_Budgets_ResponseType : INotifyPropertyChanged
	{
		private Unique_IdentifierObjectType[] request_ReferencesField;

		private Position_Budget_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Position_Budget_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Position_BudgetType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Position_Budget_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Position_Budget_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Position_Budget_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Position_Budget", IsNullable = false)]
		public Position_BudgetType[] Response_Data
		{
			get
			{
