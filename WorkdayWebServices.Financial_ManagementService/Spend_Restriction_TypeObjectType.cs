...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Spend_Restriction_TypeObjectType : INotifyPropertyChanged
	{
		private Spend_Restriction_TypeObjectIDType[] idField;
		...
		public Spend_Restriction_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
