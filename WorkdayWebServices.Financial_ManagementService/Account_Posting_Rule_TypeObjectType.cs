...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Account_Posting_Rule_TypeObjectType : INotifyPropertyChanged
	{
		private Account_Posting_Rule_TypeObjectIDType[] idField;
		...
		public Account_Posting_Rule_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
