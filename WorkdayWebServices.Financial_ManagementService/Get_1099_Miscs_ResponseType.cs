...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_1099_Miscs_ResponseType : INotifyPropertyChanged
	{
		private Unique_IdentifierObjectType[] request_ReferencesField;

		private XMLNAME_1099_Misc_Request_CriteriaType request_CriteriaField;
		...
		private XMLNAME_1099_MiscType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("IRS_1099_Misc_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public XMLNAME_1099_Misc_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("IRS_1099_Misc", IsNullable = false)]
		public XMLNAME_1099_MiscType[] Response_Data
		{
			get
			{
