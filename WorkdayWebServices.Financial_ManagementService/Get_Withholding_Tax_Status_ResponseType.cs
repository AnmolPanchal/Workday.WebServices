...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Withholding_Tax_Status_ResponseType : INotifyPropertyChanged
	{
		private Withholding_Tax_StatusObjectType[] request_ReferencesField;

		private Withholding_Tax_Status_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Withholding_Tax_Status_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Withholding_Tax_StatusType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Withholding_Tax_Status_Reference", IsNullable = false)]
		public Withholding_Tax_StatusObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Withholding_Tax_Status_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Withholding_Tax_Status_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Withholding_Tax_Status", IsNullable = false)]
		public Withholding_Tax_StatusType[] Response_Data
		{
			get
			{
