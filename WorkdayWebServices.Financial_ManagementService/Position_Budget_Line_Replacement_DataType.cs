...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Position_Budget_Line_Replacement_DataType : INotifyPropertyChanged
	{
		private string line_OrderField;

		private Budget_Line_TypeObjectType budget_Line_Type_ReferenceField;
		...
		[XmlElement(Order = 1)]
		public Budget_Line_TypeObjectType Budget_Line_Type_Reference
		{
			get
			{
				return this.budget_Line_Type_ReferenceField;
			}
			set
			{
				this.budget_Line_Type_ReferenceField = value;
				this.RaisePropertyChanged("Budget_Line_Type_Reference");
			}
		}
