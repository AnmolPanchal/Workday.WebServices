...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Statistic_DefinitionObjectType : INotifyPropertyChanged
	{
		private Statistic_DefinitionObjectIDType[] idField;
		...
		public Statistic_DefinitionObjectIDType[] ID
		{
			get
			{
				return this.idField;
