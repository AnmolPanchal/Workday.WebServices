...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Gifts_ResponseType : INotifyPropertyChanged
	{
		private GiftObjectType[] request_ReferencesField;

		private Gift_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private GiftType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Gift_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Gift_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Gift", IsNullable = false)]
		public GiftType[] Response_Data
		{
			get
			{
