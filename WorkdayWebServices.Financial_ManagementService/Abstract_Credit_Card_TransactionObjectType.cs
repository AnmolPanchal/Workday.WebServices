...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Abstract_Credit_Card_TransactionObjectType : INotifyPropertyChanged
	{
		private Abstract_Credit_Card_TransactionObjectIDType[] idField;
		...
		public Abstract_Credit_Card_TransactionObjectIDType[] ID
		{
			get
			{
				return this.idField;
