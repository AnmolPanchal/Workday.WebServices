...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Account_Posting_Rule_Sets_ResponseType : INotifyPropertyChanged
	{
		private Account_Posting_Rule_SetObjectType[] request_ReferencesField;

		private Account_Posting_Rule_Set_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Account_Posting_Rule_Set_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Account_Posting_Rule_SetType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Account_Posting_Rule_Set_Reference", IsNullable = false)]
		public Account_Posting_Rule_SetObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Account_Posting_Rule_Set_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Account_Posting_Rule_Set_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Account_Posting_Rule_Set", IsNullable = false)]
		public Account_Posting_Rule_SetType[] Response_Data
		{
			get
			{
