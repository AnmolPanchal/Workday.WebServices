...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Average_Daily_Balance_RuleObjectType : INotifyPropertyChanged
	{
		private Average_Daily_Balance_RuleObjectIDType[] idField;
		...
		public Average_Daily_Balance_RuleObjectIDType[] ID
		{
			get
			{
				return this.idField;
