...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Integration_Worktag_Mappings_ResponseType : INotifyPropertyChanged
	{
		private Integration_Worktag_MappingObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Integration_Worktag_MappingType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Integration_Worktag_Mapping_Reference", IsNullable = false)]
		public Integration_Worktag_MappingObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Integration_Worktag_Mapping", IsNullable = false)]
		public Integration_Worktag_MappingType[] Response_Data
		{
			get
			{
