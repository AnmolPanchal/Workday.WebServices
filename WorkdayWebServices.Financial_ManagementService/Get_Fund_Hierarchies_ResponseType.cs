...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Fund_Hierarchies_ResponseType : INotifyPropertyChanged
	{
		private Fund_HierarchyObjectType[] request_ReferencesField;

		private Fund_Hierarchy_Request_CriteriaType[] request_CriteriaField;

		private Response_FilterType[] response_FilterField;

		private Response_ResultsType[] response_ResultsField;

		private Fund_HierarchyType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Fund_Hierarchy_Reference", typeof(Fund_HierarchyObjectType), IsNullable = false)]
		public Fund_HierarchyObjectType[] Request_References
		{
			get
			{
		...
		public Fund_Hierarchy_Request_CriteriaType[] Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Fund_Hierarchy", typeof(Fund_HierarchyType), IsNullable = false)]
		public Fund_HierarchyType[] Response_Data
		{
			get
			{
