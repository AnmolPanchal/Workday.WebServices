...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Revenue_Categories_ResponseType : INotifyPropertyChanged
	{
		private Revenue_CategoryObjectType[] request_ReferencesField;

		private Revenue_Category_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Revenue_Category_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Revenue_CategoryType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Revenue_Category_Reference", IsNullable = false)]
		public Revenue_CategoryObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Revenue_Category_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Revenue_Category_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Revenue_Category", IsNullable = false)]
		public Revenue_CategoryType[] Response_Data
		{
			get
			{
