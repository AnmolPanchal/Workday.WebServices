...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Suspense_Account_Rules_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Suspense_Account_Rule_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Suspense_Account_Rule_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
