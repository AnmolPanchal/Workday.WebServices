...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Tax_Reportable_PayeeObjectType : INotifyPropertyChanged
	{
		private Tax_Reportable_PayeeObjectIDType[] idField;
		...
		public Tax_Reportable_PayeeObjectIDType[] ID
		{
			get
			{
				return this.idField;
