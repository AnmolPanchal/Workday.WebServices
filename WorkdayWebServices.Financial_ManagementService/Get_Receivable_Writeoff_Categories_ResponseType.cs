...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Receivable_Writeoff_Categories_ResponseType : INotifyPropertyChanged
	{
		private Receivable_Writeoff_ReasonObjectType[] request_ReferencesField;

		private Receivable_Writeoff_Reason_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Receivable_Writeoff_Reason_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Receivable_Writeoff_ReasonType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Receivable_Writeoff_Category_Reference", IsNullable = false)]
		public Receivable_Writeoff_ReasonObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Receivable_Writeoff_Reason_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Receivable_Writeoff_Reason_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Receivable_Writeoff_Category", IsNullable = false)]
		public Receivable_Writeoff_ReasonType[] Response_Data
		{
			get
			{
