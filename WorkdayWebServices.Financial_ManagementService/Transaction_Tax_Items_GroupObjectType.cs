...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Transaction_Tax_Items_GroupObjectType : INotifyPropertyChanged
	{
		private Transaction_Tax_Items_GroupObjectIDType[] idField;
		...
		public Transaction_Tax_Items_GroupObjectIDType[] ID
		{
			get
			{
				return this.idField;
