...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Revenue_Category_HierarchyObjectType : INotifyPropertyChanged
	{
		private Revenue_Category_HierarchyObjectIDType[] idField;
		...
		public Revenue_Category_HierarchyObjectIDType[] ID
		{
			get
			{
				return this.idField;
