...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Gift_ClassificationObjectType : INotifyPropertyChanged
	{
		private Gift_ClassificationObjectIDType[] idField;
		...
		public Gift_ClassificationObjectIDType[] ID
		{
			get
			{
				return this.idField;
