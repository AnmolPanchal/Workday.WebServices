...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Spend_Category_or_HierarchyObjectType : INotifyPropertyChanged
	{
		private Spend_Category_or_HierarchyObjectIDType[] idField;
		...
		public Spend_Category_or_HierarchyObjectIDType[] ID
		{
			get
			{
				return this.idField;
