...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Recurring_Journal_Templates_ResponseType : INotifyPropertyChanged
	{
		private Recurring_Journal_TemplateObjectType[] request_ReferencesField;

		private Recurring_Journal_Template_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Recurring_Journal_Template_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Recurring_Journal_TemplateType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Recurring_Journal_Template_Reference", IsNullable = false)]
		public Recurring_Journal_TemplateObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Recurring_Journal_Template_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Recurring_Journal_Template_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Recurring_Journal_Template", IsNullable = false)]
		public Recurring_Journal_TemplateType[] Response_Data
		{
			get
			{
