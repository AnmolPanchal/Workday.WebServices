...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Payment_Handling_InstructionObjectType : INotifyPropertyChanged
	{
		private Payment_Handling_InstructionObjectIDType[] idField;
		...
		public Payment_Handling_InstructionObjectIDType[] ID
		{
			get
			{
				return this.idField;
