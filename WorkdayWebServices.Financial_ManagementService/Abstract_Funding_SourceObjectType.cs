...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Abstract_Funding_SourceObjectType : INotifyPropertyChanged
	{
		private Abstract_Funding_SourceObjectIDType[] idField;
		...
		public Abstract_Funding_SourceObjectIDType[] ID
		{
			get
			{
				return this.idField;
