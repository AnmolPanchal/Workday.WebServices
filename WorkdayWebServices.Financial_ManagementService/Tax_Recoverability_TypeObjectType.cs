...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Tax_Recoverability_TypeObjectType : INotifyPropertyChanged
	{
		private Tax_Recoverability_TypeObjectIDType[] idField;
		...
		public Tax_Recoverability_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
