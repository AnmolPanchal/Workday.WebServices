...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Budget_Fringe_Rate_Tables_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Budget_Fringe_Rate_Table_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Budget_Fringe_Rate_Table_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
