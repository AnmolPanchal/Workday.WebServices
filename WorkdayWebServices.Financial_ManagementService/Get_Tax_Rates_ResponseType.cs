...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Tax_Rates_ResponseType : INotifyPropertyChanged
	{
		private Tax_RateObjectType[] request_ReferencesField;

		private Tax_Rate_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Tax_Rate_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Tax_RateType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Tax_Rate_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Tax_Rate_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Tax_Rate_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Tax_Rate", IsNullable = false)]
		public Tax_RateType[] Response_Data
		{
			get
			{
