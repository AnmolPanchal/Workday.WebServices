...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Funding_Source_RuleObjectType : INotifyPropertyChanged
	{
		private Funding_Source_RuleObjectIDType[] idField;
		...
		public Funding_Source_RuleObjectIDType[] ID
		{
			get
			{
				return this.idField;
