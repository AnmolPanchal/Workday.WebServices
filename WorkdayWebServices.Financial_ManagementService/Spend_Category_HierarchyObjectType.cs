...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Spend_Category_HierarchyObjectType : INotifyPropertyChanged
	{
		private Spend_Category_HierarchyObjectIDType[] idField;
		...
		public Spend_Category_HierarchyObjectIDType[] ID
		{
			get
			{
				return this.idField;
