...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Payment_Terms_ResponseType : INotifyPropertyChanged
	{
		private Payment_TermsObjectType[] request_ReferencesField;

		private Payment_Term_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Payment_Term_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Payment_TermType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Payment_Term_Reference", IsNullable = false)]
		public Payment_TermsObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Payment_Term_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Payment_Term_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Payment_Term", IsNullable = false)]
		public Payment_TermType[] Response_Data
		{
			get
			{
