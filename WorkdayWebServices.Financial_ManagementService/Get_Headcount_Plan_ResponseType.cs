...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Headcount_Plan_ResponseType : INotifyPropertyChanged
	{
		private Unique_IdentifierObjectType[] request_ReferencesField;

		private Headcount_Plans_Request_CriteriaType[] request_CriteriaField;

		private Response_FilterType[] response_FilterField;

		private Headcount_Plans_Response_GroupType[] response_GroupField;

		private Response_ResultsType[] response_ResultsField;

		private Headcount_PlanType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Headcount_Plan_Reference", typeof(Unique_IdentifierObjectType), IsNullable = false)]
		...
		public Headcount_Plans_Request_CriteriaType[] Request_Criteria
		{
			get
			{
		...
		public Headcount_Plans_Response_GroupType[] Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Headcount_Plan", typeof(Headcount_PlanType), IsNullable = false)]
		public Headcount_PlanType[] Response_Data
		{
			get
			{
