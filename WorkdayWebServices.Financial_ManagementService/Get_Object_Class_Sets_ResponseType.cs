...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Object_Class_Sets_ResponseType : INotifyPropertyChanged
	{
		private Object_Class_SetObjectType[] request_ReferencesField;

		private Object_Class_Set_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Object_Class_SetType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Object_Class_Set_Reference", IsNullable = false)]
		public Object_Class_SetObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Object_Class_Set_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Object_Class_Set", IsNullable = false)]
		public Object_Class_SetType[] Response_Data
		{
			get
			{
