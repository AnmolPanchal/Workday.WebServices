...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Award_Personnel_Responsibilities_ResponseType : INotifyPropertyChanged
	{
		private Award_Personnel_ResponsibilityObjectType[] request_ReferencesField;

		private Award_Personnel_Responsibility_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Award_Personnel_ResponsibilityType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Award_Personnel_Responsibility_Reference", IsNullable = false)]
		public Award_Personnel_ResponsibilityObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Award_Personnel_Responsibility_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Award_Personnel_Responsibility", IsNullable = false)]
		public Award_Personnel_ResponsibilityType[] Response_Data
		{
			get
			{
