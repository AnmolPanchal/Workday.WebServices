...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Spend_Restrictions_ResponseType : INotifyPropertyChanged
	{
		private Spend_RestrictionObjectType[] request_ReferencesField;

		private Spend_Restriction_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Spend_Restriction_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Spend_RestrictionType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Spend_Restriction_Reference", IsNullable = false)]
		public Spend_RestrictionObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Spend_Restriction_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Spend_Restriction_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Spend_Restriction", IsNullable = false)]
		public Spend_RestrictionType[] Response_Data
		{
			get
			{
