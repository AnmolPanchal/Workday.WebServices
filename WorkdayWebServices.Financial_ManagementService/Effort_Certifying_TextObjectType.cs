...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Effort_Certifying_TextObjectType : INotifyPropertyChanged
	{
		private Effort_Certifying_TextObjectIDType[] idField;
		...
		public Effort_Certifying_TextObjectIDType[] ID
		{
			get
			{
				return this.idField;
