...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Account_Sets_ResponseType : INotifyPropertyChanged
	{
		private Account_SetObjectType[] request_ReferencesField;

		private Account_Set_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Account_Set_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Account_SetType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Account_Set_Reference", IsNullable = false)]
		public Account_SetObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Account_Set_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Account_Set_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Account_Set", IsNullable = false)]
		public Account_SetType[] Response_Data
		{
			get
			{
