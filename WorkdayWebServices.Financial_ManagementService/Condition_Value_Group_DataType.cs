...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Condition_Value_Group_DataType : INotifyPropertyChanged
	{
		...
		private Account_Posting_Rule_Condition_ValueObjectType default_Value_ReferenceField;
		...
		[XmlElement(Order = 3)]
		public Account_Posting_Rule_Condition_ValueObjectType Default_Value_Reference
		{
			get
			{
				return this.default_Value_ReferenceField;
			}
			set
			{
				this.default_Value_ReferenceField = value;
				this.RaisePropertyChanged("Default_Value_Reference");
			}
		}
