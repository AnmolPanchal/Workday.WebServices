...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Loan_Investor_TypeObjectType : INotifyPropertyChanged
	{
		private Loan_Investor_TypeObjectIDType[] idField;
		...
		public Loan_Investor_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
