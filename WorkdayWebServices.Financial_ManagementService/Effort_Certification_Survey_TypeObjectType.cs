...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Effort_Certification_Survey_TypeObjectType : INotifyPropertyChanged
	{
		private Effort_Certification_Survey_TypeObjectIDType[] idField;
		...
		public Effort_Certification_Survey_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
