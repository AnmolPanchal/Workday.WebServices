...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Tax_Categories_ResponseType : INotifyPropertyChanged
	{
		private Tax_CategoryObjectType[] request_ReferencesField;

		private Tax_Category_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Tax_Category_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Tax_CategoryType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Tax_Category_Reference", IsNullable = false)]
		public Tax_CategoryObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Tax_Category_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Tax_Category_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Tax_Category", IsNullable = false)]
		public Tax_CategoryType[] Response_Data
		{
			get
			{
