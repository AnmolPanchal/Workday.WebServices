...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Budget_Fringe_Rate_TableObjectType : INotifyPropertyChanged
	{
		private Budget_Fringe_Rate_TableObjectIDType[] idField;
		...
		public Budget_Fringe_Rate_TableObjectIDType[] ID
		{
			get
			{
				return this.idField;
