...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Supplier_Categories_ResponseType : INotifyPropertyChanged
	{
		private Supplier_CategoryObjectType[] request_ReferencesField;

		private Supplier_Category_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Supplier_Category_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Supplier_CategoryType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Supplier_Category_Reference", IsNullable = false)]
		public Supplier_CategoryObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Supplier_Category_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Supplier_Category_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Supplier_Category", IsNullable = false)]
		public Supplier_CategoryType[] Response_Data
		{
			get
			{
