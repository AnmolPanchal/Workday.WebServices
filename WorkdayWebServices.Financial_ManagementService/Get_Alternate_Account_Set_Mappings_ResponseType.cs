...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Alternate_Account_Set_Mappings_ResponseType : INotifyPropertyChanged
	{
		private Unique_IdentifierObjectType[] request_ReferencesField;

		private Alternate_Account_Set_Mapping_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Alternate_Account_Set_Mapping_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Alternate_Account_Set_MappingType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Alternate_Account_Set_Mapping_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Alternate_Account_Set_Mapping_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Alternate_Account_Set_Mapping_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Alternate_Account_Set_Mapping", IsNullable = false)]
		public Alternate_Account_Set_MappingType[] Response_Data
		{
			get
			{
