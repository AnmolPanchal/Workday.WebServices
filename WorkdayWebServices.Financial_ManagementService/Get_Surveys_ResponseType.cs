...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Surveys_ResponseType : INotifyPropertyChanged
	{
		private Effort_Certification_SurveyObjectType[] request_ReferencesField;

		private Survey_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private SurveyType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Survey_Reference", IsNullable = false)]
		public Effort_Certification_SurveyObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Survey_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Survey", IsNullable = false)]
		public SurveyType[] Response_Data
		{
			get
			{
