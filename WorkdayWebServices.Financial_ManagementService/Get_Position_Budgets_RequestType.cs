...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Position_Budgets_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Position_Budget_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Position_Budget_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
