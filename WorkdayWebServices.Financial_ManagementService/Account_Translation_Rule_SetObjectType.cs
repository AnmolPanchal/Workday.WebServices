...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Account_Translation_Rule_SetObjectType : INotifyPropertyChanged
	{
		private Account_Translation_Rule_SetObjectIDType[] idField;
		...
		public Account_Translation_Rule_SetObjectIDType[] ID
		{
			get
			{
				return this.idField;
