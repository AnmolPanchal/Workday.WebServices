...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Effort_Certification_Types_ResponseType : INotifyPropertyChanged
	{
		private Effort_Certification_TypeObjectType[] request_ReferencesField;

		private Effort_Certification_Type_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Effort_Certification_TypeType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Effort_Certification_Type_Reference", IsNullable = false)]
		public Effort_Certification_TypeObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Effort_Certification_Type_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Effort_Certification_Type", IsNullable = false)]
		public Effort_Certification_TypeType[] Response_Data
		{
			get
			{
