...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Phone_Number_DataType : INotifyPropertyChanged
	{
		...
		private Phone_Device_Type_ReferenceType phone_Device_Type_ReferenceField;
		...
		[XmlElement(Order = 5)]
		public Phone_Device_Type_ReferenceType Phone_Device_Type_Reference
		{
			get
			{
