...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Custom_Worktag_ConfigurationObjectType : INotifyPropertyChanged
	{
		private Custom_Worktag_ConfigurationObjectIDType[] idField;
		...
		public Custom_Worktag_ConfigurationObjectIDType[] ID
		{
			get
			{
				return this.idField;
