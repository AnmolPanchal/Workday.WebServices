...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Custom_Validation_ContextObjectType : INotifyPropertyChanged
	{
		private Custom_Validation_ContextObjectIDType[] idField;
		...
		public Custom_Validation_ContextObjectIDType[] ID
		{
			get
			{
				return this.idField;
