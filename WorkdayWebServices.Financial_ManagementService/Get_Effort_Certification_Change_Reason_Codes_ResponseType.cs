...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Effort_Certification_Change_Reason_Codes_ResponseType : INotifyPropertyChanged
	{
		private Effort_Certification_Change_Reason_CodeObjectType[] request_ReferencesField;

		private Effort_Certification_Change_Reason_Code_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Effort_Certification_Change_Reason_CodeType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Effort_Certification_Change_Reason_Code_Reference", IsNullable = false)]
		public Effort_Certification_Change_Reason_CodeObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Effort_Certification_Change_Reason_Code_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Effort_Certification_Change_Reason_Code", IsNullable = false)]
		public Effort_Certification_Change_Reason_CodeType[] Response_Data
		{
			get
			{
