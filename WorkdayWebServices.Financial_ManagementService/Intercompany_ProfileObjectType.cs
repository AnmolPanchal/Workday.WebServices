...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Intercompany_ProfileObjectType : INotifyPropertyChanged
	{
		private Intercompany_ProfileObjectIDType[] idField;
		...
		public Intercompany_ProfileObjectIDType[] ID
		{
			get
			{
				return this.idField;
