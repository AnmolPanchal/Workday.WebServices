...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Effort_Certification_TypeObjectType : INotifyPropertyChanged
	{
		private Effort_Certification_TypeObjectIDType[] idField;
		...
		public Effort_Certification_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
