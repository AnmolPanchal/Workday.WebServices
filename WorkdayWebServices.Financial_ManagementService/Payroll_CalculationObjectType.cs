...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Payroll_CalculationObjectType : INotifyPropertyChanged
	{
		private Payroll_CalculationObjectIDType[] idField;
		...
		public Payroll_CalculationObjectIDType[] ID
		{
			get
			{
				return this.idField;
