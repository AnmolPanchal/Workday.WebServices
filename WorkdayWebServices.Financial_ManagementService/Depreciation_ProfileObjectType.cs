...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Depreciation_ProfileObjectType : INotifyPropertyChanged
	{
		private Depreciation_ProfileObjectIDType[] idField;
		...
		public Depreciation_ProfileObjectIDType[] ID
		{
			get
			{
				return this.idField;
