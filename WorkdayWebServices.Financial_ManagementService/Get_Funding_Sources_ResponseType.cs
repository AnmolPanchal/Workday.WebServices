...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Funding_Sources_ResponseType : INotifyPropertyChanged
	{
		private Funding_SourceObjectType[] request_ReferencesField;

		private Response_FilterType[] response_FilterField;

		private Response_ResultsType[] response_ResultsField;

		private Funding_SourceType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Funding_Source_Reference", typeof(Funding_SourceObjectType), IsNullable = false)]
		public Funding_SourceObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Funding_Source", typeof(Funding_SourceType), IsNullable = false)]
		public Funding_SourceType[] Response_Data
		{
			get
			{
