...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Tax_Authorities_ResponseType : INotifyPropertyChanged
	{
		private Tax_AuthorityObjectType[] request_ReferencesField;

		private Tax_Authority_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Tax_Authority_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Tax_AuthorityType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Tax_Authority_Reference", IsNullable = false)]
		public Tax_AuthorityObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Tax_Authority_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Tax_Authority_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Tax_Authority", IsNullable = false)]
		public Tax_AuthorityType[] Response_Data
		{
			get
			{
