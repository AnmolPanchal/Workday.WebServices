...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Funds_ResponseType : INotifyPropertyChanged
	{
		private FundObjectType[] request_ReferencesField;

		private Fund_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private FundType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Fund_Reference", IsNullable = false)]
		public FundObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Fund_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Fund", IsNullable = false)]
		public FundType[] Response_Data
		{
			get
			{
