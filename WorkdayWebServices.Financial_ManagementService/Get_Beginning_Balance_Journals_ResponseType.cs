...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Beginning_Balance_Journals_ResponseType : INotifyPropertyChanged
	{
		private Accounting_JournalObjectType[] request_ReferencesField;

		private Beginning_Balance_Journal_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Beginning_Balance_Journal_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Beginning_Balance_JournalType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Beginning_Balance_Journal_Reference", IsNullable = false)]
		public Accounting_JournalObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Beginning_Balance_Journal_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Beginning_Balance_Journal_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Beginning_Balance_Journal", IsNullable = false)]
		public Beginning_Balance_JournalType[] Response_Data
		{
			get
			{
