...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Journal_Sources_ResponseType : INotifyPropertyChanged
	{
		private Journal_SourceObjectType[] request_ReferencesField;

		private Journal_Source_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Journal_Source_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Journal_SourceType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Journal_Source_Reference", IsNullable = false)]
		public Journal_SourceObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Journal_Source_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Journal_Source_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Journal_Source", IsNullable = false)]
		public Journal_SourceType[] Response_Data
		{
			get
			{
