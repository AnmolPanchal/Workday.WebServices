...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Ledger_Account_TypeObjectType : INotifyPropertyChanged
	{
		private Ledger_Account_TypeObjectIDType[] idField;
		...
		public Ledger_Account_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
