...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Investor_Security_SegmentObjectType : INotifyPropertyChanged
	{
		private Investor_Security_SegmentObjectIDType[] idField;
		...
		public Investor_Security_SegmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
