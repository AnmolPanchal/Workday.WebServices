...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Put_Survey_RequestType : INotifyPropertyChanged
	{
		private Effort_Certification_SurveyObjectType survey_ReferenceField;

		private Survey_DataType survey_DataField;
		...
		[XmlElement(Order = 1)]
		public Survey_DataType Survey_Data
		{
			get
			{
				return this.survey_DataField;
			}
			set
			{
				this.survey_DataField = value;
				this.RaisePropertyChanged("Survey_Data");
			}
		}
