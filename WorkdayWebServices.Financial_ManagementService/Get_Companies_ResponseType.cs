...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Companies_ResponseType : INotifyPropertyChanged
	{
		private CompanyObjectType[] request_ReferencesField;

		private Company_Request_CriteriaType[] request_CriteriaField;

		private Response_FilterType[] response_FilterField;

		private Response_ResultsType[] response_ResultsField;

		private CompanyType[] company_Response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Company_Reference", typeof(CompanyObjectType), IsNullable = false)]
		public CompanyObjectType[] Request_References
		{
			get
			{
		...
		public Company_Request_CriteriaType[] Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Company", typeof(CompanyType), IsNullable = false)]
		public CompanyType[] Company_Response_Data
		{
			get
			{
				return this.company_Response_DataField;
			}
			set
			{
				this.company_Response_DataField = value;
				this.RaisePropertyChanged("Company_Response_Data");
			}
		}
