...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Fiscal_Summary_ScheduleObjectType : INotifyPropertyChanged
	{
		private Fiscal_Summary_ScheduleObjectIDType[] idField;
		...
		public Fiscal_Summary_ScheduleObjectIDType[] ID
		{
			get
			{
				return this.idField;
