...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Programs_ResponseType : INotifyPropertyChanged
	{
		private ProgramObjectType[] request_ReferencesField;

		private Program_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private ProgramType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Program_Reference", IsNullable = false)]
		public ProgramObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Program_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Program", IsNullable = false)]
		public ProgramType[] Response_Data
		{
			get
			{
