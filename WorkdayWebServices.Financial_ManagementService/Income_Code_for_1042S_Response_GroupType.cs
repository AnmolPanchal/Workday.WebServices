...
{
	[GeneratedCode("System.Xml", "4.6.1590.0"), DesignerCategory("code"), DebuggerStepThrough, XmlType(TypeName = "Income_Code_for_1042-S_Response_GroupType", Namespace = "urn:com.workday/bsvc")]
	[Serializable]
	public class Income_Code_for_1042S_Response_GroupType : INotifyPropertyChanged
	{
