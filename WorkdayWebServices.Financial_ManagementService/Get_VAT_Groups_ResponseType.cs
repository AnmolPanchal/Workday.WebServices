...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_VAT_Groups_ResponseType : INotifyPropertyChanged
	{
		private VAT_GroupObjectType[] request_ReferencesField;

		private VAT_Group_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private VAT_Group_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private VAT_GroupType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("VAT_Group_Reference", IsNullable = false)]
		public VAT_GroupObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public VAT_Group_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public VAT_Group_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("VAT_Group", IsNullable = false)]
		public VAT_GroupType[] Response_Data
		{
			get
			{
