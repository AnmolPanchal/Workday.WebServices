...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Operational_TransactionObjectType : INotifyPropertyChanged
	{
		private Operational_TransactionObjectIDType[] idField;
		...
		public Operational_TransactionObjectIDType[] ID
		{
			get
			{
				return this.idField;
