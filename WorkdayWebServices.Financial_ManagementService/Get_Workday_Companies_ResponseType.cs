...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Workday_Companies_ResponseType : INotifyPropertyChanged
	{
		...
		private Company_Response_GroupType[] response_GroupField;

		private Response_ResultsType[] response_ResultsField;

		private Company_WWSType[] response_DataField;
		...
		public Company_Response_GroupType[] Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Company", typeof(Company_WWSType), IsNullable = false)]
		public Company_WWSType[] Response_Data
		{
			get
			{
