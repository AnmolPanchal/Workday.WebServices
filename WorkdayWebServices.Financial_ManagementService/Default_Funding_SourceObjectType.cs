...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Default_Funding_SourceObjectType : INotifyPropertyChanged
	{
		private Default_Funding_SourceObjectIDType[] idField;
		...
		public Default_Funding_SourceObjectIDType[] ID
		{
			get
			{
				return this.idField;
