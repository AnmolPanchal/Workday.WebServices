...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Basic_Customers_RequestType : INotifyPropertyChanged
	{
		private object itemField;

		private Response_FilterType response_FilterField;

		private Basic_Customer_Response_GroupType response_GroupField;
		...
		[XmlElement("Request_Criteria", typeof(Basic_Customer_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Customer_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
		...
		[XmlElement(Order = 2)]
		public Basic_Customer_Response_GroupType Response_Group
		{
			get
			{
