...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Fiscal_Posting_IntervalObjectType : INotifyPropertyChanged
	{
		private Fiscal_Posting_IntervalObjectIDType[] idField;
		...
		public Fiscal_Posting_IntervalObjectIDType[] ID
		{
			get
			{
				return this.idField;
