...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Transaction_Tax_Item_Groups_RequestType : INotifyPropertyChanged
	{
		private Transaction_Tax_Item_Group_Request_ReferencesType itemField;
		...
		public Transaction_Tax_Item_Group_Request_ReferencesType Item
		{
			get
			{
