...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Regions_ResponseType : INotifyPropertyChanged
	{
		private RegionObjectType[] request_ReferencesField;

		private Region_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Region_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private RegionType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Region_Reference", IsNullable = false)]
		public RegionObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Region_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Region_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Region", IsNullable = false)]
		public RegionType[] Response_Data
		{
			get
			{
