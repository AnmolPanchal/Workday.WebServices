...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Basic_Sales_Items_ResponseType : INotifyPropertyChanged
	{
		private Sales_ItemObjectType[] request_ReferencesField;

		private Sales_Item_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Sales_Item_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Basic_Sales_ItemType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Sales_Item_Reference", IsNullable = false)]
		public Sales_ItemObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Sales_Item_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Sales_Item_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Sales_Item", IsNullable = false)]
		public Basic_Sales_ItemType[] Response_Data
		{
			get
			{
