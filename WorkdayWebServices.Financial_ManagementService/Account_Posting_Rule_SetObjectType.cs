...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Account_Posting_Rule_SetObjectType : INotifyPropertyChanged
	{
		private Account_Posting_Rule_SetObjectIDType[] idField;
		...
		public Account_Posting_Rule_SetObjectIDType[] ID
		{
			get
			{
				return this.idField;
