...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Effort_Certification_SurveyObjectType : INotifyPropertyChanged
	{
		private Effort_Certification_SurveyObjectIDType[] idField;
		...
		public Effort_Certification_SurveyObjectIDType[] ID
		{
			get
			{
				return this.idField;
