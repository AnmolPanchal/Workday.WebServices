...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Tax_Rule_Exception_Groups_ResponseType : INotifyPropertyChanged
	{
		private Tax_Rule_Exception_GroupObjectType[] request_ReferencesField;

		private Tax_Rule_Exception_Group_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Tax_Rule_Exception_Group_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Tax_Rule_Exception_GroupType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Tax_Rule_Exception_Group_Reference", IsNullable = false)]
		public Tax_Rule_Exception_GroupObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Tax_Rule_Exception_Group_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Tax_Rule_Exception_Group_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Tax_Rule_Exception_Group", IsNullable = false)]
		public Tax_Rule_Exception_GroupType[] Response_Data
		{
			get
			{
