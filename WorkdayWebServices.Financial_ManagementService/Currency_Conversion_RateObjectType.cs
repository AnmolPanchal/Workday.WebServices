...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Currency_Conversion_RateObjectType : INotifyPropertyChanged
	{
		private Currency_Conversion_RateObjectIDType[] idField;
		...
		public Currency_Conversion_RateObjectIDType[] ID
		{
			get
			{
				return this.idField;
