...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Grant_Hierarchies_ResponseType : INotifyPropertyChanged
	{
		private Grant_HierarchyObjectType[] request_ReferencesField;

		private Grant_Hierarchy_Request_CriteriaType[] request_CriteriaField;

		private Response_FilterType[] response_FilterField;

		private Response_ResultsType[] response_ResultsField;

		private Grant_HierarchyType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Grant_Hierarchy_Reference", typeof(Grant_HierarchyObjectType), IsNullable = false)]
		public Grant_HierarchyObjectType[] Request_References
		{
			get
			{
		...
		public Grant_Hierarchy_Request_CriteriaType[] Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Grant_Hierarchy", typeof(Grant_HierarchyType), IsNullable = false)]
		public Grant_HierarchyType[] Response_Data
		{
			get
			{
