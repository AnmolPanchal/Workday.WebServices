...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Transaction_Tax_Item_Groups_ResponseType : INotifyPropertyChanged
	{
		private Transaction_Tax_Items_GroupObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Transaction_Tax_Items_GroupType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Transaction_Tax_Item_Group_Reference", IsNullable = false)]
		public Transaction_Tax_Items_GroupObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Transaction_Tax_Item_Group", IsNullable = false)]
		public Transaction_Tax_Items_GroupType[] Response_Data
		{
			get
			{
