...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Program_Hierarchies_ResponseType : INotifyPropertyChanged
	{
		private Program_HierarchyObjectType[] request_ReferencesField;

		private Program_Hierarchy_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Program_HierarchyType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Program_Hierarchy_Reference", IsNullable = false)]
		public Program_HierarchyObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Program_Hierarchy_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Program_Hierarchy", IsNullable = false)]
		public Program_HierarchyType[] Response_Data
		{
			get
			{
