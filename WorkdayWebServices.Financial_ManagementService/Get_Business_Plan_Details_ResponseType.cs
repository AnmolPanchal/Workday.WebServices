...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Business_Plan_Details_ResponseType : INotifyPropertyChanged
	{
		private Unique_IdentifierObjectType[] request_ReferencesField;

		private Business_Plan_Details_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Business_Plan_Details_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Business_Plan_DetailsType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Business_Plan_Details_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Business_Plan_Details_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Business_Plan_Details_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Business_Plan_Details", IsNullable = false)]
		public Business_Plan_DetailsType[] Response_Data
		{
			get
			{
