...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Award_Personnel_Schedule_TypeObjectType : INotifyPropertyChanged
	{
		private Award_Personnel_Schedule_TypeObjectIDType[] idField;
		...
		public Award_Personnel_Schedule_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
