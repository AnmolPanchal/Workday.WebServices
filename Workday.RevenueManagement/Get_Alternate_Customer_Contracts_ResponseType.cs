...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Alternate_Customer_Contracts_ResponseType : INotifyPropertyChanged
	{
		private Customer_Contract_AlternateObjectType[] request_ReferencesField;

		private Alternate_Customer_Contract_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Alternate_Customer_ContractType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Alternate_Customer_Contract_Reference", IsNullable = false)]
		public Customer_Contract_AlternateObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Alternate_Customer_Contract_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Alternate_Customer_Contract", IsNullable = false)]
		public Alternate_Customer_ContractType[] Response_Data
		{
			get
			{
