...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Customer_Credit_Card_ProfileObjectType : INotifyPropertyChanged
	{
		private Customer_Credit_Card_ProfileObjectIDType[] idField;
		...
		public Customer_Credit_Card_ProfileObjectIDType[] ID
		{
			get
			{
				return this.idField;
