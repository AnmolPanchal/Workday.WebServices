...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Schedule_Distribution_MethodObjectType : INotifyPropertyChanged
	{
		private Schedule_Distribution_MethodObjectIDType[] idField;
		...
		public Schedule_Distribution_MethodObjectIDType[] ID
		{
			get
			{
				return this.idField;
