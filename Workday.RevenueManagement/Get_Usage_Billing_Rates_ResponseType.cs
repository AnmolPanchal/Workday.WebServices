...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Usage_Billing_Rates_ResponseType : INotifyPropertyChanged
	{
		private Usage_Billing_RateObjectType[] request_ReferencesField;

		private Usage_Billing_Rate_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Usage_Billing_Rate_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Usage_Billing_RateType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Usage_Billing_Rate_Reference", IsNullable = false)]
		public Usage_Billing_RateObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Usage_Billing_Rate_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Usage_Billing_Rate_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Usage_Billing_Rate", IsNullable = false)]
		public Usage_Billing_RateType[] Response_Data
		{
			get
			{
