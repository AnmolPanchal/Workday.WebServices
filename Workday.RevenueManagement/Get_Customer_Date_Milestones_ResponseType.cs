...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Customer_Date_Milestones_ResponseType : INotifyPropertyChanged
	{
		private Customer_Date_MilestoneObjectType[] request_ReferencesField;

		private Customer_Date_Milestone_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Customer_Date_Milestone_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Customer_Date_MilestoneType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Customer_Date_Milestone_Reference", IsNullable = false)]
		public Customer_Date_MilestoneObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Customer_Date_Milestone_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Customer_Date_Milestone_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Customer_Date_Milestone", IsNullable = false)]
		public Customer_Date_MilestoneType[] Response_Data
		{
			get
			{
