...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Customer_Invoice_TypeObjectType : INotifyPropertyChanged
	{
		private Customer_Invoice_TypeObjectIDType[] idField;
		...
		public Customer_Invoice_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
