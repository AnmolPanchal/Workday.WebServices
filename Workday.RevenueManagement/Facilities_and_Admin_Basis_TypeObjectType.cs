...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Facilities_and_Admin_Basis_TypeObjectType : INotifyPropertyChanged
	{
		private Facilities_and_Admin_Basis_TypeObjectIDType[] idField;
		...
		public Facilities_and_Admin_Basis_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
