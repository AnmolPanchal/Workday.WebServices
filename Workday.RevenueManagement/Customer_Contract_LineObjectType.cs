...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Customer_Contract_LineObjectType : INotifyPropertyChanged
	{
		private Customer_Contract_LineObjectIDType[] idField;
		...
		public Customer_Contract_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
