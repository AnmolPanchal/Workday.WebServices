...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Award_Posting_Interval_NameObjectType : INotifyPropertyChanged
	{
		private Award_Posting_Interval_NameObjectIDType[] idField;
		...
		public Award_Posting_Interval_NameObjectIDType[] ID
		{
			get
			{
				return this.idField;
