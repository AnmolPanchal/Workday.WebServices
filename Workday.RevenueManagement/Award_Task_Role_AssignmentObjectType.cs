...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Award_Task_Role_AssignmentObjectType : INotifyPropertyChanged
	{
		private Award_Task_Role_AssignmentObjectIDType[] idField;
		...
		public Award_Task_Role_AssignmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
