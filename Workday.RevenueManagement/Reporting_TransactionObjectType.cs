...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Reporting_TransactionObjectType : INotifyPropertyChanged
	{
		private Reporting_TransactionObjectIDType[] idField;
		...
		public Reporting_TransactionObjectIDType[] ID
		{
			get
			{
				return this.idField;
