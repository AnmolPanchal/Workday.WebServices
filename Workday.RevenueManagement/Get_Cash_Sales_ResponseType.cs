...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Cash_Sales_ResponseType : INotifyPropertyChanged
	{
		...
		private Cash_SaleType[] response_DataField;
		...
		[XmlArray(Order = 3), XmlArrayItem("Cash_Sale", IsNullable = false)]
		public Cash_SaleType[] Response_Data
		{
			get
			{
