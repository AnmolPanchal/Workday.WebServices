...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Percent_Complete_ProjectObjectType : INotifyPropertyChanged
	{
		private Percent_Complete_ProjectObjectIDType[] idField;
		...
		public Percent_Complete_ProjectObjectIDType[] ID
		{
			get
			{
				return this.idField;
