...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Customer_Invoice_DocumentObjectType : INotifyPropertyChanged
	{
		private Customer_Invoice_DocumentObjectIDType[] idField;
		...
		public Customer_Invoice_DocumentObjectIDType[] ID
		{
			get
			{
				return this.idField;
