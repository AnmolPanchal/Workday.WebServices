...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Sales_Item_Fair_Value_Price_TypeObjectType : INotifyPropertyChanged
	{
		private Sales_Item_Fair_Value_Price_TypeObjectIDType[] idField;
		...
		public Sales_Item_Fair_Value_Price_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
