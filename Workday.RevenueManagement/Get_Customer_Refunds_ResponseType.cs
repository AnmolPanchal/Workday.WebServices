...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Customer_Refunds_ResponseType : INotifyPropertyChanged
	{
		private Customer_RefundObjectType[] request_ReferencesField;

		private Customer_Refund_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Customer_Refund_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Customer_RefundType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Customer_Refund_Reference", IsNullable = false)]
		public Customer_RefundObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Customer_Refund_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Customer_Refund_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Customer_Refund", IsNullable = false)]
		public Customer_RefundType[] Response_Data
		{
			get
			{
