...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Project_Rate_CategoryObjectType : INotifyPropertyChanged
	{
		private Project_Rate_CategoryObjectIDType[] idField;
		...
		public Project_Rate_CategoryObjectIDType[] ID
		{
			get
			{
				return this.idField;
