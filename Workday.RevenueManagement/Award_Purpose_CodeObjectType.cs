...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Award_Purpose_CodeObjectType : INotifyPropertyChanged
	{
		private Award_Purpose_CodeObjectIDType[] idField;
		...
		public Award_Purpose_CodeObjectIDType[] ID
		{
			get
			{
				return this.idField;
