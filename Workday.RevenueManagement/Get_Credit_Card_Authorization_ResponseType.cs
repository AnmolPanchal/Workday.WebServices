...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Credit_Card_Authorization_ResponseType : INotifyPropertyChanged
	{
		private Unique_IdentifierObjectType[] request_ReferencesField;

		private Credit_Card_Authorization_CriteriaType[] request_CriteriaField;

		private Response_FilterType[] response_FilterField;

		private Response_ResultsType[] response_ResultsField;

		private Credit_Card_AuthorizationType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Credit_Card_Authorization_Request_Reference", typeof(Unique_IdentifierObjectType), IsNullable = false)]
		...
		public Credit_Card_Authorization_CriteriaType[] Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Credit_Card_Authorization", typeof(Credit_Card_AuthorizationType), IsNullable = false)]
		public Credit_Card_AuthorizationType[] Response_Data
		{
			get
			{
