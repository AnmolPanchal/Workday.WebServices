...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Facilities_and_Admin_ExceptionObjectType : INotifyPropertyChanged
	{
		private Facilities_and_Admin_ExceptionObjectIDType[] idField;
		...
		public Facilities_and_Admin_ExceptionObjectIDType[] ID
		{
			get
			{
				return this.idField;
