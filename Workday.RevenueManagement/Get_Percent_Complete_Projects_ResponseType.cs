...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Percent_Complete_Projects_ResponseType : INotifyPropertyChanged
	{
		private Percent_Complete_ProjectObjectType[] request_ReferencesField;

		private Unique_IdentifierObjectType[] request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Percent_Complete_ProjectType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Percent_Complete_Project_Reference", IsNullable = false)]
		public Percent_Complete_ProjectObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 1), XmlArrayItem("As_Of_Date_Reference", IsNullable = false)]
		public Unique_IdentifierObjectType[] Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Percent_Complete_Project", IsNullable = false)]
		public Percent_Complete_ProjectType[] Response_Data
		{
			get
			{
