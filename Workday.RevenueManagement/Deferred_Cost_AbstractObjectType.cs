...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Deferred_Cost_AbstractObjectType : INotifyPropertyChanged
	{
		private Deferred_Cost_AbstractObjectIDType[] idField;
		...
		public Deferred_Cost_AbstractObjectIDType[] ID
		{
			get
			{
				return this.idField;
