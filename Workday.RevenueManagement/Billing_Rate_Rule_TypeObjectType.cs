...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Billing_Rate_Rule_TypeObjectType : INotifyPropertyChanged
	{
		private Billing_Rate_Rule_TypeObjectIDType[] idField;
		...
		public Billing_Rate_Rule_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
