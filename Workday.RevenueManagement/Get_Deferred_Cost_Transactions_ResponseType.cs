...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Deferred_Cost_Transactions_ResponseType : INotifyPropertyChanged
	{
		private Deferred_Cost_AbstractObjectType[] request_ReferencesField;

		private Deferred_Cost_Transaction_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Deferred_Cost_Transaction_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Deferred_Cost_TransactionType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Deferred_Cost_Transaction_Reference", IsNullable = false)]
		public Deferred_Cost_AbstractObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Deferred_Cost_Transaction_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Deferred_Cost_Transaction_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Deferred_Cost_Transaction", IsNullable = false)]
		public Deferred_Cost_TransactionType[] Response_Data
		{
			get
			{
