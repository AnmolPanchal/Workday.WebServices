...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Percent_Complete_MethodObjectType : INotifyPropertyChanged
	{
		private Percent_Complete_MethodObjectIDType[] idField;
		...
		public Percent_Complete_MethodObjectIDType[] ID
		{
			get
			{
				return this.idField;
