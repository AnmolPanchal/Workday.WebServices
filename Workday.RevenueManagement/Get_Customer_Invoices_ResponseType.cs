...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Customer_Invoices_ResponseType : INotifyPropertyChanged
	{
		private Customer_Invoice_DocumentObjectType[] request_ReferencesField;

		private Customer_Invoice_Request_CriteriaType[] request_CriteriaField;

		private Response_FilterType[] response_FilterField;

		private Customer_Invoice_Response_GroupType[] response_GroupField;

		private Response_ResultsType[] response_ResultsField;

		private Customer_InvoiceType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Customer_Invoice_Reference", typeof(Customer_Invoice_DocumentObjectType), IsNullable = false)]
		public Customer_Invoice_DocumentObjectType[] Request_References
		{
			get
			{
		...
		public Customer_Invoice_Request_CriteriaType[] Request_Criteria
		{
			get
			{
		...
		public Customer_Invoice_Response_GroupType[] Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Customer_Invoice", typeof(Customer_InvoiceType), IsNullable = false)]
