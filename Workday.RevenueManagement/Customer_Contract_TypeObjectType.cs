...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Customer_Contract_TypeObjectType : INotifyPropertyChanged
	{
		private Customer_Contract_TypeObjectIDType[] idField;
		...
		public Customer_Contract_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
