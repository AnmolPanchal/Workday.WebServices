...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Revenue_Recognition_ScheduleObjectType : INotifyPropertyChanged
	{
		private Revenue_Recognition_ScheduleObjectIDType[] idField;
		...
		public Revenue_Recognition_ScheduleObjectIDType[] ID
		{
			get
			{
				return this.idField;
