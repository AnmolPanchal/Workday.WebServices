...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Sponsor_Award_TypeObjectType : INotifyPropertyChanged
	{
		private Sponsor_Award_TypeObjectIDType[] idField;
		...
		public Sponsor_Award_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
