...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Contact_Types_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Contact_Type_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Contact_Type_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
