...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Award_Contract_LineObjectType : INotifyPropertyChanged
	{
		private Award_Contract_LineObjectIDType[] idField;
		...
		public Award_Contract_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
