...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Award_Proposal_Personnel_LineObjectType : INotifyPropertyChanged
	{
		private Award_Proposal_Personnel_LineObjectIDType[] idField;
		...
		public Award_Proposal_Personnel_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
