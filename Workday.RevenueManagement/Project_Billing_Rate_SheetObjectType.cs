...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Project_Billing_Rate_SheetObjectType : INotifyPropertyChanged
	{
		private Project_Billing_Rate_SheetObjectIDType[] idField;
		...
		public Project_Billing_Rate_SheetObjectIDType[] ID
		{
			get
			{
				return this.idField;
