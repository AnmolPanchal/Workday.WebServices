...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Contract_Rate_Sheets_ResponseType : INotifyPropertyChanged
	{
		private Contract_Rate_SheetObjectType[] request_ReferencesField;

		private Contract_Rate_Sheet_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Contract_Rate_Sheet_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Contract_Rate_SheetType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Contract_Rate_Sheet_Reference", IsNullable = false)]
		public Contract_Rate_SheetObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Contract_Rate_Sheet_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Contract_Rate_Sheet_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Contract_Rate_Sheet", IsNullable = false)]
		public Contract_Rate_SheetType[] Response_Data
		{
			get
			{
