...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Ad_Hoc_Billable_TransactionObjectType : INotifyPropertyChanged
	{
		private Ad_Hoc_Billable_TransactionObjectIDType[] idField;
		...
		public Ad_Hoc_Billable_TransactionObjectIDType[] ID
		{
			get
			{
				return this.idField;
