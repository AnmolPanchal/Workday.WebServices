...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Salary_Over_The_Cap_Types_ResponseType : INotifyPropertyChanged
	{
		private Salary_Over_The_Cap_TypeObjectType[] request_ReferencesField;

		private Salary_Over_The_Cap_Type_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Salary_Over_The_Cap_Type_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Salary_Over_The_Cap_TypeType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Salary_Over_The_Cap_Type_Request_Reference", IsNullable = false)]
		public Salary_Over_The_Cap_TypeObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Salary_Over_The_Cap_Type_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Salary_Over_The_Cap_Type_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Salary_Over_The_Cap_Type", IsNullable = false)]
		public Salary_Over_The_Cap_TypeType[] Response_Data
		{
			get
			{
