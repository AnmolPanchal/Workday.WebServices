...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Award_Task_Type_GroupObjectType : INotifyPropertyChanged
	{
		private Award_Task_Type_GroupObjectIDType[] idField;
		...
		public Award_Task_Type_GroupObjectIDType[] ID
		{
			get
			{
				return this.idField;
