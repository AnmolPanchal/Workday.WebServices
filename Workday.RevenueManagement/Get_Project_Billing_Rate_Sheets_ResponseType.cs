...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Project_Billing_Rate_Sheets_ResponseType : INotifyPropertyChanged
	{
		private Project_Billing_Rate_SheetObjectType[] request_ReferencesField;

		private Project_Billing_Rate_Sheet_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Project_Billing_Rate_Sheet_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Project_Billing_Rate_SheetType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Project_Billing_Rate_Sheet_Reference", IsNullable = false)]
		public Project_Billing_Rate_SheetObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Project_Billing_Rate_Sheet_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Project_Billing_Rate_Sheet_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Project_Billing_Rate_Sheet", IsNullable = false)]
		public Project_Billing_Rate_SheetType[] Response_Data
		{
			get
			{
