...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Award_Lifecycle_StatusObjectType : INotifyPropertyChanged
	{
		private Award_Lifecycle_StatusObjectIDType[] idField;
		...
		public Award_Lifecycle_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
