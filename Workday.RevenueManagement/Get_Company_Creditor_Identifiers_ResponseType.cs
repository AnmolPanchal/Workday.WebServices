...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Company_Creditor_Identifiers_ResponseType : INotifyPropertyChanged
	{
		private Creditor_IdentifierObjectType[] request_ReferencesField;

		private CompanyObjectType[] request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Company_Creditor_Identifier_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Company_Creditor_IdentifierType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Company_Creditor_Identifier_Reference", IsNullable = false)]
		public Creditor_IdentifierObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 1), XmlArrayItem("Company_Reference", typeof(CompanyObjectType), IsNullable = false)]
		public CompanyObjectType[] Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Company_Creditor_Identifier_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Company_Creditor_Identifier", IsNullable = false)]
		public Company_Creditor_IdentifierType[] Response_Data
		{
			get
			{
