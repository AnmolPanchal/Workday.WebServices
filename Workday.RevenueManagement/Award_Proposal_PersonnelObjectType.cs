...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Award_Proposal_PersonnelObjectType : INotifyPropertyChanged
	{
		private Award_Proposal_PersonnelObjectIDType[] idField;
		...
		public Award_Proposal_PersonnelObjectIDType[] ID
		{
			get
			{
				return this.idField;
