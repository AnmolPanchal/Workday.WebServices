...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Company_as_Business_EntityObjectType : INotifyPropertyChanged
	{
		private Company_as_Business_EntityObjectIDType[] idField;
		...
		public Company_as_Business_EntityObjectIDType[] ID
		{
			get
			{
				return this.idField;
