...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Customer_Invoice_Line_WWS_DataType : INotifyPropertyChanged
	{
		...
		private ScheduleObjectType[] revenue_Recognition_Schedule_ReferenceField;
		...
		[XmlElement("Revenue_Recognition_Schedule_Reference", Order = 27)]
		public ScheduleObjectType[] Revenue_Recognition_Schedule_Reference
		{
			get
			{
		...
		[XmlElement("Worktags_Reference", Order = 31)]
