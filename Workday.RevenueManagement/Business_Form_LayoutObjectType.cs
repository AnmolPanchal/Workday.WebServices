...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Business_Form_LayoutObjectType : INotifyPropertyChanged
	{
		private Business_Form_LayoutObjectIDType[] idField;
		...
		public Business_Form_LayoutObjectIDType[] ID
		{
			get
			{
				return this.idField;
