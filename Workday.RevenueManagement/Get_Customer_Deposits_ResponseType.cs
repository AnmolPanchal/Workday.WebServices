...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Customer_Deposits_ResponseType : INotifyPropertyChanged
	{
		private Customer_DepositObjectType[] request_ReferencesField;

		private Customer_Deposit_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Customer_Deposit_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Customer_DepositType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Customer_Deposit_Reference", IsNullable = false)]
		public Customer_DepositObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Customer_Deposit_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Customer_Deposit_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Customer_Deposit", IsNullable = false)]
		public Customer_DepositType[] Response_Data
		{
			get
			{
