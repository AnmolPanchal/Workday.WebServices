...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Billing_Rate_Break_TypeObjectType : INotifyPropertyChanged
	{
		private Billing_Rate_Break_TypeObjectIDType[] idField;
		...
		public Billing_Rate_Break_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
