...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Billing_Rate_Adjustment_TypeObjectType : INotifyPropertyChanged
	{
		private Billing_Rate_Adjustment_TypeObjectIDType[] idField;
		...
		public Billing_Rate_Adjustment_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
