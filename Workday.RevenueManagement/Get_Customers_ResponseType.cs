...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Customers_ResponseType : INotifyPropertyChanged
	{
		private CustomerObjectType[] request_ReferencesField;

		private Customer_Request_CriteriaType[] request_CriteriaField;

		private Response_FilterType[] response_FilterField;

		private Customer_Response_GroupType[] response_GroupField;

		private Response_ResultsType[] response_ResultsField;

		private CustomerType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Customer_Reference", typeof(CustomerObjectType), IsNullable = false)]
		public CustomerObjectType[] Request_References
		{
			get
			{
		...
		public Customer_Request_CriteriaType[] Request_Criteria
		{
			get
			{
		...
		public Customer_Response_GroupType[] Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Customer", typeof(CustomerType), IsNullable = false)]
		public CustomerType[] Response_Data
		{
			get
			{
