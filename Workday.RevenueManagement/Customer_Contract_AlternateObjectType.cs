...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Customer_Contract_AlternateObjectType : INotifyPropertyChanged
	{
		private Customer_Contract_AlternateObjectIDType[] idField;
		...
		public Customer_Contract_AlternateObjectIDType[] ID
		{
			get
			{
				return this.idField;
