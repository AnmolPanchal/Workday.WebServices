...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Award_Personnel_LineObjectType : INotifyPropertyChanged
	{
		private Award_Personnel_LineObjectIDType[] idField;
		...
		public Award_Personnel_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
