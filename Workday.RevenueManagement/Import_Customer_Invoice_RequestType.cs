...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Import_Customer_Invoice_RequestType : INotifyPropertyChanged
	{
		...
		private Customer_Invoice__HV__DataType customer_Invoice_DataField;
		...
		[XmlElement(Order = 2)]
		public Customer_Invoice__HV__DataType Customer_Invoice_Data
		{
			get
			{
