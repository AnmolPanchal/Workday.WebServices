...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Salary_Caps_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Payroll_Limit_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Payroll_Limit_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
