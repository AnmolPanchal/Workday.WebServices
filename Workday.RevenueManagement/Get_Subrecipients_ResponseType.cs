...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Subrecipients_ResponseType : INotifyPropertyChanged
	{
		private Subrecipient_AbstractObjectType[] request_ReferencesField;

		private Subrecipient_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Subrecipient_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private SubrecipientType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Subrecipient_Reference", IsNullable = false)]
		public Subrecipient_AbstractObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Subrecipient_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Subrecipient_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Subrecipient", IsNullable = false)]
		public SubrecipientType[] Response_Data
		{
			get
			{
