...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Award_Amendment_ReasonsObjectType : INotifyPropertyChanged
	{
		private Award_Amendment_ReasonsObjectIDType[] idField;
		...
		public Award_Amendment_ReasonsObjectIDType[] ID
		{
			get
			{
				return this.idField;
