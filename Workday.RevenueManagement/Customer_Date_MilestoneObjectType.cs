...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Customer_Date_MilestoneObjectType : INotifyPropertyChanged
	{
		private Customer_Date_MilestoneObjectIDType[] idField;
		...
		public Customer_Date_MilestoneObjectIDType[] ID
		{
			get
			{
				return this.idField;
