...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Usage_Based_Transactions_ResponseType : INotifyPropertyChanged
	{
		private Usage_Based_TransactionObjectType[] request_ReferencesField;

		private Usage_Based_Transaction_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Usage_Based_Transaction_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Usage_Based_TransactionType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Usage_Based_Transaction_Reference", IsNullable = false)]
		public Usage_Based_TransactionObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Usage_Based_Transaction_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Usage_Based_Transaction_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Usage_Based_Transaction", IsNullable = false)]
		public Usage_Based_TransactionType[] Response_Data
		{
			get
			{
