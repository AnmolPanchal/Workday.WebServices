...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Award_Attachment_CategoryObjectType : INotifyPropertyChanged
	{
		private Award_Attachment_CategoryObjectIDType[] idField;
		...
		public Award_Attachment_CategoryObjectIDType[] ID
		{
			get
			{
				return this.idField;
