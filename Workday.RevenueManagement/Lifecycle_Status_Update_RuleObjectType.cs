...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Lifecycle_Status_Update_RuleObjectType : INotifyPropertyChanged
	{
		private Lifecycle_Status_Update_RuleObjectIDType[] idField;
		...
		public Lifecycle_Status_Update_RuleObjectIDType[] ID
		{
			get
			{
				return this.idField;
