...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Award_Task_List_TemplateObjectType : INotifyPropertyChanged
	{
		private Award_Task_List_TemplateObjectIDType[] idField;
		...
		public Award_Task_List_TemplateObjectIDType[] ID
		{
			get
			{
				return this.idField;
