...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Revenue_Recognition_Schedules_ResponseType : INotifyPropertyChanged
	{
		private Revenue_Recognition_ScheduleObjectType[] request_ReferencesField;

		private Customer_Contract_LineObjectType[] request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Revenue_Recognition_Schedule_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Revenue_Recognition_ScheduleType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Revenue_Recognition_Schedule_Reference", IsNullable = false)]
		public Revenue_Recognition_ScheduleObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 1), XmlArrayItem("Customer_Contract_Line_Reference", IsNullable = false)]
		public Customer_Contract_LineObjectType[] Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Revenue_Recognition_Schedule_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Revenue_Recognition_Schedule", IsNullable = false)]
		public Revenue_Recognition_ScheduleType[] Response_Data
		{
			get
			{
