...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Put_Sales_Item_RequestType : INotifyPropertyChanged
	{
		private Sales_ItemObjectType sales_Item_ReferenceField;

		private Sales_Item_DataType sales_Item_DataField;
		...
		[XmlElement(Order = 1)]
		public Sales_Item_DataType Sales_Item_Data
		{
			get
			{
