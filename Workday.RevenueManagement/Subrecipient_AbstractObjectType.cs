...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Subrecipient_AbstractObjectType : INotifyPropertyChanged
	{
		private Subrecipient_AbstractObjectIDType[] idField;
		...
		public Subrecipient_AbstractObjectIDType[] ID
		{
			get
			{
				return this.idField;
