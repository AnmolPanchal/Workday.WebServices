...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Subawards_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Subaward_Request_CriteriaType), Order = 0), XmlElement("Request_Reference", typeof(Subaward_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
