...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Prospects_ResponseType : INotifyPropertyChanged
	{
		private ProspectObjectType[] request_ReferencesField;

		private Prospect_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Prospect_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private ProspectType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Prospect_Reference", IsNullable = false)]
		public ProspectObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Prospect_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Prospect_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Prospect", IsNullable = false)]
		public ProspectType[] Response_Data
		{
			get
			{
