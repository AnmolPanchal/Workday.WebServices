...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Award_Lifecycle_Status_Update_Rules_ResponseType : INotifyPropertyChanged
	{
		private Lifecycle_Status_Update_RuleObjectType[] request_ReferencesField;

		private Lifecycle_Status_Update_Rule_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Lifecycle_Status_Update_Rule_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Lifecycle_Status_Update_RuleType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Lifecycle_Status_Update_Rule_Reference", IsNullable = false)]
		public Lifecycle_Status_Update_RuleObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Lifecycle_Status_Update_Rule_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Lifecycle_Status_Update_Rule_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Lifecycle_Status_Update_Rule", IsNullable = false)]
		public Lifecycle_Status_Update_RuleType[] Response_Data
		{
			get
			{
