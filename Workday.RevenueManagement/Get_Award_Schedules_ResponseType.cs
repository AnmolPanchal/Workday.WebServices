...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Award_Schedules_ResponseType : INotifyPropertyChanged
	{
		private Award_ScheduleObjectType[] request_ReferencesField;

		private Award_Schedule_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Award_Schedule_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Award_ScheduleType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Award_Schedule_Reference", IsNullable = false)]
		public Award_ScheduleObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Award_Schedule_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Award_Schedule_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Award_Schedule", IsNullable = false)]
		public Award_ScheduleType[] Response_Data
		{
			get
			{
