...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Award_Posting_Interval_GroupObjectType : INotifyPropertyChanged
	{
		private Award_Posting_Interval_GroupObjectIDType[] idField;
		...
		public Award_Posting_Interval_GroupObjectIDType[] ID
		{
			get
			{
				return this.idField;
