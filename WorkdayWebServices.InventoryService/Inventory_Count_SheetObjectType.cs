...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Inventory_Count_SheetObjectType : INotifyPropertyChanged
	{
		private Inventory_Count_SheetObjectIDType[] idField;
		...
		public Inventory_Count_SheetObjectIDType[] ID
		{
			get
			{
				return this.idField;
