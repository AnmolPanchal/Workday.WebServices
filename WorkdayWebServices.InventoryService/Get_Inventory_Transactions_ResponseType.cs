...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Get_Inventory_Transactions_ResponseType : INotifyPropertyChanged
	{
		private Unique_IdentifierObjectType[] request_ReferencesField;

		private Inventory_Transaction_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Inventory_Transaction_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Inventory_TransactionType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Inventory_Transaction_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Inventory_Transaction_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Inventory_Transaction_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Inventory_Transaction", IsNullable = false)]
		public Inventory_TransactionType[] Response_Data
		{
			get
			{
