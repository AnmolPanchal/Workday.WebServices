...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Inventory_Adjustment_ReasonObjectType : INotifyPropertyChanged
	{
		private Inventory_Adjustment_ReasonObjectIDType[] idField;
		...
		public Inventory_Adjustment_ReasonObjectIDType[] ID
		{
			get
			{
				return this.idField;
