...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Inventory_Location_Usage_TypeObjectType : INotifyPropertyChanged
	{
		private Inventory_Location_Usage_TypeObjectIDType[] idField;
		...
		public Inventory_Location_Usage_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
