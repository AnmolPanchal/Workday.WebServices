...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Submit_Inventory_Stock_RequestType : INotifyPropertyChanged
	{
		...
		private Inventory_Stock_Request_DataType inventory_Stock_Request_DataField;
		...
		[XmlElement(Order = 2)]
		public Inventory_Stock_Request_DataType Inventory_Stock_Request_Data
		{
			get
			{
