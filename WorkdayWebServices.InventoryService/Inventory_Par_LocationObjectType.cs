...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Inventory_Par_LocationObjectType : INotifyPropertyChanged
	{
		private Inventory_Par_LocationObjectIDType[] idField;
		...
		public Inventory_Par_LocationObjectIDType[] ID
		{
			get
			{
				return this.idField;
