...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Inventory_Stock_Request_TypeObjectType : INotifyPropertyChanged
	{
		private Inventory_Stock_Request_TypeObjectIDType[] idField;
		...
		public Inventory_Stock_Request_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
