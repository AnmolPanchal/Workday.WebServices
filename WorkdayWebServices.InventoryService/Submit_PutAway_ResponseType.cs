...
{
	[GeneratedCode("System.Xml", "4.6.1590.0"), DesignerCategory("code"), DebuggerStepThrough, XmlType(TypeName = "Submit_Put-Away_ResponseType", Namespace = "urn:com.workday/bsvc")]
	[Serializable]
	public class Submit_PutAway_ResponseType : INotifyPropertyChanged
	{
