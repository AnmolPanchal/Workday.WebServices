...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Submit_Inventory_Adjustment_RequestType : INotifyPropertyChanged
	{
		private Financials_Business_Process_ParametersType business_Process_ParametersField;

		private Inventory_Adjustment_DataType inventory_Adjustment_DataField;
		...
		[XmlElement(Order = 1)]
		public Inventory_Adjustment_DataType Inventory_Adjustment_Data
		{
			get
			{
				return this.inventory_Adjustment_DataField;
			}
			set
			{
				this.inventory_Adjustment_DataField = value;
				this.RaisePropertyChanged("Inventory_Adjustment_Data");
			}
		}
