...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Get_Inventory_Stock_Requests_ResponseType : INotifyPropertyChanged
	{
		private Inventory_Stock_RequestObjectType[] request_ReferencesField;

		private Inventory_Stock_Request_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Inventory_Stock_Request_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Inventory_Stock_RequestType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Inventory_Stock_Request_Reference", IsNullable = false)]
		public Inventory_Stock_RequestObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Inventory_Stock_Request_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Inventory_Stock_Request_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Inventory_Stock_Request", IsNullable = false)]
		public Inventory_Stock_RequestType[] Response_Data
		{
			get
			{
