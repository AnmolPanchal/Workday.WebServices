...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Inventory_Stock_Request_LineObjectType : INotifyPropertyChanged
	{
		private Inventory_Stock_Request_LineObjectIDType[] idField;
		...
		public Inventory_Stock_Request_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
