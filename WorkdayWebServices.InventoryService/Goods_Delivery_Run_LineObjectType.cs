...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Goods_Delivery_Run_LineObjectType : INotifyPropertyChanged
	{
		private Goods_Delivery_Run_LineObjectIDType[] idField;
		...
		public Goods_Delivery_Run_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
