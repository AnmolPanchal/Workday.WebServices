...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Get_Goods_Delivery_Rules_ResponseType : INotifyPropertyChanged
	{
		private Goods_Delivery_RuleObjectType[] request_ReferenceField;

		private Goods_Delivery_Rules_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Goods_Delivery_Rules_Response_GroupType response_GroupField;

		private Response_ResultsType[] response_ResultsField;

		private Goods_Delivery_RuleType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Goods_Delivery_Rules_Request_Reference", IsNullable = false)]
		public Goods_Delivery_RuleObjectType[] Request_Reference
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Goods_Delivery_Rules_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Goods_Delivery_Rules_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Goods_Delivery_Rules", typeof(Goods_Delivery_RuleType), IsNullable = false)]
		public Goods_Delivery_RuleType[] Response_Data
		{
			get
			{
