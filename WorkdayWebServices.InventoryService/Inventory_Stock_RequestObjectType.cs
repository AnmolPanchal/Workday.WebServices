...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Inventory_Stock_RequestObjectType : INotifyPropertyChanged
	{
		private Inventory_Stock_RequestObjectIDType[] idField;
		...
		public Inventory_Stock_RequestObjectIDType[] ID
		{
			get
			{
				return this.idField;
