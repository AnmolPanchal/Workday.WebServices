...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Goods_Delivery_LineObjectType : INotifyPropertyChanged
	{
		private Goods_Delivery_LineObjectIDType[] idField;
		...
		public Goods_Delivery_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
