...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Get_Inventory_Location_Attributes_ResponseType : INotifyPropertyChanged
	{
		private Inventory_Location_Attributes_Request_ReferencesType request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Inventory_Location_Attributes_WWS_DataType[] response_DataField;
		...
		[XmlElement(Order = 0)]
		public Inventory_Location_Attributes_Request_ReferencesType Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Inventory_Location_Attributes_Detail", IsNullable = false)]
		public Inventory_Location_Attributes_WWS_DataType[] Response_Data
		{
			get
			{
