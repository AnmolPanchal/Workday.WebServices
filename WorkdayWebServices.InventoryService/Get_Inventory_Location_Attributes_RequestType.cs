...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Get_Inventory_Location_Attributes_RequestType : INotifyPropertyChanged
	{
		private Inventory_Location_Attributes_Request_ReferencesType itemField;
		...
		public Inventory_Location_Attributes_Request_ReferencesType Item
		{
			get
			{
