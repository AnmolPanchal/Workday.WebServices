...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Inventory_Pick_List_LineObjectType : INotifyPropertyChanged
	{
		private Inventory_Pick_List_LineObjectIDType[] idField;
		...
		public Inventory_Pick_List_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
