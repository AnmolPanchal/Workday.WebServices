...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Get_Inventory_Par_Locations_ResponseType : INotifyPropertyChanged
	{
		private LocationObjectType[] request_ReferencesField;

		private Inventory_Par_Location_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Inventory_Par_Location_Response_GroupType response_GroupField;

		private Inventory_Par_LocationType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Inventory_Par_Location_Reference", IsNullable = false)]
		public LocationObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Inventory_Par_Location_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 4)]
		public Inventory_Par_Location_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Inventory_Par_Location", IsNullable = false)]
		public Inventory_Par_LocationType[] Response_Data
		{
			get
			{
