...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Inventory_Ship_ListObjectType : INotifyPropertyChanged
	{
		private Inventory_Ship_ListObjectIDType[] idField;
		...
		public Inventory_Ship_ListObjectIDType[] ID
		{
			get
			{
				return this.idField;
