...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Get_Inventory_Picking_Lists_ResponseType : INotifyPropertyChanged
	{
		private Inventory_Pick_ListObjectType[] request_ReferencesField;

		private Inventory_Picking_List_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Inventory_Picking_List_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Inventory_Picking_ListType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Inventory_Picking_List_Reference", IsNullable = false)]
		public Inventory_Pick_ListObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Inventory_Picking_List_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Inventory_Picking_List_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Inventory_Picking_List", IsNullable = false)]
		public Inventory_Picking_ListType[] Response_Data
		{
			get
			{
