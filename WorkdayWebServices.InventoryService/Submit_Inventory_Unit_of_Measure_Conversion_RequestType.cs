...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Submit_Inventory_Unit_of_Measure_Conversion_RequestType : INotifyPropertyChanged
	{
		private Financials_Business_Process_ParametersType business_Process_ParametersField;

		private Inventory_Move_DataType inventory_Move_DataField;
		...
		[XmlElement(Order = 1)]
		public Inventory_Move_DataType Inventory_Move_Data
		{
			get
			{
				return this.inventory_Move_DataField;
			}
			set
			{
				this.inventory_Move_DataField = value;
				this.RaisePropertyChanged("Inventory_Move_Data");
			}
		}
