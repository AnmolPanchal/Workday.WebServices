...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Supplier_Invoice_AdjustmentObjectType : INotifyPropertyChanged
	{
		private Supplier_Invoice_AdjustmentObjectIDType[] idField;
		...
		public Supplier_Invoice_AdjustmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
