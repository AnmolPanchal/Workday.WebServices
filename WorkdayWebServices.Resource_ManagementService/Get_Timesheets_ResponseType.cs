...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Timesheets_ResponseType : INotifyPropertyChanged
	{
		private TimesheetObjectType[] request_ReferencesField;

		private Timesheet_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Timesheet_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private TimesheetType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Timesheet_Reference", IsNullable = false)]
		public TimesheetObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Timesheet_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Timesheet_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Timesheet", IsNullable = false)]
		public TimesheetType[] Response_Data
		{
			get
			{
