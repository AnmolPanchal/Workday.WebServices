...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Request_for_Quote_ResponseObjectType : INotifyPropertyChanged
	{
		private Request_for_Quote_ResponseObjectIDType[] idField;
		...
		public Request_for_Quote_ResponseObjectIDType[] ID
		{
			get
			{
				return this.idField;
