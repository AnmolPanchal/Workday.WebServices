...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Return_to_Supplier_ReasonObjectType : INotifyPropertyChanged
	{
		private Return_to_Supplier_ReasonObjectIDType[] idField;
		...
		public Return_to_Supplier_ReasonObjectIDType[] ID
		{
			get
			{
				return this.idField;
