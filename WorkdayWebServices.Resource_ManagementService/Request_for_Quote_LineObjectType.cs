...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Request_for_Quote_LineObjectType : INotifyPropertyChanged
	{
		private Request_for_Quote_LineObjectIDType[] idField;
		...
		public Request_for_Quote_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
