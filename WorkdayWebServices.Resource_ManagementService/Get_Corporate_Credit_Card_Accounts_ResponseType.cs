...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Corporate_Credit_Card_Accounts_ResponseType : INotifyPropertyChanged
	{
		private Corporate_Credit_Card_AccountObjectType[] request_ReferencesField;

		private Corporate_Credit_Card_Account_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Corporate_Credit_Card_Account_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Corporate_Credit_Card_AccountType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Corporate_Credit_Card_Account_Reference", IsNullable = false)]
		public Corporate_Credit_Card_AccountObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Corporate_Credit_Card_Account_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Corporate_Credit_Card_Account_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Corporate_Credit_Card_Account", IsNullable = false)]
		public Corporate_Credit_Card_AccountType[] Response_Data
		{
			get
			{
