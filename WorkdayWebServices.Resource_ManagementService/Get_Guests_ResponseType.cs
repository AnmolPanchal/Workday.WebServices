...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Guests_ResponseType : INotifyPropertyChanged
	{
		private Unique_IdentifierObjectType[] request_ReferencesField;

		private Guest_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Guest_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Guest_WWSType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Guest_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Guest_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Guest_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Guest", IsNullable = false)]
		public Guest_WWSType[] Response_Data
		{
			get
			{
