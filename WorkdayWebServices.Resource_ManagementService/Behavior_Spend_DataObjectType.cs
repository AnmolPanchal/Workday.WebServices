...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Behavior_Spend_DataObjectType : INotifyPropertyChanged
	{
		private Behavior_Spend_DataObjectIDType[] idField;
		...
		public Behavior_Spend_DataObjectIDType[] ID
		{
			get
			{
				return this.idField;
