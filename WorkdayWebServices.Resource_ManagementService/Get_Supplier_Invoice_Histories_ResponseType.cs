...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Supplier_Invoice_Histories_ResponseType : INotifyPropertyChanged
	{
		private Supplier_Invoice_HistoryObjectType[] request_ReferencesField;

		private Supplier_Invoice_History_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Supplier_Invoice_History_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Supplier_Invoice_HistoryType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Supplier_Invoice_History_Reference", IsNullable = false)]
		public Supplier_Invoice_HistoryObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Supplier_Invoice_History_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Supplier_Invoice_History_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Supplier_Invoice_History", IsNullable = false)]
		public Supplier_Invoice_HistoryType[] Response_Data
		{
			get
			{
