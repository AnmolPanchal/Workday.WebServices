...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Supplier_Invoice_RequestObjectType : INotifyPropertyChanged
	{
		private Supplier_Invoice_RequestObjectIDType[] idField;
		...
		public Supplier_Invoice_RequestObjectIDType[] ID
		{
			get
			{
				return this.idField;
