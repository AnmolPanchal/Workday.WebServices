...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Project_Scenario_GroupObjectType : INotifyPropertyChanged
	{
		private Project_Scenario_GroupObjectIDType[] idField;
		...
		public Project_Scenario_GroupObjectIDType[] ID
		{
			get
			{
				return this.idField;
