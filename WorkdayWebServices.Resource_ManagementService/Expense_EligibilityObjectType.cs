...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Expense_EligibilityObjectType : INotifyPropertyChanged
	{
		private Expense_EligibilityObjectIDType[] idField;
		...
		public Expense_EligibilityObjectIDType[] ID
		{
			get
			{
				return this.idField;
