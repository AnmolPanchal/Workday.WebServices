...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Airports_ResponseType : INotifyPropertyChanged
	{
		private AirportObjectType[] request_ReferencesField;

		private Airport_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Airport_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private AirportType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Airport_Reference", IsNullable = false)]
		public AirportObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Airport_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Airport_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Airport", IsNullable = false)]
		public AirportType[] Response_Data
		{
			get
			{
