...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Workday_Project_Hierarchies_without_Dependencies_ResponseType : INotifyPropertyChanged
	{
		private Project_HierarchyObjectType[] request_ReferencesField;

		private Project_Hierarchy_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Project_Hierarchy_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Projects_HierarchyType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Project_Hierarchy_Reference", IsNullable = false)]
		public Project_HierarchyObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Project_Hierarchy_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Project_Hierarchy_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Project_Hierarchy", IsNullable = false)]
		public Projects_HierarchyType[] Response_Data
		{
			get
			{
