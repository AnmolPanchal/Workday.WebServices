...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Submit_Supplier_Contact_Information_RequestType : INotifyPropertyChanged
	{
		...
		private Contact_Information_Wrapper_DataType supplier_Contact_Information_DataField;
		...
		[XmlElement(Order = 2)]
		public Contact_Information_Wrapper_DataType Supplier_Contact_Information_Data
		{
			get
			{
				return this.supplier_Contact_Information_DataField;
			}
			set
			{
				this.supplier_Contact_Information_DataField = value;
				this.RaisePropertyChanged("Supplier_Contact_Information_Data");
			}
		}
