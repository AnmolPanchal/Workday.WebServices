...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Project_Tasks_ResponseType : INotifyPropertyChanged
	{
		private Project_TaskObjectType[] request_ReferencesField;

		private Project_Task_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Project_Task_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Project_TaskType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Project_Task_Reference", IsNullable = false)]
		public Project_TaskObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Project_Task_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Project_Task_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Project_Task", IsNullable = false)]
		public Project_TaskType[] Response_Data
		{
			get
			{
