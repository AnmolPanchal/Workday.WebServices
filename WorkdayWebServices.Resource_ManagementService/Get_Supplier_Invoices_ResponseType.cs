...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Supplier_Invoices_ResponseType : INotifyPropertyChanged
	{
		private Supplier_InvoiceObjectType[] request_ReferencesField;

		private Supplier_Invoice_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Supplier_Invoice_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Supplier_InvoiceType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Supplier_Invoice_Reference", IsNullable = false)]
		public Supplier_InvoiceObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Supplier_Invoice_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Supplier_Invoice_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Supplier_Invoice", IsNullable = false)]
		public Supplier_InvoiceType[] Response_Data
		{
			get
			{
