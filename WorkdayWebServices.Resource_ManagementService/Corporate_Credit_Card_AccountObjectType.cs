...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Corporate_Credit_Card_AccountObjectType : INotifyPropertyChanged
	{
		private Corporate_Credit_Card_AccountObjectIDType[] idField;
		...
		public Corporate_Credit_Card_AccountObjectIDType[] ID
		{
			get
			{
				return this.idField;
