...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Procurement_Award_ReasonObjectType : INotifyPropertyChanged
	{
		private Procurement_Award_ReasonObjectIDType[] idField;
		...
		public Procurement_Award_ReasonObjectIDType[] ID
		{
			get
			{
				return this.idField;
