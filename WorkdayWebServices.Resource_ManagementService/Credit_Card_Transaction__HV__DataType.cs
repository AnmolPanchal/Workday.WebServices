...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Credit_Card_Transaction__HV__DataType : INotifyPropertyChanged
	{
		...
		private bool billing_DateFieldSpecified;
		...
		[XmlIgnore]
		public bool Billing_DateSpecified
		{
			get
			{
				return this.billing_DateFieldSpecified;
			}
			set
			{
				this.billing_DateFieldSpecified = value;
				this.RaisePropertyChanged("Billing_DateSpecified");
			}
		}
