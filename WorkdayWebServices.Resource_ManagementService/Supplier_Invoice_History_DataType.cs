...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Supplier_Invoice_History_DataType : INotifyPropertyChanged
	{
		private string supplier_Invoice_History_IDField;
		...
		[XmlElement(Order = 0)]
		public string Supplier_Invoice_History_ID
		{
			get
			{
				return this.supplier_Invoice_History_IDField;
			}
			set
			{
				this.supplier_Invoice_History_IDField = value;
				this.RaisePropertyChanged("Supplier_Invoice_History_ID");
			}
		}
