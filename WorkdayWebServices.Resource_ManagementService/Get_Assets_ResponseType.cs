...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Assets_ResponseType : INotifyPropertyChanged
	{
		private Business_AssetObjectType[] request_ReferencesField;

		private Asset_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Asset_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private AssetType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Asset_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Asset_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Asset_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Asset", IsNullable = false)]
		public AssetType[] Response_Data
		{
			get
			{
