...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Receipts_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Receipt_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Receipt_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
