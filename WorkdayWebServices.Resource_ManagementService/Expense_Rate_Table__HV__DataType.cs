...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Expense_Rate_Table__HV__DataType : INotifyPropertyChanged
	{
		...
		private Expense_Rate_Table_Line__HV__DataType[] expense_Rate_Table_Line_Replacement_DataField;
		...
		public Expense_Rate_Table_Line__HV__DataType[] Expense_Rate_Table_Line_Replacement_Data
		{
			get
			{
