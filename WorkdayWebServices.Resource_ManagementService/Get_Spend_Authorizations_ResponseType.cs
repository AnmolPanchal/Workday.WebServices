...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Spend_Authorizations_ResponseType : INotifyPropertyChanged
	{
		private Spend_AuthorizationObjectType[] request_ReferencesField;

		private Spend_Authorization_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Spend_Authorization_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Spend_AuthorizationType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Spend_Authorization_Reference", IsNullable = false)]
		public Spend_AuthorizationObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Spend_Authorization_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Spend_Authorization_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Spend_Authorization", IsNullable = false)]
		public Spend_AuthorizationType[] Response_Data
		{
			get
			{
