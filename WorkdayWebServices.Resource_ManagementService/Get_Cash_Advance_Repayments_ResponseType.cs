...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Cash_Advance_Repayments_ResponseType : INotifyPropertyChanged
	{
		private Cash_Advance_RepaymentObjectType[] request_ReferencesField;

		private Cash_Advance_Repayment_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Cash_Advance_Repayment_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Cash_Advance_RepaymentType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Cash_Advance_Repayment_Reference", IsNullable = false)]
		public Cash_Advance_RepaymentObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Cash_Advance_Repayment_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Cash_Advance_Repayment_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Cash_Advance_Repayment", IsNullable = false)]
		public Cash_Advance_RepaymentType[] Response_Data
		{
			get
			{
