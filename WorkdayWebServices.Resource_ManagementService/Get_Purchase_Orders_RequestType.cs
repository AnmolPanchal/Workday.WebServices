...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Purchase_Orders_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Purchase_Order_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Purchase_Order_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
