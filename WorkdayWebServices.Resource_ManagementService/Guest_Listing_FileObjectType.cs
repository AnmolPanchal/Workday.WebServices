...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Guest_Listing_FileObjectType : INotifyPropertyChanged
	{
		private Guest_Listing_FileObjectIDType[] idField;
		...
		public Guest_Listing_FileObjectIDType[] ID
		{
			get
			{
				return this.idField;
