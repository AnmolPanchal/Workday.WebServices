...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Credit_Card_Expense_CodeObjectType : INotifyPropertyChanged
	{
		private Credit_Card_Expense_CodeObjectIDType[] idField;
		...
		public Credit_Card_Expense_CodeObjectIDType[] ID
		{
			get
			{
				return this.idField;
