...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Project_Resource_PlanObjectType : INotifyPropertyChanged
	{
		private Project_Resource_PlanObjectIDType[] idField;
		...
		public Project_Resource_PlanObjectIDType[] ID
		{
			get
			{
				return this.idField;
