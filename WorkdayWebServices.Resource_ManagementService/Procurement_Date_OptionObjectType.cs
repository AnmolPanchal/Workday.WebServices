...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Procurement_Date_OptionObjectType : INotifyPropertyChanged
	{
		private Procurement_Date_OptionObjectIDType[] idField;
		...
		public Procurement_Date_OptionObjectIDType[] ID
		{
			get
			{
				return this.idField;
