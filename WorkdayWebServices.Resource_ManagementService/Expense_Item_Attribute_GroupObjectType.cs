...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Expense_Item_Attribute_GroupObjectType : INotifyPropertyChanged
	{
		private Expense_Item_Attribute_GroupObjectIDType[] idField;
		...
		public Expense_Item_Attribute_GroupObjectIDType[] ID
		{
			get
			{
				return this.idField;
