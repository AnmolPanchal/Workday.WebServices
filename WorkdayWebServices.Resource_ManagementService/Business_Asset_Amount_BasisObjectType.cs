...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Business_Asset_Amount_BasisObjectType : INotifyPropertyChanged
	{
		private Business_Asset_Amount_BasisObjectIDType[] idField;
		...
		public Business_Asset_Amount_BasisObjectIDType[] ID
		{
			get
			{
				return this.idField;
