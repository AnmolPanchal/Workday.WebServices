...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Requisitions_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Requisition_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Requisition_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
