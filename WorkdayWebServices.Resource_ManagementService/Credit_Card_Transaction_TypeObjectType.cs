...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Credit_Card_Transaction_TypeObjectType : INotifyPropertyChanged
	{
		private Credit_Card_Transaction_TypeObjectIDType[] idField;
		...
		public Credit_Card_Transaction_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
