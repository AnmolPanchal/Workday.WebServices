...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Prepaid_Amortization_TypeObjectType : INotifyPropertyChanged
	{
		private Prepaid_Amortization_TypeObjectIDType[] idField;
		...
		public Prepaid_Amortization_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
