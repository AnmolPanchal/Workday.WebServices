...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Asset_Removal_ReasonObjectType : INotifyPropertyChanged
	{
		private Asset_Removal_ReasonObjectIDType[] idField;
		...
		public Asset_Removal_ReasonObjectIDType[] ID
		{
			get
			{
				return this.idField;
