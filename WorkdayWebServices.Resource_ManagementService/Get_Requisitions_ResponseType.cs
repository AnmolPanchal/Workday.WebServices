...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Requisitions_ResponseType : INotifyPropertyChanged
	{
		private RequisitionObjectType[] request_ReferencesField;

		private Requisition_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Requisition_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private RequisitionType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Requisition_Reference", IsNullable = false)]
		public RequisitionObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Requisition_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Requisition_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Requisition", IsNullable = false)]
		public RequisitionType[] Response_Data
		{
			get
			{
