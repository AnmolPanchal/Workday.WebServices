...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Purchase_Order_WWS_DataType : INotifyPropertyChanged
	{
		...
		private Item_Order_Line_Replacement_DataType[] goods_Line_Replacement_DataField;

		private Service_Order_Line_Replacement_DataType[] service_Line_Replacement_DataField;

		private ProjectBased_Order_Line_Replacement_DataType[] deliverables_Line_Replacement_DataField;
		...
		private PO_Prepaid_Amortization_Schedule_WWS_DataType[] purchase_Order_Prepaid_Spend_Amortization_ScheduleField;
		...
		[XmlElement("Goods_Line_Replacement_Data", Order = 44)]
		public Item_Order_Line_Replacement_DataType[] Goods_Line_Replacement_Data
		{
			get
			{
				return this.goods_Line_Replacement_DataField;
			}
			set
			{
				this.goods_Line_Replacement_DataField = value;
				this.RaisePropertyChanged("Goods_Line_Replacement_Data");
			}
		}

		[XmlElement("Service_Line_Replacement_Data", Order = 45)]
		public Service_Order_Line_Replacement_DataType[] Service_Line_Replacement_Data
		{
			get
			{
				return this.service_Line_Replacement_DataField;
			}
			set
			{
				this.service_Line_Replacement_DataField = value;
				this.RaisePropertyChanged("Service_Line_Replacement_Data");
			}
		}

		[XmlElement("Deliverables_Line_Replacement_Data", Order = 46)]
		public ProjectBased_Order_Line_Replacement_DataType[] Deliverables_Line_Replacement_Data
		{
			get
			{
				return this.deliverables_Line_Replacement_DataField;
			}
			set
			{
				this.deliverables_Line_Replacement_DataField = value;
				this.RaisePropertyChanged("Deliverables_Line_Replacement_Data");
			}
		}
		...
		[XmlElement("Attachment_Data", Order = 48)]
		...
		[XmlElement("Purchase_Order_Prepaid_Spend_Amortization_Schedule", Order = 49)]
		public PO_Prepaid_Amortization_Schedule_WWS_DataType[] Purchase_Order_Prepaid_Spend_Amortization_Schedule
		{
			get
			{
				return this.purchase_Order_Prepaid_Spend_Amortization_ScheduleField;
			}
			set
			{
				this.purchase_Order_Prepaid_Spend_Amortization_ScheduleField = value;
				this.RaisePropertyChanged("Purchase_Order_Prepaid_Spend_Amortization_Schedule");
			}
		}
