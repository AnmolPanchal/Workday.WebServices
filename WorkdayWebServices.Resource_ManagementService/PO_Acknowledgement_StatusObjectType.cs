...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class PO_Acknowledgement_StatusObjectType : INotifyPropertyChanged
	{
		private PO_Acknowledgement_StatusObjectIDType[] idField;
		...
		public PO_Acknowledgement_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
