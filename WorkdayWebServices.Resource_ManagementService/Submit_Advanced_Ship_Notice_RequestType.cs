...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Submit_Advanced_Ship_Notice_RequestType : INotifyPropertyChanged
	{
		...
		private Advanced_Ship_Notice_Data_InboundType advanced_Ship_Notice_DataField;
		...
		[XmlElement(Order = 2)]
		public Advanced_Ship_Notice_Data_InboundType Advanced_Ship_Notice_Data
		{
			get
			{
