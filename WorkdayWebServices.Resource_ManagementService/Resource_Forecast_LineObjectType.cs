...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Resource_Forecast_LineObjectType : INotifyPropertyChanged
	{
		private Resource_Forecast_LineObjectIDType[] idField;
		...
		public Resource_Forecast_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
