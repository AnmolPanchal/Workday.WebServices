...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Expense_Credit_Card_Transactions_ResponseType : INotifyPropertyChanged
	{
		private Credit_Card_TransactionObjectType[] request_ReferencesField;

		private Expense_Credit_Card_Transaction_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Expense_Credit_Card_Transaction_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Expense_Credit_Card_TransactionType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Expense_Credit_Card_Transaction_Reference", IsNullable = false)]
		public Credit_Card_TransactionObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Expense_Credit_Card_Transaction_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Expense_Credit_Card_Transaction_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Expense_Credit_Card_Transaction", IsNullable = false)]
		public Expense_Credit_Card_TransactionType[] Response_Data
		{
			get
			{
