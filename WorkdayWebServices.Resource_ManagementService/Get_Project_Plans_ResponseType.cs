...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Project_Plans_ResponseType : INotifyPropertyChanged
	{
		...
		private Project_PlanType[] response_DataField;
		...
		[XmlArray(Order = 3), XmlArrayItem("Project_Plan", IsNullable = false)]
		public Project_PlanType[] Response_Data
		{
			get
			{
