...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Depreciation_MethodObjectType : INotifyPropertyChanged
	{
		private Depreciation_MethodObjectIDType[] idField;
		...
		public Depreciation_MethodObjectIDType[] ID
		{
			get
			{
				return this.idField;
