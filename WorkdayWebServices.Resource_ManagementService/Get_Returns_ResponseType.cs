...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Returns_ResponseType : INotifyPropertyChanged
	{
		private Return_to_SupplierObjectType[] request_ReferencesField;

		private Return_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Return_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Return_to_SupplierType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Return_Reference", IsNullable = false)]
		public Return_to_SupplierObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Return_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Return_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Return", IsNullable = false)]
		public Return_to_SupplierType[] Response_Data
		{
			get
			{
