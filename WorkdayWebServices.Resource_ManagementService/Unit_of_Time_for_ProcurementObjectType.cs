...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Unit_of_Time_for_ProcurementObjectType : INotifyPropertyChanged
	{
		private Unit_of_Time_for_ProcurementObjectIDType[] idField;
		...
		public Unit_of_Time_for_ProcurementObjectIDType[] ID
		{
			get
			{
				return this.idField;
