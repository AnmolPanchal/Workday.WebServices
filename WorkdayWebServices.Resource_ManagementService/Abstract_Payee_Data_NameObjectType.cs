...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Abstract_Payee_Data_NameObjectType : INotifyPropertyChanged
	{
		private Abstract_Payee_Data_NameObjectIDType[] idField;
		...
		public Abstract_Payee_Data_NameObjectIDType[] ID
		{
			get
			{
				return this.idField;
