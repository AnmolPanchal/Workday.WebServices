...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Request_for_Quote_ResponseType : INotifyPropertyChanged
	{
		private Request_for_QuoteObjectType[] request_ReferencesField;

		private Request_for_Quote_Request_CriteriaType[] request_CriteriaField;

		private Response_FilterType[] response_FilterField;

		private Request_for_Quote_Response_GroupType[] response_GroupField;

		private Response_ResultsType[] response_ResultsField;

		private Request_for_Quote_OutboundType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Request_for_Quote_Reference", typeof(Request_for_QuoteObjectType), IsNullable = false)]
		public Request_for_QuoteObjectType[] Request_References
		{
			get
			{
		...
		public Request_for_Quote_Request_CriteriaType[] Request_Criteria
		{
			get
			{
		...
		public Request_for_Quote_Response_GroupType[] Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Request_for_Quote", typeof(Request_for_Quote_OutboundType), IsNullable = false)]
		public Request_for_Quote_OutboundType[] Response_Data
		{
			get
			{
