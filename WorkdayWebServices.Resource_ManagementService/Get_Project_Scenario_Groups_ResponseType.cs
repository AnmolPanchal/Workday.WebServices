...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Project_Scenario_Groups_ResponseType : INotifyPropertyChanged
	{
		private Project_Scenario_GroupObjectType[] request_ReferencesField;

		private Project_HierarchyObjectType[] request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Project_Scenario_Group_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Project_Scenario_GroupType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Project_Scenario_Group_Reference", IsNullable = false)]
		public Project_Scenario_GroupObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 1), XmlArrayItem("Project_Hierarchy_Containing_Project_Scenario_Group_Reference", IsNullable = false)]
		public Project_HierarchyObjectType[] Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Project_Scenario_Group_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Project_Scenario_Group", IsNullable = false)]
		public Project_Scenario_GroupType[] Response_Data
		{
			get
			{
