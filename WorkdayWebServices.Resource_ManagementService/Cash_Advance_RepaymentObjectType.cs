...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Cash_Advance_RepaymentObjectType : INotifyPropertyChanged
	{
		private Cash_Advance_RepaymentObjectIDType[] idField;
		...
		public Cash_Advance_RepaymentObjectIDType[] ID
		{
			get
			{
				return this.idField;
