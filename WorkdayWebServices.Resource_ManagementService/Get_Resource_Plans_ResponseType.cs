...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Resource_Plans_ResponseType : INotifyPropertyChanged
	{
		...
		private Resource_PlanType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Resource_Plan_Reference", IsNullable = false)]
		...
		[XmlArray(Order = 5), XmlArrayItem("Resource_Plan", IsNullable = false)]
		public Resource_PlanType[] Response_Data
		{
			get
			{
