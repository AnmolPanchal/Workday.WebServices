...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Financial_InstitutionObjectType : INotifyPropertyChanged
	{
		private Financial_InstitutionObjectIDType[] idField;
		...
		public Financial_InstitutionObjectIDType[] ID
		{
			get
			{
				return this.idField;
