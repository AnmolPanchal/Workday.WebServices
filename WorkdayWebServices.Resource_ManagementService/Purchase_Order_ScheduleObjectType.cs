...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Purchase_Order_ScheduleObjectType : INotifyPropertyChanged
	{
		private Purchase_Order_ScheduleObjectIDType[] idField;
		...
		public Purchase_Order_ScheduleObjectIDType[] ID
		{
			get
			{
				return this.idField;
