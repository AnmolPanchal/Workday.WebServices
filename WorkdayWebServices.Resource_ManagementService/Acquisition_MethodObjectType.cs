...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Acquisition_MethodObjectType : INotifyPropertyChanged
	{
		private Acquisition_MethodObjectIDType[] idField;
		...
		public Acquisition_MethodObjectIDType[] ID
		{
			get
			{
				return this.idField;
