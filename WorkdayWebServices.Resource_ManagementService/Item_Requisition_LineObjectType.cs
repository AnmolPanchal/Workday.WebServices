...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Item_Requisition_LineObjectType : INotifyPropertyChanged
	{
		private Item_Requisition_LineObjectIDType[] idField;
		...
		public Item_Requisition_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
