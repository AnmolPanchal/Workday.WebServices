...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Supplier_Connections_ResponseType : INotifyPropertyChanged
	{
		...
		private Supplier_Connection_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Supplier_ConnectionType[] response_DataField;
		...
		[XmlElement(Order = 3)]
		public Supplier_Connection_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Supplier_Connection", IsNullable = false)]
		public Supplier_ConnectionType[] Response_Data
		{
			get
			{
