...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Purchase_Order_AcknowledgementObjectType : INotifyPropertyChanged
	{
		private Purchase_Order_AcknowledgementObjectIDType[] idField;
		...
		public Purchase_Order_AcknowledgementObjectIDType[] ID
		{
			get
			{
				return this.idField;
