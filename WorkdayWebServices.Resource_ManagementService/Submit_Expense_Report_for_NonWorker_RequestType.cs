...
{
	[GeneratedCode("System.Xml", "4.6.1590.0"), DesignerCategory("code"), DebuggerStepThrough, XmlType(TypeName = "Submit_Expense_Report_for_Non-Worker_RequestType", Namespace = "urn:com.workday/bsvc")]
	[Serializable]
	public class Submit_Expense_Report_for_NonWorker_RequestType : INotifyPropertyChanged
	{
		...
		private Expense_Report_WWS_DataType expense_Report_DataField;
		...
		[XmlElement(Order = 2)]
		public Expense_Report_WWS_DataType Expense_Report_Data
		{
			get
			{
