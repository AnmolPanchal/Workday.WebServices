...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Depreciation_Rate_BasisObjectType : INotifyPropertyChanged
	{
		private Depreciation_Rate_BasisObjectIDType[] idField;
		...
		public Depreciation_Rate_BasisObjectIDType[] ID
		{
			get
			{
				return this.idField;
