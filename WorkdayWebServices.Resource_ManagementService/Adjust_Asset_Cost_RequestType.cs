...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Adjust_Asset_Cost_RequestType : INotifyPropertyChanged
	{
		...
		private Business_Asset_Cost_Adjustment_DataType business_Asset_Cost_Adjustment_DataField;
		...
		[XmlElement(Order = 2)]
		public Business_Asset_Cost_Adjustment_DataType Business_Asset_Cost_Adjustment_Data
		{
			get
			{
				return this.business_Asset_Cost_Adjustment_DataField;
			}
			set
			{
				this.business_Asset_Cost_Adjustment_DataField = value;
				this.RaisePropertyChanged("Business_Asset_Cost_Adjustment_Data");
			}
		}
