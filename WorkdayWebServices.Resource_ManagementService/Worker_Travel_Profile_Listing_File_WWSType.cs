...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Worker_Travel_Profile_Listing_File_WWSType : INotifyPropertyChanged
	{
		...
		private Worker_Travel_Profile_WWSType[] travel_Profile_DataField;
		...
		public Worker_Travel_Profile_WWSType[] Travel_Profile_Data
		{
			get
			{
