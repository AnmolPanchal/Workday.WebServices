...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Internal_Service_Delivery_LineObjectType : INotifyPropertyChanged
	{
		private Internal_Service_Delivery_LineObjectIDType[] idField;
		...
		public Internal_Service_Delivery_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
