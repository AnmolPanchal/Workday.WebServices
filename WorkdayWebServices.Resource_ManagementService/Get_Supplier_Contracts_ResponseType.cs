...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Supplier_Contracts_ResponseType : INotifyPropertyChanged
	{
		private Supplier_ContractObjectType[] request_ReferencesField;

		private Supplier_Contract_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Supplier_Contract_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Supplier_ContractType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Supplier_Contract_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Supplier_Contract_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Supplier_Contract_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Supplier_Contract", IsNullable = false)]
		public Supplier_ContractType[] Response_Data
		{
			get
			{
