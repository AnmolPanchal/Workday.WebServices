...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Expense_Rate_Table_Header__HV__RequestType : INotifyPropertyChanged
	{
		private Expense_Rate_TableObjectType expense_Rate_Table_ReferenceField;

		private Expense_Rate_Table__HV__DataType expense_Rate_Table_DataField;
		...
		[XmlElement(Order = 1)]
		public Expense_Rate_Table__HV__DataType Expense_Rate_Table_Data
		{
			get
			{
