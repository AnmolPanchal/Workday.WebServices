...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Credit_Card_Header__HV__RequestType : INotifyPropertyChanged
	{
		private Cardholder_Listing_FileObjectType card_Holder_Listing_File_ReferenceField;

		private Cardholder_Listing_File__HV__DataType card_Holder_Listing_File_DataField;
		...
		[XmlElement(Order = 1)]
		public Cardholder_Listing_File__HV__DataType Card_Holder_Listing_File_Data
		{
			get
			{
