...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Advanced_Ship_Notices_ResponseType : INotifyPropertyChanged
	{
		private Advanced_Ship_NoticeObjectType[] request_ReferencesField;

		private Advanced_Ship_Notice_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Advanced_Ship_Notice_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Advanced_Ship_Notice_OutboundType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Advanced_Ship_Notice_Reference", IsNullable = false)]
		public Advanced_Ship_NoticeObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Advanced_Ship_Notice_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Advanced_Ship_Notice_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Advanced_Ship_Notice", IsNullable = false)]
		public Advanced_Ship_Notice_OutboundType[] Response_Data
		{
			get
			{
