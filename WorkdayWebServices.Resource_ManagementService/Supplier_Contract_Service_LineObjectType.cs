...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Supplier_Contract_Service_LineObjectType : INotifyPropertyChanged
	{
		private Supplier_Contract_Service_LineObjectIDType[] idField;
		...
		public Supplier_Contract_Service_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
