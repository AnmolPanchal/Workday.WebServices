...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Business_Asset_Disposal_MethodObjectType : INotifyPropertyChanged
	{
		private Business_Asset_Disposal_MethodObjectIDType[] idField;
		...
		public Business_Asset_Disposal_MethodObjectIDType[] ID
		{
			get
			{
				return this.idField;
