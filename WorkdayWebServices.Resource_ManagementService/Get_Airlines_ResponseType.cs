...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Airlines_ResponseType : INotifyPropertyChanged
	{
		private AirlineObjectType[] request_ReferencesField;

		private Airline_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Airline_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private AirlineType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Airline_Reference", IsNullable = false)]
		public AirlineObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Airline_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Airline_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Airline", IsNullable = false)]
		public AirlineType[] Response_Data
		{
			get
			{
