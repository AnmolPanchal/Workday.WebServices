...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Asset_Shares_ResponseType : INotifyPropertyChanged
	{
		private Business_AssetObjectType[] request_ReferencesField;

		private Business_AssetObjectType[] request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Asset_Shares_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Asset_SharesType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Business_Asset_Reference", IsNullable = false)]
		public Business_AssetObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 1), XmlArrayItem("Business_Assets_Reference", IsNullable = false)]
		public Business_AssetObjectType[] Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Asset_Shares_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Asset_Shares", IsNullable = false)]
		public Asset_SharesType[] Response_Data
		{
			get
			{
