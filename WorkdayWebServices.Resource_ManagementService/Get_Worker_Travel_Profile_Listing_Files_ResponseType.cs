...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Worker_Travel_Profile_Listing_Files_ResponseType : INotifyPropertyChanged
	{
		private Worker_Travel_Profile_Listing_FileObjectType[] request_ReferencesField;

		private Worker_Travel_Profile_Listing_File_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Worker_Travel_Profile_Listing_File_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Worker_Travel_Profile_Listing_FileType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Worker_Travel_Profile_Listing_File_Reference", IsNullable = false)]
		public Worker_Travel_Profile_Listing_FileObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Worker_Travel_Profile_Listing_File_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Worker_Travel_Profile_Listing_File_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Worker_Travel_Profile_Listing_File", IsNullable = false)]
		public Worker_Travel_Profile_Listing_FileType[] Response_Data
		{
			get
			{
