...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Procurement_Document_TypeObjectType : INotifyPropertyChanged
	{
		private Procurement_Document_TypeObjectIDType[] idField;
		...
		public Procurement_Document_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
