...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Project_Booking_StatusObjectType : INotifyPropertyChanged
	{
		private Project_Booking_StatusObjectIDType[] idField;
		...
		public Project_Booking_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
