...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Request_for_Quote_Award_Line_Splits_DataType : INotifyPropertyChanged
	{
		private string rFQ_Award_Line_Split_IDField;

		private Business_Document_Line_SplitObjectType rFQ_Award_Line_Split_ReferenceField;
		...
		[XmlElement(Order = 0)]
		public string RFQ_Award_Line_Split_ID
		{
			get
			{
				return this.rFQ_Award_Line_Split_IDField;
			}
			set
			{
				this.rFQ_Award_Line_Split_IDField = value;
				this.RaisePropertyChanged("RFQ_Award_Line_Split_ID");
			}
		}

		[XmlElement(Order = 1)]
		public Business_Document_Line_SplitObjectType RFQ_Award_Line_Split_Reference
		{
			get
			{
				return this.rFQ_Award_Line_Split_ReferenceField;
			}
			set
			{
				this.rFQ_Award_Line_Split_ReferenceField = value;
				this.RaisePropertyChanged("RFQ_Award_Line_Split_Reference");
			}
		}
		...
		[XmlElement("Worktags_Reference", Order = 6)]
