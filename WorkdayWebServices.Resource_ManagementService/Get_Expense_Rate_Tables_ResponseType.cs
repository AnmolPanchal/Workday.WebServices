...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Expense_Rate_Tables_ResponseType : INotifyPropertyChanged
	{
		private Expense_Rate_TableObjectType[] request_ReferencesField;

		private Expense_Rate_Table_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Expense_Rate_Table_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Expense_Rate_TableType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Expense_Rate_Table_Reference", IsNullable = false)]
		public Expense_Rate_TableObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Expense_Rate_Table_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Expense_Rate_Table_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Expense_Rate_Table", IsNullable = false)]
		public Expense_Rate_TableType[] Response_Data
		{
			get
			{
