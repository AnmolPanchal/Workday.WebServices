...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Project_Resource_Plan_DetailObjectType : INotifyPropertyChanged
	{
		private Project_Resource_Plan_DetailObjectIDType[] idField;
		...
		public Project_Resource_Plan_DetailObjectIDType[] ID
		{
			get
			{
				return this.idField;
