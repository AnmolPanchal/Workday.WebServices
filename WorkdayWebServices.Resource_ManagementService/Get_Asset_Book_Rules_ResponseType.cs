...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Asset_Book_Rules_ResponseType : INotifyPropertyChanged
	{
		private Asset_BookObjectType[] request_ReferencesField;

		private Asset_BookObjectType[] request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Asset_Book_Rule_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Asset_Book_RuleType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Asset_Book_Reference", IsNullable = false)]
		public Asset_BookObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 1), XmlArrayItem("Asset_Books_Reference", IsNullable = false)]
		public Asset_BookObjectType[] Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Asset_Book_Rule_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Asset_Book_Rule", IsNullable = false)]
		public Asset_Book_RuleType[] Response_Data
		{
			get
			{
