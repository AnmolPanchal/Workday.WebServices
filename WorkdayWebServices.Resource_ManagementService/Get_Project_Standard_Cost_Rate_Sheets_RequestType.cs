...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Project_Standard_Cost_Rate_Sheets_RequestType : INotifyPropertyChanged
	{
		private Project_Standard_Cost_Rate_Sheet_Request_ReferencesType request_ReferencesField;
		...
		[XmlElement(Order = 0)]
		public Project_Standard_Cost_Rate_Sheet_Request_ReferencesType Request_References
		{
			get
			{
