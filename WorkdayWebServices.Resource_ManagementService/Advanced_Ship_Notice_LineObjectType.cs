...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Advanced_Ship_Notice_LineObjectType : INotifyPropertyChanged
	{
		private Advanced_Ship_Notice_LineObjectIDType[] idField;
		...
		public Advanced_Ship_Notice_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
