...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Payroll_Timesheet_Total_HoursObjectType : INotifyPropertyChanged
	{
		private Payroll_Timesheet_Total_HoursObjectIDType[] idField;
		...
		public Payroll_Timesheet_Total_HoursObjectIDType[] ID
		{
			get
			{
				return this.idField;
