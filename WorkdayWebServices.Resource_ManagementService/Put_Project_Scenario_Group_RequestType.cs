...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Put_Project_Scenario_Group_RequestType : INotifyPropertyChanged
	{
		private Project_Scenario_GroupObjectType project_Scenario_Group_ReferenceField;

		private Project_Scenario_Group_DataType project_Scenario_Group_DataField;
		...
		[XmlElement(Order = 1)]
		public Project_Scenario_Group_DataType Project_Scenario_Group_Data
		{
			get
			{
				return this.project_Scenario_Group_DataField;
			}
			set
			{
				this.project_Scenario_Group_DataField = value;
				this.RaisePropertyChanged("Project_Scenario_Group_Data");
			}
		}
