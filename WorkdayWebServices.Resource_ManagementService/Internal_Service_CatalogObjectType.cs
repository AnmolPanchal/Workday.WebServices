...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Internal_Service_CatalogObjectType : INotifyPropertyChanged
	{
		private Internal_Service_CatalogObjectIDType[] idField;
		...
		public Internal_Service_CatalogObjectIDType[] ID
		{
			get
			{
				return this.idField;
