...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Transfer_Asset_RequestType : INotifyPropertyChanged
	{
		...
		private Asset_Transfer_DataType asset_Transfer_DataField;
		...
		[XmlElement(Order = 2)]
		public Asset_Transfer_DataType Asset_Transfer_Data
		{
			get
			{
				return this.asset_Transfer_DataField;
			}
			set
			{
				this.asset_Transfer_DataField = value;
				this.RaisePropertyChanged("Asset_Transfer_Data");
			}
		}
