...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Purchase_Items_ResponseType : INotifyPropertyChanged
	{
		private Procurement_ItemObjectType[] request_ReferencesField;

		private Purchase_Item_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Purchase_Item_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Purchase_ItemType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Purchase_Item_Reference", IsNullable = false)]
		public Procurement_ItemObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Purchase_Item_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Purchase_Item_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Purchase_Item", IsNullable = false)]
		public Purchase_ItemType[] Response_Data
		{
			get
			{
