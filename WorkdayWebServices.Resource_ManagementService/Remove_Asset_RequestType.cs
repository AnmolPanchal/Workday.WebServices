...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Remove_Asset_RequestType : INotifyPropertyChanged
	{
		private Financials_Business_Process_ParametersType business_Process_ParametersField;

		private Remove_Asset_DataType remove_Asset_DataField;
		...
		[XmlElement(Order = 1)]
		public Remove_Asset_DataType Remove_Asset_Data
		{
			get
			{
				return this.remove_Asset_DataField;
			}
			set
			{
				this.remove_Asset_DataField = value;
				this.RaisePropertyChanged("Remove_Asset_Data");
			}
		}
