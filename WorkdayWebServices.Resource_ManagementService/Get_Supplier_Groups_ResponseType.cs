...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Supplier_Groups_ResponseType : INotifyPropertyChanged
	{
		private Supplier_GroupObjectType[] request_ReferencesField;

		private Supplier_Group_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Supplier_Group_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Supplier_GroupType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Supplier_Group_Reference", IsNullable = false)]
		public Supplier_GroupObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Supplier_Group_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Supplier_Group_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Supplier_Group", IsNullable = false)]
		public Supplier_GroupType[] Response_Data
		{
			get
			{
