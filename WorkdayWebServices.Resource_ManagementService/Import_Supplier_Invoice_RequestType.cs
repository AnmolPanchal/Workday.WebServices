...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Import_Supplier_Invoice_RequestType : INotifyPropertyChanged
	{
		...
		private Supplier_Invoice__HV__DataType supplier_Invoice_DataField;
		...
		[XmlElement(Order = 2)]
		public Supplier_Invoice__HV__DataType Supplier_Invoice_Data
		{
			get
			{
