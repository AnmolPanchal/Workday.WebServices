...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Car_Rental_Agencies_ResponseType : INotifyPropertyChanged
	{
		private Car_Rental_AgencyObjectType[] request_ReferencesField;

		private Car_Rental_Agency_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Car_Rental_Agency_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Car_Rental_AgencyType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Car_Rental_Agency_Reference", IsNullable = false)]
		public Car_Rental_AgencyObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Car_Rental_Agency_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Car_Rental_Agency_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Car_Rental_Agency", IsNullable = false)]
		public Car_Rental_AgencyType[] Response_Data
		{
			get
			{
