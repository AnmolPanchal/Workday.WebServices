...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Travel_Booking_Files_ResponseType : INotifyPropertyChanged
	{
		private Travel_Booking_FileObjectType[] request_ReferencesField;

		private Travel_Booking_File_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Travel_Booking_File_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Travel_Booking_FileType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Travel_Booking_File_Reference", IsNullable = false)]
		public Travel_Booking_FileObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Travel_Booking_File_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Travel_Booking_File_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Travel_Booking_File", IsNullable = false)]
		public Travel_Booking_FileType[] Response_Data
		{
			get
			{
