...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Return_to_SupplierObjectType : INotifyPropertyChanged
	{
		private Return_to_SupplierObjectIDType[] idField;
		...
		public Return_to_SupplierObjectIDType[] ID
		{
			get
			{
				return this.idField;
