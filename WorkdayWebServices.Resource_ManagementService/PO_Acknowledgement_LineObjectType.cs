...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class PO_Acknowledgement_LineObjectType : INotifyPropertyChanged
	{
		private PO_Acknowledgement_LineObjectIDType[] idField;
		...
		public PO_Acknowledgement_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
