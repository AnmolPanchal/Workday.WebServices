...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Supplier_Invoice_InstallmentObjectType : INotifyPropertyChanged
	{
		private Supplier_Invoice_InstallmentObjectIDType[] idField;
		...
		public Supplier_Invoice_InstallmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
