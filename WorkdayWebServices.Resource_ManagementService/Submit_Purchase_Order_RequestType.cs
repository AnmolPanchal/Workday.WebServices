...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Submit_Purchase_Order_RequestType : INotifyPropertyChanged
	{
		...
		private Purchase_Order_WWS_DataType purchase_Order_DataField;
		...
		[XmlElement(Order = 2)]
		public Purchase_Order_WWS_DataType Purchase_Order_Data
		{
			get
			{
