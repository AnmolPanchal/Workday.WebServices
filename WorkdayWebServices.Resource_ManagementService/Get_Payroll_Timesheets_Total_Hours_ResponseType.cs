...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Payroll_Timesheets_Total_Hours_ResponseType : INotifyPropertyChanged
	{
		private Payroll_Timesheet_Total_HoursObjectType[] request_ReferencesField;

		private Payroll_Timesheet_Total_Hours_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Payroll_Timesheet_Total_Hours_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Payroll_Timesheet_Total_HoursType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Payroll_Timesheet_Total_Hours_Reference", IsNullable = false)]
		public Payroll_Timesheet_Total_HoursObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Payroll_Timesheet_Total_Hours_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Payroll_Timesheet_Total_Hours_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Payroll_Timesheet_Total_Hours", IsNullable = false)]
		public Payroll_Timesheet_Total_HoursType[] Response_Data
		{
			get
			{
