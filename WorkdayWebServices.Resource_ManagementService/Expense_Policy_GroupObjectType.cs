...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Expense_Policy_GroupObjectType : INotifyPropertyChanged
	{
		private Expense_Policy_GroupObjectIDType[] idField;
		...
		public Expense_Policy_GroupObjectIDType[] ID
		{
			get
			{
				return this.idField;
