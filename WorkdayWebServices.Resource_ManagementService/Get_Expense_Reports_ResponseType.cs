...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Expense_Reports_ResponseType : INotifyPropertyChanged
	{
		private Expense_ReportObjectType[] request_ReferencesField;

		private Expense_Report_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Expense_Report_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Expense_Report_WWSType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Expense_Report_Reference", IsNullable = false)]
		public Expense_ReportObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Expense_Report_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Expense_Report_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Expense_Report", IsNullable = false)]
		public Expense_Report_WWSType[] Response_Data
		{
			get
			{
