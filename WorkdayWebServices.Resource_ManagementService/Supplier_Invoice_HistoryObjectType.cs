...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Supplier_Invoice_HistoryObjectType : INotifyPropertyChanged
	{
		private Supplier_Invoice_HistoryObjectIDType[] idField;
		...
		public Supplier_Invoice_HistoryObjectIDType[] ID
		{
			get
			{
				return this.idField;
