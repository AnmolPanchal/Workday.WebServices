...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Purchase_Order_InstallmentObjectType : INotifyPropertyChanged
	{
		private Purchase_Order_InstallmentObjectIDType[] idField;
		...
		public Purchase_Order_InstallmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
