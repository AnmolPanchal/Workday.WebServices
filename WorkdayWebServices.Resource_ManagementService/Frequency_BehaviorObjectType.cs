...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Frequency_BehaviorObjectType : INotifyPropertyChanged
	{
		private Frequency_BehaviorObjectIDType[] idField;
		...
		public Frequency_BehaviorObjectIDType[] ID
		{
			get
			{
				return this.idField;
