...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Suppliers_ResponseType : INotifyPropertyChanged
	{
		...
		private SupplierType[] response_DataField;
		...
		[XmlArray(Order = 5), XmlArrayItem("Supplier", IsNullable = false)]
		public SupplierType[] Response_Data
		{
			get
			{
