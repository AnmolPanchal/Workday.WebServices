...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Hotels_ResponseType : INotifyPropertyChanged
	{
		private HotelObjectType[] request_ReferencesField;

		private Hotel_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Hotel_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private HotelType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Hotel_Reference", IsNullable = false)]
		public HotelObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Hotel_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Hotel_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Hotel", IsNullable = false)]
		public HotelType[] Response_Data
		{
			get
			{
