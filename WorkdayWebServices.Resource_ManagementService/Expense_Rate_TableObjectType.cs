...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Expense_Rate_TableObjectType : INotifyPropertyChanged
	{
		private Expense_Rate_TableObjectIDType[] idField;
		...
		public Expense_Rate_TableObjectIDType[] ID
		{
			get
			{
				return this.idField;
