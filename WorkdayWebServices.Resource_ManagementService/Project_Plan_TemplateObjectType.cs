...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Project_Plan_TemplateObjectType : INotifyPropertyChanged
	{
		private Project_Plan_TemplateObjectIDType[] idField;
		...
		public Project_Plan_TemplateObjectIDType[] ID
		{
			get
			{
				return this.idField;
