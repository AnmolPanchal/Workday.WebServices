...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Replenishment_TypeObjectType : INotifyPropertyChanged
	{
		private Replenishment_TypeObjectIDType[] idField;
		...
		public Replenishment_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
