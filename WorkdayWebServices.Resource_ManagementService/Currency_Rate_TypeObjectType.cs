...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Currency_Rate_TypeObjectType : INotifyPropertyChanged
	{
		private Currency_Rate_TypeObjectIDType[] idField;
		...
		public Currency_Rate_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
