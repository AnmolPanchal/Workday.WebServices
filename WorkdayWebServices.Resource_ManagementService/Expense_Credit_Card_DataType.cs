...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Expense_Credit_Card_DataType : INotifyPropertyChanged
	{
		...
		[XmlElement("Employee_ID", typeof(string), Order = 2), XmlElement("Employee_Reference", typeof(EmployeeObjectType), Order = 2)]
		public object Item
		{
			get
			{
		...
		[XmlElement("Card_Holder_Listing_File_Reference", Order = 13)]
