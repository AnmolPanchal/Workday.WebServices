...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Purchase_Order_Issue_OptionObjectType : INotifyPropertyChanged
	{
		private Purchase_Order_Issue_OptionObjectIDType[] idField;
		...
		public Purchase_Order_Issue_OptionObjectIDType[] ID
		{
			get
			{
				return this.idField;
