...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Internal_Service_ProviderObjectType : INotifyPropertyChanged
	{
		private Internal_Service_ProviderObjectIDType[] idField;
		...
		public Internal_Service_ProviderObjectIDType[] ID
		{
			get
			{
				return this.idField;
