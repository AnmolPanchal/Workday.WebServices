...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Expense_Reports_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Expense_Report_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Expense_Report_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
