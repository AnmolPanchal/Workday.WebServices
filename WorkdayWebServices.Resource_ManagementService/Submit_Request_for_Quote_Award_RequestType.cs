...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Submit_Request_for_Quote_Award_RequestType : INotifyPropertyChanged
	{
		...
		private Request_for_Quote_Award_Data_InboundType request_for_Quote_Award_DataField;
		...
		[XmlElement(Order = 2)]
		public Request_for_Quote_Award_Data_InboundType Request_for_Quote_Award_Data
		{
			get
			{
