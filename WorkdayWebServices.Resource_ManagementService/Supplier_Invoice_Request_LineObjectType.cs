...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Supplier_Invoice_Request_LineObjectType : INotifyPropertyChanged
	{
		private Supplier_Invoice_Request_LineObjectIDType[] idField;
		...
		public Supplier_Invoice_Request_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
