...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Spend_Category_Hierarchies_ResponseType : INotifyPropertyChanged
	{
		private Spend_Category_HierarchyObjectType[] request_ReferencesField;

		private Spend_Category_Hierarchy_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Spend_Category_Hierarchy_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Spend_Category_HierarchyType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Spend_Category_Hierarchy_Reference", IsNullable = false)]
		public Spend_Category_HierarchyObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Spend_Category_Hierarchy_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Spend_Category_Hierarchy_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Spend_Category_Hierarchy", IsNullable = false)]
		public Spend_Category_HierarchyType[] Response_Data
		{
			get
			{
