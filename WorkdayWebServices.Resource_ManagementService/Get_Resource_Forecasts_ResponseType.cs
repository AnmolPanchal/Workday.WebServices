...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Get_Resource_Forecasts_ResponseType : INotifyPropertyChanged
	{
		private Resource_ForecastObjectType[] request_ReferencesField;

		private Resource_Forecast_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Resource_Forecast_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Resource_ForecastType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Resource_Forecast_Reference", IsNullable = false)]
		public Resource_ForecastObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Resource_Forecast_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Resource_Forecast_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Resource_Forecast_Data", IsNullable = false)]
		public Resource_ForecastType[] Response_Data
		{
			get
			{
