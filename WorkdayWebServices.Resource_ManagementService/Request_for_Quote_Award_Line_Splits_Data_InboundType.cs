...
namespace WorkdayWebServices.Resource_ManagementService
{
	...
	[Serializable]
	public class Request_for_Quote_Award_Line_Splits_Data_InboundType : INotifyPropertyChanged
	{
		...
		private Business_Document_Line_SplitObjectType rFQ_Line_Split_ReferenceField;
		...
		[XmlElement("Worktags_Reference", Order = 3)]
		...
		[XmlElement(Order = 4)]
		public Business_Document_Line_SplitObjectType RFQ_Line_Split_Reference
		{
			get
			{
				return this.rFQ_Line_Split_ReferenceField;
			}
			set
			{
				this.rFQ_Line_Split_ReferenceField = value;
				this.RaisePropertyChanged("RFQ_Line_Split_Reference");
			}
		}
