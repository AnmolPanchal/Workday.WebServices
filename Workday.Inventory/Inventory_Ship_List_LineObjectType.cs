...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Inventory_Ship_List_LineObjectType : INotifyPropertyChanged
	{
		private Inventory_Ship_List_LineObjectIDType[] idField;
		...
		public Inventory_Ship_List_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
