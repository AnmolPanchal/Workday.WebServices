...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Inventory_Return_Order_TypeObjectType : INotifyPropertyChanged
	{
		private Inventory_Return_Order_TypeObjectIDType[] idField;
		...
		public Inventory_Return_Order_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
