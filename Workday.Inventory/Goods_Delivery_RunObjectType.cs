...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Goods_Delivery_RunObjectType : INotifyPropertyChanged
	{
		private Goods_Delivery_RunObjectIDType[] idField;
		...
		public Goods_Delivery_RunObjectIDType[] ID
		{
			get
			{
				return this.idField;
