...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Inventory_Par_CountObjectType : INotifyPropertyChanged
	{
		private Inventory_Par_CountObjectIDType[] idField;
		...
		public Inventory_Par_CountObjectIDType[] ID
		{
			get
			{
				return this.idField;
