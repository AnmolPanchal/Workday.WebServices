...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Inventory_Par_Count_LineObjectType : INotifyPropertyChanged
	{
		private Inventory_Par_Count_LineObjectIDType[] idField;
		...
		public Inventory_Par_Count_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
