...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Get_Inventory_Return_Orders_ResponseType : INotifyPropertyChanged
	{
		private Inventory_ReturnObjectType[] request_ReferencesField;

		private Inventory_Return_Order_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Inventory_Return_Order_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Inventory_Return_OrderType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Inventory_Return_Order_Reference", IsNullable = false)]
		public Inventory_ReturnObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Inventory_Return_Order_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Inventory_Return_Order_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Inventory_Return_Order", IsNullable = false)]
		public Inventory_Return_OrderType[] Response_Data
		{
			get
			{
