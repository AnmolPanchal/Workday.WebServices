...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Inventory_Return_LineObjectType : INotifyPropertyChanged
	{
		private Inventory_Return_LineObjectIDType[] idField;
		...
		public Inventory_Return_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
