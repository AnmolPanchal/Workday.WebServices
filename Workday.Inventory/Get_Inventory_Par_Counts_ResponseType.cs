...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Get_Inventory_Par_Counts_ResponseType : INotifyPropertyChanged
	{
		private Inventory_Par_CountObjectType[] request_ReferencesField;

		private Inventory_Par_Count_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Inventory_Par_Count_Response_GroupType response_GroupField;

		private Inventory_Par_CountType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Inventory_Par_Count_Reference", IsNullable = false)]
		public Inventory_Par_CountObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Inventory_Par_Count_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 4)]
		public Inventory_Par_Count_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Inventory_Par_Count", IsNullable = false)]
		public Inventory_Par_CountType[] Response_Data
		{
			get
			{
