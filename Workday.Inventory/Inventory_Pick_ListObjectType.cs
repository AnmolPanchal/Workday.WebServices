...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Inventory_Pick_ListObjectType : INotifyPropertyChanged
	{
		private Inventory_Pick_ListObjectIDType[] idField;
		...
		public Inventory_Pick_ListObjectIDType[] ID
		{
			get
			{
				return this.idField;
