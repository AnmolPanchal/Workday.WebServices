...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Accounting_WorktagObjectType : INotifyPropertyChanged
	{
		private Accounting_WorktagObjectIDType[] idField;
		...
		public Accounting_WorktagObjectIDType[] ID
		{
			get
			{
				return this.idField;
