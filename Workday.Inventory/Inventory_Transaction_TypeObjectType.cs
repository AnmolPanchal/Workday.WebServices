...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Inventory_Transaction_TypeObjectType : INotifyPropertyChanged
	{
		private Inventory_Transaction_TypeObjectIDType[] idField;
		...
		public Inventory_Transaction_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
