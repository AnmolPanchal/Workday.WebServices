...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Get_Goods_Delivery_Tickets_ResponseType : INotifyPropertyChanged
	{
		private Goods_DeliveryObjectType[] request_ReferencesField;

		private Goods_Delivery_Ticket_Request_CriteriaType[] request_CriteriaField;

		private Response_FilterType[] response_FilterField;

		private Goods_Delivery_Ticket_Response_GroupType[] response_GroupField;

		private Response_ResultsType[] response_ResultsField;

		private Goods_Delivery_TicketType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Goods_Delivery_Ticket_Request_Reference", typeof(Goods_DeliveryObjectType), IsNullable = false)]
		public Goods_DeliveryObjectType[] Request_References
		{
			get
			{
		...
		public Goods_Delivery_Ticket_Request_CriteriaType[] Request_Criteria
		{
			get
			{
		...
		public Goods_Delivery_Ticket_Response_GroupType[] Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Goods_Delivery_Ticket", typeof(Goods_Delivery_TicketType), IsNullable = false)]
		public Goods_Delivery_TicketType[] Response_Data
		{
			get
			{
