...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Inventory_Par_Location_LineObjectType : INotifyPropertyChanged
	{
		private Inventory_Par_Location_LineObjectIDType[] idField;
		...
		public Inventory_Par_Location_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
