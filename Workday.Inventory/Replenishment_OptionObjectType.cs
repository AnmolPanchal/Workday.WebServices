...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Replenishment_OptionObjectType : INotifyPropertyChanged
	{
		private Replenishment_OptionObjectIDType[] idField;
		...
		public Replenishment_OptionObjectIDType[] ID
		{
			get
			{
				return this.idField;
