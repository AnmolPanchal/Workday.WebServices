...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Item_Identifier_TypeObjectType : INotifyPropertyChanged
	{
		private Item_Identifier_TypeObjectIDType[] idField;
		...
		public Item_Identifier_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
