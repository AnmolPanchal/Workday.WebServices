...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Get_Manufacturers_ResponseType : INotifyPropertyChanged
	{
		private ManufacturerObjectType[] request_ReferencesField;

		private Manufacturer_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Manufacturer_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private ManufacturerType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Manufacturer_Reference", IsNullable = false)]
		public ManufacturerObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Manufacturer_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Manufacturer_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Manufacturer", IsNullable = false)]
		public ManufacturerType[] Response_Data
		{
			get
			{
