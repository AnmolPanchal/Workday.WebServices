...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Get_Inventory_Shipments_ResponseType : INotifyPropertyChanged
	{
		private Inventory_Ship_ListObjectType[] request_ReferencesField;

		private Inventory_Shipment_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Inventory_Shipment_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Inventory_ShipmentType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Inventory_Shipment_Reference", IsNullable = false)]
		public Inventory_Ship_ListObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Inventory_Shipment_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Inventory_Shipment_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Inventory_Shipment", IsNullable = false)]
		public Inventory_ShipmentType[] Response_Data
		{
			get
			{
