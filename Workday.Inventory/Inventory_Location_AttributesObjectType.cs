...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Inventory_Location_AttributesObjectType : INotifyPropertyChanged
	{
		private Inventory_Location_AttributesObjectIDType[] idField;
		...
		public Inventory_Location_AttributesObjectIDType[] ID
		{
			get
			{
				return this.idField;
