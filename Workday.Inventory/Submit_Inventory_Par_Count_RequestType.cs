...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Submit_Inventory_Par_Count_RequestType : INotifyPropertyChanged
	{
		...
		private Inventory_Par_Count_DataType inventory_Par_Count_DataField;
		...
		[XmlElement(Order = 2)]
		public Inventory_Par_Count_DataType Inventory_Par_Count_Data
		{
			get
			{
