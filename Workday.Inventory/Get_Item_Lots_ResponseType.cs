...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Get_Item_Lots_ResponseType : INotifyPropertyChanged
	{
		private Item_LotObjectType[] request_ReferencesField;

		private Item_Lot_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Item_Lot_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Item_LotType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Item_Lot_Reference", IsNullable = false)]
		public Item_LotObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Item_Lot_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Item_Lot_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Item_Lot", IsNullable = false)]
		public Item_LotType[] Response_Data
		{
			get
			{
