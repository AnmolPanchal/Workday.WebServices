...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Get_Capture_Goods_Delivery_Runs_ResponseType : INotifyPropertyChanged
	{
		private Goods_Delivery_RunObjectType[] request_ReferencesField;

		private Capture_Goods_Delivery_Run_Request_CriteriaType[] request_CriteriaField;

		private Response_FilterType[] response_FilterField;

		private Capture_Goods_Delivery_Run_Response_GroupType[] response_GroupField;

		private Response_ResultsType[] response_ResultsField;

		private Capture_Goods_Delivery_RunType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Capture_Goods_Delivery_Run_Request_Reference", typeof(Goods_Delivery_RunObjectType), IsNullable = false)]
		public Goods_Delivery_RunObjectType[] Request_References
		{
			get
			{
		...
		public Capture_Goods_Delivery_Run_Request_CriteriaType[] Request_Criteria
		{
			get
			{
		...
		public Capture_Goods_Delivery_Run_Response_GroupType[] Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Capture_Goods_Delivery_Run", typeof(Capture_Goods_Delivery_RunType), IsNullable = false)]
		public Capture_Goods_Delivery_RunType[] Response_Data
		{
			get
			{
