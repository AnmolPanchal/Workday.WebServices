...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Goods_Delivery_RuleObjectType : INotifyPropertyChanged
	{
		private Goods_Delivery_RuleObjectIDType[] idField;
		...
		public Goods_Delivery_RuleObjectIDType[] ID
		{
			get
			{
				return this.idField;
