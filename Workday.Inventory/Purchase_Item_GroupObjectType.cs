...
namespace WorkdayWebServices.InventoryService
{
	...
	[Serializable]
	public class Purchase_Item_GroupObjectType : INotifyPropertyChanged
	{
		private Purchase_Item_GroupObjectIDType[] idField;
		...
		public Purchase_Item_GroupObjectIDType[] ID
		{
			get
			{
				return this.idField;
