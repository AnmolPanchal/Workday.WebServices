...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Get_Single_Legal_Entities_ResponseType : INotifyPropertyChanged
	{
		private Single_Legal_EntityObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Single_Legal_Entity_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Single_Legal_EntityType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Single_Legal_Entity_Reference", IsNullable = false)]
		public Single_Legal_EntityObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 2)]
		public Single_Legal_Entity_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Single_Legal_Entity", IsNullable = false)]
		public Single_Legal_EntityType[] Response_Data
		{
			get
			{
