...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Payslip_Printing_OptionObjectType : INotifyPropertyChanged
	{
		private Payslip_Printing_OptionObjectIDType[] idField;
		...
		public Payslip_Printing_OptionObjectIDType[] ID
		{
			get
			{
				return this.idField;
