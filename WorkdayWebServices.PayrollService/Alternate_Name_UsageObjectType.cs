...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Alternate_Name_UsageObjectType : INotifyPropertyChanged
	{
		private Alternate_Name_UsageObjectIDType[] idField;
		...
		public Alternate_Name_UsageObjectIDType[] ID
		{
			get
			{
				return this.idField;
