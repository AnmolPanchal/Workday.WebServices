...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Related_Calculation__All_ObjectType : INotifyPropertyChanged
	{
		private Related_Calculation__All_ObjectIDType[] idField;
		...
		public Related_Calculation__All_ObjectIDType[] ID
		{
			get
			{
				return this.idField;
