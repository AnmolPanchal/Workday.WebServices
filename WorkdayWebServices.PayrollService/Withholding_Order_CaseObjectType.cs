...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Withholding_Order_CaseObjectType : INotifyPropertyChanged
	{
		private Withholding_Order_CaseObjectIDType[] idField;
		...
		public Withholding_Order_CaseObjectIDType[] ID
		{
			get
			{
				return this.idField;
