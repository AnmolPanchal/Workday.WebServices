...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Get_Payroll_Payee_Tax_Location_Mappings_ResponseType : INotifyPropertyChanged
	{
		private Payroll_Payee_Tax_Location_MappingObjectType[] request_ReferencesField;

		private Payroll_Payee_Tax_Location_Mapping_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Payroll_Payee_Tax_Location_Mapping_Get_DataType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Payroll_Payee_Tax_Location_Mapping_Reference", IsNullable = false)]
		public Payroll_Payee_Tax_Location_MappingObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Payroll_Payee_Tax_Location_Mapping_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Payroll_Payee_Tax_Location_Mapping", IsNullable = false)]
		public Payroll_Payee_Tax_Location_Mapping_Get_DataType[] Response_Data
		{
			get
			{
