...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Payroll_Constant_NumberObjectType : INotifyPropertyChanged
	{
		private Payroll_Constant_NumberObjectIDType[] idField;
		...
		public Payroll_Constant_NumberObjectIDType[] ID
		{
			get
			{
				return this.idField;
