...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Get_Payroll_History_Payments_ResponseType : INotifyPropertyChanged
	{
		...
		private Payroll_History_PaymentType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Payment_History_Request_Reference", IsNullable = false)]
		...
		[XmlArray(Order = 3), XmlArrayItem("Payroll_History_Payment", IsNullable = false)]
		public Payroll_History_PaymentType[] Response_Data
		{
			get
			{
