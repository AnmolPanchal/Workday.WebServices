...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Payroll_Reporting_TypeObjectType : INotifyPropertyChanged
	{
		private Payroll_Reporting_TypeObjectIDType[] idField;
		...
		public Payroll_Reporting_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
