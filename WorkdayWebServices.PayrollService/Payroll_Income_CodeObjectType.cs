...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Payroll_Income_CodeObjectType : INotifyPropertyChanged
	{
		private Payroll_Income_CodeObjectIDType[] idField;
		...
		public Payroll_Income_CodeObjectIDType[] ID
		{
			get
			{
				return this.idField;
