...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Withholding_Order_Fee_TypeObjectType : INotifyPropertyChanged
	{
		private Withholding_Order_Fee_TypeObjectIDType[] idField;
		...
		public Withholding_Order_Fee_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
