...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Payroll_Tax_Location_MappingObjectType : INotifyPropertyChanged
	{
		private Payroll_Tax_Location_MappingObjectIDType[] idField;
		...
		public Payroll_Tax_Location_MappingObjectIDType[] ID
		{
			get
			{
				return this.idField;
