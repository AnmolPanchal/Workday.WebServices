...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Payroll_Payee_Other_Election_for_State_and_LocalType : INotifyPropertyChanged
	{
		...
		private Payroll_Local_AuthorityObjectType payroll_Other_Authority_ReferenceField;
		...
		[XmlElement(Order = 2)]
		public Payroll_Local_AuthorityObjectType Payroll_Other_Authority_Reference
		{
			get
			{
