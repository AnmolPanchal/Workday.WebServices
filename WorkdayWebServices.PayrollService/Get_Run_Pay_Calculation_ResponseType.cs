...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Get_Run_Pay_Calculation_ResponseType : INotifyPropertyChanged
	{
		private Background_Process_RuntimeObjectType[] request_ReferencesField;

		private Run_Pay_Calculation_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Run_Pay_Calculation_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Run_Pay_CalculationType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Run_Pay_Calculation_Reference", IsNullable = false)]
		public Background_Process_RuntimeObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Run_Pay_Calculation_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Run_Pay_Calculation_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Run_Pay_Calculation", IsNullable = false)]
		public Run_Pay_CalculationType[] Response_Data
		{
			get
			{
