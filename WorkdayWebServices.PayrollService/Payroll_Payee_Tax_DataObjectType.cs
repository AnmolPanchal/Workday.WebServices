...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Payroll_Payee_Tax_DataObjectType : INotifyPropertyChanged
	{
		private Payroll_Payee_Tax_DataObjectIDType[] idField;
		...
		public Payroll_Payee_Tax_DataObjectIDType[] ID
		{
			get
			{
				return this.idField;
