...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Background_ProcessObjectType : INotifyPropertyChanged
	{
		private Background_ProcessObjectIDType[] idField;
		...
		public Background_ProcessObjectIDType[] ID
		{
			get
			{
				return this.idField;
