...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Background_Process_RuntimeObjectType : INotifyPropertyChanged
	{
		private Background_Process_RuntimeObjectIDType[] idField;
		...
		public Background_Process_RuntimeObjectIDType[] ID
		{
			get
			{
				return this.idField;
