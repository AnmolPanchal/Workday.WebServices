...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Single_Legal_EntityObjectType : INotifyPropertyChanged
	{
		private Single_Legal_EntityObjectIDType[] idField;
		...
		public Single_Legal_EntityObjectIDType[] ID
		{
			get
			{
				return this.idField;
