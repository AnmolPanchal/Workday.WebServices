...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Get_Tax_Document_Deliveries_ResponseType : INotifyPropertyChanged
	{
		private Unique_IdentifierObjectType[] request_ReferencesField;

		private Tax_Document_Delivery_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Tax_Document_Delivery_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Tax_Document_DeliveryType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Tax_Document_Delivery_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Tax_Document_Delivery_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Tax_Document_Delivery_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Tax_Document_Delivery", IsNullable = false)]
		public Tax_Document_DeliveryType[] Response_Data
		{
			get
			{
