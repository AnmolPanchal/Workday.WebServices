...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Payroll_Action_ReasonObjectType : INotifyPropertyChanged
	{
		private Payroll_Action_ReasonObjectIDType[] idField;
		...
		public Payroll_Action_ReasonObjectIDType[] ID
		{
			get
			{
				return this.idField;
