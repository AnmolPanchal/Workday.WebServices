...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Payroll_Limit_OverrideObjectType : INotifyPropertyChanged
	{
		private Payroll_Limit_OverrideObjectIDType[] idField;
		...
		public Payroll_Limit_OverrideObjectIDType[] ID
		{
			get
			{
				return this.idField;
