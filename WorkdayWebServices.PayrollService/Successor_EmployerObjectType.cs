...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Successor_EmployerObjectType : INotifyPropertyChanged
	{
		private Successor_EmployerObjectIDType[] idField;
		...
		public Successor_EmployerObjectIDType[] ID
		{
			get
			{
				return this.idField;
