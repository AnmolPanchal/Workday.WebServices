...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Payroll_Payee_Tax_Location_Mapping_Request_ReferencesType : INotifyPropertyChanged
	{
		...
		[XmlElement("Payroll_Payee_Tax_Location_Mapping_Reference", Order = 0)]
