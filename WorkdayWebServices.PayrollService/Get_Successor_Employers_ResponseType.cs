...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Get_Successor_Employers_ResponseType : INotifyPropertyChanged
	{
		private Successor_EmployerObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Successor_Employer_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Successor_EmployerType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Successor_Employer_Reference", IsNullable = false)]
		public Successor_EmployerObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 2)]
		public Successor_Employer_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Successor_Employer", IsNullable = false)]
		public Successor_EmployerType[] Response_Data
		{
			get
			{
