...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Time_Unit_for_AnnualizationObjectType : INotifyPropertyChanged
	{
		private Time_Unit_for_AnnualizationObjectIDType[] idField;
		...
		public Time_Unit_for_AnnualizationObjectIDType[] ID
		{
			get
			{
				return this.idField;
