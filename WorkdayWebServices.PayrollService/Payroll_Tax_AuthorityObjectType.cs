...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Payroll_Tax_AuthorityObjectType : INotifyPropertyChanged
	{
		private Payroll_Tax_AuthorityObjectIDType[] idField;
		...
		public Payroll_Tax_AuthorityObjectIDType[] ID
		{
			get
			{
				return this.idField;
