...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Payslip_Printing_OverrideObjectType : INotifyPropertyChanged
	{
		private Payslip_Printing_OverrideObjectIDType[] idField;
		...
		public Payslip_Printing_OverrideObjectIDType[] ID
		{
			get
			{
				return this.idField;
