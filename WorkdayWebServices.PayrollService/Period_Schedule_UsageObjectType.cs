...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Period_Schedule_UsageObjectType : INotifyPropertyChanged
	{
		private Period_Schedule_UsageObjectIDType[] idField;
		...
		public Period_Schedule_UsageObjectIDType[] ID
		{
			get
			{
				return this.idField;
