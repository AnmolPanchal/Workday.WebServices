...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Payroll_Constant_TextObjectType : INotifyPropertyChanged
	{
		private Payroll_Constant_TextObjectIDType[] idField;
		...
		public Payroll_Constant_TextObjectIDType[] ID
		{
			get
			{
				return this.idField;
