...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Get_Payroll_Payee_TD1s_ResponseType : INotifyPropertyChanged
	{
		private Payroll_Payee_T1ObjectType[] request_ReferencesField;

		private Payroll_Payee_TD1_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Payroll_Payee_TD1_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Payroll_Payee_TD1_DataType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("TD1_Election_Reference", IsNullable = false)]
		public Payroll_Payee_T1ObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Payroll_Payee_TD1_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Payroll_Payee_TD1_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Payroll_Payee_TD1", IsNullable = false), XmlArrayItem("Payroll_Payee_TD1_Data", IsNullable = false, NestingLevel = 1)]
		public Payroll_Payee_TD1_DataType[] Response_Data
		{
			get
			{
