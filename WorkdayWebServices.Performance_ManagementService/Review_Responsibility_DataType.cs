...
namespace WorkdayWebServices.Performance_ManagementService
{
	...
	[Serializable]
	public class Review_Responsibility_DataType : INotifyPropertyChanged
	{
		...
		private ResponsibilityObjectType responsibility_Base_ReferenceField;
		...
		[XmlElement(Order = 2)]
		public ResponsibilityObjectType Responsibility_Base_Reference
		{
			get
			{
				return this.responsibility_Base_ReferenceField;
			}
			set
			{
				this.responsibility_Base_ReferenceField = value;
				this.RaisePropertyChanged("Responsibility_Base_Reference");
			}
		}
