...
namespace WorkdayWebServices.Performance_ManagementService
{
	...
	[Serializable]
	public class Responsibilities_Review_Section_DataType : INotifyPropertyChanged
	{
		private Review_Responsibility_DataType[] review_Responsibility_DataField;
		...
		[XmlElement("Review_Responsibility_Data", Order = 0)]
		public Review_Responsibility_DataType[] Review_Responsibility_Data
		{
			get
			{
				return this.review_Responsibility_DataField;
			}
			set
			{
				this.review_Responsibility_DataField = value;
				this.RaisePropertyChanged("Review_Responsibility_Data");
			}
		}
