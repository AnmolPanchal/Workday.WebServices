...
namespace WorkdayWebServices.Performance_ManagementService
{
	...
	[Serializable]
	public class Evaluation_Feedback_StatusObjectType : INotifyPropertyChanged
	{
		private Evaluation_Feedback_StatusObjectIDType[] idField;
		...
		public Evaluation_Feedback_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
