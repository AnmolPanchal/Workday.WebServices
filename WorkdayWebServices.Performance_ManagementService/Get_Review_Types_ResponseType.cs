...
namespace WorkdayWebServices.Performance_ManagementService
{
	...
	[Serializable]
	public class Get_Review_Types_ResponseType : INotifyPropertyChanged
	{
		private Review_TypeObjectType[] request_ReferencesField;

		private Review_Type_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Review_TypeType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Review_Type_Reference", IsNullable = false)]
		public Review_TypeObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Review_Type_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Review_Type", IsNullable = false)]
		public Review_TypeType[] Response_Data
		{
			get
			{
