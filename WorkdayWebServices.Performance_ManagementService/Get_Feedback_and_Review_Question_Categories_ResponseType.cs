...
namespace WorkdayWebServices.Performance_ManagementService
{
	...
	[Serializable]
	public class Get_Feedback_and_Review_Question_Categories_ResponseType : INotifyPropertyChanged
	{
		private Question_CategoryObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Feedback_and_Review_Question_CategoryType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Feedback_and_Review_Question_Category_Reference", IsNullable = false)]
		public Question_CategoryObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Feedback_and_Review_Question_Category", IsNullable = false)]
		public Feedback_and_Review_Question_CategoryType[] Response_Data
		{
			get
			{
