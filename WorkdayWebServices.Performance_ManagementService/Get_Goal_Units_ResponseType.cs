...
namespace WorkdayWebServices.Performance_ManagementService
{
	...
	[Serializable]
	public class Get_Goal_Units_ResponseType : INotifyPropertyChanged
	{
		private Goal_Target_And_Actual_Track_By__Tenanted_ObjectType[] request_ReferencesField;

		private Goal_Unit_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Goal_UnitType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Goal_Unit_Reference", IsNullable = false)]
		public Goal_Target_And_Actual_Track_By__Tenanted_ObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Goal_Unit_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Goal_Unit", IsNullable = false)]
		public Goal_UnitType[] Response_Data
		{
			get
			{
