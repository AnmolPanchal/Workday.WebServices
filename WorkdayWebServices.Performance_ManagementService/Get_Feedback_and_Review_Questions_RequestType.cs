...
namespace WorkdayWebServices.Performance_ManagementService
{
	...
	[Serializable]
	public class Get_Feedback_and_Review_Questions_RequestType : INotifyPropertyChanged
	{
		private Feedback_and_Review_Question_Request_ReferencesType itemField;
		...
		public Feedback_and_Review_Question_Request_ReferencesType Item
		{
			get
			{
