...
namespace WorkdayWebServices.Performance_ManagementService
{
	...
	[Serializable]
	public class Get_Certifications_ResponseType : INotifyPropertyChanged
	{
		...
		[XmlArray(Order = 0), XmlArrayItem("Certification_Reference", IsNullable = false)]
		...
		[XmlArray(Order = 5), XmlArrayItem("Certification", IsNullable = false)]
