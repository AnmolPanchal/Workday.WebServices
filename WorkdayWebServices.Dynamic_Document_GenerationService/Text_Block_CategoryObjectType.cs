...
namespace WorkdayWebServices.Dynamic_Document_GenerationService
{
	...
	[Serializable]
	public class Text_Block_CategoryObjectType : INotifyPropertyChanged
	{
		private Text_Block_CategoryObjectIDType[] idField;
		...
		public Text_Block_CategoryObjectIDType[] ID
		{
			get
			{
				return this.idField;
