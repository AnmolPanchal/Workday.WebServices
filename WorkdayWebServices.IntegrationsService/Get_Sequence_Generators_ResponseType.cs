...
namespace WorkdayWebServices.IntegrationsService
{
	...
	[Serializable]
	public class Get_Sequence_Generators_ResponseType : INotifyPropertyChanged
	{
		...
		[XmlArray(Order = 0), XmlArrayItem("Sequence_Generator_Reference", IsNullable = false)]
		...
		[XmlArray(Order = 3), XmlArrayItem("Sequence_Generator", IsNullable = false)]
