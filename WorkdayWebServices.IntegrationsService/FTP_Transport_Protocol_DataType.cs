...
namespace WorkdayWebServices.IntegrationsService
{
	...
	[Serializable]
	public class FTP_Transport_Protocol_DataType : INotifyPropertyChanged
	{
		...
		public string FTP_Address
		{
			...
			set
			{
				...
				this.RaisePropertyChanged("FTP_Address");
			}
		}
		...
		public bool Use_Passive_ModeSpecified
		{
			...
			set
			{
				...
				this.RaisePropertyChanged("Use_Passive_ModeSpecified");
			}
		}
