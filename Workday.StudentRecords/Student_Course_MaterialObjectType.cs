...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Student_Course_MaterialObjectType : INotifyPropertyChanged
	{
		private Student_Course_MaterialObjectIDType[] idField;
		...
		public Student_Course_MaterialObjectIDType[] ID
		{
			get
			{
				return this.idField;
