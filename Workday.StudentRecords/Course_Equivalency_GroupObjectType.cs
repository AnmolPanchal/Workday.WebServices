...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Course_Equivalency_GroupObjectType : INotifyPropertyChanged
	{
		private Course_Equivalency_GroupObjectIDType[] idField;
		...
		public Course_Equivalency_GroupObjectIDType[] ID
		{
			get
			{
				return this.idField;
