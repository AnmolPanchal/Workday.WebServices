...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Get_Scheduled_Assessments_ResponseType : INotifyPropertyChanged
	{
		private Scheduled_AssessmentObjectType[] request_ReferencesField;

		private Scheduled_Assessment_Request_CriteriaType[] request_CriteriaField;

		private Response_FilterType[] response_FilterField;

		private Response_ResultsType[] response_ResultsField;

		private Scheduled_AssessmentType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Scheduled_Assessment_Reference", typeof(Scheduled_AssessmentObjectType), IsNullable = false)]
		public Scheduled_AssessmentObjectType[] Request_References
		{
			get
			{
		...
		public Scheduled_Assessment_Request_CriteriaType[] Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Scheduled_Assessment", typeof(Scheduled_AssessmentType), IsNullable = false)]
		public Scheduled_AssessmentType[] Response_Data
		{
			get
			{
