...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Get_Student_Courses_ResponseType : INotifyPropertyChanged
	{
		private Course_DefinitionObjectType[] request_ReferencesField;

		private Student_Course_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Student_CourseType[] response_DataField;
		...
		[XmlElement(Order = 1)]
		public Student_Course_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Student_Course", IsNullable = false)]
		public Student_CourseType[] Response_Data
		{
			get
			{
