...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Get_Course_Subjects_ResponseType : INotifyPropertyChanged
	{
		private Course_Subject_Request_ReferencesType request_ReferencesField;

		private Course_Subject_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Course_SubjectType[] response_DataField;
		...
		[XmlElement(Order = 0)]
		public Course_Subject_Request_ReferencesType Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Course_Subject_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Course_Subject", IsNullable = false)]
		public Course_SubjectType[] Response_Data
		{
			get
			{
