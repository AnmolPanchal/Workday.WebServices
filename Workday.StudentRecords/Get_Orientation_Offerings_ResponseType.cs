...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Get_Orientation_Offerings_ResponseType : INotifyPropertyChanged
	{
		private Orientation_OfferingObjectType[] request_ReferencesField;

		private Orientation_Offering_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Orientation_OfferingType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Orientation_Offering_Reference", IsNullable = false)]
		public Orientation_OfferingObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Orientation_Offering_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Orientation_Offering", IsNullable = false)]
		public Orientation_OfferingType[] Response_Data
		{
			get
			{
