...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Other_Credit_Type_Value_DataType : INotifyPropertyChanged
	{
		private Other_Credit_TypeObjectType[] other_Unit_Type_ReferenceField;
		...
		[XmlElement("Other_Unit_Type_Reference", Order = 0)]
		public Other_Credit_TypeObjectType[] Other_Unit_Type_Reference
		{
			get
			{
				return this.other_Unit_Type_ReferenceField;
			}
			set
			{
				this.other_Unit_Type_ReferenceField = value;
				this.RaisePropertyChanged("Other_Unit_Type_Reference");
			}
		}
