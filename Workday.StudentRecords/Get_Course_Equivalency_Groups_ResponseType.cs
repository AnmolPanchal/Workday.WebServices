...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Get_Course_Equivalency_Groups_ResponseType : INotifyPropertyChanged
	{
		private Course_Equivalency_GroupObjectType[] request_ReferencesField;

		private Course_Equivalency_Group_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Course_Equivalency_GroupType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Course_Equivalency_Group_Reference", IsNullable = false)]
		public Course_Equivalency_GroupObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Course_Equivalency_Group_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Course_Equivalency_Group", IsNullable = false)]
		public Course_Equivalency_GroupType[] Response_Data
		{
			get
			{
