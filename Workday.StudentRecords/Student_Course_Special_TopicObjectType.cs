...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Student_Course_Special_TopicObjectType : INotifyPropertyChanged
	{
		private Student_Course_Special_TopicObjectIDType[] idField;
		...
		public Student_Course_Special_TopicObjectIDType[] ID
		{
			get
			{
				return this.idField;
