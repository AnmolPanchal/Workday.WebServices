...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Get_Course_Sections_ResponseType : INotifyPropertyChanged
	{
		private Course_Section_DefinitionObjectType[] request_ReferencesField;

		private Course_Section_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Course_SectionType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Course_Section_Reference", IsNullable = false)]
		public Course_Section_DefinitionObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Course_Section_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Course_Section", IsNullable = false)]
		public Course_SectionType[] Response_Data
		{
			get
			{
