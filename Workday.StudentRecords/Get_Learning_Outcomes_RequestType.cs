...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Get_Learning_Outcomes_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Learning_Outcome_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Learning_Outcome_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
