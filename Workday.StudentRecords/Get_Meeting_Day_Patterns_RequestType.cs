...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Get_Meeting_Day_Patterns_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Meeting_Day_Pattern_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Meeting_Day_Pattern_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
