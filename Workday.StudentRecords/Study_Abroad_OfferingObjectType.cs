...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Study_Abroad_OfferingObjectType : INotifyPropertyChanged
	{
		private Study_Abroad_OfferingObjectIDType[] idField;
		...
		public Study_Abroad_OfferingObjectIDType[] ID
		{
			get
			{
				return this.idField;
