...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Student_Eligibility_RuleObjectType : INotifyPropertyChanged
	{
		private Student_Eligibility_RuleObjectIDType[] idField;
		...
		public Student_Eligibility_RuleObjectIDType[] ID
		{
			get
			{
				return this.idField;
