...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Put_Student_Course_Registered_Registration_RequestType : INotifyPropertyChanged
	{
		private Student_Course_RegistrationObjectType student_Course_Registration_ReferenceField;

		private Student_Course_Registered_Registration_DataType student_Course_Registration_DataField;
		...
		[XmlElement(Order = 1)]
		public Student_Course_Registered_Registration_DataType Student_Course_Registration_Data
		{
			get
			{
