...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Get_Course_Offering_Sets_ResponseType : INotifyPropertyChanged
	{
		private Course_Offering_SetObjectType[] request_ReferencesField;

		private Course_Offering_Set_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Course_Offering_SetType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Course_Offering_Set_Reference", IsNullable = false)]
		public Course_Offering_SetObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Course_Offering_Set_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Course_Offering_Set", IsNullable = false)]
		public Course_Offering_SetType[] Response_Data
		{
			get
			{
