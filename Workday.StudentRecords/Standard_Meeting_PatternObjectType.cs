...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Standard_Meeting_PatternObjectType : INotifyPropertyChanged
	{
		private Standard_Meeting_PatternObjectIDType[] idField;
		...
		public Standard_Meeting_PatternObjectIDType[] ID
		{
			get
			{
				return this.idField;
