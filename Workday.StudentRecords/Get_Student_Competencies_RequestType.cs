...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Get_Student_Competencies_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Student_Competency_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Student_Competency_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
