...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Student_Course_Tag_CategoryObjectType : INotifyPropertyChanged
	{
		private Student_Course_Tag_CategoryObjectIDType[] idField;
		...
		public Student_Course_Tag_CategoryObjectIDType[] ID
		{
			get
			{
				return this.idField;
