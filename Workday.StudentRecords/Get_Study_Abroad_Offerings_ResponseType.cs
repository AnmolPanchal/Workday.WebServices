...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Get_Study_Abroad_Offerings_ResponseType : INotifyPropertyChanged
	{
		private Study_Abroad_OfferingObjectType[] request_ReferencesField;

		private Study_Abroad_Offering_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Study_Abroad_OfferingType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Study_Abroad_Offering_Reference", IsNullable = false)]
		public Study_Abroad_OfferingObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Study_Abroad_Offering_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Study_Abroad_Offering", IsNullable = false)]
		public Study_Abroad_OfferingType[] Response_Data
		{
			get
			{
