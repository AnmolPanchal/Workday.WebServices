...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Get_Student_Activity_Registration_Records_ResponseType : INotifyPropertyChanged
	{
		private Student_Activity_Registration_RecordObjectType[] request_ReferencesField;

		private Student_Activity_Registration_Record_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Student_Activity_Registration_RecordType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Student_Activity_Registration_Record_Reference", IsNullable = false)]
		public Student_Activity_Registration_RecordObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Student_Activity_Registration_Record_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Student_Activity_Registration_Record", IsNullable = false)]
		public Student_Activity_Registration_RecordType[] Response_Data
		{
			get
			{
