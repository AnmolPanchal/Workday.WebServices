...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Get_Student_Accomplishments_ResponseType : INotifyPropertyChanged
	{
		private Student_AccomplishmentObjectType[] request_ReferencesField;

		private Student_Accomplishment_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Student_AccomplishmentType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Student_Accomplishment_Reference", IsNullable = false)]
		public Student_AccomplishmentObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Student_Accomplishment_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Student_Accomplishment", IsNullable = false)]
		public Student_AccomplishmentType[] Response_Data
		{
			get
			{
