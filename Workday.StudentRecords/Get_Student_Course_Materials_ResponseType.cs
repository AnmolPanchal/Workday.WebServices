...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Get_Student_Course_Materials_ResponseType : INotifyPropertyChanged
	{
		private Student_Course_MaterialObjectType[] request_ReferencesField;

		private Student_Course_Material_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Student_Course_MaterialType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Student_Course_Material_Reference", IsNullable = false)]
		public Student_Course_MaterialObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Student_Course_Material_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Student_Course_Material", IsNullable = false)]
		public Student_Course_MaterialType[] Response_Data
		{
			get
			{
