...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Practical_LearningObjectType : INotifyPropertyChanged
	{
		private Practical_LearningObjectIDType[] idField;
		...
		public Practical_LearningObjectIDType[] ID
		{
			get
			{
				return this.idField;
