...
namespace WorkdayWebServices.Workday_ExtensibilityService
{
	...
	[Serializable]
	public class Get_Custom_Lists_ResponseType : INotifyPropertyChanged
	{
		private Custom_ListObjectType[] request_ReferencesField;

		private Custom_List_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Custom_List_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Custom_ListType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Custom_List_Reference", IsNullable = false)]
		public Custom_ListObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Custom_List_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Custom_List_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Custom_List", IsNullable = false)]
		public Custom_ListType[] Response_Data
		{
			get
			{
