...
namespace WorkdayWebServices.Workday_ExtensibilityService
{
	...
	[Serializable]
	public class Get_Custom_Lists_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Custom_List_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Custom_List_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
