...
namespace WorkdayWebServices.Academic_AdvisingService
{
	...
	[Serializable]
	public class Academic_RequirementObjectType : INotifyPropertyChanged
	{
		private Academic_RequirementObjectIDType[] idField;
		...
		public Academic_RequirementObjectIDType[] ID
		{
			get
			{
				return this.idField;
