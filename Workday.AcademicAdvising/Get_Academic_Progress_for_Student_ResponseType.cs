...
namespace WorkdayWebServices.Academic_AdvisingService
{
	...
	[Serializable]
	public class Get_Academic_Progress_for_Student_ResponseType : INotifyPropertyChanged
	{
		private StudentObjectType[] request_ReferencesField;

		private Student_Academic_Progress_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Student_Academic_ProgressType[] response_DataField;
		...
		[XmlElement(Order = 1)]
		public Student_Academic_Progress_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Student_Academic_Progress", IsNullable = false)]
		public Student_Academic_ProgressType[] Response_Data
		{
			get
			{
