...
namespace WorkdayWebServices.Academic_AdvisingService
{
	...
	[Serializable]
	public class Requirement_Completion_StatusObjectType : INotifyPropertyChanged
	{
		private Requirement_Completion_StatusObjectIDType[] idField;
		...
		public Requirement_Completion_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
