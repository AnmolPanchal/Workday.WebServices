...
namespace WorkdayWebServices.Academic_AdvisingService
{
	...
	[Serializable]
	public class Program_of_Study_Type_CategoryObjectType : INotifyPropertyChanged
	{
		private Program_of_Study_Type_CategoryObjectIDType[] idField;
		...
		public Program_of_Study_Type_CategoryObjectIDType[] ID
		{
			get
			{
				return this.idField;
