...
namespace WorkdayWebServices.Campus_EngagementService
{
	...
	[Serializable]
	public class Engagement_External_ItemObjectType : INotifyPropertyChanged
	{
		private Engagement_External_ItemObjectIDType[] idField;
		...
		public Engagement_External_ItemObjectIDType[] ID
		{
			get
			{
				return this.idField;
