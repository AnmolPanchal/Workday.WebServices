...
namespace WorkdayWebServices.Campus_EngagementService
{
	...
	[Serializable]
	public class Engagement_Conversation_TopicObjectType : INotifyPropertyChanged
	{
		private Engagement_Conversation_TopicObjectIDType[] idField;
		...
		public Engagement_Conversation_TopicObjectIDType[] ID
		{
			get
			{
				return this.idField;
