...
namespace WorkdayWebServices.Campus_EngagementService
{
	...
	[Serializable]
	public class Has_Engagement_RecordObjectType : INotifyPropertyChanged
	{
		private Has_Engagement_RecordObjectIDType[] idField;
		...
		public Has_Engagement_RecordObjectIDType[] ID
		{
			get
			{
				return this.idField;
