...
namespace WorkdayWebServices.Payroll_InterfaceService
{
	...
	[Serializable]
	public class Related_Person_RelationshipObjectType : INotifyPropertyChanged
	{
		private Related_Person_RelationshipObjectIDType[] idField;
		...
		public Related_Person_RelationshipObjectIDType[] ID
		{
			get
			{
				return this.idField;
