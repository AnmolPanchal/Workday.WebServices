...
namespace WorkdayWebServices.Payroll_InterfaceService
{
	...
	[Serializable]
	public class Compensation_PackageObjectType : INotifyPropertyChanged
	{
		private Compensation_PackageObjectIDType[] idField;
		...
		public Compensation_PackageObjectIDType[] ID
		{
			get
			{
				return this.idField;
