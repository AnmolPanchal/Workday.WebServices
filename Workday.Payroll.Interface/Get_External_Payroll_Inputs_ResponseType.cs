...
namespace WorkdayWebServices.Payroll_InterfaceService
{
	...
	[Serializable]
	public class Get_External_Payroll_Inputs_ResponseType : INotifyPropertyChanged
	{
		private Payroll_InputObjectType[] request_ReferencesField;

		private External_Payroll_Input_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private External_Payroll_InputType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("External_Payroll_Input_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public External_Payroll_Input_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("External_Payroll_Input", IsNullable = false)]
		public External_Payroll_InputType[] Response_Data
		{
			get
			{
