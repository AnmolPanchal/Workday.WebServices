...
namespace WorkdayWebServices.Payroll_InterfaceService
{
	...
	[Serializable]
	public class International_Assignment_TypeObjectType : INotifyPropertyChanged
	{
		private International_Assignment_TypeObjectIDType[] idField;
		...
		public International_Assignment_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
