...
namespace WorkdayWebServices.Payroll_InterfaceService
{
	...
	[Serializable]
	public class Local_Termination_ReasonObjectType : INotifyPropertyChanged
	{
		private Local_Termination_ReasonObjectIDType[] idField;
		...
		public Local_Termination_ReasonObjectIDType[] ID
		{
			get
			{
				return this.idField;
