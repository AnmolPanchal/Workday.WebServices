...
namespace WorkdayWebServices.Payroll_InterfaceService
{
	...
	[Serializable]
	public class Get_Payees_ResponseType : INotifyPropertyChanged
	{
		...
		private Payees_Response_DataType response_DataField;
		...
		[XmlElement(Order = 5)]
		public Payees_Response_DataType Response_Data
		{
			get
			{
