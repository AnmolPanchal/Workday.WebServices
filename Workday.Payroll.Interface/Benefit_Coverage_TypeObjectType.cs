...
namespace WorkdayWebServices.Payroll_InterfaceService
{
	...
	[Serializable]
	public class Benefit_Coverage_TypeObjectType : INotifyPropertyChanged
	{
		private Benefit_Coverage_TypeObjectIDType[] idField;
		...
		public Benefit_Coverage_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
