...
namespace WorkdayWebServices.Payroll_InterfaceService
{
	...
	[Serializable]
	public class Period_Salary_PlanObjectType : INotifyPropertyChanged
	{
		private Period_Salary_PlanObjectIDType[] idField;
		...
		public Period_Salary_PlanObjectIDType[] ID
		{
			get
			{
				return this.idField;
