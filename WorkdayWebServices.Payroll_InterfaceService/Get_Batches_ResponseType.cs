...
namespace WorkdayWebServices.Payroll_InterfaceService
{
	...
	[Serializable]
	public class Get_Batches_ResponseType : INotifyPropertyChanged
	{
		private Application_BatchObjectType[] request_ReferencesField;

		private Batch_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Application_BatchType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Batch_Reference", IsNullable = false)]
		public Application_BatchObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Batch_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Batch", IsNullable = false)]
		public Application_BatchType[] Response_Data
		{
			get
			{
