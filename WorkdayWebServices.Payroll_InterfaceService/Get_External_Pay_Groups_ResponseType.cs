...
namespace WorkdayWebServices.Payroll_InterfaceService
{
	...
	[Serializable]
	public class Get_External_Pay_Groups_ResponseType : INotifyPropertyChanged
	{
		private Pay_GroupObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private External_Pay_GroupType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("External_Pay_Group_Reference", IsNullable = false)]
		public Pay_GroupObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("External_Pay_Group", IsNullable = false)]
		public External_Pay_GroupType[] Response_Data
		{
			get
			{
