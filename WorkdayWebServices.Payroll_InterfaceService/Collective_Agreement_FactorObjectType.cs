...
namespace WorkdayWebServices.Payroll_InterfaceService
{
	...
	[Serializable]
	public class Collective_Agreement_FactorObjectType : INotifyPropertyChanged
	{
		private Collective_Agreement_FactorObjectIDType[] idField;
		...
		public Collective_Agreement_FactorObjectIDType[] ID
		{
			get
			{
				return this.idField;
