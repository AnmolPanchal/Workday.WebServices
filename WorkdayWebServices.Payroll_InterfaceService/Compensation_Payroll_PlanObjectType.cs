...
namespace WorkdayWebServices.Payroll_InterfaceService
{
	...
	[Serializable]
	public class Compensation_Payroll_PlanObjectType : INotifyPropertyChanged
	{
		private Compensation_Payroll_PlanObjectIDType[] idField;
		...
		public Compensation_Payroll_PlanObjectIDType[] ID
		{
			get
			{
				return this.idField;
