...
namespace WorkdayWebServices.Payroll_InterfaceService
{
	...
	[Serializable]
	public class Benefit_Plan_Year_DefinitionObjectType : INotifyPropertyChanged
	{
		private Benefit_Plan_Year_DefinitionObjectIDType[] idField;
		...
		public Benefit_Plan_Year_DefinitionObjectIDType[] ID
		{
			get
			{
				return this.idField;
