...
namespace WorkdayWebServices.Payroll_InterfaceService
{
	...
	[Serializable]
	public class Difficulty_to_FillObjectType : INotifyPropertyChanged
	{
		private Difficulty_to_FillObjectIDType[] idField;
		...
		public Difficulty_to_FillObjectIDType[] ID
		{
			get
			{
				return this.idField;
