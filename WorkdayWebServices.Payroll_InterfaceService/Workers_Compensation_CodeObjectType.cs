...
namespace WorkdayWebServices.Payroll_InterfaceService
{
	...
	[Serializable]
	public class Workers_Compensation_CodeObjectType : INotifyPropertyChanged
	{
		private Workers_Compensation_CodeObjectIDType[] idField;
		...
		public Workers_Compensation_CodeObjectIDType[] ID
		{
			get
			{
				return this.idField;
