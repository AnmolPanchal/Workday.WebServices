...
namespace WorkdayWebServices.Payroll_InterfaceService
{
	...
	[Serializable]
	public class Disability_Status_ReferenceObjectType : INotifyPropertyChanged
	{
		private Disability_Status_ReferenceObjectIDType[] idField;
		...
		public Disability_Status_ReferenceObjectIDType[] ID
		{
			get
			{
				return this.idField;
