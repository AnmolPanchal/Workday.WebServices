...
namespace WorkdayWebServices.Payroll_InterfaceService
{
	...
	[Serializable]
	public class Application_Batch_UsageObjectType : INotifyPropertyChanged
	{
		private Application_Batch_UsageObjectIDType[] idField;
		...
		public Application_Batch_UsageObjectIDType[] ID
		{
			get
			{
				return this.idField;
