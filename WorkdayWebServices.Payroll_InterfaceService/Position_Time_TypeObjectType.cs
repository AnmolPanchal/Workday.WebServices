...
namespace WorkdayWebServices.Payroll_InterfaceService
{
	...
	[Serializable]
	public class Position_Time_TypeObjectType : INotifyPropertyChanged
	{
		private Position_Time_TypeObjectIDType[] idField;
		...
		public Position_Time_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
