...
namespace WorkdayWebServices.Payroll_InterfaceService
{
	...
	[Serializable]
	public class Employee_Probation_Period_TypeObjectType : INotifyPropertyChanged
	{
		private Employee_Probation_Period_TypeObjectIDType[] idField;
		...
		public Employee_Probation_Period_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
