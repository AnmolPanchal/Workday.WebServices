...
namespace WorkdayWebServices.Payroll_InterfaceService
{
	...
	[Serializable]
	public class Universal_IdentifierObjectType : INotifyPropertyChanged
	{
		private Universal_IdentifierObjectIDType[] idField;
		...
		public Universal_IdentifierObjectIDType[] ID
		{
			get
			{
				return this.idField;
