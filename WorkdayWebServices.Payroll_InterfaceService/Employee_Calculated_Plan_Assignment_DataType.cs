...
namespace WorkdayWebServices.Payroll_InterfaceService
{
	...
	[Serializable]
	public class Employee_Calculated_Plan_Assignment_DataType : INotifyPropertyChanged
	{
		private Calculated_PlanObjectType compensation_Plan_ReferenceField;
		...
		[XmlElement(Order = 0)]
		public Calculated_PlanObjectType Compensation_Plan_Reference
		{
			get
			{
