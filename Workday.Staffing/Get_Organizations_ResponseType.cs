...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Get_Organizations_ResponseType : INotifyPropertyChanged
	{
		private Organization_Request_ReferencesType request_ReferencesField;

		private Organization_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Organization_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Organization_WWSType[] response_DataField;
		...
		[XmlElement(Order = 0)]
		public Organization_Request_ReferencesType Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Organization_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Organization_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Organization", IsNullable = false)]
		public Organization_WWSType[] Response_Data
		{
			get
			{
