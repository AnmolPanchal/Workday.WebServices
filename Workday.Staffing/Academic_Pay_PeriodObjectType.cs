...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Academic_Pay_PeriodObjectType : INotifyPropertyChanged
	{
		private Academic_Pay_PeriodObjectIDType[] idField;
		...
		public Academic_Pay_PeriodObjectIDType[] ID
		{
			get
			{
				return this.idField;
