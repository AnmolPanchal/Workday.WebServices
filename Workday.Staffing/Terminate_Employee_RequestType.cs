...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Terminate_Employee_RequestType : INotifyPropertyChanged
	{
		private Business_Process_ParametersType business_Process_ParametersField;

		private Terminate_Employee_DataType terminate_Employee_DataField;
		...
		[XmlElement(Order = 1)]
		public Terminate_Employee_DataType Terminate_Employee_Data
		{
			get
			{
				return this.terminate_Employee_DataField;
			}
			set
			{
				this.terminate_Employee_DataField = value;
				this.RaisePropertyChanged("Terminate_Employee_Data");
			}
		}
