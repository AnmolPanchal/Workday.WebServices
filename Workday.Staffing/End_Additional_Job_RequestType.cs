...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class End_Additional_Job_RequestType : INotifyPropertyChanged
	{
		private Business_Process_ParametersType business_Process_ParametersField;

		private End_Additional_Job_DataType end_Additional_Job_DataField;
		...
		[XmlElement(Order = 1)]
		public End_Additional_Job_DataType End_Additional_Job_Data
		{
			get
			{
				return this.end_Additional_Job_DataField;
			}
			set
			{
				this.end_Additional_Job_DataField = value;
				this.RaisePropertyChanged("End_Additional_Job_Data");
			}
		}
