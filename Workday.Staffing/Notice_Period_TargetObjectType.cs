...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Notice_Period_TargetObjectType : INotifyPropertyChanged
	{
		private Notice_Period_TargetObjectIDType[] idField;
		...
		public Notice_Period_TargetObjectIDType[] ID
		{
			get
			{
				return this.idField;
