...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Job_Requisition_Questionnaire_DataType : INotifyPropertyChanged
	{
		...
		private QuestionnaireObjectType secondary_Questionnaire_for_External_Career_Site_ReferenceField;
		...
		[XmlElement(Order = 3)]
		public QuestionnaireObjectType Secondary_Questionnaire_for_External_Career_Site_Reference
		{
			get
			{
				return this.secondary_Questionnaire_for_External_Career_Site_ReferenceField;
			}
			set
			{
				this.secondary_Questionnaire_for_External_Career_Site_ReferenceField = value;
				this.RaisePropertyChanged("Secondary_Questionnaire_for_External_Career_Site_Reference");
			}
		}
