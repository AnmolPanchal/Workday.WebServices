...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Appointment_SpecialtyObjectType : INotifyPropertyChanged
	{
		private Appointment_SpecialtyObjectIDType[] idField;
		...
		public Appointment_SpecialtyObjectIDType[] ID
		{
			get
			{
				return this.idField;
