...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Allowance_Unit_PlanObjectType : INotifyPropertyChanged
	{
		private Allowance_Unit_PlanObjectIDType[] idField;
		...
		public Allowance_Unit_PlanObjectIDType[] ID
		{
			get
			{
				return this.idField;
