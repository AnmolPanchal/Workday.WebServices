...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class External_Payroll_EntityObjectType : INotifyPropertyChanged
	{
		private External_Payroll_EntityObjectIDType[] idField;
		...
		public External_Payroll_EntityObjectIDType[] ID
		{
			get
			{
				return this.idField;
