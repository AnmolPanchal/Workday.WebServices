...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Merit_Percent_PlanObjectType : INotifyPropertyChanged
	{
		private Merit_Percent_PlanObjectIDType[] idField;
		...
		public Merit_Percent_PlanObjectIDType[] ID
		{
			get
			{
				return this.idField;
