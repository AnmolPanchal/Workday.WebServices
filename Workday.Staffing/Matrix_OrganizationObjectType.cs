...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Matrix_OrganizationObjectType : INotifyPropertyChanged
	{
		private Matrix_OrganizationObjectIDType[] idField;
		...
		public Matrix_OrganizationObjectIDType[] ID
		{
			get
			{
				return this.idField;
