...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Get_Job_Classification_Groups_RequestType : INotifyPropertyChanged
	{
		private Job_Classification_Group_Request_ReferencesType itemField;
		...
		public Job_Classification_Group_Request_ReferencesType Item
		{
			get
			{
