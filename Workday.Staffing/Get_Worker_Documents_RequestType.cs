...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Get_Worker_Documents_RequestType : INotifyPropertyChanged
	{
		private Worker_Document_Request_ReferencesType itemField;
		...
		public Worker_Document_Request_ReferencesType Item
		{
			get
			{
