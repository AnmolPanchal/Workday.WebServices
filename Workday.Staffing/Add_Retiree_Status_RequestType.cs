...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Add_Retiree_Status_RequestType : INotifyPropertyChanged
	{
		private Business_Process_ParametersType business_Process_ParametersField;

		private Add_Retiree_Status_DataType add_Retiree_Status_DataField;
		...
		[XmlElement(Order = 1)]
		public Add_Retiree_Status_DataType Add_Retiree_Status_Data
		{
			get
			{
				return this.add_Retiree_Status_DataField;
			}
			set
			{
				this.add_Retiree_Status_DataField = value;
				this.RaisePropertyChanged("Add_Retiree_Status_Data");
			}
		}
