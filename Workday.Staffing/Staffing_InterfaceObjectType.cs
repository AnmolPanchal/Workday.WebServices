...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Staffing_InterfaceObjectType : INotifyPropertyChanged
	{
		private Staffing_InterfaceObjectIDType[] idField;
		...
		public Staffing_InterfaceObjectIDType[] ID
		{
			get
			{
				return this.idField;
