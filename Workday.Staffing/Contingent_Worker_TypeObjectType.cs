...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Contingent_Worker_TypeObjectType : INotifyPropertyChanged
	{
		private Contingent_Worker_TypeObjectIDType[] idField;
		...
		public Contingent_Worker_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
