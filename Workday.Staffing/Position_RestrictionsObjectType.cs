...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Position_RestrictionsObjectType : INotifyPropertyChanged
	{
		private Position_RestrictionsObjectIDType[] idField;
		...
		public Position_RestrictionsObjectIDType[] ID
		{
			get
			{
				return this.idField;
