...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Insurance_Coverage_TargetObjectType : INotifyPropertyChanged
	{
		private Insurance_Coverage_TargetObjectIDType[] idField;
		...
		public Insurance_Coverage_TargetObjectIDType[] ID
		{
			get
			{
				return this.idField;
