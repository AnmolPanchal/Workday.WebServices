...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Get_Notice_Periods_for_Notice_Period_Target_ResponseType : INotifyPropertyChanged
	{
		private Get_Notice_Periods_Request_ReferencesType request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Notice_Period_Data_for_Notice_Period_TargetType[] response_DataField;
		...
		[XmlElement(Order = 0)]
		public Get_Notice_Periods_Request_ReferencesType Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Notice_Period_Data_for_Notice_Period_Target", IsNullable = false)]
		public Notice_Period_Data_for_Notice_Period_TargetType[] Response_Data
		{
			get
			{
