...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Put_Worker_Document_RequestType : INotifyPropertyChanged
	{
		private Worker_DocumentObjectType worker_Document_ReferenceField;

		private Worker_Document_DataType worker_Document_DataField;
		...
		[XmlElement(Order = 1)]
		public Worker_Document_DataType Worker_Document_Data
		{
			get
			{
