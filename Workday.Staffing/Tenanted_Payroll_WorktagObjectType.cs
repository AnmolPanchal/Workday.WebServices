...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Tenanted_Payroll_WorktagObjectType : INotifyPropertyChanged
	{
		private Tenanted_Payroll_WorktagObjectIDType[] idField;
		...
		public Tenanted_Payroll_WorktagObjectIDType[] ID
		{
			get
			{
				return this.idField;
