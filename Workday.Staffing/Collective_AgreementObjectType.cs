...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Collective_AgreementObjectType : INotifyPropertyChanged
	{
		private Collective_AgreementObjectIDType[] idField;
		...
		public Collective_AgreementObjectIDType[] ID
		{
			get
			{
				return this.idField;
