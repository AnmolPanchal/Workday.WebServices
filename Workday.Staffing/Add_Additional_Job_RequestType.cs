...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Add_Additional_Job_RequestType : INotifyPropertyChanged
	{
		private Business_Process_ParametersType business_Process_ParametersField;

		private Add_Additional_Job_DataType add_Additional_Job_DataField;
		...
		[XmlElement(Order = 1)]
		public Add_Additional_Job_DataType Add_Additional_Job_Data
		{
			get
			{
				return this.add_Additional_Job_DataField;
			}
			set
			{
				this.add_Additional_Job_DataField = value;
				this.RaisePropertyChanged("Add_Additional_Job_Data");
			}
		}
