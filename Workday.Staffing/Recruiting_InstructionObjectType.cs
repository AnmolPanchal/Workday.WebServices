...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Recruiting_InstructionObjectType : INotifyPropertyChanged
	{
		private Recruiting_InstructionObjectIDType[] idField;
		...
		public Recruiting_InstructionObjectIDType[] ID
		{
			get
			{
				return this.idField;
