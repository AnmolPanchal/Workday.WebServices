...
namespace WorkdayWebServices.StaffingService
{
	...
	[Serializable]
	public class Job_Classification_GroupObjectType : INotifyPropertyChanged
	{
		private Job_Classification_GroupObjectIDType[] idField;
		...
		public Job_Classification_GroupObjectIDType[] ID
		{
			get
			{
				return this.idField;
