...
namespace WorkdayWebServices.Compensation_ReviewService
{
	...
	[Serializable]
	public class Compensation_Grade_ProfileObjectType : INotifyPropertyChanged
	{
		private Compensation_Grade_ProfileObjectIDType[] idField;
		...
		public Compensation_Grade_ProfileObjectIDType[] ID
		{
			get
			{
				return this.idField;
