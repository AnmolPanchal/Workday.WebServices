...
namespace WorkdayWebServices.Compensation_ReviewService
{
	...
	[Serializable]
	public class Get_Employee_Awards_ResponseType : INotifyPropertyChanged
	{
		private Employee_Award_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Employee_Award_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Employee_AwardType[] response_DataField;
		...
		[XmlElement(Order = 0)]
		public Employee_Award_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 2)]
		public Employee_Award_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Employee_Award", IsNullable = false)]
		public Employee_AwardType[] Response_Data
		{
			get
			{
