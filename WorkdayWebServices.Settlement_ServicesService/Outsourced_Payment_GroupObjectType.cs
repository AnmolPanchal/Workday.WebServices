...
namespace WorkdayWebServices.Settlement_ServicesService
{
	...
	[Serializable]
	public class Outsourced_Payment_GroupObjectType : INotifyPropertyChanged
	{
		private Outsourced_Payment_GroupObjectIDType[] idField;
		...
		public Outsourced_Payment_GroupObjectIDType[] ID
		{
			get
			{
				return this.idField;
