...
namespace WorkdayWebServices.Settlement_ServicesService
{
	...
	[Serializable]
	public class Settlement_Run_FilterObjectType : INotifyPropertyChanged
	{
		private Settlement_Run_FilterObjectIDType[] idField;
		...
		public Settlement_Run_FilterObjectIDType[] ID
		{
			get
			{
				return this.idField;
