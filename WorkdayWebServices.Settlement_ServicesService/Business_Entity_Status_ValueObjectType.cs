...
namespace WorkdayWebServices.Settlement_ServicesService
{
	...
	[Serializable]
	public class Business_Entity_Status_ValueObjectType : INotifyPropertyChanged
	{
		private Business_Entity_Status_ValueObjectIDType[] idField;
		...
		public Business_Entity_Status_ValueObjectIDType[] ID
		{
			get
			{
				return this.idField;
