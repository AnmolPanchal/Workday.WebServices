...
namespace WorkdayWebServices.Settlement_ServicesService
{
	...
	[Serializable]
	public class Payment_Acknowledgement_StatusObjectType : INotifyPropertyChanged
	{
		private Payment_Acknowledgement_StatusObjectIDType[] idField;
		...
		public Payment_Acknowledgement_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
