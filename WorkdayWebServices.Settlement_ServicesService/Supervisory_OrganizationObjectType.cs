...
namespace WorkdayWebServices.Settlement_ServicesService
{
	...
	[Serializable]
	public class Supervisory_OrganizationObjectType : INotifyPropertyChanged
	{
		private Supervisory_OrganizationObjectIDType[] idField;
		...
		public Supervisory_OrganizationObjectIDType[] ID
		{
			get
			{
				return this.idField;
