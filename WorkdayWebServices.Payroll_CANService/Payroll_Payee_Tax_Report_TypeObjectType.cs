...
namespace WorkdayWebServices.Payroll_CANService
{
	...
	[Serializable]
	public class Payroll_Payee_Tax_Report_TypeObjectType : INotifyPropertyChanged
	{
		private Payroll_Payee_Tax_Report_TypeObjectIDType[] idField;
		...
		public Payroll_Payee_Tax_Report_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
