...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Get_Course_Section_Relationship_ResponseType : INotifyPropertyChanged
	{
		private Student_Course_Section_ClusterObjectType[] request_ReferencesField;

		private Course_Section_Relationship_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Course_Section_RelationshipType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Course_Section_Relationship_Reference", IsNullable = false)]
		public Student_Course_Section_ClusterObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Course_Section_Relationship_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Course_Section_Relationship", IsNullable = false)]
		public Course_Section_RelationshipType[] Response_Data
		{
			get
			{
