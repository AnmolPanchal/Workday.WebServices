...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Student_Accomplishment_TypeObjectType : INotifyPropertyChanged
	{
		private Student_Accomplishment_TypeObjectIDType[] idField;
		...
		public Student_Accomplishment_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
