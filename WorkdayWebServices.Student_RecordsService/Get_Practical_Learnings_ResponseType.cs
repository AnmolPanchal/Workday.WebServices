...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Get_Practical_Learnings_ResponseType : INotifyPropertyChanged
	{
		private Practical_LearningObjectType[] request_ReferencesField;

		private Practical_Learning_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Practical_LearningType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Practical_Learning_Reference", IsNullable = false)]
		public Practical_LearningObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Practical_Learning_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Practical_Learning", IsNullable = false)]
		public Practical_LearningType[] Response_Data
		{
			get
			{
