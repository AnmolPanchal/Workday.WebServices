...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Get_Transcript_Orders_RequestType : INotifyPropertyChanged
	{
		private Transcript_Order_Request_ReferencesType itemField;
		...
		public Transcript_Order_Request_ReferencesType Item
		{
			get
			{
