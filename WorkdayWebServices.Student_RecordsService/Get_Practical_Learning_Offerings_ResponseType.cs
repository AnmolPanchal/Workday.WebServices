...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Get_Practical_Learning_Offerings_ResponseType : INotifyPropertyChanged
	{
		private Practical_Learning_OfferingObjectType[] request_ReferencesField;

		private Practical_Learning_Offering_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Practical_Learning_OfferingType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Practical_Learning_Offering_Reference", IsNullable = false)]
		public Practical_Learning_OfferingObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Practical_Learning_Offering_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Practical_Learning_Offering", IsNullable = false)]
		public Practical_Learning_OfferingType[] Response_Data
		{
			get
			{
