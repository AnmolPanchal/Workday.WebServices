...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Get_Student_Course_Tags_ResponseType : INotifyPropertyChanged
	{
		private Student_Course_TagObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Student_Course_TagType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Student_Course_Tag_Reference", IsNullable = false)]
		public Student_Course_TagObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Student_Course_Tag", IsNullable = false)]
		public Student_Course_TagType[] Response_Data
		{
			get
			{
