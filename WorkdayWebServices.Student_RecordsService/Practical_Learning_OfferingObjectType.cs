...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Practical_Learning_OfferingObjectType : INotifyPropertyChanged
	{
		private Practical_Learning_OfferingObjectIDType[] idField;
		...
		public Practical_Learning_OfferingObjectIDType[] ID
		{
			get
			{
				return this.idField;
