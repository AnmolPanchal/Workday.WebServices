...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Get_Learning_Outcomes_ResponseType : INotifyPropertyChanged
	{
		private Learning_Outcome_Request_ReferencesType request_ReferencesField;

		private Learning_Outcome_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Learning_OutcomeType[] response_DataField;
		...
		[XmlElement(Order = 0)]
		public Learning_Outcome_Request_ReferencesType Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Learning_Outcome_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Learning_Outcome", IsNullable = false)]
		public Learning_OutcomeType[] Response_Data
		{
			get
			{
