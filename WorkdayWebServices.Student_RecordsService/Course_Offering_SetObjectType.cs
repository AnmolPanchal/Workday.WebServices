...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Course_Offering_SetObjectType : INotifyPropertyChanged
	{
		private Course_Offering_SetObjectIDType[] idField;
		...
		public Course_Offering_SetObjectIDType[] ID
		{
			get
			{
				return this.idField;
