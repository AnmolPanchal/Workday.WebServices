...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Student_AccomplishmentObjectType : INotifyPropertyChanged
	{
		private Student_AccomplishmentObjectIDType[] idField;
		...
		public Student_AccomplishmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
