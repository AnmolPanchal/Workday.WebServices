...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Orientation_Offering_DataType : INotifyPropertyChanged
	{
		...
		private Orientation_Offering_Specific_DataType[] orientation_Offering_Specific_DataField;
		...
		[XmlElement("Orientation_Offering_Specific_Data", Order = 3)]
		public Orientation_Offering_Specific_DataType[] Orientation_Offering_Specific_Data
		{
			get
			{
				return this.orientation_Offering_Specific_DataField;
			}
			set
			{
				this.orientation_Offering_Specific_DataField = value;
				this.RaisePropertyChanged("Orientation_Offering_Specific_Data");
			}
		}

		[XmlElement("Has_Academic_Curricular_Division_Data", Order = 4)]
