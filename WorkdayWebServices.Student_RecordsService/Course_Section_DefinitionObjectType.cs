...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Course_Section_DefinitionObjectType : INotifyPropertyChanged
	{
		private Course_Section_DefinitionObjectIDType[] idField;
		...
		public Course_Section_DefinitionObjectIDType[] ID
		{
			get
			{
				return this.idField;
