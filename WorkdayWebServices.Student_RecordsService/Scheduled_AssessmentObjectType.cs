...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Scheduled_AssessmentObjectType : INotifyPropertyChanged
	{
		private Scheduled_AssessmentObjectIDType[] idField;
		...
		public Scheduled_AssessmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
