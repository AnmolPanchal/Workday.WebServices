...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Transcript_Delivery_TypeObjectType : INotifyPropertyChanged
	{
		private Transcript_Delivery_TypeObjectIDType[] idField;
		...
		public Transcript_Delivery_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
