...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Get_Meeting_Day_Patterns_ResponseType : INotifyPropertyChanged
	{
		private Meeting_Day_Pattern_Request_ReferencesType request_ReferencesField;

		private Day_of_the_WeekObjectType[] request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Meeting_Day_PatternType[] response_DataField;
		...
		[XmlElement(Order = 0)]
		public Meeting_Day_Pattern_Request_ReferencesType Request_References
		{
			get
			{
		...
		[XmlArray(Order = 1), XmlArrayItem("Meets_Days_of_the_Week_Reference", IsNullable = false)]
		public Day_of_the_WeekObjectType[] Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Meeting_Day_Pattern", IsNullable = false)]
		public Meeting_Day_PatternType[] Response_Data
		{
			get
			{
