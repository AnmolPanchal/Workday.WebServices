...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Activity_Offering_StatusObjectType : INotifyPropertyChanged
	{
		private Activity_Offering_StatusObjectIDType[] idField;
		...
		public Activity_Offering_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
