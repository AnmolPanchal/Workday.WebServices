...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Program_of_Study_TypeObjectType : INotifyPropertyChanged
	{
		private Program_of_Study_TypeObjectIDType[] idField;
		...
		public Program_of_Study_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
