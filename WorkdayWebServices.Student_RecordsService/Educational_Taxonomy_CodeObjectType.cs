...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Educational_Taxonomy_CodeObjectType : INotifyPropertyChanged
	{
		private Educational_Taxonomy_CodeObjectIDType[] idField;
		...
		public Educational_Taxonomy_CodeObjectIDType[] ID
		{
			get
			{
				return this.idField;
