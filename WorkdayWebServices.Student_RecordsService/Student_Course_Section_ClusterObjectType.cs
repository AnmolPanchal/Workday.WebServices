...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Student_Course_Section_ClusterObjectType : INotifyPropertyChanged
	{
		private Student_Course_Section_ClusterObjectIDType[] idField;
		...
		public Student_Course_Section_ClusterObjectIDType[] ID
		{
			get
			{
				return this.idField;
