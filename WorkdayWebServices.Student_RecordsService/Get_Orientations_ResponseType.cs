...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Get_Orientations_ResponseType : INotifyPropertyChanged
	{
		private OrientationObjectType[] request_ReferencesField;

		private Orientation_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private OrientationType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Orientation_Reference", IsNullable = false)]
		public OrientationObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Orientation_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Orientation", IsNullable = false)]
		public OrientationType[] Response_Data
		{
			get
			{
