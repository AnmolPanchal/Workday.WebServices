...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Get_Meeting_Patterns_ResponseType : INotifyPropertyChanged
	{
		private Meeting_Pattern_Request_ReferencesType request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Meeting_PatternType[] response_DataField;
		...
		[XmlElement(Order = 0)]
		public Meeting_Pattern_Request_ReferencesType Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Meeting_Pattern", IsNullable = false)]
		public Meeting_PatternType[] Response_Data
		{
			get
			{
