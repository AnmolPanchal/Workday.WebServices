...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Get_Student_Courses_without_Dependencies_ResponseType : INotifyPropertyChanged
	{
		private Course_DefinitionObjectType[] request_ReferencesField;

		private Student_Courses_without_Dependencies_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Student_Course_without_DependenciesType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Student_Course_Reference", IsNullable = false)]
		public Course_DefinitionObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Student_Courses_without_Dependencies_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Student_Course_without_Dependencies", IsNullable = false)]
		public Student_Course_without_DependenciesType[] Response_Data
		{
			get
			{
