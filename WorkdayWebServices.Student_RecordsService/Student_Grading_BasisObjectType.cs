...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Student_Grading_BasisObjectType : INotifyPropertyChanged
	{
		private Student_Grading_BasisObjectIDType[] idField;
		...
		public Student_Grading_BasisObjectIDType[] ID
		{
			get
			{
				return this.idField;
