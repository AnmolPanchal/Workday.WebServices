...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Get_Orientations_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Orientation_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Orientation_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
