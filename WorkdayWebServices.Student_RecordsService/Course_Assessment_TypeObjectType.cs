...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Course_Assessment_TypeObjectType : INotifyPropertyChanged
	{
		private Course_Assessment_TypeObjectIDType[] idField;
		...
		public Course_Assessment_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
