...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Orientation_OfferingObjectType : INotifyPropertyChanged
	{
		private Orientation_OfferingObjectIDType[] idField;
		...
		public Orientation_OfferingObjectIDType[] ID
		{
			get
			{
				return this.idField;
