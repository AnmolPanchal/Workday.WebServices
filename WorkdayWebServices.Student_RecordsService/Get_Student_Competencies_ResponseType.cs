...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Get_Student_Competencies_ResponseType : INotifyPropertyChanged
	{
		private Student_Competency_Manual_AssignmentObjectType[] request_ReferencesField;

		private Student_Competency_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Student_CompetencyType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Student_Competency_Reference", IsNullable = false)]
		public Student_Competency_Manual_AssignmentObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Student_Competency_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Student_Competency", IsNullable = false)]
		public Student_CompetencyType[] Response_Data
		{
			get
			{
