...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Meeting_Day_PatternObjectType : INotifyPropertyChanged
	{
		private Meeting_Day_PatternObjectIDType[] idField;
		...
		public Meeting_Day_PatternObjectIDType[] ID
		{
			get
			{
				return this.idField;
