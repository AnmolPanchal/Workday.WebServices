...
namespace WorkdayWebServices.Student_RecordsService
{
	...
	[Serializable]
	public class Course_Equivalency_UsageObjectType : INotifyPropertyChanged
	{
		private Course_Equivalency_UsageObjectIDType[] idField;
		...
		public Course_Equivalency_UsageObjectIDType[] ID
		{
			get
			{
				return this.idField;
