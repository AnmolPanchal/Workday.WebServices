...
namespace WorkdayWebServices.Workforce_PlanningService
{
	...
	[Serializable]
	public class Headcount_Plan_PeriodObjectType : INotifyPropertyChanged
	{
		private Headcount_Plan_PeriodObjectIDType[] idField;
		...
		public Headcount_Plan_PeriodObjectIDType[] ID
		{
			get
			{
				return this.idField;
