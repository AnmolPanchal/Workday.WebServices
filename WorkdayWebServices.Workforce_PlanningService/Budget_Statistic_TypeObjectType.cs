...
namespace WorkdayWebServices.Workforce_PlanningService
{
	...
	[Serializable]
	public class Budget_Statistic_TypeObjectType : INotifyPropertyChanged
	{
		private Budget_Statistic_TypeObjectIDType[] idField;
		...
		public Budget_Statistic_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
