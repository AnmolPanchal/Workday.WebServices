...
namespace WorkdayWebServices.Workforce_PlanningService
{
	...
	[Serializable]
	public class Worktag_and_Aggregation_TypeObjectType : INotifyPropertyChanged
	{
		private Worktag_and_Aggregation_TypeObjectIDType[] idField;
		...
		public Worktag_and_Aggregation_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
