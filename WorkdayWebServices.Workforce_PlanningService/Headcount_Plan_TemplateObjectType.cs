...
namespace WorkdayWebServices.Workforce_PlanningService
{
	...
	[Serializable]
	public class Headcount_Plan_TemplateObjectType : INotifyPropertyChanged
	{
		private Headcount_Plan_TemplateObjectIDType[] idField;
		...
		public Headcount_Plan_TemplateObjectIDType[] ID
		{
			get
			{
				return this.idField;
