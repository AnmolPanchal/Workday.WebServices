...
namespace WorkdayWebServices.Workforce_PlanningService
{
	...
	[Serializable]
	public class Headcount_Plan_StructureObjectType : INotifyPropertyChanged
	{
		private Headcount_Plan_StructureObjectIDType[] idField;
		...
		public Headcount_Plan_StructureObjectIDType[] ID
		{
			get
			{
				return this.idField;
