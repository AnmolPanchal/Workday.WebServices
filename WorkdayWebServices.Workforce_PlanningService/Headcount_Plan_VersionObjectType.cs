...
namespace WorkdayWebServices.Workforce_PlanningService
{
	...
	[Serializable]
	public class Headcount_Plan_VersionObjectType : INotifyPropertyChanged
	{
		private Headcount_Plan_VersionObjectIDType[] idField;
		...
		public Headcount_Plan_VersionObjectIDType[] ID
		{
			get
			{
				return this.idField;
