...
namespace WorkdayWebServices.Workforce_PlanningService
{
	...
	[Serializable]
	public class Headcount_Plan_LineObjectType : INotifyPropertyChanged
	{
		private Headcount_Plan_LineObjectIDType[] idField;
		...
		public Headcount_Plan_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
