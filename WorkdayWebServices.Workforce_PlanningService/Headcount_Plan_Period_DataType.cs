...
namespace WorkdayWebServices.Workforce_PlanningService
{
	...
	[Serializable]
	public class Headcount_Plan_Period_DataType : INotifyPropertyChanged
	{
		private Headcount_Plan_PeriodObjectType headcount_Plan_Period_ReferenceField;

		private Headcount_Plan_Entry_DataType headcount_Plan_Entry_DataField;
		...
		[XmlElement(Order = 1)]
		public Headcount_Plan_Entry_DataType Headcount_Plan_Entry_Data
		{
			get
			{
				return this.headcount_Plan_Entry_DataField;
			}
			set
			{
				this.headcount_Plan_Entry_DataField = value;
				this.RaisePropertyChanged("Headcount_Plan_Entry_Data");
			}
		}
