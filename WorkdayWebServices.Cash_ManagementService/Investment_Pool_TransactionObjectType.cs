...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Investment_Pool_TransactionObjectType : INotifyPropertyChanged
	{
		private Investment_Pool_TransactionObjectIDType[] idField;
		...
		public Investment_Pool_TransactionObjectIDType[] ID
		{
			get
			{
				return this.idField;
