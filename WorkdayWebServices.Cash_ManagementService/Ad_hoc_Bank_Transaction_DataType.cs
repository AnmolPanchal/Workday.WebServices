...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Ad_hoc_Bank_Transaction_DataType : INotifyPropertyChanged
	{
		...
		private Ad_hoc_Bank_Transaction_Line_DataType[] transaction_Line_Replacement_DataField;
		...
		[XmlChoiceIdentifier("ItemElementName"), XmlElement("Deposit", typeof(bool), Order = 12), XmlElement("Withdrawl", typeof(bool), Order = 12)]
		public bool Item
		{
			get
			{
		...
		[XmlElement("Transaction_Line_Replacement_Data", Order = 20)]
		public Ad_hoc_Bank_Transaction_Line_DataType[] Transaction_Line_Replacement_Data
		{
			get
			{
