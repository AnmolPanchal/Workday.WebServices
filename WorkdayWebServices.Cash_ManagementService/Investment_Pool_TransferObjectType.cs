...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Investment_Pool_TransferObjectType : INotifyPropertyChanged
	{
		private Investment_Pool_TransferObjectIDType[] idField;
		...
		public Investment_Pool_TransferObjectIDType[] ID
		{
			get
			{
				return this.idField;
