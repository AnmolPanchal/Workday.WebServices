...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Get_Ad_Hoc_Payees_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Ad_Hoc_Payee_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Ad_Hoc_Payee_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
