...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Get_Bank_Accounts_ResponseType : INotifyPropertyChanged
	{
		private Bank_AccountObjectType[] request_ReferencesField;

		private Bank_Account_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Bank_Account_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Bank_AccountType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Bank_Account_Reference", IsNullable = false)]
		public Bank_AccountObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Bank_Account_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Bank_Account_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Bank_Account", IsNullable = false)]
		public Bank_AccountType[] Response_Data
		{
			get
			{
