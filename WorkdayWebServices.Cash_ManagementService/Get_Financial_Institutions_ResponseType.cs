...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Get_Financial_Institutions_ResponseType : INotifyPropertyChanged
	{
		private Financial_InstitutionObjectType[] request_ReferencesField;

		private Financial_Institution_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Financial_Institution_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Financial_InstitutionType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Financial_Institution_Reference", IsNullable = false)]
		public Financial_InstitutionObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Financial_Institution_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Financial_Institution_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Financial_Institution", IsNullable = false)]
		public Financial_InstitutionType[] Response_Data
		{
			get
			{
