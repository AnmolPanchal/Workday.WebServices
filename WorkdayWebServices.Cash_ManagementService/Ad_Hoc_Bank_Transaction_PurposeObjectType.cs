...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Ad_Hoc_Bank_Transaction_PurposeObjectType : INotifyPropertyChanged
	{
		private Ad_Hoc_Bank_Transaction_PurposeObjectIDType[] idField;
		...
		public Ad_Hoc_Bank_Transaction_PurposeObjectIDType[] ID
		{
			get
			{
				return this.idField;
