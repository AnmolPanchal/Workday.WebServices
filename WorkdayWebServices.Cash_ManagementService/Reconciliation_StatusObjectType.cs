...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Reconciliation_StatusObjectType : INotifyPropertyChanged
	{
		private Reconciliation_StatusObjectIDType[] idField;
		...
		public Reconciliation_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
