...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Get_Donors_ResponseType : INotifyPropertyChanged
	{
		private DonorObjectType[] request_ReferencesField;

		private Donor_Request_CriteriaType[] request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private DonorType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Donor_Reference", IsNullable = false)]
		public DonorObjectType[] Request_References
		{
			get
			{
		...
		public Donor_Request_CriteriaType[] Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Donor", IsNullable = false)]
		public DonorType[] Response_Data
		{
			get
			{
