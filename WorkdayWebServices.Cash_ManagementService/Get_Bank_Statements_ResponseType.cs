...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Get_Bank_Statements_ResponseType : INotifyPropertyChanged
	{
		private Bank_StatementObjectType[] request_ReferencesField;

		private Bank_Statements_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Bank_Statements_Request_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Bank_StatementType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Bank_Statements_Request_Reference", IsNullable = false)]
		public Bank_StatementObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Bank_Statements_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Bank_Statements_Request_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Bank_Statement", IsNullable = false)]
		public Bank_StatementType[] Response_Data
		{
			get
			{
