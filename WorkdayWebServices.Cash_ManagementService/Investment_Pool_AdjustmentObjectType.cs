...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Investment_Pool_AdjustmentObjectType : INotifyPropertyChanged
	{
		private Investment_Pool_AdjustmentObjectIDType[] idField;
		...
		public Investment_Pool_AdjustmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
