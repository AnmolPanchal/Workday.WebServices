...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Get_Bank_Statement_Custom_Code_Sets_ResponseType : INotifyPropertyChanged
	{
		private Bank_Statement_Custom_Code_SetObjectType[] request_ReferencesField;

		private Bank_Statement_Custom_Code_Set_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Bank_Statement_Custom_Code_Set_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Bank_Statement_Custom_Code_SetType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Bank_Statement_Custom_Code_Set_Reference", IsNullable = false)]
		public Bank_Statement_Custom_Code_SetObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Bank_Statement_Custom_Code_Set_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Bank_Statement_Custom_Code_Set_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Bank_Statement_Custom_Code_Set", IsNullable = false)]
		public Bank_Statement_Custom_Code_SetType[] Response_Data
		{
			get
			{
