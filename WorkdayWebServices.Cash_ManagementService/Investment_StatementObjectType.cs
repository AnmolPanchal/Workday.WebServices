...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Investment_StatementObjectType : INotifyPropertyChanged
	{
		private Investment_StatementObjectIDType[] idField;
		...
		public Investment_StatementObjectIDType[] ID
		{
			get
			{
				return this.idField;
