...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Business_Document_Line_SplitObjectType : INotifyPropertyChanged
	{
		private Business_Document_Line_SplitObjectIDType[] idField;
		...
		public Business_Document_Line_SplitObjectIDType[] ID
		{
			get
			{
				return this.idField;
