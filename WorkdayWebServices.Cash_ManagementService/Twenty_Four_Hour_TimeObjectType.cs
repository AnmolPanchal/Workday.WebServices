...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Twenty_Four_Hour_TimeObjectType : INotifyPropertyChanged
	{
		private Twenty_Four_Hour_TimeObjectIDType[] idField;
		...
		public Twenty_Four_Hour_TimeObjectIDType[] ID
		{
			get
			{
				return this.idField;
