...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Get_Donor_Contributions_ResponseType : INotifyPropertyChanged
	{
		private Donor_ContributionObjectType[] request_ReferencesField;

		private Donor_Contribution_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Donor_ContributionType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Donor_Contribution_Reference", IsNullable = false)]
		public Donor_ContributionObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Donor_Contribution_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Donor_Contribution", IsNullable = false)]
		public Donor_ContributionType[] Response_Data
		{
			get
			{
