...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Ad_Hoc_Bank_TransactionObjectType : INotifyPropertyChanged
	{
		private Ad_Hoc_Bank_TransactionObjectIDType[] idField;
		...
		public Ad_Hoc_Bank_TransactionObjectIDType[] ID
		{
			get
			{
				return this.idField;
