...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Bank_Statement_Type_CategoryObjectType : INotifyPropertyChanged
	{
		private Bank_Statement_Type_CategoryObjectIDType[] idField;
		...
		public Bank_Statement_Type_CategoryObjectIDType[] ID
		{
			get
			{
				return this.idField;
