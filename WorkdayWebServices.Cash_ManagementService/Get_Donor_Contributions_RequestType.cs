...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Get_Donor_Contributions_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Donor_Contribution_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Donor_Contribution_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
