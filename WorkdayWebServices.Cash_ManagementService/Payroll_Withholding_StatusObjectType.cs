...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Payroll_Withholding_StatusObjectType : INotifyPropertyChanged
	{
		private Payroll_Withholding_StatusObjectIDType[] idField;
		...
		public Payroll_Withholding_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
