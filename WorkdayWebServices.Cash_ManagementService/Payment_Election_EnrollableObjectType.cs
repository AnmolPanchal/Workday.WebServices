...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Payment_Election_EnrollableObjectType : INotifyPropertyChanged
	{
		private Payment_Election_EnrollableObjectIDType[] idField;
		...
		public Payment_Election_EnrollableObjectIDType[] ID
		{
			get
			{
				return this.idField;
