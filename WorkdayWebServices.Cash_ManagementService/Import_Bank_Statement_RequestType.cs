...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Import_Bank_Statement_RequestType : INotifyPropertyChanged
	{
		private Bank_StatementObjectType bank_Statement_ReferenceField;

		private Bank_Statement__HV__DataType bank_Statement_DataField;
		...
		[XmlElement(Order = 1)]
		public Bank_Statement__HV__DataType Bank_Statement_Data
		{
			get
			{
