...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Supplier_Contract_LineObjectType : INotifyPropertyChanged
	{
		private Supplier_Contract_LineObjectIDType[] idField;
		...
		public Supplier_Contract_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
