...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Get_Intraday_Bank_Statements_ResponseType : INotifyPropertyChanged
	{
		private Intraday_Bank_StatementObjectType[] request_ReferencesField;

		private Intraday_Bank_Statement_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Intraday_Bank_Statement_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Intraday_Bank_StatementType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Intraday_Bank_Statement_Reference", IsNullable = false)]
		public Intraday_Bank_StatementObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Intraday_Bank_Statement_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Intraday_Bank_Statement_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Intraday_Bank_Statement", IsNullable = false)]
		public Intraday_Bank_StatementType[] Response_Data
		{
			get
			{
