...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Bank_Statement_Custom_Code_SetObjectType : INotifyPropertyChanged
	{
		private Bank_Statement_Custom_Code_SetObjectIDType[] idField;
		...
		public Bank_Statement_Custom_Code_SetObjectIDType[] ID
		{
			get
			{
				return this.idField;
