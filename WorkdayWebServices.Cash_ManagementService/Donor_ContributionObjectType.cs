...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Donor_ContributionObjectType : INotifyPropertyChanged
	{
		private Donor_ContributionObjectIDType[] idField;
		...
		public Donor_ContributionObjectIDType[] ID
		{
			get
			{
				return this.idField;
