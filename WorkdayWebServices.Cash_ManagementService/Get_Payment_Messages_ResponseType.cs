...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Get_Payment_Messages_ResponseType : INotifyPropertyChanged
	{
		private Payment_MessageObjectType[] request_ReferencesField;

		private Payment_Message_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Payment_Message_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Payment_Message_WWSType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Payment_Message_Reference", IsNullable = false)]
		public Payment_MessageObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Payment_Message_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Payment_Message_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Payment_Message", IsNullable = false)]
		public Payment_Message_WWSType[] Response_Data
		{
			get
			{
