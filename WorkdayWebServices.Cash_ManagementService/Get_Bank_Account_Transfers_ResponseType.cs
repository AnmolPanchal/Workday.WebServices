...
namespace WorkdayWebServices.Cash_ManagementService
{
	...
	[Serializable]
	public class Get_Bank_Account_Transfers_ResponseType : INotifyPropertyChanged
	{
		private Bank_Account_TransferObjectType[] request_ReferencesField;

		private Bank_Account_Transfer_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Bank_Account_Transfer_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Bank_Account_TransferType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Bank_Account_Transfer_Reference", IsNullable = false)]
		public Bank_Account_TransferObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Bank_Account_Transfer_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Bank_Account_Transfer_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Bank_Account_Transfer", IsNullable = false)]
		public Bank_Account_TransferType[] Response_Data
		{
			get
			{
