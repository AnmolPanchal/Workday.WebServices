...
namespace WorkdayWebServices.Payroll_GBRService
{
	...
	[Serializable]
	public class Get_Payroll_IDs_ResponseType : INotifyPropertyChanged
	{
		private Payroll_IDObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Payroll_ID_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Payroll_IDType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Payroll_ID_Reference", IsNullable = false)]
		public Payroll_IDObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 2)]
		public Payroll_ID_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Payroll_ID", IsNullable = false)]
		public Payroll_IDType[] Response_Data
		{
			get
			{
