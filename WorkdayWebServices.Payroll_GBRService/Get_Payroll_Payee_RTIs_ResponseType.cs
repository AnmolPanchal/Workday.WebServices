...
namespace WorkdayWebServices.Payroll_GBRService
{
	...
	[Serializable]
	public class Get_Payroll_Payee_RTIs_ResponseType : INotifyPropertyChanged
	{
		private Unique_IdentifierObjectType[] request_ReferencesField;

		private Payroll_Payee_RTI_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Payroll_Payee_RTI_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Payroll_Payee_RTI_HistoryType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Payroll_Payee_RTI_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Payroll_Payee_RTI_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Payroll_Payee_RTI_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Payroll_Payee_RTI", IsNullable = false)]
		public Payroll_Payee_RTI_HistoryType[] Response_Data
		{
			get
			{
