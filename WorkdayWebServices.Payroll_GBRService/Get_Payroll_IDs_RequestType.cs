...
namespace WorkdayWebServices.Payroll_GBRService
{
	...
	[Serializable]
	public class Get_Payroll_IDs_RequestType : INotifyPropertyChanged
	{
		private Payroll_ID_Request_ReferencesType itemField;
		...
		public Payroll_ID_Request_ReferencesType Item
		{
			get
			{
