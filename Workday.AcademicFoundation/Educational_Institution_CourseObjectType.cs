...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Educational_Institution_CourseObjectType : INotifyPropertyChanged
	{
		private Educational_Institution_CourseObjectIDType[] idField;
		...
		public Educational_Institution_CourseObjectIDType[] ID
		{
			get
			{
				return this.idField;
