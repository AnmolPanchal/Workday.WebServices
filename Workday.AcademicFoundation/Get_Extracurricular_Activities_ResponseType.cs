...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Get_Extracurricular_Activities_ResponseType : INotifyPropertyChanged
	{
		private Extracurricular_ActivityObjectType[] request_ReferencesField;

		private Extracurricular_Activity_CategoryObjectType[] request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Extracurricular_ActivityType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Extracurricular_Activity_Reference", IsNullable = false)]
		public Extracurricular_ActivityObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 1), XmlArrayItem("Extracurricular_Activity_Category_Reference", IsNullable = false)]
		public Extracurricular_Activity_CategoryObjectType[] Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Extracurricular_Activity", IsNullable = false)]
		public Extracurricular_ActivityType[] Response_Data
		{
			get
			{
