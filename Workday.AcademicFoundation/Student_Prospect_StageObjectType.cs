...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Student_Prospect_StageObjectType : INotifyPropertyChanged
	{
		private Student_Prospect_StageObjectIDType[] idField;
		...
		public Student_Prospect_StageObjectIDType[] ID
		{
			get
			{
				return this.idField;
