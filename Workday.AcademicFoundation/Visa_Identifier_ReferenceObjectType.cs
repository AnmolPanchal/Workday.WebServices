...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Visa_Identifier_ReferenceObjectType : INotifyPropertyChanged
	{
		private Visa_Identifier_ReferenceObjectIDType[] idField;
		...
		public Visa_Identifier_ReferenceObjectIDType[] ID
		{
			get
			{
				return this.idField;
