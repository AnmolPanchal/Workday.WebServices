...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Education_Test__All_ObjectType : INotifyPropertyChanged
	{
		private Education_Test__All_ObjectIDType[] idField;
		...
		public Education_Test__All_ObjectIDType[] ID
		{
			get
			{
				return this.idField;
