...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Student_Graduation_or_EquivalencyObjectType : INotifyPropertyChanged
	{
		private Student_Graduation_or_EquivalencyObjectIDType[] idField;
		...
		public Student_Graduation_or_EquivalencyObjectIDType[] ID
		{
			get
			{
				return this.idField;
