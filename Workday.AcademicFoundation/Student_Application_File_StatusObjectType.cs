...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Student_Application_File_StatusObjectType : INotifyPropertyChanged
	{
		private Student_Application_File_StatusObjectIDType[] idField;
		...
		public Student_Application_File_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
