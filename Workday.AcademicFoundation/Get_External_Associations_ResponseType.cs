...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Get_External_Associations_ResponseType : INotifyPropertyChanged
	{
		private External_AssociationObjectType[] request_ReferencesField;

		private External_Association_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private External_AssociationType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("External_Association_Reference", IsNullable = false)]
		public External_AssociationObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public External_Association_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("External_Association", IsNullable = false)]
		public External_AssociationType[] Response_Data
		{
			get
			{
