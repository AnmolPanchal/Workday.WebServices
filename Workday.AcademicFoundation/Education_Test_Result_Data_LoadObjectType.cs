...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Education_Test_Result_Data_LoadObjectType : INotifyPropertyChanged
	{
		private Education_Test_Result_Data_LoadObjectIDType[] idField;
		...
		public Education_Test_Result_Data_LoadObjectIDType[] ID
		{
			get
			{
				return this.idField;
