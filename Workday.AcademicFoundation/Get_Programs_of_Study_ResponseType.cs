...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Get_Programs_of_Study_ResponseType : INotifyPropertyChanged
	{
		private Program_of_StudyObjectType[] request_ReferencesField;

		private Program_of_Study_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Program_of_StudyType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Program_of_Study_Reference", IsNullable = false)]
		public Program_of_StudyObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Program_of_Study_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Program_of_Study", IsNullable = false)]
		public Program_of_StudyType[] Response_Data
		{
			get
			{
