...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Student_Application_SourceObjectType : INotifyPropertyChanged
	{
		private Student_Application_SourceObjectIDType[] idField;
		...
		public Student_Application_SourceObjectIDType[] ID
		{
			get
			{
				return this.idField;
