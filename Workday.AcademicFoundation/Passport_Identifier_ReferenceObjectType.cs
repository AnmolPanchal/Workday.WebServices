...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Passport_Identifier_ReferenceObjectType : INotifyPropertyChanged
	{
		private Passport_Identifier_ReferenceObjectIDType[] idField;
		...
		public Passport_Identifier_ReferenceObjectIDType[] ID
		{
			get
			{
				return this.idField;
