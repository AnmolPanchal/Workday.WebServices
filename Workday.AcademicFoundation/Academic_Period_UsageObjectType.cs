...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Academic_Period_UsageObjectType : INotifyPropertyChanged
	{
		private Academic_Period_UsageObjectIDType[] idField;
		...
		public Academic_Period_UsageObjectIDType[] ID
		{
			get
			{
				return this.idField;
