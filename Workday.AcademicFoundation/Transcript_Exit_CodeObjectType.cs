...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Transcript_Exit_CodeObjectType : INotifyPropertyChanged
	{
		private Transcript_Exit_CodeObjectIDType[] idField;
		...
		public Transcript_Exit_CodeObjectIDType[] ID
		{
			get
			{
				return this.idField;
