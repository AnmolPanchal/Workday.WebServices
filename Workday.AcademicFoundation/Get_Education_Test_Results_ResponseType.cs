...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Get_Education_Test_Results_ResponseType : INotifyPropertyChanged
	{
		private Education_Test_ResultObjectType[] request_ReferencesField;

		private Education_Test_Result_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Education_Test_ResultType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Education_Test_Result_Reference", IsNullable = false)]
		public Education_Test_ResultObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Education_Test_Result_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Education_Test_Result", IsNullable = false)]
		public Education_Test_ResultType[] Response_Data
		{
			get
			{
