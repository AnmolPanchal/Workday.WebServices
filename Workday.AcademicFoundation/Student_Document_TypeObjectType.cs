...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Student_Document_TypeObjectType : INotifyPropertyChanged
	{
		private Student_Document_TypeObjectIDType[] idField;
		...
		public Student_Document_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
