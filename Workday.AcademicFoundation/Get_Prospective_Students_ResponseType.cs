...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Get_Prospective_Students_ResponseType : INotifyPropertyChanged
	{
		private StudentObjectType[] request_ReferencesField;

		private Prospective_Student_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Prospective_Student_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Prospective_StudentType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Student_Reference", IsNullable = false)]
		public StudentObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Prospective_Student_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Prospective_Student_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Student", IsNullable = false)]
		public Prospective_StudentType[] Response_Data
		{
			get
			{
