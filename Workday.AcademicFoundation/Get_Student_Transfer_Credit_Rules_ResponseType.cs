...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Get_Student_Transfer_Credit_Rules_ResponseType : INotifyPropertyChanged
	{
		private Student_Articulation_RuleObjectType[] request_ReferencesField;

		private Student_Articulation_Rule_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Student_Articulation_RuleType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Student_Articulation_Rule_Reference", IsNullable = false)]
		public Student_Articulation_RuleObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Student_Articulation_Rule_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Student_Articulation_Rule", IsNullable = false)]
		public Student_Articulation_RuleType[] Response_Data
		{
			get
			{
