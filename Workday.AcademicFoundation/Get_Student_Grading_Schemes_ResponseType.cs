...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Get_Student_Grading_Schemes_ResponseType : INotifyPropertyChanged
	{
		private Student_Grading_SchemeObjectType[] request_ReferencesField;

		private Student_Grading_Scheme_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Student_Grading_SchemeType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Student_Grading_Scheme_Reference", IsNullable = false)]
		public Student_Grading_SchemeObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Student_Grading_Scheme_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Student_Grading_Scheme", IsNullable = false)]
		public Student_Grading_SchemeType[] Response_Data
		{
			get
			{
