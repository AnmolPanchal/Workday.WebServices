...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Get_Student_Friends_and_Family_ResponseType : INotifyPropertyChanged
	{
		private Student_ProxyObjectType[] request_ReferencesField;

		private Student_Proxy_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Student_ProxyType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Student_Proxy_Reference", IsNullable = false)]
		public Student_ProxyObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Student_Proxy_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Student_Proxy", IsNullable = false)]
		public Student_ProxyType[] Response_Data
		{
			get
			{
