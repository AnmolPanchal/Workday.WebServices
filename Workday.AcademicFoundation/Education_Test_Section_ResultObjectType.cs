...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Education_Test_Section_ResultObjectType : INotifyPropertyChanged
	{
		private Education_Test_Section_ResultObjectIDType[] idField;
		...
		public Education_Test_Section_ResultObjectIDType[] ID
		{
			get
			{
				return this.idField;
