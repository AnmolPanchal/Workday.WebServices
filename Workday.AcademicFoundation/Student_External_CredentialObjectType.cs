...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Student_External_CredentialObjectType : INotifyPropertyChanged
	{
		private Student_External_CredentialObjectIDType[] idField;
		...
		public Student_External_CredentialObjectIDType[] ID
		{
			get
			{
				return this.idField;
