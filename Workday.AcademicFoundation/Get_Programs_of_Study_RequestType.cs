...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Get_Programs_of_Study_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Program_of_Study_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Program_of_Study_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
