...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Get_Student_Tags_ResponseType : INotifyPropertyChanged
	{
		private Student_TagObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Student_TagType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Student_Tag_Reference", IsNullable = false)]
		public Student_TagObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Student_Tag", IsNullable = false)]
		public Student_TagType[] Response_Data
		{
			get
			{
