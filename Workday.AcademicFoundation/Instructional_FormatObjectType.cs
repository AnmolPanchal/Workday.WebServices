...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Instructional_FormatObjectType : INotifyPropertyChanged
	{
		private Instructional_FormatObjectIDType[] idField;
		...
		public Instructional_FormatObjectIDType[] ID
		{
			get
			{
				return this.idField;
