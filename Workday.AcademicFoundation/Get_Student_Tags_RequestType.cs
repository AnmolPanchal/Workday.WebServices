...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Get_Student_Tags_RequestType : INotifyPropertyChanged
	{
		private Student_Tag_Request_ReferencesType itemField;
		...
		public Student_Tag_Request_ReferencesType Item
		{
			get
			{
