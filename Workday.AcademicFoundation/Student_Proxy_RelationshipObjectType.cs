...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Student_Proxy_RelationshipObjectType : INotifyPropertyChanged
	{
		private Student_Proxy_RelationshipObjectIDType[] idField;
		...
		public Student_Proxy_RelationshipObjectIDType[] ID
		{
			get
			{
				return this.idField;
