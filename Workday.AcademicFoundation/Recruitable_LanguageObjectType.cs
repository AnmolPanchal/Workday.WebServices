...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Recruitable_LanguageObjectType : INotifyPropertyChanged
	{
		private Recruitable_LanguageObjectIDType[] idField;
		...
		public Recruitable_LanguageObjectIDType[] ID
		{
			get
			{
				return this.idField;
