...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Get_Maintained_Academic_Periods_RequestType : INotifyPropertyChanged
	{
		private Academic_Period_Request_ReferencesType itemField;
		...
		public Academic_Period_Request_ReferencesType Item
		{
			get
			{
