...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Educational_InterestObjectType : INotifyPropertyChanged
	{
		private Educational_InterestObjectIDType[] idField;
		...
		public Educational_InterestObjectIDType[] ID
		{
			get
			{
				return this.idField;
