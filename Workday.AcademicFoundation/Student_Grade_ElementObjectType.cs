...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Student_Grade_ElementObjectType : INotifyPropertyChanged
	{
		private Student_Grade_ElementObjectIDType[] idField;
		...
		public Student_Grade_ElementObjectIDType[] ID
		{
			get
			{
				return this.idField;
