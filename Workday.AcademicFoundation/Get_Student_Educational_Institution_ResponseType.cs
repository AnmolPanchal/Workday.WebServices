...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Get_Student_Educational_Institution_ResponseType : INotifyPropertyChanged
	{
		private Educational_InstitutionObjectType[] request_ReferencesField;

		private Response_FilterType[] response_FilterField;

		private Response_ResultsType[] response_ResultsField;

		private Student_Educational_InstitutionType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Educational_Institution_Reference", typeof(Educational_InstitutionObjectType), IsNullable = false)]
		public Educational_InstitutionObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Student_Educational_Institution", typeof(Student_Educational_InstitutionType), IsNullable = false)]
		public Student_Educational_InstitutionType[] Response_Data
		{
			get
			{
