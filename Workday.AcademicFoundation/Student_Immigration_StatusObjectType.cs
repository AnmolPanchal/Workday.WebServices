...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Student_Immigration_StatusObjectType : INotifyPropertyChanged
	{
		private Student_Immigration_StatusObjectIDType[] idField;
		...
		public Student_Immigration_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
