...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Academic_Period_Weight_TypeObjectType : INotifyPropertyChanged
	{
		private Academic_Period_Weight_TypeObjectIDType[] idField;
		...
		public Academic_Period_Weight_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
