...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Get_Student_Tag_Categories_ResponseType : INotifyPropertyChanged
	{
		private Student_Tag_CategoryObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Student_Tag_CategoryType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Student_Tag_Category_Reference", IsNullable = false)]
		public Student_Tag_CategoryObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Student_Tag_Category", IsNullable = false)]
		public Student_Tag_CategoryType[] Response_Data
		{
			get
			{
