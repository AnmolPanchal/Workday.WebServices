...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Educational_CredentialObjectType : INotifyPropertyChanged
	{
		private Educational_CredentialObjectIDType[] idField;
		...
		public Educational_CredentialObjectIDType[] ID
		{
			get
			{
				return this.idField;
