...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Student_Application_Review_StatusObjectType : INotifyPropertyChanged
	{
		private Student_Application_Review_StatusObjectIDType[] idField;
		...
		public Student_Application_Review_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
