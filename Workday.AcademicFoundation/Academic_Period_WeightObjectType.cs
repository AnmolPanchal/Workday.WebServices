...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Academic_Period_WeightObjectType : INotifyPropertyChanged
	{
		private Academic_Period_WeightObjectIDType[] idField;
		...
		public Academic_Period_WeightObjectIDType[] ID
		{
			get
			{
				return this.idField;
