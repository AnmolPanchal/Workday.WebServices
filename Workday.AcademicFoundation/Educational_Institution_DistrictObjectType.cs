...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Educational_Institution_DistrictObjectType : INotifyPropertyChanged
	{
		private Educational_Institution_DistrictObjectIDType[] idField;
		...
		public Educational_Institution_DistrictObjectIDType[] ID
		{
			get
			{
				return this.idField;
