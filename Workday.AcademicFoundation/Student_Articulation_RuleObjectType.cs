...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Student_Articulation_RuleObjectType : INotifyPropertyChanged
	{
		private Student_Articulation_RuleObjectIDType[] idField;
		...
		public Student_Articulation_RuleObjectIDType[] ID
		{
			get
			{
				return this.idField;
