...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Educational_Institution_CategoryObjectType : INotifyPropertyChanged
	{
		private Educational_Institution_CategoryObjectIDType[] idField;
		...
		public Educational_Institution_CategoryObjectIDType[] ID
		{
			get
			{
				return this.idField;
