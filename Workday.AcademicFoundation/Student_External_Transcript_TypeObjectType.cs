...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Student_External_Transcript_TypeObjectType : INotifyPropertyChanged
	{
		private Student_External_Transcript_TypeObjectIDType[] idField;
		...
		public Student_External_Transcript_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
