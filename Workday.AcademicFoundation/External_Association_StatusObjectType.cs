...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class External_Association_StatusObjectType : INotifyPropertyChanged
	{
		private External_Association_StatusObjectIDType[] idField;
		...
		public External_Association_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
