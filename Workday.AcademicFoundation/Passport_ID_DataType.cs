...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Passport_ID_DataType : INotifyPropertyChanged
	{
		private string idField;

		private Passport_ID_Type__All_ObjectType iD_Type_ReferenceField;
		...
		[XmlElement(Order = 1)]
		public Passport_ID_Type__All_ObjectType ID_Type_Reference
		{
			get
			{
