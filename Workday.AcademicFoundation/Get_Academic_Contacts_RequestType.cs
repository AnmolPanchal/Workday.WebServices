...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Get_Academic_Contacts_RequestType : INotifyPropertyChanged
	{
		private Academic_Contact_Request_ReferencesType itemField;
		...
		public Academic_Contact_Request_ReferencesType Item
		{
			get
			{
