...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Get_Student_Tag_Categories_RequestType : INotifyPropertyChanged
	{
		private Student_Tag_Category_Request_ReferencesType itemField;
		...
		public Student_Tag_Category_Request_ReferencesType Item
		{
			get
			{
