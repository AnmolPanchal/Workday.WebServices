...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Admission_Decision_ReasonObjectType : INotifyPropertyChanged
	{
		private Admission_Decision_ReasonObjectIDType[] idField;
		...
		public Admission_Decision_ReasonObjectIDType[] ID
		{
			get
			{
				return this.idField;
