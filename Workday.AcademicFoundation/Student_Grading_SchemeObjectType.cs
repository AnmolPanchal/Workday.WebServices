...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Student_Grading_SchemeObjectType : INotifyPropertyChanged
	{
		private Student_Grading_SchemeObjectIDType[] idField;
		...
		public Student_Grading_SchemeObjectIDType[] ID
		{
			get
			{
				return this.idField;
