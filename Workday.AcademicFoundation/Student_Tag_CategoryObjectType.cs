...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Student_Tag_CategoryObjectType : INotifyPropertyChanged
	{
		private Student_Tag_CategoryObjectIDType[] idField;
		...
		public Student_Tag_CategoryObjectIDType[] ID
		{
			get
			{
				return this.idField;
