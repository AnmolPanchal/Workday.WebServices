...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Student_External_TranscriptObjectType : INotifyPropertyChanged
	{
		private Student_External_TranscriptObjectIDType[] idField;
		...
		public Student_External_TranscriptObjectIDType[] ID
		{
			get
			{
				return this.idField;
