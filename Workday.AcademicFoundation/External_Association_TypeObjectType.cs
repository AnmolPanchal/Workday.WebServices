...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class External_Association_TypeObjectType : INotifyPropertyChanged
	{
		private External_Association_TypeObjectIDType[] idField;
		...
		public External_Association_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
