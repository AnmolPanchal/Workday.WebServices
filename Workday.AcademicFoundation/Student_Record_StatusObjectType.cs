...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Student_Record_StatusObjectType : INotifyPropertyChanged
	{
		private Student_Record_StatusObjectIDType[] idField;
		...
		public Student_Record_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
