...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Student_Personal_InformationType : INotifyPropertyChanged
	{
		private StudentObjectType student_ReferenceField;

		private Student_Personal_Information_DataType[] student_DataField;
		...
		public Student_Personal_Information_DataType[] Student_Data
		{
			get
			{
