...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Student_ApplicationObjectType : INotifyPropertyChanged
	{
		private Student_ApplicationObjectIDType[] idField;
		...
		public Student_ApplicationObjectIDType[] ID
		{
			get
			{
				return this.idField;
