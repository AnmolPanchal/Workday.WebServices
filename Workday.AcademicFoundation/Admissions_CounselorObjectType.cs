...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Admissions_CounselorObjectType : INotifyPropertyChanged
	{
		private Admissions_CounselorObjectIDType[] idField;
		...
		public Admissions_CounselorObjectIDType[] ID
		{
			get
			{
				return this.idField;
