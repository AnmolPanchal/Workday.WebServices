...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Get_Academic_Contacts_ResponseType : INotifyPropertyChanged
	{
		private Academic_ContactObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Academic_ContactType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Academic_Contact_Reference", IsNullable = false)]
		public Academic_ContactObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Academic_Contact", IsNullable = false)]
		public Academic_ContactType[] Response_Data
		{
			get
			{
