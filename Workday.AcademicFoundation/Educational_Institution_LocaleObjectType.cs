...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Educational_Institution_LocaleObjectType : INotifyPropertyChanged
	{
		private Educational_Institution_LocaleObjectIDType[] idField;
		...
		public Educational_Institution_LocaleObjectIDType[] ID
		{
			get
			{
				return this.idField;
