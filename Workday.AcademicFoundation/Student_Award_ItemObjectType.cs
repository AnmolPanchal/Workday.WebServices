...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Student_Award_ItemObjectType : INotifyPropertyChanged
	{
		private Student_Award_ItemObjectIDType[] idField;
		...
		public Student_Award_ItemObjectIDType[] ID
		{
			get
			{
				return this.idField;
