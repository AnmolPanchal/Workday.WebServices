...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class License_Identifier_ReferenceObjectType : INotifyPropertyChanged
	{
		private License_Identifier_ReferenceObjectIDType[] idField;
		...
		public License_Identifier_ReferenceObjectIDType[] ID
		{
			get
			{
				return this.idField;
