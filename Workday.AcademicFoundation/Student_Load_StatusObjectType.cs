...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Student_Load_StatusObjectType : INotifyPropertyChanged
	{
		private Student_Load_StatusObjectIDType[] idField;
		...
		public Student_Load_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
