...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Education_Test_ResultObjectType : INotifyPropertyChanged
	{
		private Education_Test_ResultObjectIDType[] idField;
		...
		public Education_Test_ResultObjectIDType[] ID
		{
			get
			{
				return this.idField;
