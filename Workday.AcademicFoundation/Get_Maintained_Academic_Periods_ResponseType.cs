...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Get_Maintained_Academic_Periods_ResponseType : INotifyPropertyChanged
	{
		private Academic_PeriodObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Maintained_Academic_PeriodType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Academic_Period_Reference", IsNullable = false)]
		public Academic_PeriodObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Maintained_Academic_Period", IsNullable = false)]
		public Maintained_Academic_PeriodType[] Response_Data
		{
			get
			{
