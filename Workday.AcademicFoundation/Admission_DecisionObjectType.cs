...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Admission_DecisionObjectType : INotifyPropertyChanged
	{
		private Admission_DecisionObjectIDType[] idField;
		...
		public Admission_DecisionObjectIDType[] ID
		{
			get
			{
				return this.idField;
