...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Student_Application_RecommenderObjectType : INotifyPropertyChanged
	{
		private Student_Application_RecommenderObjectIDType[] idField;
		...
		public Student_Application_RecommenderObjectIDType[] ID
		{
			get
			{
				return this.idField;
