...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Student_Course_RegistrationObjectType : INotifyPropertyChanged
	{
		private Student_Course_RegistrationObjectIDType[] idField;
		...
		public Student_Course_RegistrationObjectIDType[] ID
		{
			get
			{
				return this.idField;
