...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Student_Applicant_TypeObjectType : INotifyPropertyChanged
	{
		private Student_Applicant_TypeObjectIDType[] idField;
		...
		public Student_Applicant_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
