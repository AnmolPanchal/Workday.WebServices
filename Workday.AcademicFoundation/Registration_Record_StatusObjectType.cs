...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Registration_Record_StatusObjectType : INotifyPropertyChanged
	{
		private Registration_Record_StatusObjectIDType[] idField;
		...
		public Registration_Record_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
