...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Educational_DesignationObjectType : INotifyPropertyChanged
	{
		private Educational_DesignationObjectIDType[] idField;
		...
		public Educational_DesignationObjectIDType[] ID
		{
			get
			{
				return this.idField;
