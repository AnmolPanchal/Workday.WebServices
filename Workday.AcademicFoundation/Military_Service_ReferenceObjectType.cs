...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Military_Service_ReferenceObjectType : INotifyPropertyChanged
	{
		private Military_Service_ReferenceObjectIDType[] idField;
		...
		public Military_Service_ReferenceObjectIDType[] ID
		{
			get
			{
				return this.idField;
