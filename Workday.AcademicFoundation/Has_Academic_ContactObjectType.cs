...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Has_Academic_ContactObjectType : INotifyPropertyChanged
	{
		private Has_Academic_ContactObjectIDType[] idField;
		...
		public Has_Academic_ContactObjectIDType[] ID
		{
			get
			{
				return this.idField;
