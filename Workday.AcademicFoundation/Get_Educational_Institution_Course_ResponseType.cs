...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Get_Educational_Institution_Course_ResponseType : INotifyPropertyChanged
	{
		private Educational_Institution_CourseObjectType[] request_ReferencesField;

		private Educational_Institution_Course_Request_CriteriaType[] request_CriteriaField;

		private Response_FilterType[] response_FilterField;

		private Response_ResultsType[] response_ResultsField;

		private Educational_Institution_CourseType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Educational_Institution_Course_Reference", typeof(Educational_Institution_CourseObjectType), IsNullable = false)]
		public Educational_Institution_CourseObjectType[] Request_References
		{
			get
			{
		...
		public Educational_Institution_Course_Request_CriteriaType[] Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Educational_Institution_Course", typeof(Educational_Institution_CourseType), IsNullable = false)]
		public Educational_Institution_CourseType[] Response_Data
		{
			get
			{
