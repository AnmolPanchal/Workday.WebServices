...
namespace WorkdayWebServices.Academic_FoundationService
{
	...
	[Serializable]
	public class Extracurricular_Activity_CategoryObjectType : INotifyPropertyChanged
	{
		private Extracurricular_Activity_CategoryObjectIDType[] idField;
		...
		public Extracurricular_Activity_CategoryObjectIDType[] ID
		{
			get
			{
				return this.idField;
