...
{
	[GeneratedCode("System.Xml", "4.6.1590.0"), DesignerCategory("code"), DebuggerStepThrough, XmlType(TypeName = "Get_One-Time_Payment_Plan_Configurable_Categories_ResponseType", Namespace = "urn:com.workday/bsvc")]
	[Serializable]
	public class Get_OneTime_Payment_Plan_Configurable_Categories_ResponseType : INotifyPropertyChanged
	{
		private OneTime_Payment_Plan_Configurable_CategoryObjectType[] request_ReferencesField;

		private OneTime_Payment_Plan_Configurable_Category_Request_CriteriaType request_CriteriaField;
		...
		private OneTime_Payment_Plan_Configurable_CategoryType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("One-Time_Payment_Plan_Configurable_Category_Reference", IsNullable = false)]
		public OneTime_Payment_Plan_Configurable_CategoryObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public OneTime_Payment_Plan_Configurable_Category_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("One-Time_Payment_Plan_Configurable_Category", IsNullable = false)]
		public OneTime_Payment_Plan_Configurable_CategoryType[] Response_Data
		{
			get
			{
