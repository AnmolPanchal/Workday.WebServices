...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Compa_Ratio_Range_SegmentObjectType : INotifyPropertyChanged
	{
		private Compa_Ratio_Range_SegmentObjectIDType[] idField;
		...
		public Compa_Ratio_Range_SegmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
