...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Stock_Participation_Rate_TableObjectType : INotifyPropertyChanged
	{
		private Stock_Participation_Rate_TableObjectIDType[] idField;
		...
		public Stock_Participation_Rate_TableObjectIDType[] ID
		{
			get
			{
				return this.idField;
