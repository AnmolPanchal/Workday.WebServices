...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Get_Compensation_Grades_RequestType : INotifyPropertyChanged
	{
		private Compensation_GradeObjectType[] request_ReferencesField;

		private Compensation_Grade_Request_CriteriaType request_CriteriaField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Compensation_Grade_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Compensation_Grade_Request_CriteriaType Request_Criteria
		{
			get
			{
