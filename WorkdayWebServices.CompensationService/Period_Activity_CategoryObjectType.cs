...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Period_Activity_CategoryObjectType : INotifyPropertyChanged
	{
		private Period_Activity_CategoryObjectIDType[] idField;
		...
		public Period_Activity_CategoryObjectIDType[] ID
		{
			get
			{
				return this.idField;
