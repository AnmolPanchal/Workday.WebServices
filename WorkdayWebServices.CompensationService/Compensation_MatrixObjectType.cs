...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Compensation_MatrixObjectType : INotifyPropertyChanged
	{
		private Compensation_MatrixObjectIDType[] idField;
		...
		public Compensation_MatrixObjectIDType[] ID
		{
			get
			{
				return this.idField;
