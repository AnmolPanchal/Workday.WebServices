...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Period_Activity_UnitObjectType : INotifyPropertyChanged
	{
		private Period_Activity_UnitObjectIDType[] idField;
		...
		public Period_Activity_UnitObjectIDType[] ID
		{
			get
			{
				return this.idField;
