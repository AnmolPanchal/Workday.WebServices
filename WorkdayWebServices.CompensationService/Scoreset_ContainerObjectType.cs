...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Scoreset_ContainerObjectType : INotifyPropertyChanged
	{
		private Scoreset_ContainerObjectIDType[] idField;
		...
		public Scoreset_ContainerObjectIDType[] ID
		{
			get
			{
				return this.idField;
