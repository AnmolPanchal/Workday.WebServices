...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Get_Benchmark_Jobs_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Benchmark_Job_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Benchmark_Job_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
