...
{
	[GeneratedCode("System.Xml", "4.6.1590.0"), DesignerCategory("code"), DebuggerStepThrough, XmlType(TypeName = "One-Time_Payment_Plan_Configurable_Category_Response_GroupType", Namespace = "urn:com.workday/bsvc")]
	[Serializable]
	public class OneTime_Payment_Plan_Configurable_Category_Response_GroupType : INotifyPropertyChanged
	{
