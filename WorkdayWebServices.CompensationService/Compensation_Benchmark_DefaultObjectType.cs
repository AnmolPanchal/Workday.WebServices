...
namespace WorkdayWebServices.CompensationService
{
	...
	[Serializable]
	public class Compensation_Benchmark_DefaultObjectType : INotifyPropertyChanged
	{
		private Compensation_Benchmark_DefaultObjectIDType[] idField;
		...
		public Compensation_Benchmark_DefaultObjectIDType[] ID
		{
			get
			{
				return this.idField;
