...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Recruiting_Prospect_TypeObjectType : INotifyPropertyChanged
	{
		private Recruiting_Prospect_TypeObjectIDType[] idField;
		...
		public Recruiting_Prospect_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
