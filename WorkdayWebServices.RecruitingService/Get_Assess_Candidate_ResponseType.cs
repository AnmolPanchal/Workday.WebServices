...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Get_Assess_Candidate_ResponseType : INotifyPropertyChanged
	{
		private Assess_Candidate_Request_ReferencesType request_ReferencesField;

		private Assess_Candidate_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Assess_Candidate_EventType[] response_DataField;
		...
		[XmlElement(Order = 0)]
		public Assess_Candidate_Request_ReferencesType Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Assess_Candidate_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Assess_Candidate_Data", IsNullable = false)]
		public Assess_Candidate_EventType[] Response_Data
		{
			get
			{
