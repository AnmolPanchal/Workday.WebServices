...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Get_Background_Check_ResponseType : INotifyPropertyChanged
	{
		private Background_Check_EventObjectType[] request_ReferencesField;

		private Background_Check_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Background_Check_EventType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Event_Reference", IsNullable = false)]
		public Background_Check_EventObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Background_Check_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Background_Check_Event", IsNullable = false)]
		public Background_Check_EventType[] Response_Data
		{
			get
			{
