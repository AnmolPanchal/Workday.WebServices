...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Communication_Usage_TypeObjectType : INotifyPropertyChanged
	{
		private Communication_Usage_TypeObjectIDType[] idField;
		...
		public Communication_Usage_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
