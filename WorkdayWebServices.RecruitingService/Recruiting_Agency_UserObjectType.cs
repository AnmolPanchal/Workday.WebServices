...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Recruiting_Agency_UserObjectType : INotifyPropertyChanged
	{
		private Recruiting_Agency_UserObjectIDType[] idField;
		...
		public Recruiting_Agency_UserObjectIDType[] ID
		{
			get
			{
				return this.idField;
