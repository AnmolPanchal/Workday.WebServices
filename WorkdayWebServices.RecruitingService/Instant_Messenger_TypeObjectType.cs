...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Instant_Messenger_TypeObjectType : INotifyPropertyChanged
	{
		private Instant_Messenger_TypeObjectIDType[] idField;
		...
		public Instant_Messenger_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
