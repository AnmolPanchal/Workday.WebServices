...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Background_Check_Package_TestObjectType : INotifyPropertyChanged
	{
		private Background_Check_Package_TestObjectIDType[] idField;
		...
		public Background_Check_Package_TestObjectIDType[] ID
		{
			get
			{
				return this.idField;
