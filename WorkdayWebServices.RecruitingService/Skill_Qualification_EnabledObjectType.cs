...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Skill_Qualification_EnabledObjectType : INotifyPropertyChanged
	{
		private Skill_Qualification_EnabledObjectIDType[] idField;
		...
		public Skill_Qualification_EnabledObjectIDType[] ID
		{
			get
			{
				return this.idField;
