...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Job_Posting_Reference_DataType : INotifyPropertyChanged
	{
		...
		[XmlElement("Job_Posting_Site_Name", typeof(string), Order = 0), XmlElement("Job_Posting_Site_Reference", typeof(Job_Posting_SiteObjectType), Order = 0)]
		public object Item
		{
			get
			{
