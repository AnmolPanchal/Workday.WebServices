...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Get_Job_Postings_ResponseType : INotifyPropertyChanged
	{
		private Job_PostingObjectType[] request_ReferencesField;

		private Job_Posting_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Job_Posting_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Job_PostingType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Job_Posting_Reference", IsNullable = false)]
		public Job_PostingObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Job_Posting_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Job_Posting_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Job_Posting", IsNullable = false)]
		public Job_PostingType[] Response_Data
		{
			get
			{
