...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Update_Job_Posting_ResponseType : INotifyPropertyChanged
	{
		private Unique_IdentifierObjectType event_ReferenceField;

		private Job_Posting_DataType[] job_Posting_DataField;
		...
		public Job_Posting_DataType[] Job_Posting_Data
		{
			get
			{
