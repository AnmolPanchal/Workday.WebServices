...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Recruiting_Assessment_TestObjectType : INotifyPropertyChanged
	{
		private Recruiting_Assessment_TestObjectIDType[] idField;
		...
		public Recruiting_Assessment_TestObjectIDType[] ID
		{
			get
			{
				return this.idField;
