...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Post_Job_RequestType : INotifyPropertyChanged
	{
		private Business_Process_ParametersType business_Process_ParametersField;

		private Post_Job_Business_Process_DataType post_Job_DataField;
		...
		[XmlElement(Order = 1)]
		public Post_Job_Business_Process_DataType Post_Job_Data
		{
			get
			{
