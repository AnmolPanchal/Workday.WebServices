...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Get_Recruiting_Agency_Additional_Data_ResponseType : INotifyPropertyChanged
	{
		private Recruiting_Agency_SiteObjectType[] request_ReferencesField;

		private Recruiting_Agency_Request_CriteriaType[] request_CriteriaField;

		private Response_FilterType[] response_FilterField;

		private Recruiting_Agency_User_Response_GroupType[] response_GroupField;

		private Response_ResultsType[] response_ResultsField;

		private Recruiting_Agency_Additional_DataType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Recruiting_Agency_Reference", typeof(Recruiting_Agency_SiteObjectType), IsNullable = false)]
		public Recruiting_Agency_SiteObjectType[] Request_References
		{
			get
			{
		...
		public Recruiting_Agency_Request_CriteriaType[] Request_Criteria
		{
			get
			{
		...
		public Recruiting_Agency_User_Response_GroupType[] Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Recruiting_Agency_Custom_Object_Data", typeof(Recruiting_Agency_Additional_DataType), IsNullable = false)]
		public Recruiting_Agency_Additional_DataType[] Response_Data
		{
			get
			{
