...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Evergreen_Job_Requisition_Data_2Type : INotifyPropertyChanged
	{
		...
		[XmlArray(Order = 7), XmlArrayItem("Organization_Assignments_Data", typeof(Organization_Assignments_for_Job_Requisition_DataType), IsNullable = false)]
		...
		[XmlElement("Role_Assignment_Data", Order = 8)]
