...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Evergreen_Job_RequisitionObjectType : INotifyPropertyChanged
	{
		private Evergreen_Job_RequisitionObjectIDType[] idField;
		...
		public Evergreen_Job_RequisitionObjectIDType[] ID
		{
			get
			{
				return this.idField;
