...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Get_Candidates_ResponseType : INotifyPropertyChanged
	{
		private Candidate_Request_ReferencesType request_ReferencesField;

		private Candidate_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Candidate_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private CandidateType[] response_DataField;
		...
		[XmlElement(Order = 0)]
		public Candidate_Request_ReferencesType Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Candidate_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Candidate_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Candidate", IsNullable = false)]
		public CandidateType[] Response_Data
		{
			get
			{
