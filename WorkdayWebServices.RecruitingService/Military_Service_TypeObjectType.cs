...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Military_Service_TypeObjectType : INotifyPropertyChanged
	{
		private Military_Service_TypeObjectIDType[] idField;
		...
		public Military_Service_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
