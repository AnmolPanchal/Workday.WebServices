...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Get_Candidate_Photos_ResponseType : INotifyPropertyChanged
	{
		...
		private Candidate_PhotoType[] response_DataField;
		...
		[XmlArray(Order = 4), XmlArrayItem("Candidate_Photo", typeof(Candidate_PhotoType), IsNullable = false)]
		public Candidate_PhotoType[] Response_Data
		{
			get
			{
