...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Background_Check_PackageObjectType : INotifyPropertyChanged
	{
		private Background_Check_PackageObjectIDType[] idField;
		...
		public Background_Check_PackageObjectIDType[] ID
		{
			get
			{
				return this.idField;
