...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Recruiting_DispositionObjectType : INotifyPropertyChanged
	{
		private Recruiting_DispositionObjectIDType[] idField;
		...
		public Recruiting_DispositionObjectIDType[] ID
		{
			get
			{
				return this.idField;
