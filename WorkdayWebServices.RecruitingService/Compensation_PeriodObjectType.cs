...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Compensation_PeriodObjectType : INotifyPropertyChanged
	{
		private Compensation_PeriodObjectIDType[] idField;
		...
		public Compensation_PeriodObjectIDType[] ID
		{
			get
			{
				return this.idField;
