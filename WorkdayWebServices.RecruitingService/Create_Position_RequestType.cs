...
namespace WorkdayWebServices.RecruitingService
{
	...
	[Serializable]
	public class Create_Position_RequestType : INotifyPropertyChanged
	{
		private Business_Process_ParametersType business_Process_ParametersField;

		private Create_Position_DataType create_Position_DataField;
		...
		[XmlElement(Order = 1)]
		public Create_Position_DataType Create_Position_Data
		{
			get
			{
				return this.create_Position_DataField;
			}
			set
			{
				this.create_Position_DataField = value;
				this.RaisePropertyChanged("Create_Position_Data");
			}
		}
