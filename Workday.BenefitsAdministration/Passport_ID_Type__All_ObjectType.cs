...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class Passport_ID_Type__All_ObjectType : INotifyPropertyChanged
	{
		private Passport_ID_Type__All_ObjectIDType[] idField;
		...
		public Passport_ID_Type__All_ObjectIDType[] ID
		{
			get
			{
				return this.idField;
