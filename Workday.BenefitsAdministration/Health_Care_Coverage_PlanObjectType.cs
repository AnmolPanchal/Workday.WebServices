...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class Health_Care_Coverage_PlanObjectType : INotifyPropertyChanged
	{
		private Health_Care_Coverage_PlanObjectIDType[] idField;
		...
		public Health_Care_Coverage_PlanObjectIDType[] ID
		{
			get
			{
				return this.idField;
