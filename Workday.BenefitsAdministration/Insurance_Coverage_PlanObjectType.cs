...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class Insurance_Coverage_PlanObjectType : INotifyPropertyChanged
	{
		private Insurance_Coverage_PlanObjectIDType[] idField;
		...
		public Insurance_Coverage_PlanObjectIDType[] ID
		{
			get
			{
				return this.idField;
