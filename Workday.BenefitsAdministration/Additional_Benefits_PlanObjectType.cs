...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class Additional_Benefits_PlanObjectType : INotifyPropertyChanged
	{
		private Additional_Benefits_PlanObjectIDType[] idField;
		...
		public Additional_Benefits_PlanObjectIDType[] ID
		{
			get
			{
				return this.idField;
