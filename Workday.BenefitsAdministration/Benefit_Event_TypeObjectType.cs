...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class Benefit_Event_TypeObjectType : INotifyPropertyChanged
	{
		private Benefit_Event_TypeObjectIDType[] idField;
		...
		public Benefit_Event_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
