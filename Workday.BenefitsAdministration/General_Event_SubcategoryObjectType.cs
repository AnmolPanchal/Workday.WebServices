...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class General_Event_SubcategoryObjectType : INotifyPropertyChanged
	{
		private General_Event_SubcategoryObjectIDType[] idField;
		...
		public General_Event_SubcategoryObjectIDType[] ID
		{
			get
			{
				return this.idField;
