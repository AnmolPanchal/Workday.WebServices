...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class Get_Benefit_Annual_Rates_ResponseType : INotifyPropertyChanged
	{
		...
		private Benefit_Annual_RateType[] response_DataField;
		...
		[XmlArray(Order = 3), XmlArrayItem("Benefit_Annual_Rate", typeof(Benefit_Annual_RateType), IsNullable = false)]
		public Benefit_Annual_RateType[] Response_Data
		{
			get
			{
