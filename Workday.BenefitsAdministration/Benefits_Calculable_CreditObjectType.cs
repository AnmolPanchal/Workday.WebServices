...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class Benefits_Calculable_CreditObjectType : INotifyPropertyChanged
	{
		private Benefits_Calculable_CreditObjectIDType[] idField;
		...
		public Benefits_Calculable_CreditObjectIDType[] ID
		{
			get
			{
				return this.idField;
