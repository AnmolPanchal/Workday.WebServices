...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class Retirement_Savings_PlanObjectType : INotifyPropertyChanged
	{
		private Retirement_Savings_PlanObjectIDType[] idField;
		...
		public Retirement_Savings_PlanObjectIDType[] ID
		{
			get
			{
				return this.idField;
