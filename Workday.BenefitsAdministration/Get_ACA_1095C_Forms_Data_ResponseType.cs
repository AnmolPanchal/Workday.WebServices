...
{
	[GeneratedCode("System.Xml", "4.6.1590.0"), DesignerCategory("code"), DebuggerStepThrough, XmlType(TypeName = "Get_ACA_1095-C_Forms_Data_ResponseType", Namespace = "urn:com.workday/bsvc")]
	[Serializable]
	public class Get_ACA_1095C_Forms_Data_ResponseType : INotifyPropertyChanged
	{
		private ACA_1095C_Form_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private ACA_1095C_FormsType[] response_DataField;
		...
		[XmlElement(Order = 0)]
		public ACA_1095C_Form_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("ACA_1095-C_Forms", IsNullable = false)]
		public ACA_1095C_FormsType[] Response_Data
		{
			get
			{
