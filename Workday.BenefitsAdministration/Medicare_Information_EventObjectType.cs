...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class Medicare_Information_EventObjectType : INotifyPropertyChanged
	{
		private Medicare_Information_EventObjectIDType[] idField;
		...
		public Medicare_Information_EventObjectIDType[] ID
		{
			get
			{
				return this.idField;
