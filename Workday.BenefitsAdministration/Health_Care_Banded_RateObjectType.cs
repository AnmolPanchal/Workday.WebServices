...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class Health_Care_Banded_RateObjectType : INotifyPropertyChanged
	{
		private Health_Care_Banded_RateObjectIDType[] idField;
		...
		public Health_Care_Banded_RateObjectIDType[] ID
		{
			get
			{
				return this.idField;
