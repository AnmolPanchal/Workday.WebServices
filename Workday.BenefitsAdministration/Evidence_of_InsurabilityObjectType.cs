...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class Evidence_of_InsurabilityObjectType : INotifyPropertyChanged
	{
		private Evidence_of_InsurabilityObjectIDType[] idField;
		...
		public Evidence_of_InsurabilityObjectIDType[] ID
		{
			get
			{
				return this.idField;
