...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class Compensation_Pay_EarningObjectType : INotifyPropertyChanged
	{
		private Compensation_Pay_EarningObjectIDType[] idField;
		...
		public Compensation_Pay_EarningObjectIDType[] ID
		{
			get
			{
				return this.idField;
