...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class Benefit_Annual_Rate_TypeObjectType : INotifyPropertyChanged
	{
		private Benefit_Annual_Rate_TypeObjectIDType[] idField;
		...
		public Benefit_Annual_Rate_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
