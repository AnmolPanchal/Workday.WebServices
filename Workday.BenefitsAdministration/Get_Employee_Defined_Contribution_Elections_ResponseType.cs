...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class Get_Employee_Defined_Contribution_Elections_ResponseType : INotifyPropertyChanged
	{
		...
		private Defined_Contribution_PackageType[] response_DataField;
		...
		[XmlArray(Order = 3), XmlArrayItem("Employee_Defined_Contribution_Election", IsNullable = false)]
		public Defined_Contribution_PackageType[] Response_Data
		{
			get
			{
