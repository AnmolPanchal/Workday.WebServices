...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class Health_Savings_Account_PlanObjectType : INotifyPropertyChanged
	{
		private Health_Savings_Account_PlanObjectIDType[] idField;
		...
		public Health_Savings_Account_PlanObjectIDType[] ID
		{
			get
			{
				return this.idField;
