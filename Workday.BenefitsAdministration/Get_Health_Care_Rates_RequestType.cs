...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class Get_Health_Care_Rates_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Health_Care_Rate_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Health_Care_Rate_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
