...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class Insurance_Coverage_Master_AmountObjectType : INotifyPropertyChanged
	{
		private Insurance_Coverage_Master_AmountObjectIDType[] idField;
		...
		public Insurance_Coverage_Master_AmountObjectIDType[] ID
		{
			get
			{
				return this.idField;
