...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class Benefit_Round_DirectionObjectType : INotifyPropertyChanged
	{
		private Benefit_Round_DirectionObjectIDType[] idField;
		...
		public Benefit_Round_DirectionObjectIDType[] ID
		{
			get
			{
				return this.idField;
