...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class Benefit_Individual_RateObjectType : INotifyPropertyChanged
	{
		private Benefit_Individual_RateObjectIDType[] idField;
		...
		public Benefit_Individual_RateObjectIDType[] ID
		{
			get
			{
				return this.idField;
