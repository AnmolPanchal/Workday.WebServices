...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class Benefit_Rate_Band_Tobacco_UseObjectType : INotifyPropertyChanged
	{
		private Benefit_Rate_Band_Tobacco_UseObjectIDType[] idField;
		...
		public Benefit_Rate_Band_Tobacco_UseObjectIDType[] ID
		{
			get
			{
				return this.idField;
