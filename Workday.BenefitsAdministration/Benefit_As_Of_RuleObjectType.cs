...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class Benefit_As_Of_RuleObjectType : INotifyPropertyChanged
	{
		private Benefit_As_Of_RuleObjectIDType[] idField;
		...
		public Benefit_As_Of_RuleObjectIDType[] ID
		{
			get
			{
				return this.idField;
