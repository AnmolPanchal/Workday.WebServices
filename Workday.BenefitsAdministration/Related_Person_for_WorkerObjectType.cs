...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class Related_Person_for_WorkerObjectType : INotifyPropertyChanged
	{
		private Related_Person_for_WorkerObjectIDType[] idField;
		...
		public Related_Person_for_WorkerObjectIDType[] ID
		{
			get
			{
				return this.idField;
