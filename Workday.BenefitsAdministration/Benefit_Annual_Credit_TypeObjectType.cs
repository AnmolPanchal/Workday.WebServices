...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class Benefit_Annual_Credit_TypeObjectType : INotifyPropertyChanged
	{
		private Benefit_Annual_Credit_TypeObjectIDType[] idField;
		...
		public Benefit_Annual_Credit_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
