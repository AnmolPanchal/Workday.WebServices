...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class Benefits_Event_SubcategoryObjectType : INotifyPropertyChanged
	{
		private Benefits_Event_SubcategoryObjectIDType[] idField;
		...
		public Benefits_Event_SubcategoryObjectIDType[] ID
		{
			get
			{
				return this.idField;
