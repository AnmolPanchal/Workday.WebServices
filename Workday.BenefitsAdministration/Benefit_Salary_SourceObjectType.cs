...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class Benefit_Salary_SourceObjectType : INotifyPropertyChanged
	{
		private Benefit_Salary_SourceObjectIDType[] idField;
		...
		public Benefit_Salary_SourceObjectIDType[] ID
		{
			get
			{
				return this.idField;
