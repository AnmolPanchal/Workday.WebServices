...
namespace WorkdayWebServices.Benefits_AdministrationService
{
	...
	[Serializable]
	public class Spending_Account_PlanObjectType : INotifyPropertyChanged
	{
		private Spending_Account_PlanObjectIDType[] idField;
		...
		public Spending_Account_PlanObjectIDType[] ID
		{
			get
			{
				return this.idField;
