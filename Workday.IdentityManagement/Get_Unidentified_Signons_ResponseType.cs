...
namespace WorkdayWebServices.Identity_ManagementService
{
	...
	[Serializable]
	public class Get_Unidentified_Signons_ResponseType : INotifyPropertyChanged
	{
		private Unidentified_Signon_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Unidentified_Signon_DataType[] response_DataField;
		...
		[XmlElement(Order = 0)]
		public Unidentified_Signon_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Unidentified_Signon", IsNullable = false)]
		public Unidentified_Signon_DataType[] Response_Data
		{
			get
			{
