...
namespace WorkdayWebServices.Identity_ManagementService
{
	...
	[Serializable]
	public class Get_Workday_Account_Signons_ResponseType : INotifyPropertyChanged
	{
		private Workday_Account_Signon_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Workday_Account_Signon_DataType[] response_DataField;
		...
		[XmlElement(Order = 0)]
		public Workday_Account_Signon_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Workday_Account_Signon", IsNullable = false)]
		public Workday_Account_Signon_DataType[] Response_Data
		{
			get
			{
