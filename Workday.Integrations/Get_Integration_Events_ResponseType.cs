...
namespace WorkdayWebServices.IntegrationsService
{
	...
	[Serializable]
	public class Get_Integration_Events_ResponseType : INotifyPropertyChanged
	{
		private Integration_ESB_Invocation__Abstract_ObjectType[] request_ReferencesField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Integration_Event_Reference", IsNullable = false)]
		public Integration_ESB_Invocation__Abstract_ObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Integration_Event", IsNullable = false)]
