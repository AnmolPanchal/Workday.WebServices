...
namespace WorkdayWebServices.IntegrationsService
{
	...
	[Serializable]
	public class Get_Subscriptions_ResponseType : INotifyPropertyChanged
	{
		...
		[XmlArray(Order = 0), XmlArrayItem("Subscription_Reference", IsNullable = false)]
		...
		[XmlArray(Order = 3), XmlArrayItem("Subscription", IsNullable = false)]
