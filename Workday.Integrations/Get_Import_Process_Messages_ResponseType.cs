...
namespace WorkdayWebServices.IntegrationsService
{
	...
	[Serializable]
	public class Get_Import_Process_Messages_ResponseType : INotifyPropertyChanged
	{
		...
		[XmlArray(Order = 3), XmlArrayItem("Import_Process_Message", typeof(Import_Process_MessageType), IsNullable = false)]
