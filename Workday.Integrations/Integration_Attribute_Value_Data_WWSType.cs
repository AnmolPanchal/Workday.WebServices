...
namespace WorkdayWebServices.IntegrationsService
{
	...
	[Serializable]
	public class Integration_Attribute_Value_Data_WWSType : INotifyPropertyChanged
	{
		...
		[XmlElement("Environment_Reference", Order = 6)]
		public OMS_EnvironmentObjectType[] Environment_Reference
		{
			...
			set
			{
				...
				this.RaisePropertyChanged("Environment_Reference");
			}
		}
