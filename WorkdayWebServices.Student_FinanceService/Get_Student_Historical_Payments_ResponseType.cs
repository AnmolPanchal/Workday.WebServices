...
namespace WorkdayWebServices.Student_FinanceService
{
	...
	[Serializable]
	public class Get_Student_Historical_Payments_ResponseType : INotifyPropertyChanged
	{
		private Student_Historical_PaymentObjectType[] request_ReferencesField;

		private Student_Historical_Payment_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Student_Historical_PaymentType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Student_Historical_Payment_Reference", IsNullable = false)]
		public Student_Historical_PaymentObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Student_Historical_Payment_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Student_Historical_Payment", IsNullable = false)]
		public Student_Historical_PaymentType[] Response_Data
		{
			get
			{
