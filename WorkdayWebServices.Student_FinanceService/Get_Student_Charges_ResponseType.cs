...
namespace WorkdayWebServices.Student_FinanceService
{
	...
	[Serializable]
	public class Get_Student_Charges_ResponseType : INotifyPropertyChanged
	{
		private Student_ChargeObjectType[] request_ReferencesField;

		private Student_Charge_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Student_ChargeType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Student_Charge_Reference", IsNullable = false)]
		public Student_ChargeObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Student_Charge_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Student_Charge", IsNullable = false)]
		public Student_ChargeType[] Response_Data
		{
			get
			{
