...
namespace WorkdayWebServices.Student_FinanceService
{
	...
	[Serializable]
	public class Student_Charge_ItemObjectType : INotifyPropertyChanged
	{
		private Student_Charge_ItemObjectIDType[] idField;
		...
		public Student_Charge_ItemObjectIDType[] ID
		{
			get
			{
				return this.idField;
