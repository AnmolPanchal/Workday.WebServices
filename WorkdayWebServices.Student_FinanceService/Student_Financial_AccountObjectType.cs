...
namespace WorkdayWebServices.Student_FinanceService
{
	...
	[Serializable]
	public class Student_Financial_AccountObjectType : INotifyPropertyChanged
	{
		private Student_Financial_AccountObjectIDType[] idField;
		...
		public Student_Financial_AccountObjectIDType[] ID
		{
			get
			{
				return this.idField;
