...
namespace WorkdayWebServices.Student_FinanceService
{
	...
	[Serializable]
	public class Student_Historical_PaymentObjectType : INotifyPropertyChanged
	{
		private Student_Historical_PaymentObjectIDType[] idField;
		...
		public Student_Historical_PaymentObjectIDType[] ID
		{
			get
			{
				return this.idField;
