...
namespace WorkdayWebServices.Student_FinanceService
{
	...
	[Serializable]
	public class Student_Historical_ChargeObjectType : INotifyPropertyChanged
	{
		private Student_Historical_ChargeObjectIDType[] idField;
		...
		public Student_Historical_ChargeObjectIDType[] ID
		{
			get
			{
				return this.idField;
