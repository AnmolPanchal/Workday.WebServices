...
namespace WorkdayWebServices.Student_FinanceService
{
	...
	[Serializable]
	public class Student_Payment_ItemObjectType : INotifyPropertyChanged
	{
		private Student_Payment_ItemObjectIDType[] idField;
		...
		public Student_Payment_ItemObjectIDType[] ID
		{
			get
			{
				return this.idField;
