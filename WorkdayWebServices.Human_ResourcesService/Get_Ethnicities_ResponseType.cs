...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Ethnicities_ResponseType : INotifyPropertyChanged
	{
		private EthnicityObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private EthnicityType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Ethnicity_Reference", IsNullable = false)]
		public EthnicityObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Ethnicity", IsNullable = false)]
		public EthnicityType[] Response_Data
		{
			get
			{
