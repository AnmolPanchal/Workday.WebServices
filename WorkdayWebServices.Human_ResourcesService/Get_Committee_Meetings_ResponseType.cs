...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Committee_Meetings_ResponseType : INotifyPropertyChanged
	{
		private Committee_MeetingObjectType[] request_ReferencesField;

		private Committee_Meeting_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Committee_Meeting_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Committee_MeetingType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Committee_Meeting_Reference", IsNullable = false)]
		public Committee_MeetingObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Committee_Meeting_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Committee_Meeting_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Committee_Meeting", IsNullable = false)]
		public Committee_MeetingType[] Response_Data
		{
			get
			{
