...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Job_Classification_ReferenceType : INotifyPropertyChanged
	{
		private string job_Classification_Group_NameField;

		private string job_Classification_NameField;
		...
		[XmlElement(Order = 1)]
		public string Job_Classification_Name
		{
			get
			{
				return this.job_Classification_NameField;
			}
			set
			{
				this.job_Classification_NameField = value;
				this.RaisePropertyChanged("Job_Classification_Name");
			}
		}
