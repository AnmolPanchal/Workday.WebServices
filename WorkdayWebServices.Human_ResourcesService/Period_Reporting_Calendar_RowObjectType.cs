...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Period_Reporting_Calendar_RowObjectType : INotifyPropertyChanged
	{
		private Period_Reporting_Calendar_RowObjectIDType[] idField;
		...
		public Period_Reporting_Calendar_RowObjectIDType[] ID
		{
			get
			{
				return this.idField;
