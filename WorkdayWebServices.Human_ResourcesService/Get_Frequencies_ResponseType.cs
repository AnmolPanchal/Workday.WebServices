...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Frequencies_ResponseType : INotifyPropertyChanged
	{
		private FrequencyObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private FrequencyType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Frequency_Reference", IsNullable = false)]
		public FrequencyObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Frequency", IsNullable = false)]
		public FrequencyType[] Response_Data
		{
			get
			{
