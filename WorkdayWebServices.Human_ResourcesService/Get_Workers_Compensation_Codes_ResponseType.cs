...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Workers_Compensation_Codes_ResponseType : INotifyPropertyChanged
	{
		private Workers_Compensation_CodeObjectType[] request_ReferencesField;

		private Workers_Compensation_Code_Request_CriteriaType request_CriteriaField;
		...
		private Workers_Compensation_CodeType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Workers_Compensation_Code_Reference", IsNullable = false)]
		public Workers_Compensation_CodeObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Workers_Compensation_Code_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Workers_Compensation_Code", IsNullable = false)]
		public Workers_Compensation_CodeType[] Response_Data
		{
			get
			{
