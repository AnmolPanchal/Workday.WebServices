...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Evaluation_ConstraintObjectType : INotifyPropertyChanged
	{
		private Evaluation_ConstraintObjectIDType[] idField;
		...
		public Evaluation_ConstraintObjectIDType[] ID
		{
			get
			{
				return this.idField;
