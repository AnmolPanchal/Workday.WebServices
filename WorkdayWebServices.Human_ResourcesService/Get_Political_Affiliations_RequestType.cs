...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Political_Affiliations_RequestType : INotifyPropertyChanged
	{
		private Political_Affiliation_Request_ReferencesType itemField;
		...
		public Political_Affiliation_Request_ReferencesType Item
		{
			get
			{
