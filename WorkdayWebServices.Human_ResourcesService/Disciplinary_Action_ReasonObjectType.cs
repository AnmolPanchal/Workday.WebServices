...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Disciplinary_Action_ReasonObjectType : INotifyPropertyChanged
	{
		private Disciplinary_Action_ReasonObjectIDType[] idField;
		...
		public Disciplinary_Action_ReasonObjectIDType[] ID
		{
			get
			{
				return this.idField;
