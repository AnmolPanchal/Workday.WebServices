...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Sexual_Orientations_ResponseType : INotifyPropertyChanged
	{
		private Sexual_OrientationObjectType[] request_ReferencesField;

		private Sexual_Orientation_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Sexual_OrientationType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Sexual_Orientation_Reference", IsNullable = false)]
		public Sexual_OrientationObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Sexual_Orientation_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Sexual_Orientation", IsNullable = false)]
		public Sexual_OrientationType[] Response_Data
		{
			get
			{
