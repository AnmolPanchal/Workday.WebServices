...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Service_Center_Representatives_ResponseType : INotifyPropertyChanged
	{
		private Service_Center_RepresentativeObjectType[] request_ReferencesField;

		private Service_Center_Representative_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Service_Center_Representative_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Service_Center_RepresentativeType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Service_Center_Representative_Reference", IsNullable = false)]
		public Service_Center_RepresentativeObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Service_Center_Representative_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Service_Center_Representative_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Service_Center_Representative", IsNullable = false)]
		public Service_Center_RepresentativeType[] Response_Data
		{
			get
			{
