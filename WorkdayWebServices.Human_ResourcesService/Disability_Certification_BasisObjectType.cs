...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Disability_Certification_BasisObjectType : INotifyPropertyChanged
	{
		private Disability_Certification_BasisObjectIDType[] idField;
		...
		public Disability_Certification_BasisObjectIDType[] ID
		{
			get
			{
				return this.idField;
