...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Ethnicities_RequestType : INotifyPropertyChanged
	{
		private Ethnicity_Request_ReferencesType itemField;
		...
		public Ethnicity_Request_ReferencesType Item
		{
			get
			{
