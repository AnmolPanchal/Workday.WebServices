...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Training_Types_RequestType : INotifyPropertyChanged
	{
		private Training_Type_Request_ReferencesType itemField;
		...
		public Training_Type_Request_ReferencesType Item
		{
			get
			{
