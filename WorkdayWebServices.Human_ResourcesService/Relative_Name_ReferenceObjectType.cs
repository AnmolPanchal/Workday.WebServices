...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Relative_Name_ReferenceObjectType : INotifyPropertyChanged
	{
		private Relative_Name_ReferenceObjectIDType[] idField;
		...
		public Relative_Name_ReferenceObjectIDType[] ID
		{
			get
			{
				return this.idField;
