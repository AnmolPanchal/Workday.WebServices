...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class External_Pay_GroupObjectType : INotifyPropertyChanged
	{
		private External_Pay_GroupObjectIDType[] idField;
		...
		public External_Pay_GroupObjectIDType[] ID
		{
			get
			{
				return this.idField;
