...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Political_Affiliations_ResponseType : INotifyPropertyChanged
	{
		private Political_AffiliationObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Political_AffiliationType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Political_Affiliation_Reference", IsNullable = false)]
		public Political_AffiliationObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Political_Affiliation", IsNullable = false)]
		public Political_AffiliationType[] Response_Data
		{
			get
			{
