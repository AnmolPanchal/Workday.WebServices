...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Generic_Disability_Status_Sub_DataType : INotifyPropertyChanged
	{
		...
		[XmlElement("Disability_Authority", typeof(string), Order = 7), XmlElement("Disability_Certification_Authority_Reference", typeof(Disability_Certification_AuthorityObjectType), Order = 7)]
		public object Item
		{
			get
			{
