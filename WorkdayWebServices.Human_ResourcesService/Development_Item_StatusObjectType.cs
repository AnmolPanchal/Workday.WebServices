...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Development_Item_StatusObjectType : INotifyPropertyChanged
	{
		private Development_Item_StatusObjectIDType[] idField;
		...
		public Development_Item_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
