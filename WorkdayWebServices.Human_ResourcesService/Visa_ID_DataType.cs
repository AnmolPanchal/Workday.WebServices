...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Visa_ID_DataType : INotifyPropertyChanged
	{
		private string idField;

		private Visa_ID_TypeObjectType iD_Type_ReferenceField;
		...
		[XmlElement(Order = 1)]
		public Visa_ID_TypeObjectType ID_Type_Reference
		{
			get
			{
