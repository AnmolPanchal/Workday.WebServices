...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Committee_Membership_TargetObjectType : INotifyPropertyChanged
	{
		private Committee_Membership_TargetObjectIDType[] idField;
		...
		public Committee_Membership_TargetObjectIDType[] ID
		{
			get
			{
				return this.idField;
