...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Employee_Contract_StatusObjectType : INotifyPropertyChanged
	{
		private Employee_Contract_StatusObjectIDType[] idField;
		...
		public Employee_Contract_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
