...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Disabilities_RequestType : INotifyPropertyChanged
	{
		private Disability_Request_ReferencesType itemField;
		...
		public Disability_Request_ReferencesType Item
		{
			get
			{
