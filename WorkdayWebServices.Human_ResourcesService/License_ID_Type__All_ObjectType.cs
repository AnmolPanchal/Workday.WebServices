...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class License_ID_Type__All_ObjectType : INotifyPropertyChanged
	{
		private License_ID_Type__All_ObjectIDType[] idField;
		...
		public License_ID_Type__All_ObjectIDType[] ID
		{
			get
			{
				return this.idField;
