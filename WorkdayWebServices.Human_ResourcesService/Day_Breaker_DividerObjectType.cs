...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Day_Breaker_DividerObjectType : INotifyPropertyChanged
	{
		private Day_Breaker_DividerObjectIDType[] idField;
		...
		public Day_Breaker_DividerObjectIDType[] ID
		{
			get
			{
				return this.idField;
