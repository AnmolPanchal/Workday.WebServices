...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Communication_Usage_BehaviorObjectType : INotifyPropertyChanged
	{
		private Communication_Usage_BehaviorObjectIDType[] idField;
		...
		public Communication_Usage_BehaviorObjectIDType[] ID
		{
			get
			{
				return this.idField;
