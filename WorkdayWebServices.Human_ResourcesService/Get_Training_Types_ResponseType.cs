...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Training_Types_ResponseType : INotifyPropertyChanged
	{
		private Training_TypeObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Training_TypeType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Training_Type_Reference", IsNullable = false)]
		public Training_TypeObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Training_Type", IsNullable = false)]
		public Training_TypeType[] Response_Data
		{
			get
			{
