...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Student_Award_SourceObjectType : INotifyPropertyChanged
	{
		private Student_Award_SourceObjectIDType[] idField;
		...
		public Student_Award_SourceObjectIDType[] ID
		{
			get
			{
				return this.idField;
