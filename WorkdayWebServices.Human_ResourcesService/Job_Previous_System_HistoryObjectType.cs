...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Job_Previous_System_HistoryObjectType : INotifyPropertyChanged
	{
		private Job_Previous_System_HistoryObjectIDType[] idField;
		...
		public Job_Previous_System_HistoryObjectIDType[] ID
		{
			get
			{
				return this.idField;
