...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Emergency_Contact_PriorityObjectType : INotifyPropertyChanged
	{
		private Emergency_Contact_PriorityObjectIDType[] idField;
		...
		public Emergency_Contact_PriorityObjectIDType[] ID
		{
			get
			{
				return this.idField;
