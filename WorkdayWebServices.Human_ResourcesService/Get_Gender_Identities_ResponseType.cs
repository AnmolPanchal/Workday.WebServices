...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Gender_Identities_ResponseType : INotifyPropertyChanged
	{
		private Gender_IdentityObjectType[] request_ReferencesField;

		private Gender_Identity_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Gender_IdentityType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Gender_Identity_Reference", IsNullable = false)]
		public Gender_IdentityObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Gender_Identity_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Gender_Identity", IsNullable = false)]
		public Gender_IdentityType[] Response_Data
		{
			get
			{
