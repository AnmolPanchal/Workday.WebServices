...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Academic_Appointment_IdentifierObjectType : INotifyPropertyChanged
	{
		private Academic_Appointment_IdentifierObjectIDType[] idField;
		...
		public Academic_Appointment_IdentifierObjectIDType[] ID
		{
			get
			{
				return this.idField;
