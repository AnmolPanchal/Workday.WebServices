...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Location_HierarchyObjectType : INotifyPropertyChanged
	{
		private Location_HierarchyObjectIDType[] idField;
		...
		public Location_HierarchyObjectIDType[] ID
		{
			get
			{
				return this.idField;
