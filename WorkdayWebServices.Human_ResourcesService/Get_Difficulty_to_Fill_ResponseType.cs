...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Difficulty_to_Fill_ResponseType : INotifyPropertyChanged
	{
		private Difficulty_to_FillObjectType[] request_ReferencesField;

		private Response_FilterType[] response_FilterField;

		private Response_ResultsType[] response_ResultsField;

		private Difficulty_to_FillType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Difficulty_to_Fill_Reference", typeof(Difficulty_to_FillObjectType), IsNullable = false)]
		public Difficulty_to_FillObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Difficulty_to_Fill", typeof(Difficulty_to_FillType), IsNullable = false)]
		public Difficulty_to_FillType[] Response_Data
		{
			get
			{
