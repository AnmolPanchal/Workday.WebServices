...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Service_Center_RepresentativeObjectType : INotifyPropertyChanged
	{
		private Service_Center_RepresentativeObjectIDType[] idField;
		...
		public Service_Center_RepresentativeObjectIDType[] ID
		{
			get
			{
				return this.idField;
