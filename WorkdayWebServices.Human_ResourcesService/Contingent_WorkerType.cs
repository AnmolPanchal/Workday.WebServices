...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Contingent_WorkerType : INotifyPropertyChanged
	{
		private Contingent_Worker_Reference_DataType contingent_Worker_ReferenceField;

		private Contingent_Worker_DataType contingent_Worker_DataField;
		...
		[XmlElement(Order = 1)]
		public Contingent_Worker_DataType Contingent_Worker_Data
		{
			get
			{
				return this.contingent_Worker_DataField;
			}
			set
			{
				this.contingent_Worker_DataField = value;
				this.RaisePropertyChanged("Contingent_Worker_Data");
			}
		}
