...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Academic_Units_ResponseType : INotifyPropertyChanged
	{
		private Academic_UnitObjectType[] request_ReferencesField;

		private Academic_Unit_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Academic_Unit_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Academic_UnitType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Academic_Unit_Reference", IsNullable = false)]
		public Academic_UnitObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Academic_Unit_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Academic_Unit_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Academic_Unit", IsNullable = false)]
		public Academic_UnitType[] Response_Data
		{
			get
			{
