...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Global_Setup_Data_MappingObjectType : INotifyPropertyChanged
	{
		private Global_Setup_Data_MappingObjectIDType[] idField;
		...
		public Global_Setup_Data_MappingObjectIDType[] ID
		{
			get
			{
				return this.idField;
