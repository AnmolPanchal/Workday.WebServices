...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Employee_Probation_PeriodObjectType : INotifyPropertyChanged
	{
		private Employee_Probation_PeriodObjectIDType[] idField;
		...
		public Employee_Probation_PeriodObjectIDType[] ID
		{
			get
			{
				return this.idField;
