...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Former_Worker_AttachmentObjectType : INotifyPropertyChanged
	{
		private Former_Worker_AttachmentObjectIDType[] idField;
		...
		public Former_Worker_AttachmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
