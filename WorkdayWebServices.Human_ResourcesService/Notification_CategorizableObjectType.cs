...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Notification_CategorizableObjectType : INotifyPropertyChanged
	{
		private Notification_CategorizableObjectIDType[] idField;
		...
		public Notification_CategorizableObjectIDType[] ID
		{
			get
			{
				return this.idField;
