...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Service_Center_Representative_Workday_Accounts_ResponseType : INotifyPropertyChanged
	{
		private Service_Center_RepresentativeObjectType[] request_ReferencesField;

		private Service_Center_Representative_Workday_Account_Request_CriteriaType request_CriteriaField;
		...
		private Service_Center_Representative_Workday_AccountType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Service_Center_Representative_Workday_Account_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Service_Center_Representative_Workday_Account_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Service_Center_Representative_Workday_Account", IsNullable = false)]
		public Service_Center_Representative_Workday_AccountType[] Response_Data
		{
			get
			{
