...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Employee_Related_PersonsType : INotifyPropertyChanged
	{
		private Employee_ReferenceType employee_ReferenceField;

		private Related_Person_DataType[] related_Persons_DataField;
		...
		[XmlArray(Order = 1), XmlArrayItem("Related_Person_Data", IsNullable = false)]
		public Related_Person_DataType[] Related_Persons_Data
		{
			get
			{
				return this.related_Persons_DataField;
			}
			set
			{
				this.related_Persons_DataField = value;
				this.RaisePropertyChanged("Related_Persons_Data");
			}
		}
