...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Disability_Status_Information_Data_for_Related_PersonType : INotifyPropertyChanged
	{
		...
		private Disability_Status_Sub_Data_for_Related_PersonType disability_Status_DataField;
		...
		[XmlElement(Order = 2)]
		public Disability_Status_Sub_Data_for_Related_PersonType Disability_Status_Data
		{
			get
			{
