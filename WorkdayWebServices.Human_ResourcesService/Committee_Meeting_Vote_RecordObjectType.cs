...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Committee_Meeting_Vote_RecordObjectType : INotifyPropertyChanged
	{
		private Committee_Meeting_Vote_RecordObjectIDType[] idField;
		...
		public Committee_Meeting_Vote_RecordObjectIDType[] ID
		{
			get
			{
				return this.idField;
