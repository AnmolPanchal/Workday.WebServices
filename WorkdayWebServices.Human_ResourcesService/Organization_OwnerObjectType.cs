...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Organization_OwnerObjectType : INotifyPropertyChanged
	{
		private Organization_OwnerObjectIDType[] idField;
		...
		public Organization_OwnerObjectIDType[] ID
		{
			get
			{
				return this.idField;
