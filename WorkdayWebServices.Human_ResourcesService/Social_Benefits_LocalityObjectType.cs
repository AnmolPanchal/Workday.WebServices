...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Social_Benefits_LocalityObjectType : INotifyPropertyChanged
	{
		private Social_Benefits_LocalityObjectIDType[] idField;
		...
		public Social_Benefits_LocalityObjectIDType[] ID
		{
			get
			{
				return this.idField;
