...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Named_ProfessorshipObjectType : INotifyPropertyChanged
	{
		private Named_ProfessorshipObjectIDType[] idField;
		...
		public Named_ProfessorshipObjectIDType[] ID
		{
			get
			{
				return this.idField;
