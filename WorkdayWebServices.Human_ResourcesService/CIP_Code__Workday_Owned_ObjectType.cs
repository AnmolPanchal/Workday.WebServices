...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class CIP_Code__Workday_Owned_ObjectType : INotifyPropertyChanged
	{
		private CIP_Code__Workday_Owned_ObjectIDType[] idField;
		...
		public CIP_Code__Workday_Owned_ObjectIDType[] ID
		{
			get
			{
				return this.idField;
