...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Generic_Disability_Status_Information_DataType : INotifyPropertyChanged
	{
		private Disability_Status_ReferenceObjectType disability_Status_ReferenceField;

		private Generic_Disability_Status_Sub_DataType disability_Status_DataField;
		...
		[XmlElement(Order = 1)]
		public Generic_Disability_Status_Sub_DataType Disability_Status_Data
		{
			get
			{
