...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Workday_Account_ResponseType : INotifyPropertyChanged
	{
		private RoleObjectType[] request_ReferencesField;

		private Get_Workday_Account_Request_CriteriaType[] request_CriteriaField;

		private Response_FilterType[] response_FilterField;

		private Workday_Account_Response_GroupType[] response_GroupField;

		private Response_ResultsType[] response_ResultsField;

		private Get_Workday_AccountType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Workday_Account_Reference", typeof(RoleObjectType), IsNullable = false)]
		public RoleObjectType[] Request_References
		{
			get
			{
		...
		public Get_Workday_Account_Request_CriteriaType[] Request_Criteria
		{
			get
			{
		...
		public Workday_Account_Response_GroupType[] Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Workday_Account_Response_Data", typeof(Get_Workday_AccountType), IsNullable = false)]
		public Get_Workday_AccountType[] Response_Data
		{
			get
			{
