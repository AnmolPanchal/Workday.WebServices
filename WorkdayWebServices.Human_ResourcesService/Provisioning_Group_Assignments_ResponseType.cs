...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Provisioning_Group_Assignments_ResponseType : INotifyPropertyChanged
	{
		private Unique_IdentifierObjectType[] request_ReferencesField;

		private Provisioning_Group_Assignment_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Provisioning_Group_Assignment_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Provisioning_Group_AssignmentType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Provisioning_Group_Assignment_Request_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Provisioning_Group_Assignment_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Provisioning_Group_Assignment_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Provisioning_Group_Assignment", IsNullable = false)]
		public Provisioning_Group_AssignmentType[] Response_Data
		{
			get
			{
