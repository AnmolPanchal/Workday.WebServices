...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Establishments_ResponseType : INotifyPropertyChanged
	{
		private EstablishmentObjectType[] request_ReferencesField;

		private Establishment_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private EstablishmentType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Establishment_Reference", IsNullable = false)]
		public EstablishmentObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Establishment_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Establishment", IsNullable = false)]
		public EstablishmentType[] Response_Data
		{
			get
			{
