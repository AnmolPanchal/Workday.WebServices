...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Health_Care_ClassificationObjectType : INotifyPropertyChanged
	{
		private Health_Care_ClassificationObjectIDType[] idField;
		...
		public Health_Care_ClassificationObjectIDType[] ID
		{
			get
			{
				return this.idField;
