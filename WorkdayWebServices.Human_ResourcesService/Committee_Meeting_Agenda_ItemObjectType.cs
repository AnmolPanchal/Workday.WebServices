...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Committee_Meeting_Agenda_ItemObjectType : INotifyPropertyChanged
	{
		private Committee_Meeting_Agenda_ItemObjectIDType[] idField;
		...
		public Committee_Meeting_Agenda_ItemObjectIDType[] ID
		{
			get
			{
				return this.idField;
