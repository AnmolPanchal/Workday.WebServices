...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Location_AttributeObjectType : INotifyPropertyChanged
	{
		private Location_AttributeObjectIDType[] idField;
		...
		public Location_AttributeObjectIDType[] ID
		{
			get
			{
				return this.idField;
