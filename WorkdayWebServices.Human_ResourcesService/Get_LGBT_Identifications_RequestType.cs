...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_LGBT_Identifications_RequestType : INotifyPropertyChanged
	{
		private LGBT_Identification_Request_ReferencesType itemField;
		...
		public LGBT_Identification_Request_ReferencesType Item
		{
			get
			{
