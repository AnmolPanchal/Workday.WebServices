...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Background_Check_EventObjectType : INotifyPropertyChanged
	{
		private Background_Check_EventObjectIDType[] idField;
		...
		public Background_Check_EventObjectIDType[] ID
		{
			get
			{
				return this.idField;
