...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Committee_ClassificationObjectType : INotifyPropertyChanged
	{
		private Committee_ClassificationObjectIDType[] idField;
		...
		public Committee_ClassificationObjectIDType[] ID
		{
			get
			{
				return this.idField;
