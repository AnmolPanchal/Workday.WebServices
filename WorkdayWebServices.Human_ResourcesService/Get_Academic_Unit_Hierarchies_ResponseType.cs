...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Academic_Unit_Hierarchies_ResponseType : INotifyPropertyChanged
	{
		private Academic_Unit_HierarchyObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Academic_Unit_HierarchyType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Academic_Unit_Hierarchy_Reference", IsNullable = false)]
		public Academic_Unit_HierarchyObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Academic_Unit_Hierarchy", IsNullable = false)]
		public Academic_Unit_HierarchyType[] Response_Data
		{
			get
			{
