...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Change_Licenses_RequestType : INotifyPropertyChanged
	{
		private Business_Process_ParametersType business_Process_ParametersField;

		private Change_Licenses_Business_Process_DataType change_Licenses_DataField;
		...
		[XmlElement(Order = 1)]
		public Change_Licenses_Business_Process_DataType Change_Licenses_Data
		{
			get
			{
				return this.change_Licenses_DataField;
			}
			set
			{
				this.change_Licenses_DataField = value;
				this.RaisePropertyChanged("Change_Licenses_Data");
			}
		}
