...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Location_Attributes_ResponseType : INotifyPropertyChanged
	{
		private Location_AttributeObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Location_AttributeType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Location_Attribute_Reference", IsNullable = false)]
		public Location_AttributeObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Location_Attribute", IsNullable = false)]
		public Location_AttributeType[] Response_Data
		{
			get
			{
