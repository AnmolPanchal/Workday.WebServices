...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Work_Shifts_ResponseType : INotifyPropertyChanged
	{
		private Work_ShiftObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Work_ShiftType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Work_Shift_Reference", IsNullable = false)]
		public Work_ShiftObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Work_Shift", IsNullable = false)]
		public Work_ShiftType[] Response_Data
		{
			get
			{
