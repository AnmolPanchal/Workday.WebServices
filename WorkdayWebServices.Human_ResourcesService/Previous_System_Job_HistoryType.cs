...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Previous_System_Job_HistoryType : INotifyPropertyChanged
	{
		private WorkerObjectType worker_ReferenceField;

		private Previous_System_Job_History_DataType[] previous_System_Job_HistoryField;
		...
		public Previous_System_Job_History_DataType[] Previous_System_Job_History
		{
			get
			{
