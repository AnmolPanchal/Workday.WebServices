...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Disabilities_ResponseType : INotifyPropertyChanged
	{
		private DisabilityObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private DisabilityType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Disability_Reference", IsNullable = false)]
		public DisabilityObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Disability", IsNullable = false)]
		public DisabilityType[] Response_Data
		{
			get
			{
