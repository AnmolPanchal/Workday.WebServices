...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Committee_Membership_Types_ResponseType : INotifyPropertyChanged
	{
		private Committee_Membership_TypeObjectType[] request_ReferencesField;

		private Committee_Membership_Type_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Committee_Membership_Type_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Committee_Membership_TypeType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Committee_Membership_Type_Reference", IsNullable = false)]
		public Committee_Membership_TypeObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Committee_Membership_Type_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Committee_Membership_Type_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Committee_Membership_Type", IsNullable = false)]
		public Committee_Membership_TypeType[] Response_Data
		{
			get
			{
