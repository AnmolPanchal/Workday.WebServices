...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Social_Benefits_Localities_RequestType : INotifyPropertyChanged
	{
		private Social_Benefits_Locality_Request_ReferencesType itemField;
		...
		public Social_Benefits_Locality_Request_ReferencesType Item
		{
			get
			{
