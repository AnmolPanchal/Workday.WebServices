...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Performance_ReviewObjectType : INotifyPropertyChanged
	{
		private Performance_ReviewObjectIDType[] idField;
		...
		public Performance_ReviewObjectIDType[] ID
		{
			get
			{
				return this.idField;
