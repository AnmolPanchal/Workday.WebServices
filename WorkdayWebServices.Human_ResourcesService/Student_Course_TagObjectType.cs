...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Student_Course_TagObjectType : INotifyPropertyChanged
	{
		private Student_Course_TagObjectIDType[] idField;
		...
		public Student_Course_TagObjectIDType[] ID
		{
			get
			{
				return this.idField;
