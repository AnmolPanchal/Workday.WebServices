...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Stock_Vesting_ScheduleObjectType : INotifyPropertyChanged
	{
		private Stock_Vesting_ScheduleObjectIDType[] idField;
		...
		public Stock_Vesting_ScheduleObjectIDType[] ID
		{
			get
			{
				return this.idField;
