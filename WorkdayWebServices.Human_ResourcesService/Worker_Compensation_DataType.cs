...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Worker_Compensation_DataType : INotifyPropertyChanged
	{
		...
		private Compensatable_Summary_DataType employee_Compensation_Summary_DataField;
		...
		[XmlElement(Order = 13)]
		public Compensatable_Summary_DataType Employee_Compensation_Summary_Data
		{
			get
			{
