...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Job_Profiles_ResponseType : INotifyPropertyChanged
	{
		private Job_Profile_Request_ReferencesType request_ReferencesField;

		private Job_Profile_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Job_Profile_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Job_Profile_Get_DataType[] response_DataField;
		...
		[XmlElement(Order = 0)]
		public Job_Profile_Request_ReferencesType Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Job_Profile_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Job_Profile_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Job_Profile", IsNullable = false)]
		public Job_Profile_Get_DataType[] Response_Data
		{
			get
			{
