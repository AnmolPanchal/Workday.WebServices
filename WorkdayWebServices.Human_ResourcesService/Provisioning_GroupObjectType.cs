...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Provisioning_GroupObjectType : INotifyPropertyChanged
	{
		private Provisioning_GroupObjectIDType[] idField;
		...
		public Provisioning_GroupObjectIDType[] ID
		{
			get
			{
				return this.idField;
