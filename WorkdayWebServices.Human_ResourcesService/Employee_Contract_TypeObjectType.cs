...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Employee_Contract_TypeObjectType : INotifyPropertyChanged
	{
		private Employee_Contract_TypeObjectIDType[] idField;
		...
		public Employee_Contract_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
