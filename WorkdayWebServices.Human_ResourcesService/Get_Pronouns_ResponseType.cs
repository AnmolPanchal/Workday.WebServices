...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Pronouns_ResponseType : INotifyPropertyChanged
	{
		private PronounObjectType[] request_ReferencesField;

		private Pronoun_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private PronounType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Pronoun_Reference", IsNullable = false)]
		public PronounObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Pronoun_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Pronoun", IsNullable = false)]
		public PronounType[] Response_Data
		{
			get
			{
