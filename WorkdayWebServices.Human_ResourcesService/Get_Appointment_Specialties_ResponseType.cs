...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Appointment_Specialties_ResponseType : INotifyPropertyChanged
	{
		private Appointment_SpecialtyObjectType[] request_ReferencesField;

		private Appointment_Specialty_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Appointment_Specialty_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Appointment_SpecialtyType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Appointment_Specialty_Reference", IsNullable = false)]
		public Appointment_SpecialtyObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Appointment_Specialty_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Appointment_Specialty_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Appointment_Specialty", IsNullable = false)]
		public Appointment_SpecialtyType[] Response_Data
		{
			get
			{
