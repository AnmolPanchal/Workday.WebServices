...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Location_Hierarchy_Organization_Assignments_ResponseType : INotifyPropertyChanged
	{
		private Location_HierarchyObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Location_Hierarchy_Organization_Assignments_DataType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Location_Hierarchy_Reference", IsNullable = false)]
		public Location_HierarchyObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Location_Hierarchy_Organization_Assignments", IsNullable = false), XmlArrayItem("Location_Hierarchy_Organization_Assignments_Data", IsNullable = false, NestingLevel = 1)]
		public Location_Hierarchy_Organization_Assignments_DataType[] Response_Data
		{
			get
			{
