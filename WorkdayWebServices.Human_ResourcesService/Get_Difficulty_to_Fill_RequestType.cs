...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Difficulty_to_Fill_RequestType : INotifyPropertyChanged
	{
		private Difficulty_to_Fill_Request_ReferencesType itemField;
		...
		public Difficulty_to_Fill_Request_ReferencesType Item
		{
			get
			{
