...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Employee_Contract_ReasonObjectType : INotifyPropertyChanged
	{
		private Employee_Contract_ReasonObjectIDType[] idField;
		...
		public Employee_Contract_ReasonObjectIDType[] ID
		{
			get
			{
				return this.idField;
