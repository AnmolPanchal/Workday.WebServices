...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Loans_ResponseType : INotifyPropertyChanged
	{
		private LoanObjectType[] request_ReferencesField;

		private Loan_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private LoanType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Loan_Reference", IsNullable = false)]
		public LoanObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Loan_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Loan", IsNullable = false)]
		public LoanType[] Response_Data
		{
			get
			{
