...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Grants_ResponseType : INotifyPropertyChanged
	{
		private GrantObjectType[] request_ReferencesField;

		private Grant_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private GrantType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Grant_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Grant_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Grant", IsNullable = false)]
		public GrantType[] Response_Data
		{
			get
			{
