...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Gift_Hierarchies_ResponseType : INotifyPropertyChanged
	{
		private Gift_HierarchyObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Gift_Hierarchy_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Gift_HierarchyType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Gift_Hierarchy_Reference", IsNullable = false)]
		public Gift_HierarchyObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 2)]
		public Gift_Hierarchy_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Gift_Hierarchy", IsNullable = false)]
		public Gift_HierarchyType[] Response_Data
		{
			get
			{
