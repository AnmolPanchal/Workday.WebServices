...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Gift_Hierarchies_RequestType : INotifyPropertyChanged
	{
		private Gift_Hierarchy_Request_ReferencesType itemField;
		...
		public Gift_Hierarchy_Request_ReferencesType Item
		{
			get
			{
