...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Ledger_Account_Summaries_ResponseType : INotifyPropertyChanged
	{
		private Ledger_Account_SummaryObjectType[] request_ReferencesField;

		private Ledger_Account_Summary_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Ledger_Account_Summary_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Ledger_Account_SummaryType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Ledger_Account_Summary_Reference", IsNullable = false)]
		public Ledger_Account_SummaryObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Ledger_Account_Summary_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Ledger_Account_Summary_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Ledger_Account_Summary", IsNullable = false)]
		public Ledger_Account_SummaryType[] Response_Data
		{
			get
			{
