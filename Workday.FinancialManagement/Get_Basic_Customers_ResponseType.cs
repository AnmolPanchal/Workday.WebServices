...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Basic_Customers_ResponseType : INotifyPropertyChanged
	{
		private CustomerObjectType[] request_ReferencesField;

		private Basic_Customer_Request_CriteriaType request_CriteriaField;
		...
		private Basic_CustomerType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Customer_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Basic_Customer_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Basic_Customer", IsNullable = false)]
		public Basic_CustomerType[] Response_Data
		{
			get
			{
