...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Position_Budget_Group_EventObjectType : INotifyPropertyChanged
	{
		private Position_Budget_Group_EventObjectIDType[] idField;
		...
		public Position_Budget_Group_EventObjectIDType[] ID
		{
			get
			{
				return this.idField;
