...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Funding_Source_Rules_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Funding_Source_Rule_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Funding_Source_Rule_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
