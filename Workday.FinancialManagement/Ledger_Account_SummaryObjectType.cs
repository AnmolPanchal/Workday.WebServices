...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Ledger_Account_SummaryObjectType : INotifyPropertyChanged
	{
		private Ledger_Account_SummaryObjectIDType[] idField;
		...
		public Ledger_Account_SummaryObjectIDType[] ID
		{
			get
			{
				return this.idField;
