...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Default_Funding_Sources_ResponseType : INotifyPropertyChanged
	{
		private Default_Funding_SourceObjectType[] request_ReferencesField;

		private Default_Funding_Source_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Default_Funding_Source_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Default_Funding_SourceType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Default_Funding_Source_Reference", IsNullable = false)]
		public Default_Funding_SourceObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Default_Funding_Source_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Default_Funding_Source_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Default_Funding_Source", IsNullable = false)]
		public Default_Funding_SourceType[] Response_Data
		{
			get
			{
