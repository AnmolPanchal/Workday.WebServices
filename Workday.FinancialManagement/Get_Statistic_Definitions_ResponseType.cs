...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Statistic_Definitions_ResponseType : INotifyPropertyChanged
	{
		private Statistic_DefinitionObjectType[] request_ReferencesField;

		private Statistic_Definition_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Statistic_Definition_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Statistic_DefinitionType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Statistic_Definition_Reference", IsNullable = false)]
		public Statistic_DefinitionObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Statistic_Definition_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Statistic_Definition_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Statistic_Definition", IsNullable = false)]
		public Statistic_DefinitionType[] Response_Data
		{
			get
			{
