...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Restricted_By_ValueObjectType : INotifyPropertyChanged
	{
		private Restricted_By_ValueObjectIDType[] idField;
		...
		public Restricted_By_ValueObjectIDType[] ID
		{
			get
			{
				return this.idField;
