...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Payment_Terms_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Payment_Term_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Payment_Term_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
