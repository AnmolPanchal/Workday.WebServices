...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Effort_Certification_Eligibility_Rules_ResponseType : INotifyPropertyChanged
	{
		private Condition_RuleObjectType[] request_ReferencesField;

		private Effort_Certification_Eligibility_Rule_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Effort_Certification_Eligibility_Rule_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Effort_Certification_Eligibility_RuleType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Effort_Certification_Eligibility_Rule_Reference", IsNullable = false)]
		public Condition_RuleObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Effort_Certification_Eligibility_Rule_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Effort_Certification_Eligibility_Rule_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Effort_Certification_Eligibility_Rule", IsNullable = false)]
		public Effort_Certification_Eligibility_RuleType[] Response_Data
		{
			get
			{
