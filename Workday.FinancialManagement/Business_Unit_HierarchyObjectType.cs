...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Business_Unit_HierarchyObjectType : INotifyPropertyChanged
	{
		private Business_Unit_HierarchyObjectIDType[] idField;
		...
		public Business_Unit_HierarchyObjectIDType[] ID
		{
			get
			{
				return this.idField;
