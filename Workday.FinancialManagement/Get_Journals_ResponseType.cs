...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Journals_ResponseType : INotifyPropertyChanged
	{
		private Journal_EntryObjectType[] request_ReferencesField;

		private Journal_Entry_Request_CriteriaType[] request_CriteriaField;

		private Response_FilterType[] response_FilterField;

		private Response_ResultsType[] response_ResultsField;

		private Journal_Entry_Response_GroupType[] response_GroupField;

		private Journal_EntryType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("JournalEntryReference", typeof(Journal_EntryObjectType), IsNullable = false)]
		public Journal_EntryObjectType[] Request_References
		{
			get
			{
		...
		public Journal_Entry_Request_CriteriaType[] Request_Criteria
		{
			get
			{
		...
		[XmlElement("Response_Group", Order = 4)]
		public Journal_Entry_Response_GroupType[] Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Journal_Entry", typeof(Journal_EntryType), IsNullable = false)]
		public Journal_EntryType[] Response_Data
		{
			get
			{
