...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Condition_Rule_CategoryObjectType : INotifyPropertyChanged
	{
		private Condition_Rule_CategoryObjectIDType[] idField;
		...
		public Condition_Rule_CategoryObjectIDType[] ID
		{
			get
			{
				return this.idField;
