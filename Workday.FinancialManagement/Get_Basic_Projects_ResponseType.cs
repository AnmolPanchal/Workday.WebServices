...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Basic_Projects_ResponseType : INotifyPropertyChanged
	{
		private ProjectObjectType[] request_ReferencesField;

		private Basic_Project_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Basic_Project_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Basic_ProjectType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Basic_Project_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Basic_Project_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Basic_Project_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Basic_Project", IsNullable = false)]
		public Basic_ProjectType[] Response_Data
		{
			get
			{
