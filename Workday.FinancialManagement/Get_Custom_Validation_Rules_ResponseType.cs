...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Custom_Validation_Rules_ResponseType : INotifyPropertyChanged
	{
		private Custom_Validation_ContextObjectType[] request_ReferencesField;

		private Custom_Validation_Rule_Request_CriteriaType[] request_CriteriaField;

		private Response_FilterType[] response_FilterField;

		private Custom_Validation_Rule_Response_GroupType[] response_GroupField;

		private Response_ResultsType[] response_ResultsField;

		private Custom_Validation_RuleType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Custom_Validation_Context_Reference", typeof(Custom_Validation_ContextObjectType), IsNullable = false)]
		public Custom_Validation_ContextObjectType[] Request_References
		{
			get
			{
		...
		public Custom_Validation_Rule_Request_CriteriaType[] Request_Criteria
		{
			get
			{
		...
		public Custom_Validation_Rule_Response_GroupType[] Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Custom_Validation_Rule", typeof(Custom_Validation_RuleType), IsNullable = false)]
		public Custom_Validation_RuleType[] Response_Data
		{
			get
			{
