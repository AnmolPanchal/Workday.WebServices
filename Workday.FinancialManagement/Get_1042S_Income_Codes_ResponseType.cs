...
{
	[GeneratedCode("System.Xml", "4.6.1590.0"), DesignerCategory("code"), DebuggerStepThrough, XmlType(TypeName = "Get_1042-S_Income_Codes_ResponseType", Namespace = "urn:com.workday/bsvc")]
	[Serializable]
	public class Get_1042S_Income_Codes_ResponseType : INotifyPropertyChanged
	{
		private Income_Code_for_1042SObjectType[] request_ReferencesField;

		private Income_Code_for_1042S_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Income_Code_for_1042S_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Income_Code_for_1042SType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Income_Code_for_1042-S_Reference", IsNullable = false)]
		public Income_Code_for_1042SObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Income_Code_for_1042S_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Income_Code_for_1042S_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Income_Code_for_1042-S", IsNullable = false)]
		public Income_Code_for_1042SType[] Response_Data
		{
			get
			{
