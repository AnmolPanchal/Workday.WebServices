...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Settlement_InstructionObjectType : INotifyPropertyChanged
	{
		private Settlement_InstructionObjectIDType[] idField;
		...
		public Settlement_InstructionObjectIDType[] ID
		{
			get
			{
				return this.idField;
