...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Escheatment_Items_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Escheatment_Item_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Escheatment_Item_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
