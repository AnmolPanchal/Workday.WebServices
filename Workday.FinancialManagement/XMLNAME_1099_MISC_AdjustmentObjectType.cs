...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class XMLNAME_1099_MISC_AdjustmentObjectType : INotifyPropertyChanged
	{
		private XMLNAME_1099_MISC_AdjustmentObjectIDType[] idField;
		...
		public XMLNAME_1099_MISC_AdjustmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
