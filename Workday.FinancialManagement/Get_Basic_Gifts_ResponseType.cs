...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Basic_Gifts_ResponseType : INotifyPropertyChanged
	{
		private GiftObjectType[] request_ReferencesField;

		private Basic_Gift_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Basic_GiftType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Basic_Gift_Reference", IsNullable = false)]
		public GiftObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Basic_Gift_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Basic_Gift", IsNullable = false)]
		public Basic_GiftType[] Response_Data
		{
			get
			{
