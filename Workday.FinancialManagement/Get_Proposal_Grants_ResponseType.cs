...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Proposal_Grants_ResponseType : INotifyPropertyChanged
	{
		private Proposal_GrantObjectType[] request_ReferencesField;

		private Proposal_Grant_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Proposal_Grant_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Proposal_GrantType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Proposal_Grant_Reference", IsNullable = false)]
		public Proposal_GrantObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Proposal_Grant_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Proposal_Grant_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Proposal_Grant", IsNullable = false)]
		public Proposal_GrantType[] Response_Data
		{
			get
			{
