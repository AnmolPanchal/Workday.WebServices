...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Worktag_with_Related_WorktagsObjectType : INotifyPropertyChanged
	{
		private Worktag_with_Related_WorktagsObjectIDType[] idField;
		...
		public Worktag_with_Related_WorktagsObjectIDType[] ID
		{
			get
			{
				return this.idField;
