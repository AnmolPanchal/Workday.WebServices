...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_1099_Electronic_Filing_Run_ResponseType : INotifyPropertyChanged
	{
		private XMLNAME_1099_Data_Request_ReferencesType request_ReferencesField;
		...
		private XMLNAME_1099_Electronic_Filing_Run_DataType[] response_DataField;
		...
		[XmlElement(Order = 0)]
		public XMLNAME_1099_Data_Request_ReferencesType Request_References
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Electronic_Filing_1099_Run_Data", IsNullable = false)]
		public XMLNAME_1099_Electronic_Filing_Run_DataType[] Response_Data
		{
			get
			{
