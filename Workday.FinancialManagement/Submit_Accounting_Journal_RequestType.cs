...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Submit_Accounting_Journal_RequestType : INotifyPropertyChanged
	{
		...
		private Accounting_Journal_DataType accounting_Journal_DataField;
		...
		[XmlElement(Order = 2)]
		public Accounting_Journal_DataType Accounting_Journal_Data
		{
			get
			{
