...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Withholding_Tax_Items_GroupObjectType : INotifyPropertyChanged
	{
		private Withholding_Tax_Items_GroupObjectIDType[] idField;
		...
		public Withholding_Tax_Items_GroupObjectIDType[] ID
		{
			get
			{
				return this.idField;
