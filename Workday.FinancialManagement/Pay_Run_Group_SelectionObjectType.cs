...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Pay_Run_Group_SelectionObjectType : INotifyPropertyChanged
	{
		private Pay_Run_Group_SelectionObjectIDType[] idField;
		...
		public Pay_Run_Group_SelectionObjectIDType[] ID
		{
			get
			{
				return this.idField;
