...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Loan_Referral_TypeObjectType : INotifyPropertyChanged
	{
		private Loan_Referral_TypeObjectIDType[] idField;
		...
		public Loan_Referral_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
