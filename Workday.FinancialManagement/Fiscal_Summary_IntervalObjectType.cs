...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Fiscal_Summary_IntervalObjectType : INotifyPropertyChanged
	{
		private Fiscal_Summary_IntervalObjectIDType[] idField;
		...
		public Fiscal_Summary_IntervalObjectIDType[] ID
		{
			get
			{
				return this.idField;
