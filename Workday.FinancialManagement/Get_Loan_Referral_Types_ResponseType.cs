...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Loan_Referral_Types_ResponseType : INotifyPropertyChanged
	{
		private Loan_Referral_TypeObjectType[] request_ReferencesField;

		private Loan_Referral_Type_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Loan_Referral_TypeType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Loan_Referral_Type_Reference", IsNullable = false)]
		public Loan_Referral_TypeObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Loan_Referral_Type_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Loan_Referral_Type", IsNullable = false)]
		public Loan_Referral_TypeType[] Response_Data
		{
			get
			{
