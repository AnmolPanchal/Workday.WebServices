...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class IRS_1099_MISC_CategoryObjectType : INotifyPropertyChanged
	{
		private IRS_1099_MISC_CategoryObjectIDType[] idField;
		...
		public IRS_1099_MISC_CategoryObjectIDType[] ID
		{
			get
			{
				return this.idField;
