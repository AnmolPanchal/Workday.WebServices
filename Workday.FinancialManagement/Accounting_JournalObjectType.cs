...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Accounting_JournalObjectType : INotifyPropertyChanged
	{
		private Accounting_JournalObjectIDType[] idField;
		...
		public Accounting_JournalObjectIDType[] ID
		{
			get
			{
				return this.idField;
