...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Tax_Applicabilities_ResponseType : INotifyPropertyChanged
	{
		private Tax_ApplicabilityObjectType[] request_ReferencesField;

		private Tax_Applicability_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Tax_Applicability_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Tax_ApplicabilityType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Tax_Applicability_Reference", IsNullable = false)]
		public Tax_ApplicabilityObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Tax_Applicability_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Tax_Applicability_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Tax_Applicability", IsNullable = false)]
		public Tax_ApplicabilityType[] Response_Data
		{
			get
			{
