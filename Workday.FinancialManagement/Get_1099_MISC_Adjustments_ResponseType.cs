...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_1099_MISC_Adjustments_ResponseType : INotifyPropertyChanged
	{
		private XMLNAME_1099_MISC_AdjustmentObjectType[] request_ReferencesField;

		private XMLNAME_1099_MISC_Adjustment_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private XMLNAME_1099_MISC_Adjustment_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private XMLNAME_1099_MISC_AdjustmentType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("IRS_1099_MISC_Adjustment_Reference", IsNullable = false)]
		public XMLNAME_1099_MISC_AdjustmentObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public XMLNAME_1099_MISC_Adjustment_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public XMLNAME_1099_MISC_Adjustment_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("IRS_1099_MISC_Adjustment", IsNullable = false)]
		public XMLNAME_1099_MISC_AdjustmentType[] Response_Data
		{
			get
			{
