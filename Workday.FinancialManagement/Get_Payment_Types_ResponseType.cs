...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Payment_Types_ResponseType : INotifyPropertyChanged
	{
		private Payment_TypeObjectType[] request_ReferencesField;

		private Payment_Type_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Payment_Type_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Payment_TypeType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Payment_Type_Reference", IsNullable = false)]
		public Payment_TypeObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Payment_Type_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Payment_Type_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Payment_Type", IsNullable = false)]
		public Payment_TypeType[] Response_Data
		{
			get
			{
