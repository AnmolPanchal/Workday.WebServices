...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Revenue_Category_Hierarchies_ResponseType : INotifyPropertyChanged
	{
		private Revenue_Category_HierarchyObjectType[] request_ReferencesField;

		private Revenue_Category_Hierarchy_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Revenue_Category_Hierarchy_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Revenue_Category_HierarchyType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Revenue_Category_Hierarchy_Reference", IsNullable = false)]
		public Revenue_Category_HierarchyObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Revenue_Category_Hierarchy_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Revenue_Category_Hierarchy_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Revenue_Category_Hierarchy", IsNullable = false)]
		public Revenue_Category_HierarchyType[] Response_Data
		{
			get
			{
