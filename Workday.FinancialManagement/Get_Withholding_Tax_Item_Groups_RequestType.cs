...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Withholding_Tax_Item_Groups_RequestType : INotifyPropertyChanged
	{
		private Withholding_Tax_Item_Group_Request_ReferencesType itemField;
		...
		public Withholding_Tax_Item_Group_Request_ReferencesType Item
		{
			get
			{
