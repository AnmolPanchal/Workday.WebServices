...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Financial_Report_GroupObjectType : INotifyPropertyChanged
	{
		private Financial_Report_GroupObjectIDType[] idField;
		...
		public Financial_Report_GroupObjectIDType[] ID
		{
			get
			{
				return this.idField;
