...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Withholding_Tax_StatusObjectType : INotifyPropertyChanged
	{
		private Withholding_Tax_StatusObjectIDType[] idField;
		...
		public Withholding_Tax_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
