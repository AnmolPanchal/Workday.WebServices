...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Recurring_Journal_TemplateObjectType : INotifyPropertyChanged
	{
		private Recurring_Journal_TemplateObjectIDType[] idField;
		...
		public Recurring_Journal_TemplateObjectIDType[] ID
		{
			get
			{
				return this.idField;
