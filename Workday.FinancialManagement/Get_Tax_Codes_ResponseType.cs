...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Tax_Codes_ResponseType : INotifyPropertyChanged
	{
		private Tax_CodeObjectType[] request_ReferencesField;

		private Tax_Code_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Tax_Code_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Tax_CodeType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Tax_Code_Reference", IsNullable = false)]
		public Tax_CodeObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Tax_Code_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Tax_Code_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Tax_Code", IsNullable = false)]
		public Tax_CodeType[] Response_Data
		{
			get
			{
