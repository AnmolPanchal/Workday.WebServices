...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Financial_Entry_TypeObjectType : INotifyPropertyChanged
	{
		private Financial_Entry_TypeObjectIDType[] idField;
		...
		public Financial_Entry_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
