...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Default_Values_for_Worktags_ResponseType : INotifyPropertyChanged
	{
		private Worktag_with_Related_WorktagsObjectType[] request_ReferencesField;

		private Default_Values_for_Worktag_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Default_Values_for_Worktag_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Default_Values_for_Worktag_DataType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Related_Worktag_Reference", IsNullable = false)]
		public Worktag_with_Related_WorktagsObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Default_Values_for_Worktag_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Default_Values_for_Worktag_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Default_Values_for_Worktag", IsNullable = false), XmlArrayItem("Default_Values_for_Worktag_Data", IsNullable = false, NestingLevel = 1)]
		public Default_Values_for_Worktag_DataType[] Response_Data
		{
			get
			{
