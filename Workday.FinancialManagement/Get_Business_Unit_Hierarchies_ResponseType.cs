...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Business_Unit_Hierarchies_ResponseType : INotifyPropertyChanged
	{
		private Business_Unit_HierarchyObjectType[] request_ReferencesField;

		private Business_Unit_Hierarchy_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Business_Unit_HierarchyType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Business_Unit_Hierarchy_Reference", IsNullable = false)]
		public Business_Unit_HierarchyObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Business_Unit_Hierarchy_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Business_Unit_Hierarchy", IsNullable = false)]
		public Business_Unit_HierarchyType[] Response_Data
		{
			get
			{
