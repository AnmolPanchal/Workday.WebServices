...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Investors_ResponseType : INotifyPropertyChanged
	{
		private InvestorObjectType[] request_ReferencesField;

		private Investor_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Investor_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private InvestorType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Investor_Reference", IsNullable = false)]
		public InvestorObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Investor_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Investor_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Investor", IsNullable = false)]
		public InvestorType[] Response_Data
		{
			get
			{
