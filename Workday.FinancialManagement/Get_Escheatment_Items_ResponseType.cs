...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Escheatment_Items_ResponseType : INotifyPropertyChanged
	{
		private Escheatment_ItemObjectType[] request_ReferencesField;

		private Escheatment_Item_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Escheatment_WWS_ItemType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Escheatment_Item_Reference", IsNullable = false)]
		public Escheatment_ItemObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Escheatment_Item_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Escheatment_Item", IsNullable = false)]
		public Escheatment_WWS_ItemType[] Response_Data
		{
			get
			{
