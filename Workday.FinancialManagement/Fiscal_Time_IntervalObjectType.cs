...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Fiscal_Time_IntervalObjectType : INotifyPropertyChanged
	{
		private Fiscal_Time_IntervalObjectIDType[] idField;
		...
		public Fiscal_Time_IntervalObjectIDType[] ID
		{
			get
			{
				return this.idField;
