...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Effort_Certifying_Texts_ResponseType : INotifyPropertyChanged
	{
		private Effort_Certifying_TextObjectType[] request_ReferencesField;

		private Effort_Certifying_Text_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Effort_Certifying_TextType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Effort_Certifying_Text_Reference", IsNullable = false)]
		public Effort_Certifying_TextObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Effort_Certifying_Text_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Effort_Certifying_Text", IsNullable = false)]
		public Effort_Certifying_TextType[] Response_Data
		{
			get
			{
