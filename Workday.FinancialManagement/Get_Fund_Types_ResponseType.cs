...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Fund_Types_ResponseType : INotifyPropertyChanged
	{
		private Fund_TypeObjectType[] request_ReferencesField;

		private Response_FilterType[] response_FilterField;

		private Response_ResultsType[] response_ResultsField;

		private Fund_TypeType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Fund_Type_Reference", typeof(Fund_TypeObjectType), IsNullable = false)]
		public Fund_TypeObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Fund_Type", typeof(Fund_TypeType), IsNullable = false)]
		public Fund_TypeType[] Response_Data
		{
			get
			{
