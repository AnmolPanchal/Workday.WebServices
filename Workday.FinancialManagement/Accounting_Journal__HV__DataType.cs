...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Accounting_Journal__HV__DataType : INotifyPropertyChanged
	{
		...
		private Journal_Entry_Line__HV__DataType[] journal_Entry_Line_Replacement_DataField;
		...
		public Journal_Entry_Line__HV__DataType[] Journal_Entry_Line_Replacement_Data
		{
			get
			{
