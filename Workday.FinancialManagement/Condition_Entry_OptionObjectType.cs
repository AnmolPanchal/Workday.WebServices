...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Condition_Entry_OptionObjectType : INotifyPropertyChanged
	{
		private Condition_Entry_OptionObjectIDType[] idField;
		...
		public Condition_Entry_OptionObjectIDType[] ID
		{
			get
			{
				return this.idField;
