...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Receivable_Writeoff_ReasonObjectType : INotifyPropertyChanged
	{
		private Receivable_Writeoff_ReasonObjectIDType[] idField;
		...
		public Receivable_Writeoff_ReasonObjectIDType[] ID
		{
			get
			{
				return this.idField;
