...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Business_Units_ResponseType : INotifyPropertyChanged
	{
		private Business_UnitObjectType[] request_ReferencesField;

		private Business_Unit_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Business_UnitType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Business_Unit_Reference", IsNullable = false)]
		public Business_UnitObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Business_Unit_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Business_Unit", IsNullable = false)]
		public Business_UnitType[] Response_Data
		{
			get
			{
