...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Basic_Suppliers_ResponseType : INotifyPropertyChanged
	{
		...
		private Basic_SupplierType[] response_DataField;
		...
		[XmlArray(Order = 5), XmlArrayItem("Basic_Supplier", IsNullable = false)]
		public Basic_SupplierType[] Response_Data
		{
			get
			{
