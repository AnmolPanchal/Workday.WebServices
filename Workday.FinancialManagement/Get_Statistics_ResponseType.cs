...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Statistics_ResponseType : INotifyPropertyChanged
	{
		private StatisticObjectType[] request_ReferencesField;

		private Statistic_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Statistic_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private StatisticType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Statistic_Reference", IsNullable = false)]
		public StatisticObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Statistic_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Statistic_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Statistic", IsNullable = false)]
		public StatisticType[] Response_Data
		{
			get
			{
