...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Budget_Import_ModeObjectType : INotifyPropertyChanged
	{
		private Budget_Import_ModeObjectIDType[] idField;
		...
		public Budget_Import_ModeObjectIDType[] ID
		{
			get
			{
				return this.idField;
