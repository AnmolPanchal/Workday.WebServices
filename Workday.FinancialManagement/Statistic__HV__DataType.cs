...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Statistic__HV__DataType : INotifyPropertyChanged
	{
		...
		private Statistic_Line__HV__DataType[] statistic_Values_Replacement_DataField;
		...
		public Statistic_Line__HV__DataType[] Statistic_Values_Replacement_Data
		{
			get
			{
