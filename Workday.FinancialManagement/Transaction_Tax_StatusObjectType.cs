...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Transaction_Tax_StatusObjectType : INotifyPropertyChanged
	{
		private Transaction_Tax_StatusObjectIDType[] idField;
		...
		public Transaction_Tax_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
