...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Currency_Conversion_Rates_ResponseType : INotifyPropertyChanged
	{
		private Currency_Conversion_RateObjectType[] request_ReferencesField;

		private Currency_Conversion_Rate_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Currency_Conversion_Rate_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Currency_Conversion_RateType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Currency_Conversion_Rate_Reference", IsNullable = false)]
		public Currency_Conversion_RateObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Currency_Conversion_Rate_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Currency_Conversion_Rate_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Currency_Conversion_Rate", IsNullable = false)]
		public Currency_Conversion_RateType[] Response_Data
		{
			get
			{
