...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Loan_Investor_Types_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Loan_Investor_Type_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Loan_Investor_Type_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
