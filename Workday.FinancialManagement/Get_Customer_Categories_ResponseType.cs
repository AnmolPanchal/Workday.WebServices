...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Customer_Categories_ResponseType : INotifyPropertyChanged
	{
		private Customer_CategoryObjectType[] request_ReferencesField;

		private Customer_Category_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Customer_Category_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Customer_CategoryType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Customer_Category_Reference", IsNullable = false)]
		public Customer_CategoryObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Customer_Category_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Customer_Category_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Customer_Category", IsNullable = false)]
		public Customer_CategoryType[] Response_Data
		{
			get
			{
