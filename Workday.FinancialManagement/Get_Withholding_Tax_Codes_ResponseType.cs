...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Withholding_Tax_Codes_ResponseType : INotifyPropertyChanged
	{
		...
		private Withholding_Tax_CodeType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Withholding_Tax_Code_Reference", IsNullable = false)]
		...
		[XmlArray(Order = 3), XmlArrayItem("Withholding_Tax_Code", IsNullable = false)]
		public Withholding_Tax_CodeType[] Response_Data
		{
			get
			{
