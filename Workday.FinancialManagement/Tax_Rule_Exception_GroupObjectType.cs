...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Tax_Rule_Exception_GroupObjectType : INotifyPropertyChanged
	{
		private Tax_Rule_Exception_GroupObjectIDType[] idField;
		...
		public Tax_Rule_Exception_GroupObjectIDType[] ID
		{
			get
			{
				return this.idField;
