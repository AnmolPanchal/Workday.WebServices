...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Surveys_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Survey_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Survey_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
