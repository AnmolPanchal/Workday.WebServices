...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Withholding_Tax_Item_Groups_ResponseType : INotifyPropertyChanged
	{
		private Withholding_Tax_Items_GroupObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Withholding_Tax_Items_GroupType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Withholding_Tax_Item_Group_Reference", IsNullable = false)]
		public Withholding_Tax_Items_GroupObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Withholding_Tax_Item_Group", IsNullable = false)]
		public Withholding_Tax_Items_GroupType[] Response_Data
		{
			get
			{
