...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Currency_Rate_Types_ResponseType : INotifyPropertyChanged
	{
		private Currency_Rate_TypeObjectType[] request_ReferencesField;

		private Currency_Rate_Type_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Currency_Rate_Type_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Currency_Rate_TypeType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Currency_Rate_Type_Reference", IsNullable = false)]
		public Currency_Rate_TypeObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Currency_Rate_Type_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Currency_Rate_Type_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Currency_Rate_Type", IsNullable = false)]
		public Currency_Rate_TypeType[] Response_Data
		{
			get
			{
