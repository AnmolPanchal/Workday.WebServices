...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Integration_Worktag_MappingObjectType : INotifyPropertyChanged
	{
		private Integration_Worktag_MappingObjectIDType[] idField;
		...
		public Integration_Worktag_MappingObjectIDType[] ID
		{
			get
			{
				return this.idField;
