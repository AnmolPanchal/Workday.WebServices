...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Audited_Accounting_WorktagObjectType : INotifyPropertyChanged
	{
		private Audited_Accounting_WorktagObjectIDType[] idField;
		...
		public Audited_Accounting_WorktagObjectIDType[] ID
		{
			get
			{
				return this.idField;
