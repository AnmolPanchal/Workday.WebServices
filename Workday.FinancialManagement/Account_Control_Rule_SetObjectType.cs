...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Account_Control_Rule_SetObjectType : INotifyPropertyChanged
	{
		private Account_Control_Rule_SetObjectIDType[] idField;
		...
		public Account_Control_Rule_SetObjectIDType[] ID
		{
			get
			{
				return this.idField;
