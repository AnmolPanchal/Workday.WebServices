...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Intercompany_Profiles_ResponseType : INotifyPropertyChanged
	{
		private Intercompany_ProfileObjectType[] request_ReferencesField;

		private Intercompany_Profile_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Intercompany_Profile_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Intercompany_ProfileType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Intercompany_Profile_Reference", IsNullable = false)]
		public Intercompany_ProfileObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Intercompany_Profile_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Intercompany_Profile_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Intercompany_Profile", IsNullable = false)]
		public Intercompany_ProfileType[] Response_Data
		{
			get
			{
