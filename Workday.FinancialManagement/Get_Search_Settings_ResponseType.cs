...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Search_Settings_ResponseType : INotifyPropertyChanged
	{
		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Search_Settings_Response_DataType response_DataField;
		...
		[XmlElement(Order = 2)]
		public Search_Settings_Response_DataType Response_Data
		{
			get
			{
