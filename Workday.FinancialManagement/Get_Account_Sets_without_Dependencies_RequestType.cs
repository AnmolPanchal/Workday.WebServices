...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Account_Sets_without_Dependencies_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Account_Set_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Account_Set_Request_ReferencesType), Order = 0)]
		public object[] Items
		{
			get
			{
