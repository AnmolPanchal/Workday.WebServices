...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Worktag_Type_Configuration_SetObjectType : INotifyPropertyChanged
	{
		private Worktag_Type_Configuration_SetObjectIDType[] idField;
		...
		public Worktag_Type_Configuration_SetObjectIDType[] ID
		{
			get
			{
				return this.idField;
