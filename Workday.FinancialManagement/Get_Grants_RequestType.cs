...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Grants_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Grant_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Grant_Request_ReferencesType), Order = 0)]
		public object[] Items
		{
			get
			{
