...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Taxable_Document_LineObjectType : INotifyPropertyChanged
	{
		private Taxable_Document_LineObjectIDType[] idField;
		...
		public Taxable_Document_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
