...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Resource_Categories_ResponseType : INotifyPropertyChanged
	{
		private Spend_CategoryObjectType[] request_ReferencesField;

		private Spend_Category_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Spend_Category_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Spend_CategoryType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Resource_Category_Reference", IsNullable = false)]
		public Spend_CategoryObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Spend_Category_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Spend_Category_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Resource_Category", IsNullable = false)]
		public Spend_CategoryType[] Response_Data
		{
			get
			{
