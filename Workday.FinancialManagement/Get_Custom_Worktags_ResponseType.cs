...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Custom_Worktags_ResponseType : INotifyPropertyChanged
	{
		private Custom_Worktag_ConfigurationObjectType[] request_ReferencesField;

		private Custom_Worktag_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Custom_Worktag_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Custom_WorktagType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Custom_Worktag_Reference", IsNullable = false)]
		public Custom_Worktag_ConfigurationObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Custom_Worktag_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Custom_Worktag_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Custom_Worktag", IsNullable = false)]
		public Custom_WorktagType[] Response_Data
		{
			get
			{
