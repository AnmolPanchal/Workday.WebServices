...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Basic_Grants_ResponseType : INotifyPropertyChanged
	{
		private GrantObjectType[] request_ReferencesField;

		private Basic_Grant_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Basic_Grant_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Basic_GrantType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Basic_Grant_Reference", IsNullable = false)]
		public GrantObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Basic_Grant_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Basic_Grant_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Basic_Grant", IsNullable = false)]
		public Basic_GrantType[] Response_Data
		{
			get
			{
