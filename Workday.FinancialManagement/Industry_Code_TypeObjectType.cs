...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Industry_Code_TypeObjectType : INotifyPropertyChanged
	{
		private Industry_Code_TypeObjectIDType[] idField;
		...
		public Industry_Code_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
