...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Object_Class_Sets_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Object_Class_Set_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Object_Class_Set_Request_ReferencesType), Order = 0)]
		public object[] Items
		{
			get
			{
