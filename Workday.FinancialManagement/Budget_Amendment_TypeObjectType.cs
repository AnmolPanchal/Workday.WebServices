...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Budget_Amendment_TypeObjectType : INotifyPropertyChanged
	{
		private Budget_Amendment_TypeObjectIDType[] idField;
		...
		public Budget_Amendment_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
