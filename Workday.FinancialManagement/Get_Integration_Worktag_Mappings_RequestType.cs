...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Integration_Worktag_Mappings_RequestType : INotifyPropertyChanged
	{
		private Integration_Worktag_Mapping_Request_ReferencesType itemField;
		...
		public Integration_Worktag_Mapping_Request_ReferencesType Item
		{
			get
			{
