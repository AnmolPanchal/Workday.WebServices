...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Journal_Entry_StatusObjectType : INotifyPropertyChanged
	{
		private Journal_Entry_StatusObjectIDType[] idField;
		...
		public Journal_Entry_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
