...
namespace WorkdayWebServices.Financial_ManagementService
{
	...
	[Serializable]
	public class Get_Cost_Centers_ResponseType : INotifyPropertyChanged
	{
		private Cost_CenterObjectType[] request_ReferencesField;

		private Cost_Center_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Cost_Center_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Cost_CenterType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Cost_Center_Reference", IsNullable = false)]
		public Cost_CenterObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Cost_Center_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Cost_Center_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Cost_Center", IsNullable = false)]
		public Cost_CenterType[] Response_Data
		{
			get
			{
