...
namespace WorkdayWebServices.Time_TrackingService
{
	...
	[Serializable]
	public class Work_Schedule_CalendarObjectType : INotifyPropertyChanged
	{
		private Work_Schedule_CalendarObjectIDType[] idField;
		...
		public Work_Schedule_CalendarObjectIDType[] ID
		{
			get
			{
				return this.idField;
