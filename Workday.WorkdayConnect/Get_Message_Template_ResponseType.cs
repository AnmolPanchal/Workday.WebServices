...
namespace WorkdayWebServices.Workday_ConnectService
{
	...
	[Serializable]
	public class Get_Message_Template_ResponseType : INotifyPropertyChanged
	{
		private Message_TemplateObjectType[] request_ReferencesField;

		private Message_Template_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Message_Template_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Message_TemplateType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Message_Template_Reference", IsNullable = false)]
		public Message_TemplateObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Message_Template_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Message_Template_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Message_Template", IsNullable = false)]
		public Message_TemplateType[] Response_Data
		{
			get
			{
