...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Get_ROE_History_Data_ResponseType : INotifyPropertyChanged
	{
		private Unique_IdentifierObjectType[] request_ReferencesField;

		private ROE_History_Data_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private ROE_History_Data_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private ROE_HistoryType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("ROE_History_Data_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public ROE_History_Data_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public ROE_History_Data_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("ROE_History", IsNullable = false)]
		public ROE_HistoryType[] Response_Data
		{
			get
			{
