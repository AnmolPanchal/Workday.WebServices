...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Payroll_Other_AuthorityObjectType : INotifyPropertyChanged
	{
		private Payroll_Other_AuthorityObjectIDType[] idField;
		...
		public Payroll_Other_AuthorityObjectIDType[] ID
		{
			get
			{
				return this.idField;
