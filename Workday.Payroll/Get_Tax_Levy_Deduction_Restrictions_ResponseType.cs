...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Get_Tax_Levy_Deduction_Restrictions_ResponseType : INotifyPropertyChanged
	{
		private Tax_LevyObjectType[] request_ReferencesField;

		private Tax_Levy_Deduction_Restriction_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Tax_Levy_Deduction_Restriction_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Tax_Levy_Deduction_RestrictionsType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Tax_Levy_Reference", IsNullable = false)]
		public Tax_LevyObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Tax_Levy_Deduction_Restriction_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Tax_Levy_Deduction_Restriction_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Tax_Levy_Deduction_Restriction", IsNullable = false)]
		public Tax_Levy_Deduction_RestrictionsType[] Response_Data
		{
			get
			{
