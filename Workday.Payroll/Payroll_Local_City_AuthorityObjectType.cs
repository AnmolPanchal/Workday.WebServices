...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Payroll_Local_City_AuthorityObjectType : INotifyPropertyChanged
	{
		private Payroll_Local_City_AuthorityObjectIDType[] idField;
		...
		public Payroll_Local_City_AuthorityObjectIDType[] ID
		{
			get
			{
				return this.idField;
