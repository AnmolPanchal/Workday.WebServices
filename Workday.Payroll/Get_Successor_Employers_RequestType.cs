...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Get_Successor_Employers_RequestType : INotifyPropertyChanged
	{
		private Successor_Employer_Request_ReferencesType itemField;
		...
		public Successor_Employer_Request_ReferencesType Item
		{
			get
			{
