...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Payroll_Local_AuthorityObjectType : INotifyPropertyChanged
	{
		private Payroll_Local_AuthorityObjectIDType[] idField;
		...
		public Payroll_Local_AuthorityObjectIDType[] ID
		{
			get
			{
				return this.idField;
