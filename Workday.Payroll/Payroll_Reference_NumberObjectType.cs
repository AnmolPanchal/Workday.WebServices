...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Payroll_Reference_NumberObjectType : INotifyPropertyChanged
	{
		private Payroll_Reference_NumberObjectIDType[] idField;
		...
		public Payroll_Reference_NumberObjectIDType[] ID
		{
			get
			{
				return this.idField;
