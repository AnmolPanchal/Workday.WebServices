...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Payroll_Payee_Tax_TreatyObjectType : INotifyPropertyChanged
	{
		private Payroll_Payee_Tax_TreatyObjectIDType[] idField;
		...
		public Payroll_Payee_Tax_TreatyObjectIDType[] ID
		{
			get
			{
				return this.idField;
