...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Company_Relationship_TypeObjectType : INotifyPropertyChanged
	{
		private Company_Relationship_TypeObjectIDType[] idField;
		...
		public Company_Relationship_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
