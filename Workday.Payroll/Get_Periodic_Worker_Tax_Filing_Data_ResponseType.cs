...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Get_Periodic_Worker_Tax_Filing_Data_ResponseType : INotifyPropertyChanged
	{
		...
		private Peridoic_Worker_Tax_Filing_DataType[] response_DataField;
		...
		[XmlArray(Order = 4), XmlArrayItem("Periodic_Worker_Tax_Filing_Data", IsNullable = false)]
		public Peridoic_Worker_Tax_Filing_DataType[] Response_Data
		{
			get
			{
