...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Withholding_Order_Amount_TypeObjectType : INotifyPropertyChanged
	{
		private Withholding_Order_Amount_TypeObjectIDType[] idField;
		...
		public Withholding_Order_Amount_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
