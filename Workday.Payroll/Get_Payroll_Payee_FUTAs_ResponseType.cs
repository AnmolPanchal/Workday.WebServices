...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Get_Payroll_Payee_FUTAs_ResponseType : INotifyPropertyChanged
	{
		private Payroll_Payee_FUTAObjectType[] request_ReferencesField;

		private Payroll_Payee_FUTA_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Payroll_Payee_FUTA_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Payroll_Payee_FUTAType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Payroll_Payee_FUTA_Reference", IsNullable = false)]
		public Payroll_Payee_FUTAObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Payroll_Payee_FUTA_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Payroll_Payee_FUTA_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Payroll_Payee_FUTA", IsNullable = false)]
		public Payroll_Payee_FUTAType[] Response_Data
		{
			get
			{
