...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Payroll_Payee_FUTAObjectType : INotifyPropertyChanged
	{
		private Payroll_Payee_FUTAObjectIDType[] idField;
		...
		public Payroll_Payee_FUTAObjectIDType[] ID
		{
			get
			{
				return this.idField;
