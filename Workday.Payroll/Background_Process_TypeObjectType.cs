...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Background_Process_TypeObjectType : INotifyPropertyChanged
	{
		private Background_Process_TypeObjectIDType[] idField;
		...
		public Background_Process_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
