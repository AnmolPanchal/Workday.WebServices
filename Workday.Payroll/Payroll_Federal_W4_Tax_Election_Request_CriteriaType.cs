...
{
	[GeneratedCode("System.Xml", "4.6.1590.0"), DesignerCategory("code"), DebuggerStepThrough, XmlType(TypeName = "Payroll_Federal_W-4_Tax_Election_Request_CriteriaType", Namespace = "urn:com.workday/bsvc")]
	[Serializable]
	public class Payroll_Federal_W4_Tax_Election_Request_CriteriaType : INotifyPropertyChanged
	{
