...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Get_EFW2_Year_End_Worker_Filing_Data_ResponseType : INotifyPropertyChanged
	{
		private EFW2_Year_End_Worker_Filing_Data_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private EFW2_Year_End_Worker_FilingType[] response_DataField;
		...
		[XmlElement(Order = 0)]
		public EFW2_Year_End_Worker_Filing_Data_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("EFW2_Year_End_Worker_Filing", IsNullable = false)]
		public EFW2_Year_End_Worker_FilingType[] Response_Data
		{
			get
			{
