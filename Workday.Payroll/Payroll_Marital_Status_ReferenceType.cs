...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Payroll_Marital_Status_ReferenceType : INotifyPropertyChanged
	{
		private string payroll_Marital_Status_ReferenceField;
		...
		[XmlElement(Order = 0)]
		public string Payroll_Marital_Status_Reference
		{
			get
			{
