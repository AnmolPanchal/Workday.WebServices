...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Get_Single_Legal_Entities_RequestType : INotifyPropertyChanged
	{
		private Single_Legal_Entity_Request_ReferencesType itemField;
		...
		public Single_Legal_Entity_Request_ReferencesType Item
		{
			get
			{
