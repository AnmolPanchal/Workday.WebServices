...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Withholding_Order_TypeObjectType : INotifyPropertyChanged
	{
		private Withholding_Order_TypeObjectIDType[] idField;
		...
		public Withholding_Order_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
