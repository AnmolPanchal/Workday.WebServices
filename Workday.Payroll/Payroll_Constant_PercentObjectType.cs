...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Payroll_Constant_PercentObjectType : INotifyPropertyChanged
	{
		private Payroll_Constant_PercentObjectIDType[] idField;
		...
		public Payroll_Constant_PercentObjectIDType[] ID
		{
			get
			{
				return this.idField;
