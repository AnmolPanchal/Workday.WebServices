...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Deduction__Workday_Owned_ObjectType : INotifyPropertyChanged
	{
		private Deduction__Workday_Owned_ObjectIDType[] idField;
		...
		public Deduction__Workday_Owned_ObjectIDType[] ID
		{
			get
			{
				return this.idField;
