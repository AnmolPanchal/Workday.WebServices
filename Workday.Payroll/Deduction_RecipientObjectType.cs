...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Deduction_RecipientObjectType : INotifyPropertyChanged
	{
		private Deduction_RecipientObjectIDType[] idField;
		...
		public Deduction_RecipientObjectIDType[] ID
		{
			get
			{
				return this.idField;
