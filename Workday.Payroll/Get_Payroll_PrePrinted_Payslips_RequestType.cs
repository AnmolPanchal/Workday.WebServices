...
{
	[GeneratedCode("System.Xml", "4.6.1590.0"), DesignerCategory("code"), DebuggerStepThrough, XmlType(TypeName = "Get_Payroll_Pre-Printed_Payslips_RequestType", Namespace = "urn:com.workday/bsvc")]
	[Serializable]
	public class Get_Payroll_PrePrinted_Payslips_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Payroll_PrePrinted_Payslips_Request_CriteriaType), Order = 0), XmlElement("Request_Reference", typeof(Payroll_PrePrinted_Payslips_Request_ReferenceType), Order = 0)]
		public object Item
		{
			get
			{
