...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Metadata_Payroll_WorktagObjectType : INotifyPropertyChanged
	{
		private Metadata_Payroll_WorktagObjectIDType[] idField;
		...
		public Metadata_Payroll_WorktagObjectIDType[] ID
		{
			get
			{
				return this.idField;
