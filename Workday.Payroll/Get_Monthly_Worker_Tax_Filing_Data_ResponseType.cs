...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Get_Monthly_Worker_Tax_Filing_Data_ResponseType : INotifyPropertyChanged
	{
		private Monthly_Worker_Tax_Filing_Data_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Monthly_Worker_Tax_Filing_Data_Response_GroupType response_GroupField;

		private Response_ResultsType[] response_ResultsField;

		private Monthly_Worker_Tax_Filing_DataType[] response_DataField;
		...
		[XmlElement(Order = 0)]
		public Monthly_Worker_Tax_Filing_Data_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 2)]
		public Monthly_Worker_Tax_Filing_Data_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Monthly_Worker_Tax_Filing_Data", typeof(Monthly_Worker_Tax_Filing_DataType), IsNullable = false)]
		public Monthly_Worker_Tax_Filing_DataType[] Response_Data
		{
			get
			{
