...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Get_Payroll_Deduction_Recipients_ResponseType : INotifyPropertyChanged
	{
		private Deduction_RecipientObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Payroll_Deduction_Recipient_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Payroll_Deduction_RecipientType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Payroll_Deduction_Recipient_Reference", IsNullable = false)]
		public Deduction_RecipientObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 2)]
		public Payroll_Deduction_Recipient_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Payroll_Deduction_Recipient", IsNullable = false)]
		public Payroll_Deduction_RecipientType[] Response_Data
		{
			get
			{
