...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Import_ROE_Prior_Period_History_Results_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Payroll_ROE_Prior_Period_History_Results_Data", Order = 0)]
