...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Period_Date_IndicatorObjectType : INotifyPropertyChanged
	{
		private Period_Date_IndicatorObjectIDType[] idField;
		...
		public Period_Date_IndicatorObjectIDType[] ID
		{
			get
			{
				return this.idField;
