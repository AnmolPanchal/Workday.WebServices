...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Get_Paycheck_Deliveries_ResponseType : INotifyPropertyChanged
	{
		private Unique_IdentifierObjectType[] request_ReferencesField;

		private Paycheck_Delivery_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Paycheck_Delivery_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Paycheck_DeliveryType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Paycheck_Delivery_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Paycheck_Delivery_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Paycheck_Delivery_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Paycheck_Delivery", IsNullable = false)]
		public Paycheck_DeliveryType[] Response_Data
		{
			get
			{
