...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Balance_Period__All_ObjectType : INotifyPropertyChanged
	{
		private Balance_Period__All_ObjectIDType[] idField;
		...
		public Balance_Period__All_ObjectIDType[] ID
		{
			get
			{
				return this.idField;
