...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Payroll_Income_Code_SubtypeObjectType : INotifyPropertyChanged
	{
		private Payroll_Income_Code_SubtypeObjectIDType[] idField;
		...
		public Payroll_Income_Code_SubtypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
