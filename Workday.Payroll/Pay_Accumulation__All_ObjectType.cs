...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Pay_Accumulation__All_ObjectType : INotifyPropertyChanged
	{
		private Pay_Accumulation__All_ObjectIDType[] idField;
		...
		public Pay_Accumulation__All_ObjectIDType[] ID
		{
			get
			{
				return this.idField;
