...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Payroll_IRS_CountryObjectType : INotifyPropertyChanged
	{
		private Payroll_IRS_CountryObjectIDType[] idField;
		...
		public Payroll_IRS_CountryObjectIDType[] ID
		{
			get
			{
				return this.idField;
