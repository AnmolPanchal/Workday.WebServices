...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Settlement_Bank_AccountObjectType : INotifyPropertyChanged
	{
		private Settlement_Bank_AccountObjectIDType[] idField;
		...
		public Settlement_Bank_AccountObjectIDType[] ID
		{
			get
			{
				return this.idField;
