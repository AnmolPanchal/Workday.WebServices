...
namespace WorkdayWebServices.PayrollService
{
	...
	[Serializable]
	public class Payroll_State_AuthorityObjectType : INotifyPropertyChanged
	{
		private Payroll_State_AuthorityObjectIDType[] idField;
		...
		public Payroll_State_AuthorityObjectIDType[] ID
		{
			get
			{
				return this.idField;
