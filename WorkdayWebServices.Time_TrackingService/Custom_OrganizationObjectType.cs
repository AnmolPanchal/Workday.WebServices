...
namespace WorkdayWebServices.Time_TrackingService
{
	...
	[Serializable]
	public class Custom_OrganizationObjectType : INotifyPropertyChanged
	{
		private Custom_OrganizationObjectIDType[] idField;
		...
		public Custom_OrganizationObjectIDType[] ID
		{
			get
			{
				return this.idField;
