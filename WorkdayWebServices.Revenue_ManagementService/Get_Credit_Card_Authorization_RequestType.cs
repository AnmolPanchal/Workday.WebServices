...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Credit_Card_Authorization_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Credit_Card_Authorization_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Credit_Card_Authorization_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
