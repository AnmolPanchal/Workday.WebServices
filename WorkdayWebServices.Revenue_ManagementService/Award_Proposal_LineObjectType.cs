...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Award_Proposal_LineObjectType : INotifyPropertyChanged
	{
		private Award_Proposal_LineObjectIDType[] idField;
		...
		public Award_Proposal_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
