...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Sales_Item_Fair_Value_Price_Lists_ResponseType : INotifyPropertyChanged
	{
		private Sales_Item_Fair_Value_Price_ListObjectType[] request_ReferencesField;

		private Sales_Item_Fair_Value_Price_List_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Sales_Item_Fair_Value_Price_List_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Sales_Item_Fair_Value_Price_ListType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Sales_Item_Fair_Value_Price_List_Reference", IsNullable = false)]
		public Sales_Item_Fair_Value_Price_ListObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Sales_Item_Fair_Value_Price_List_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Sales_Item_Fair_Value_Price_List_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Sales_Item_Fair_Value_Price_List", IsNullable = false)]
		public Sales_Item_Fair_Value_Price_ListType[] Response_Data
		{
			get
			{
