...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Milestone_AbstractObjectType : INotifyPropertyChanged
	{
		private Milestone_AbstractObjectIDType[] idField;
		...
		public Milestone_AbstractObjectIDType[] ID
		{
			get
			{
				return this.idField;
