...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Subaward_Risk_Assessments_ResponseType : INotifyPropertyChanged
	{
		private Risk_EvaluationObjectType[] request_ReferencesField;

		private Subaward_Risk_Assessment_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Subaward_Risk_Assessment_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Subaward_Risk_AssessmentType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Subaward_Risk_Assessment_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Subaward_Risk_Assessment_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Subaward_Risk_Assessment_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Subaward_Risk_Assessment", IsNullable = false)]
		public Subaward_Risk_AssessmentType[] Response_Data
		{
			get
			{
