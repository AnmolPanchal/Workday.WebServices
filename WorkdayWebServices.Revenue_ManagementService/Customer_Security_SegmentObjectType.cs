...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Customer_Security_SegmentObjectType : INotifyPropertyChanged
	{
		private Customer_Security_SegmentObjectIDType[] idField;
		...
		public Customer_Security_SegmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
