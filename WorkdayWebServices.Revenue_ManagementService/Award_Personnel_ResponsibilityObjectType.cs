...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Award_Personnel_ResponsibilityObjectType : INotifyPropertyChanged
	{
		private Award_Personnel_ResponsibilityObjectIDType[] idField;
		...
		public Award_Personnel_ResponsibilityObjectIDType[] ID
		{
			get
			{
				return this.idField;
