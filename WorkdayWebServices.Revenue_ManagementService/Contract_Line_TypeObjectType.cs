...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Contract_Line_TypeObjectType : INotifyPropertyChanged
	{
		private Contract_Line_TypeObjectIDType[] idField;
		...
		public Contract_Line_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
