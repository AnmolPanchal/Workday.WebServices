...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Usage_Billing_RateObjectType : INotifyPropertyChanged
	{
		private Usage_Billing_RateObjectIDType[] idField;
		...
		public Usage_Billing_RateObjectIDType[] ID
		{
			get
			{
				return this.idField;
