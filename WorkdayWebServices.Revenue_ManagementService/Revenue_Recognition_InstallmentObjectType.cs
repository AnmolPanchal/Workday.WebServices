...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Revenue_Recognition_InstallmentObjectType : INotifyPropertyChanged
	{
		private Revenue_Recognition_InstallmentObjectIDType[] idField;
		...
		public Revenue_Recognition_InstallmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
