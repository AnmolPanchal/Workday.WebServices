...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Payroll_Limit_SnapshotObjectType : INotifyPropertyChanged
	{
		private Payroll_Limit_SnapshotObjectIDType[] idField;
		...
		public Payroll_Limit_SnapshotObjectIDType[] ID
		{
			get
			{
				return this.idField;
