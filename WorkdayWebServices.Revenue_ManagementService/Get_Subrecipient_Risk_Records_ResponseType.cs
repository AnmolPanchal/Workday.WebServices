...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Subrecipient_Risk_Records_ResponseType : INotifyPropertyChanged
	{
		private Risk_EvaluationObjectType[] request_ReferencesField;

		private Subrecipient_Risk_Record_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Subrecipient_Risk_Record_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Subrecipient_Risk_RecordType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Subrecipient_Risk_Record_Reference", IsNullable = false)]
		public Risk_EvaluationObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Subrecipient_Risk_Record_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Subrecipient_Risk_Record_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Subrecipient_Risk_Record", IsNullable = false)]
		public Subrecipient_Risk_RecordType[] Response_Data
		{
			get
			{
