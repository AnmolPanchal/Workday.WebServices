...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Sales_Item_Fair_Value_Price_ListObjectType : INotifyPropertyChanged
	{
		private Sales_Item_Fair_Value_Price_ListObjectIDType[] idField;
		...
		public Sales_Item_Fair_Value_Price_ListObjectIDType[] ID
		{
			get
			{
				return this.idField;
