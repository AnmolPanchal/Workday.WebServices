...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Companies_as_Business_Entities_ResponseType : INotifyPropertyChanged
	{
		private Company_as_Business_EntityObjectType[] request_ReferencesField;

		private Company_as_Business_Entity_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Company_as_Business_Entity_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Company_as_Business_EntityType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Company_as_Business_Entity_Reference", IsNullable = false)]
		public Company_as_Business_EntityObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Company_as_Business_Entity_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Company_as_Business_Entity_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Company_as_Business_Entity", IsNullable = false)]
		public Company_as_Business_EntityType[] Response_Data
		{
			get
			{
