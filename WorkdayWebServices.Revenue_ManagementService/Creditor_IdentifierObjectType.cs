...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Creditor_IdentifierObjectType : INotifyPropertyChanged
	{
		private Creditor_IdentifierObjectIDType[] idField;
		...
		public Creditor_IdentifierObjectIDType[] ID
		{
			get
			{
				return this.idField;
