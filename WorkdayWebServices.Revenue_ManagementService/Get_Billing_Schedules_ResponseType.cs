...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Billing_Schedules_ResponseType : INotifyPropertyChanged
	{
		private Billing_ScheduleObjectType[] request_ReferencesField;

		private Billing_Schedule_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Billing_Schedule_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Billing_ScheduleType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Billing_Schedule_Reference", IsNullable = false)]
		public Billing_ScheduleObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Billing_Schedule_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Billing_Schedule_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Billing_Schedule", IsNullable = false)]
		public Billing_ScheduleType[] Response_Data
		{
			get
			{
