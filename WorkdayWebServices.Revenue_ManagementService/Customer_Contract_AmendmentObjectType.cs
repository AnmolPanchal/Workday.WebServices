...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Customer_Contract_AmendmentObjectType : INotifyPropertyChanged
	{
		private Customer_Contract_AmendmentObjectIDType[] idField;
		...
		public Customer_Contract_AmendmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
