...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Project_Rate_Categories_ResponseType : INotifyPropertyChanged
	{
		private Project_Rate_CategoryObjectType[] request_ReferencesField;

		private Project_Rate_Category_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Project_Rate_Category_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Project_Rate_CategoryType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Project_Rate_Category_Reference", IsNullable = false)]
		public Project_Rate_CategoryObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Project_Rate_Category_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Project_Rate_Category_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Project_Rate_Category", IsNullable = false)]
		public Project_Rate_CategoryType[] Response_Data
		{
			get
			{
