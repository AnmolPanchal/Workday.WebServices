...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Risk_Evaluation_LevelObjectType : INotifyPropertyChanged
	{
		private Risk_Evaluation_LevelObjectIDType[] idField;
		...
		public Risk_Evaluation_LevelObjectIDType[] ID
		{
			get
			{
				return this.idField;
