...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Award_Lifecycle_Statuses_ResponseType : INotifyPropertyChanged
	{
		private Award_Lifecycle_StatusObjectType[] request_ReferencesField;

		private Response_FilterType[] response_FilterField;

		private Response_ResultsType[] response_ResultsField;

		private Award_Lifecycle_StatusType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Award_Lifecycle_Status_Request_Reference", typeof(Award_Lifecycle_StatusObjectType), IsNullable = false)]
		public Award_Lifecycle_StatusObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Award_Lifecycle_Status", typeof(Award_Lifecycle_StatusType), IsNullable = false)]
		public Award_Lifecycle_StatusType[] Response_Data
		{
			get
			{
