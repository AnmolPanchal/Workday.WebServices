...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Customer_Billable_DocumentObjectType : INotifyPropertyChanged
	{
		private Customer_Billable_DocumentObjectIDType[] idField;
		...
		public Customer_Billable_DocumentObjectIDType[] ID
		{
			get
			{
				return this.idField;
