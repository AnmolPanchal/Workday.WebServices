...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Contract_Amendment_TypeObjectType : INotifyPropertyChanged
	{
		private Contract_Amendment_TypeObjectIDType[] idField;
		...
		public Contract_Amendment_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
