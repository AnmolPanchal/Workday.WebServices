...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Contact_Types_ResponseType : INotifyPropertyChanged
	{
		private Business_Entity_Contact_Type_TenantedObjectType[] request_ReferencesField;

		private Contact_Type_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Contact_TypeType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Contact_Type_Reference", IsNullable = false)]
		public Business_Entity_Contact_Type_TenantedObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Contact_Type_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Contact_Type", IsNullable = false)]
		public Contact_TypeType[] Response_Data
		{
			get
			{
