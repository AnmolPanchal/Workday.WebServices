...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Award_Attachment_DataType : INotifyPropertyChanged
	{
		private byte[] file_ContentField;

		private string commentField;

		private Award_Attachment_CategoryObjectType attachment_Category_ReferenceField;
		...
		[XmlElement(Order = 2)]
		public Award_Attachment_CategoryObjectType Attachment_Category_Reference
		{
			get
			{
				return this.attachment_Category_ReferenceField;
			}
			set
			{
				this.attachment_Category_ReferenceField = value;
				this.RaisePropertyChanged("Attachment_Category_Reference");
			}
		}
