...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Special_Condition_TypeObjectType : INotifyPropertyChanged
	{
		private Special_Condition_TypeObjectIDType[] idField;
		...
		public Special_Condition_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
