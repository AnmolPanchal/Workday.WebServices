...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Customer_Activity_ResponseType : INotifyPropertyChanged
	{
		private Customer_Activity_Request_CriteriaType[] request_CriteriaField;

		private Response_FilterType[] response_FilterField;

		private Response_ResultsType[] response_ResultsField;

		private Customer_ActivityType[] customer_Activity_Response_DataField;
		...
		[XmlElement("Request_Criteria", Order = 0)]
		public Customer_Activity_Request_CriteriaType[] Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Customer_Activity", typeof(Customer_ActivityType), IsNullable = false)]
		public Customer_ActivityType[] Customer_Activity_Response_Data
		{
			get
			{
				return this.customer_Activity_Response_DataField;
			}
			set
			{
				this.customer_Activity_Response_DataField = value;
				this.RaisePropertyChanged("Customer_Activity_Response_Data");
			}
		}
