...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Consolidated_Invoices_ResponseType : INotifyPropertyChanged
	{
		private Consolidated_InvoiceObjectType[] request_ReferencesField;

		private Consolidated_Invoice_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Consolidated_Invoice_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Consolidated_InvoiceType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Consolidated_Invoice_Reference", IsNullable = false)]
		public Consolidated_InvoiceObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Consolidated_Invoice_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Consolidated_Invoice_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Consolidated_Invoice", IsNullable = false)]
		public Consolidated_InvoiceType[] Response_Data
		{
			get
			{
