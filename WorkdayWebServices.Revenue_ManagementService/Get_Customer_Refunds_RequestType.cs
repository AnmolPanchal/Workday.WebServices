...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Customer_Refunds_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Customer_Refund_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Customer_Refund_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
