...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Dunning_Level_GroupObjectType : INotifyPropertyChanged
	{
		private Dunning_Level_GroupObjectIDType[] idField;
		...
		public Dunning_Level_GroupObjectIDType[] ID
		{
			get
			{
				return this.idField;
