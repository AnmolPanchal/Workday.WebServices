...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Deferred_Cost_TransactionObjectType : INotifyPropertyChanged
	{
		private Deferred_Cost_TransactionObjectIDType[] idField;
		...
		public Deferred_Cost_TransactionObjectIDType[] ID
		{
			get
			{
				return this.idField;
