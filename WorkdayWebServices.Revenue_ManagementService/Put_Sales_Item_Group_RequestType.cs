...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Put_Sales_Item_Group_RequestType : INotifyPropertyChanged
	{
		private Sales_Item_GroupObjectType sales_Item_Group_ReferenceField;

		private Sales_Item_Group_DataType sales_Item_Group_DataField;
		...
		[XmlElement(Order = 1)]
		public Sales_Item_Group_DataType Sales_Item_Group_Data
		{
			get
			{
				return this.sales_Item_Group_DataField;
			}
			set
			{
				this.sales_Item_Group_DataField = value;
				this.RaisePropertyChanged("Sales_Item_Group_Data");
			}
		}
