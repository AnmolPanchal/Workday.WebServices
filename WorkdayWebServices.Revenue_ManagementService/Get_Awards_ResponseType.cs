...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Awards_ResponseType : INotifyPropertyChanged
	{
		private Award_ContractObjectType[] request_ReferencesField;

		private Award_Contract_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Award_Contract_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Award_ContractType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Award_Reference", IsNullable = false)]
		public Award_ContractObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Award_Contract_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Award_Contract_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Award", IsNullable = false)]
		public Award_ContractType[] Response_Data
		{
			get
			{
