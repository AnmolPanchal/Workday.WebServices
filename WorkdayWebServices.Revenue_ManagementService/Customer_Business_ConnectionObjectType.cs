...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Customer_Business_ConnectionObjectType : INotifyPropertyChanged
	{
		private Customer_Business_ConnectionObjectIDType[] idField;
		...
		public Customer_Business_ConnectionObjectIDType[] ID
		{
			get
			{
				return this.idField;
