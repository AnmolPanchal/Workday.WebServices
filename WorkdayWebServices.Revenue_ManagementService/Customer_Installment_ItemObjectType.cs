...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Customer_Installment_ItemObjectType : INotifyPropertyChanged
	{
		private Customer_Installment_ItemObjectIDType[] idField;
		...
		public Customer_Installment_ItemObjectIDType[] ID
		{
			get
			{
				return this.idField;
