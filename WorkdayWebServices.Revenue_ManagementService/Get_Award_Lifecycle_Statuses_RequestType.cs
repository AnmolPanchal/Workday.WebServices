...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Award_Lifecycle_Statuses_RequestType : INotifyPropertyChanged
	{
		...
		[XmlArray(Order = 0), XmlArrayItem("Award_Lifecycle_Status_Request_Reference", IsNullable = false)]
