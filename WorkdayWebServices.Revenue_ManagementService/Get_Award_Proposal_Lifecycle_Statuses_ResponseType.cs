...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Award_Proposal_Lifecycle_Statuses_ResponseType : INotifyPropertyChanged
	{
		private Award_Proposal_Lifecycle_StatusObjectType[] request_ReferencesField;

		private Award_Proposal_Lifecycle_Status_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Award_Proposal_Lifecycle_Status_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Award_Proposal_Lifecycle_StatusType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Award_Proposal_Lifecycle_Status_Reference", IsNullable = false)]
		public Award_Proposal_Lifecycle_StatusObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Award_Proposal_Lifecycle_Status_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Award_Proposal_Lifecycle_Status_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Award_Proposal_Lifecycle_Status", IsNullable = false)]
		public Award_Proposal_Lifecycle_StatusType[] Response_Data
		{
			get
			{
