...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Customer_Requests_ResponseType : INotifyPropertyChanged
	{
		private Customer_RequestObjectType[] request_ReferencesField;

		private Customer_Request_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Customer_Request_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Customer_RequestType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Customer_Request_Reference", IsNullable = false)]
		public Customer_RequestObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Customer_Request_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Customer_Request_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Customer_Request", IsNullable = false)]
		public Customer_RequestType[] Response_Data
		{
			get
			{
