...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Award_Task_Role_GroupObjectType : INotifyPropertyChanged
	{
		private Award_Task_Role_GroupObjectIDType[] idField;
		...
		public Award_Task_Role_GroupObjectIDType[] ID
		{
			get
			{
				return this.idField;
