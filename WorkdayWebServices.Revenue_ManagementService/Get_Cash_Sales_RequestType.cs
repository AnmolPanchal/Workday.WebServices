...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Cash_Sales_RequestType : INotifyPropertyChanged
	{
		private object[] itemsField;

		private Response_FilterType response_FilterField;

		private Cash_Sale_Response_GroupType response_GroupField;
		...
		[XmlElement("Request_Criteria", typeof(Cash_Sale_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Cash_Sale_Request_ReferenceType), Order = 0)]
		public object[] Items
		{
			get
			{
		...
		[XmlElement(Order = 2)]
		public Cash_Sale_Response_GroupType Response_Group
		{
			get
			{
