...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Order_Fulfillment_Transactions_ResponseType : INotifyPropertyChanged
	{
		private Order_Fulfillment_TransactionObjectType[] request_ReferencesField;

		private Order_Fulfillment_Transaction_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Order_Fulfillment_Transaction_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Order_Fulfillment_TransactionType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Order_Fulfillment_Transaction_Reference", IsNullable = false)]
		public Order_Fulfillment_TransactionObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Order_Fulfillment_Transaction_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Order_Fulfillment_Transaction_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Order_Fulfillment_Transaction", IsNullable = false)]
		public Order_Fulfillment_TransactionType[] Response_Data
		{
			get
			{
