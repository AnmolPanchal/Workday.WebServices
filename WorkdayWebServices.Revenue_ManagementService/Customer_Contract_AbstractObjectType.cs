...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Customer_Contract_AbstractObjectType : INotifyPropertyChanged
	{
		private Customer_Contract_AbstractObjectIDType[] idField;
		...
		public Customer_Contract_AbstractObjectIDType[] ID
		{
			get
			{
				return this.idField;
