...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Order_Fulfillment_TransactionObjectType : INotifyPropertyChanged
	{
		private Order_Fulfillment_TransactionObjectIDType[] idField;
		...
		public Order_Fulfillment_TransactionObjectIDType[] ID
		{
			get
			{
				return this.idField;
