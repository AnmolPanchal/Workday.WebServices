...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Billing_Schedule_TemplateObjectType : INotifyPropertyChanged
	{
		private Billing_Schedule_TemplateObjectIDType[] idField;
		...
		public Billing_Schedule_TemplateObjectIDType[] ID
		{
			get
			{
				return this.idField;
