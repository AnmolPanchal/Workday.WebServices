...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Facilities_and_Administration_Exceptions_ResponseType : INotifyPropertyChanged
	{
		private Facilities_and_Admin_ExceptionObjectType[] request_ReferencesField;

		private Facilities_and_Admin_Exception_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Facilities_and_Admin_Exception_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Facilities_and_Admin_ExceptionType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Facilities_and_Administration_Exception_Reference", IsNullable = false)]
		public Facilities_and_Admin_ExceptionObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Facilities_and_Admin_Exception_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Facilities_and_Admin_Exception_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Facilities_and_Administration_Exception", IsNullable = false)]
		public Facilities_and_Admin_ExceptionType[] Response_Data
		{
			get
			{
