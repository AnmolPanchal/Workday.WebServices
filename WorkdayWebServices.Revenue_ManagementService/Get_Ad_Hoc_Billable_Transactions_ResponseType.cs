...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Ad_Hoc_Billable_Transactions_ResponseType : INotifyPropertyChanged
	{
		private Ad_Hoc_Billable_TransactionObjectType[] request_ReferencesField;

		private Ad_Hoc_Billable_Transaction_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Ad_Hoc_Billable_Transaction_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Ad_Hoc_Billable_TransactionType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Ad_Hoc_Billable_Transaction_Reference", IsNullable = false)]
		public Ad_Hoc_Billable_TransactionObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Ad_Hoc_Billable_Transaction_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Ad_Hoc_Billable_Transaction_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Ad_Hoc_Billable_Transaction", IsNullable = false)]
		public Ad_Hoc_Billable_TransactionType[] Response_Data
		{
			get
			{
