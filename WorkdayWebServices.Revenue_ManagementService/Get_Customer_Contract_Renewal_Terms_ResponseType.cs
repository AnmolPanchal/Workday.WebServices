...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Customer_Contract_Renewal_Terms_ResponseType : INotifyPropertyChanged
	{
		private Unique_IdentifierObjectType[] request_ReferencesField;

		private Contract_Line_Renewal_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Contract_Line_Renewal_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Contract_Line_Renewal_DataType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Contract_Line_Renewal_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Contract_Line_Renewal_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Contract_Line_Renewal_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Contract_Line_Renewal", IsNullable = false), XmlArrayItem("Contract_Line_Renewal_Data", IsNullable = false, NestingLevel = 1)]
		public Contract_Line_Renewal_DataType[] Response_Data
		{
			get
			{
