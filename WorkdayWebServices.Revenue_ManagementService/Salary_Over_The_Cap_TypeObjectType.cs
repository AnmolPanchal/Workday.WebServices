...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Salary_Over_The_Cap_TypeObjectType : INotifyPropertyChanged
	{
		private Salary_Over_The_Cap_TypeObjectIDType[] idField;
		...
		public Salary_Over_The_Cap_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
