...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Customer_Invoice_AdjustmentObjectType : INotifyPropertyChanged
	{
		private Customer_Invoice_AdjustmentObjectIDType[] idField;
		...
		public Customer_Invoice_AdjustmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
