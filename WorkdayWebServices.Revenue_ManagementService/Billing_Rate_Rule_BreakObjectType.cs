...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Billing_Rate_Rule_BreakObjectType : INotifyPropertyChanged
	{
		private Billing_Rate_Rule_BreakObjectIDType[] idField;
		...
		public Billing_Rate_Rule_BreakObjectIDType[] ID
		{
			get
			{
				return this.idField;
