...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Billing_InstallmentObjectType : INotifyPropertyChanged
	{
		private Billing_InstallmentObjectIDType[] idField;
		...
		public Billing_InstallmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
