...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Business_Entity_WWS_DataType : INotifyPropertyChanged
	{
		private string business_Entity_NameField;

		private string business_Entity_Tax_IDField;
		...
		[XmlElement(Order = 1)]
		public string Business_Entity_Tax_ID
		{
			get
			{
				return this.business_Entity_Tax_IDField;
			}
			set
			{
				this.business_Entity_Tax_IDField = value;
				this.RaisePropertyChanged("Business_Entity_Tax_ID");
			}
		}
