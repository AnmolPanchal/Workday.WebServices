...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Award_Proposal_Submission_Types_ResponseType : INotifyPropertyChanged
	{
		private Award_Proposal_Submission_TypeObjectType[] request_ReferencesField;

		private Award_Proposal_Submission_Type_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Award_Proposal_Submission_Type_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Award_Proposal_Submission_TypeType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Award_Proposal_Submission_Type_Reference", IsNullable = false)]
		public Award_Proposal_Submission_TypeObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Award_Proposal_Submission_Type_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Award_Proposal_Submission_Type_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Award_Proposal_Submission_Type", IsNullable = false)]
		public Award_Proposal_Submission_TypeType[] Response_Data
		{
			get
			{
