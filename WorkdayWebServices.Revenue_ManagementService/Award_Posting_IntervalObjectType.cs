...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Award_Posting_IntervalObjectType : INotifyPropertyChanged
	{
		private Award_Posting_IntervalObjectIDType[] idField;
		...
		public Award_Posting_IntervalObjectIDType[] ID
		{
			get
			{
				return this.idField;
