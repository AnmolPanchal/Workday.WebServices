...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Accounting_CategoryObjectType : INotifyPropertyChanged
	{
		private Accounting_CategoryObjectIDType[] idField;
		...
		public Accounting_CategoryObjectIDType[] ID
		{
			get
			{
				return this.idField;
