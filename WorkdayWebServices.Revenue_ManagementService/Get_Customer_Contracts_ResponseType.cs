...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Customer_Contracts_ResponseType : INotifyPropertyChanged
	{
		private Customer_ContractObjectType[] request_ReferencesField;

		private Customer_Contract_Request_CriteriaType[] request_CriteriaField;

		private Response_FilterType[] response_FilterField;

		private Customer_Contract_Response_GroupType[] response_GroupField;

		private Response_ResultsType[] response_ResultsField;

		private Customer_ContractType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Customer_Contract_Reference", typeof(Customer_ContractObjectType), IsNullable = false)]
		public Customer_ContractObjectType[] Request_References
		{
			get
			{
		...
		public Customer_Contract_Request_CriteriaType[] Request_Criteria
		{
			get
			{
		...
		public Customer_Contract_Response_GroupType[] Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Customer_Contract", typeof(Customer_ContractType), IsNullable = false)]
		public Customer_ContractType[] Response_Data
		{
			get
			{
