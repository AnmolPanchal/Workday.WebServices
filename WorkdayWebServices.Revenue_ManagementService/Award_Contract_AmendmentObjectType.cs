...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Award_Contract_AmendmentObjectType : INotifyPropertyChanged
	{
		private Award_Contract_AmendmentObjectIDType[] idField;
		...
		public Award_Contract_AmendmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
