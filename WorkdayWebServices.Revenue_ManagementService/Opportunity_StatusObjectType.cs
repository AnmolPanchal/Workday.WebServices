...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Opportunity_StatusObjectType : INotifyPropertyChanged
	{
		private Opportunity_StatusObjectIDType[] idField;
		...
		public Opportunity_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
