...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Opportunities_ResponseType : INotifyPropertyChanged
	{
		private OpportunityObjectType[] request_ReferencesField;

		private Opportunity_Request_CriteriaType[] request_CriteriaField;

		private Response_FilterType[] response_FilterField;

		private Opportunity_Response_GroupType[] response_GroupField;

		private Response_ResultsType[] response_ResultsField;

		private OpportunityType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Opportunity_Reference", typeof(OpportunityObjectType), IsNullable = false)]
		public OpportunityObjectType[] Request_References
		{
			get
			{
		...
		public Opportunity_Request_CriteriaType[] Request_Criteria
		{
			get
			{
		...
		public Opportunity_Response_GroupType[] Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Opportunity", typeof(OpportunityType), IsNullable = false)]
		public OpportunityType[] Response_Data
		{
			get
			{
