...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Customer_Contract_Amendments_ResponseType : INotifyPropertyChanged
	{
		private Customer_Contract_AmendmentObjectType[] request_ReferencesField;

		private Customer_Contract_Amendment_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Customer_Contract_Amendment_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Customer_Contract_AmendmentType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Customer_Contract_Amendment_Reference", IsNullable = false)]
		public Customer_Contract_AmendmentObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Customer_Contract_Amendment_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Customer_Contract_Amendment_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Customer_Contract_Amendment", IsNullable = false)]
		public Customer_Contract_AmendmentType[] Response_Data
		{
			get
			{
