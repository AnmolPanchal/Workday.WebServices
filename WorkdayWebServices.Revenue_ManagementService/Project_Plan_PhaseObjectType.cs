...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Project_Plan_PhaseObjectType : INotifyPropertyChanged
	{
		private Project_Plan_PhaseObjectIDType[] idField;
		...
		public Project_Plan_PhaseObjectIDType[] ID
		{
			get
			{
				return this.idField;
