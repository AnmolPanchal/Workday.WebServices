...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Salary_Caps_ResponseType : INotifyPropertyChanged
	{
		private Payroll_LimitObjectType[] request_ReferencesField;

		private Payroll_Limit_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Payroll_Limit_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Payroll_LimitType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Salary_Cap_Request_Reference", IsNullable = false)]
		public Payroll_LimitObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Payroll_Limit_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Payroll_Limit_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Salary_Cap", IsNullable = false)]
		public Payroll_LimitType[] Response_Data
		{
			get
			{
