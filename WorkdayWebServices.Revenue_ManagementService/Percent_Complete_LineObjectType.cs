...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Percent_Complete_LineObjectType : INotifyPropertyChanged
	{
		private Percent_Complete_LineObjectIDType[] idField;
		...
		public Percent_Complete_LineObjectIDType[] ID
		{
			get
			{
				return this.idField;
