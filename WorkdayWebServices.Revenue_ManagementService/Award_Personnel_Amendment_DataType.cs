...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Award_Personnel_Amendment_DataType : INotifyPropertyChanged
	{
		...
		private Award_Personnel_Line_Amendment_DataType[] award_Personnel_Line_Amendment_DataField;
		...
		[XmlElement("Award_Personnel_Line_Amendment_Data", Order = 5)]
		public Award_Personnel_Line_Amendment_DataType[] Award_Personnel_Line_Amendment_Data
		{
			get
			{
				return this.award_Personnel_Line_Amendment_DataField;
			}
			set
			{
				this.award_Personnel_Line_Amendment_DataField = value;
				this.RaisePropertyChanged("Award_Personnel_Line_Amendment_Data");
			}
		}
