...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Award_Proposal_Submission_TypeObjectType : INotifyPropertyChanged
	{
		private Award_Proposal_Submission_TypeObjectIDType[] idField;
		...
		public Award_Proposal_Submission_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
