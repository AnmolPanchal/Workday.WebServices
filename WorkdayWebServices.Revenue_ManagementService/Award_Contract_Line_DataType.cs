...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Award_Contract_Line_DataType : INotifyPropertyChanged
	{
		...
		private DateTime award_Line_Start_DateField;

		private bool award_Line_Start_DateFieldSpecified;

		private DateTime award_Line_End_DateField;

		private bool award_Line_End_DateFieldSpecified;
		...
		[XmlElement("Spend_Restriction_Reference", Order = 7)]
		...
		public DateTime Award_Line_Start_Date
		{
			get
			{
				return this.award_Line_Start_DateField;
			}
			set
			{
				this.award_Line_Start_DateField = value;
				this.RaisePropertyChanged("Award_Line_Start_Date");
			}
		}

		[XmlIgnore]
		public bool Award_Line_Start_DateSpecified
		{
			get
			{
				return this.award_Line_Start_DateFieldSpecified;
			}
			set
			{
				this.award_Line_Start_DateFieldSpecified = value;
				this.RaisePropertyChanged("Award_Line_Start_DateSpecified");
			}
		}

		[XmlElement(DataType = "date", Order = 20)]
		public DateTime Award_Line_End_Date
		{
			get
			{
				return this.award_Line_End_DateField;
			}
			set
			{
				this.award_Line_End_DateField = value;
				this.RaisePropertyChanged("Award_Line_End_Date");
			}
		}

		[XmlIgnore]
		public bool Award_Line_End_DateSpecified
		{
			get
			{
				return this.award_Line_End_DateFieldSpecified;
			}
			set
			{
				this.award_Line_End_DateFieldSpecified = value;
				this.RaisePropertyChanged("Award_Line_End_DateSpecified");
			}
		}
