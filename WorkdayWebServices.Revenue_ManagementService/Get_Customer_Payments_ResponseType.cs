...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Customer_Payments_ResponseType : INotifyPropertyChanged
	{
		private Customer_Payment_for_InvoicesObjectType[] request_ReferencesField;

		private Customer_Payment_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Customer_Payment_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Customer_PaymentType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Customer_Payment_Reference", IsNullable = false)]
		public Customer_Payment_for_InvoicesObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Customer_Payment_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Customer_Payment_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Customer_Payment", IsNullable = false)]
		public Customer_PaymentType[] Response_Data
		{
			get
			{
