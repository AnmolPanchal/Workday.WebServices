...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Submit_Award_Amendment_RequestType : INotifyPropertyChanged
	{
		private Financials_Business_Process_ParametersType business_Process_ParametersField;

		private Award_Amendment_DataType award_Amendment_DataField;
		...
		[XmlElement(Order = 1)]
		public Award_Amendment_DataType Award_Amendment_Data
		{
			get
			{
				return this.award_Amendment_DataField;
			}
			set
			{
				this.award_Amendment_DataField = value;
				this.RaisePropertyChanged("Award_Amendment_Data");
			}
		}
