...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Merchant_Customer_Profile_ResponseType : INotifyPropertyChanged
	{
		private Customer_Credit_Card_ProfileObjectType[] request_ReferencesField;

		private Customer_Credit_Card_Profile_CriteriaType[] request_CriteriaField;

		private Response_FilterType[] response_FilterField;

		private Response_ResultsType[] response_ResultsField;

		private Customer_Credit_Card_ProfileType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Merchant_Customer_Profile_Reference", typeof(Customer_Credit_Card_ProfileObjectType), IsNullable = false)]
		public Customer_Credit_Card_ProfileObjectType[] Request_References
		{
			get
			{
		...
		public Customer_Credit_Card_Profile_CriteriaType[] Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Merchant_Customer_Profile", typeof(Customer_Credit_Card_ProfileType), IsNullable = false)]
		public Customer_Credit_Card_ProfileType[] Response_Data
		{
			get
			{
