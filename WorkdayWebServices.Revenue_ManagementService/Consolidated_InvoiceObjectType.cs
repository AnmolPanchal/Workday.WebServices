...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Consolidated_InvoiceObjectType : INotifyPropertyChanged
	{
		private Consolidated_InvoiceObjectIDType[] idField;
		...
		public Consolidated_InvoiceObjectIDType[] ID
		{
			get
			{
				return this.idField;
