...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Subawards_ResponseType : INotifyPropertyChanged
	{
		private Subaward_AbstractObjectType[] request_ReferencesField;

		private Subaward_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Subaward_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private SubawardType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Subaward_Reference", IsNullable = false)]
		public Subaward_AbstractObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Subaward_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Subaward_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Subaward", IsNullable = false)]
		public SubawardType[] Response_Data
		{
			get
			{
