...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Award_Task_Type_Groups_ResponseType : INotifyPropertyChanged
	{
		private Award_Task_Type_GroupObjectType[] request_ReferencesField;

		private Award_Task_Type_Group_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Award_Task_Type_Group_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Award_Task_Type_GroupType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Award_Task_Type_Group_Reference", IsNullable = false)]
		public Award_Task_Type_GroupObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Award_Task_Type_Group_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Award_Task_Type_Group_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Award_Task_Type_Group", IsNullable = false)]
		public Award_Task_Type_GroupType[] Response_Data
		{
			get
			{
