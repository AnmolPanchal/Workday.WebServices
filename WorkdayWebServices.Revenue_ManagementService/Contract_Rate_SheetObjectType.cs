...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Contract_Rate_SheetObjectType : INotifyPropertyChanged
	{
		private Contract_Rate_SheetObjectIDType[] idField;
		...
		public Contract_Rate_SheetObjectIDType[] ID
		{
			get
			{
				return this.idField;
