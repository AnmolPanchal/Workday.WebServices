...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	public class Import_Customer_InvoiceOutput
	{
		[MessageBodyMember(Namespace = "urn:com.workday/bsvc", Order = 0)]
		public Put_Import_Process_ResponseType Put_Import_Process_Response;

		public Import_Customer_InvoiceOutput()
		{
		}

		public Import_Customer_InvoiceOutput(Put_Import_Process_ResponseType Put_Import_Process_Response)
		{
