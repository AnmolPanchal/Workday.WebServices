...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Award_Groups_ResponseType : INotifyPropertyChanged
	{
		private Award_GroupObjectType[] request_ReferencesField;

		private Award_Group_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Award_GroupType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Award_Group_Reference", IsNullable = false)]
		public Award_GroupObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Award_Group_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Award_Group", IsNullable = false)]
		public Award_GroupType[] Response_Data
		{
			get
			{
