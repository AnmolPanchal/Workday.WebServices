...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Project_Transaction_SourceObjectType : INotifyPropertyChanged
	{
		private Project_Transaction_SourceObjectIDType[] idField;
		...
		public Project_Transaction_SourceObjectIDType[] ID
		{
			get
			{
				return this.idField;
