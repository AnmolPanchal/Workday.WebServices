...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Revenue_Recognition_Schedule_Templates_ResponseType : INotifyPropertyChanged
	{
		private Revenue_Recognition_Schedule_TemplateObjectType[] request_ReferencesField;

		private Revenue_Recognition_Schedule_Template_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Revenue_Recognition_Schedule_TemplateType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Revenue_Recognition_Schedule_Template_Reference", IsNullable = false)]
		public Revenue_Recognition_Schedule_TemplateObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Revenue_Recognition_Schedule_Template_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Revenue_Recognition_Schedule_Template", IsNullable = false)]
		public Revenue_Recognition_Schedule_TemplateType[] Response_Data
		{
			get
			{
