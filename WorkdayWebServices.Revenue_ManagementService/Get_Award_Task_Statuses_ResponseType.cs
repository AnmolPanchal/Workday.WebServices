...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Award_Task_Statuses_ResponseType : INotifyPropertyChanged
	{
		private Award_Task_StatusObjectType[] request_ReferencesField;

		private Award_Task_Status_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Award_Task_StatusType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Award_Task_Status_Reference", IsNullable = false)]
		public Award_Task_StatusObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Award_Task_Status_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Award_Task_Status", IsNullable = false)]
		public Award_Task_StatusType[] Response_Data
		{
			get
			{
