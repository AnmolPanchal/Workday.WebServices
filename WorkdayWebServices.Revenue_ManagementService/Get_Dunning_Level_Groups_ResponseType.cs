...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Dunning_Level_Groups_ResponseType : INotifyPropertyChanged
	{
		private Dunning_Level_GroupObjectType[] request_ReferencesField;

		private Dunning_Level_Group_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Dunning_Level_Group_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Dunning_Level_GroupType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Dunning_Level_Group_Reference", IsNullable = false)]
		public Dunning_Level_GroupObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Dunning_Level_Group_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Dunning_Level_Group_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Dunning_Level_Group", IsNullable = false)]
		public Dunning_Level_GroupType[] Response_Data
		{
			get
			{
