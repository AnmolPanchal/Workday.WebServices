...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Usage_Based_TransactionObjectType : INotifyPropertyChanged
	{
		private Usage_Based_TransactionObjectIDType[] idField;
		...
		public Usage_Based_TransactionObjectIDType[] ID
		{
			get
			{
				return this.idField;
