...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Business_Entity_Contact_TypeObjectType : INotifyPropertyChanged
	{
		private Business_Entity_Contact_TypeObjectIDType[] idField;
		...
		public Business_Entity_Contact_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
