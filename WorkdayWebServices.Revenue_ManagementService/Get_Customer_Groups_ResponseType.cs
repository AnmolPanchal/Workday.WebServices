...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Customer_Groups_ResponseType : INotifyPropertyChanged
	{
		private Customer_GroupObjectType[] request_ReferencesField;

		private Customer_Group_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Customer_Group_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Customer_GroupType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Customer_Group_Reference", IsNullable = false)]
		public Customer_GroupObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Customer_Group_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Customer_Group_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Customer_Group", IsNullable = false)]
		public Customer_GroupType[] Response_Data
		{
			get
			{
