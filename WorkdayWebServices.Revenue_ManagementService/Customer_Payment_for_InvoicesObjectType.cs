...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Customer_Payment_for_InvoicesObjectType : INotifyPropertyChanged
	{
		private Customer_Payment_for_InvoicesObjectIDType[] idField;
		...
		public Customer_Payment_for_InvoicesObjectIDType[] ID
		{
			get
			{
				return this.idField;
