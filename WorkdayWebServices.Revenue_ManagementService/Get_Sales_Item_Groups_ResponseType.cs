...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Sales_Item_Groups_ResponseType : INotifyPropertyChanged
	{
		private Sales_Item_GroupObjectType[] request_ReferencesField;

		private Sales_Item_Group_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Sales_Item_Group_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Sales_Item_GroupType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Sales_Item_Group_Reference", IsNullable = false)]
		public Sales_Item_GroupObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Sales_Item_Group_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Sales_Item_Group_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Sales_Item_Group", IsNullable = false)]
		public Sales_Item_GroupType[] Response_Data
		{
			get
			{
