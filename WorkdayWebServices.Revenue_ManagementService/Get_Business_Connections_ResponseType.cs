...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Business_Connections_ResponseType : INotifyPropertyChanged
	{
		private Customer_Business_ConnectionObjectType[] request_ReferencesField;

		private Business_Connection_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Business_Connection_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Business_ConnectionType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Business_Connection_Reference", IsNullable = false)]
		public Customer_Business_ConnectionObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Business_Connection_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Business_Connection_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Business_Connection", IsNullable = false)]
		public Business_ConnectionType[] Response_Data
		{
			get
			{
