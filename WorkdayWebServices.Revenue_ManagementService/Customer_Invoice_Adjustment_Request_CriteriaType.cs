...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Customer_Invoice_Adjustment_Request_CriteriaType : INotifyPropertyChanged
	{
		...
		[XmlElement("Adjustment_Reason_Reference", Order = 5)]
		...
		[XmlElement("Creating_Worker_Reference", Order = 9)]
		...
		[XmlElement("Approving_Worker_Reference", Order = 10)]
		...
		[XmlElement("Customer_Hierarchy_Reference", Order = 11)]
		...
		[XmlElement("Customer_Status_Reference", Order = 12)]
		...
		[XmlElement("Payment_Status_Reference", Order = 13)]
		...
		[XmlElement("Payment_Type_Reference", Order = 14)]
