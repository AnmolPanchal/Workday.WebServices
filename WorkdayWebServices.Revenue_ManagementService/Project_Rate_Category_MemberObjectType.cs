...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Project_Rate_Category_MemberObjectType : INotifyPropertyChanged
	{
		private Project_Rate_Category_MemberObjectIDType[] idField;
		...
		public Project_Rate_Category_MemberObjectIDType[] ID
		{
			get
			{
				return this.idField;
