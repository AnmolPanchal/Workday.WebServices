...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Pay_Component_Group__All_ObjectType : INotifyPropertyChanged
	{
		private Pay_Component_Group__All_ObjectIDType[] idField;
		...
		public Pay_Component_Group__All_ObjectIDType[] ID
		{
			get
			{
				return this.idField;
