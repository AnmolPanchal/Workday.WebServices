...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Get_Sponsors_ResponseType : INotifyPropertyChanged
	{
		private SponsorObjectType[] request_ReferencesField;

		private Sponsor_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Sponsor_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private SponsorType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Sponsor_Reference", IsNullable = false)]
		public SponsorObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Sponsor_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Sponsor_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Sponsor", IsNullable = false)]
		public SponsorType[] Response_Data
		{
			get
			{
