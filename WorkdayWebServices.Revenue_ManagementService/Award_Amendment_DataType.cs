...
namespace WorkdayWebServices.Revenue_ManagementService
{
	...
	[Serializable]
	public class Award_Amendment_DataType : INotifyPropertyChanged
	{
		private Award_ContractObjectType award_Contract_to_Amend_ReferenceField;
		...
		private Award_ProposalObjectType original_Award_Proposal_ReferenceField;

		private Award_ProposalObjectType[] related_Proposals_ReferenceField;

		private Award_Contract_Amendment_InformationType award_Contract_Amendment_InformationField;

		private string award_NotesField;

		private string billing_NotesField;

		private Award_Contract_Amendment_Line_DataType[] award_Amendment_Line_DataField;

		private Special_Condition_Amendment_DataType[] special_Condition_Amendment_DataField;

		private Award_Personnel_Amendment_DataType[] award_Personnel_Amendment_DataField;

		private Award_Budget_Amendment_DataType[] award_Budget_Amendment_DataField;
		...
		[XmlElement(Order = 0)]
		public Award_ContractObjectType Award_Contract_to_Amend_Reference
		{
			get
			{
				return this.award_Contract_to_Amend_ReferenceField;
			}
			set
			{
				this.award_Contract_to_Amend_ReferenceField = value;
				this.RaisePropertyChanged("Award_Contract_to_Amend_Reference");
			}
		}
		...
		[XmlElement("Purpose_Code_Reference", Order = 9)]
		...
		[XmlElement("Organizations_for_Award_Reference", Order = 14)]
		...
		[XmlElement("Spend_Restriction_Default_Reference", Order = 17)]
		...
		[XmlElement("NSF_Code_Reference", Order = 42)]
		...
		[XmlElement(Order = 45)]
		public Award_ProposalObjectType Original_Award_Proposal_Reference
		{
			get
			{
				return this.original_Award_Proposal_ReferenceField;
			}
			set
			{
				this.original_Award_Proposal_ReferenceField = value;
				this.RaisePropertyChanged("Original_Award_Proposal_Reference");
			}
		}

		[XmlElement("Related_Proposals_Reference", Order = 46)]
		...
		[XmlElement(Order = 47)]
		public Award_Contract_Amendment_InformationType Award_Contract_Amendment_Information
		{
			get
			{
				return this.award_Contract_Amendment_InformationField;
			}
			set
			{
				this.award_Contract_Amendment_InformationField = value;
				this.RaisePropertyChanged("Award_Contract_Amendment_Information");
			}
		}
		...
		[XmlElement("Award_Amendment_Line_Data", Order = 50)]
		public Award_Contract_Amendment_Line_DataType[] Award_Amendment_Line_Data
		{
			get
			{
				return this.award_Amendment_Line_DataField;
			}
			set
			{
				this.award_Amendment_Line_DataField = value;
				this.RaisePropertyChanged("Award_Amendment_Line_Data");
			}
		}

		[XmlElement("Special_Condition_Amendment_Data", Order = 51)]
		public Special_Condition_Amendment_DataType[] Special_Condition_Amendment_Data
		{
			get
			{
				return this.special_Condition_Amendment_DataField;
			}
			set
			{
				this.special_Condition_Amendment_DataField = value;
				this.RaisePropertyChanged("Special_Condition_Amendment_Data");
			}
		}

		[XmlElement("Award_Personnel_Amendment_Data", Order = 52)]
		public Award_Personnel_Amendment_DataType[] Award_Personnel_Amendment_Data
		{
			get
			{
				return this.award_Personnel_Amendment_DataField;
			}
			set
			{
				this.award_Personnel_Amendment_DataField = value;
				this.RaisePropertyChanged("Award_Personnel_Amendment_Data");
			}
		}

		[XmlElement("Award_Budget_Amendment_Data", Order = 53)]
		public Award_Budget_Amendment_DataType[] Award_Budget_Amendment_Data
		{
			get
			{
				return this.award_Budget_Amendment_DataField;
			}
			set
			{
				this.award_Budget_Amendment_DataField = value;
				this.RaisePropertyChanged("Award_Budget_Amendment_Data");
			}
		}

		[XmlElement("Attachment_Data", Order = 54)]
