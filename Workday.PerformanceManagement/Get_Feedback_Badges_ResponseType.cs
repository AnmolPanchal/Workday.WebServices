...
namespace WorkdayWebServices.Performance_ManagementService
{
	...
	[Serializable]
	public class Get_Feedback_Badges_ResponseType : INotifyPropertyChanged
	{
		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Feedback__BadgeType[] response_DataField;
		...
		[XmlArray(Order = 2), XmlArrayItem("Feedback_Badge", IsNullable = false)]
		public Feedback__BadgeType[] Response_Data
		{
			get
			{
