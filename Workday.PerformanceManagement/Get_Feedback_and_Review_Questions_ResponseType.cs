...
namespace WorkdayWebServices.Performance_ManagementService
{
	...
	[Serializable]
	public class Get_Feedback_and_Review_Questions_ResponseType : INotifyPropertyChanged
	{
		private QuestionObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Feedback_and_Review_QuestionType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Feedback_and_Review_Question_Reference", IsNullable = false)]
		public QuestionObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Feedback_and_Review_Question", IsNullable = false)]
		public Feedback_and_Review_QuestionType[] Response_Data
		{
			get
			{
