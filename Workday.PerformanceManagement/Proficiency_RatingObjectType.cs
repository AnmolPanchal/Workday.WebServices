...
namespace WorkdayWebServices.Performance_ManagementService
{
	...
	[Serializable]
	public class Proficiency_RatingObjectType : INotifyPropertyChanged
	{
		private Proficiency_RatingObjectIDType[] idField;
		...
		public Proficiency_RatingObjectIDType[] ID
		{
			get
			{
				return this.idField;
