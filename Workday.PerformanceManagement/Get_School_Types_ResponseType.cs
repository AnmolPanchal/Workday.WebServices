...
namespace WorkdayWebServices.Performance_ManagementService
{
	...
	[Serializable]
	public class Get_School_Types_ResponseType : INotifyPropertyChanged
	{
		private School_TypeObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private School_TypeType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("School_Type_Reference", IsNullable = false)]
		public School_TypeObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("School_Type", IsNullable = false)]
		public School_TypeType[] Response_Data
		{
			get
			{
