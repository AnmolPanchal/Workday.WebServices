...
namespace WorkdayWebServices.Performance_ManagementService
{
	...
	[Serializable]
	public class Manage_Goals_RequestType : INotifyPropertyChanged
	{
		private Business_Process_ParametersType business_Process_ParametersField;

		private Manage_Goals_DataType manage_Goals_DataField;
		...
		[XmlElement(Order = 1)]
		public Manage_Goals_DataType Manage_Goals_Data
		{
			get
			{
				return this.manage_Goals_DataField;
			}
			set
			{
				this.manage_Goals_DataField = value;
				this.RaisePropertyChanged("Manage_Goals_Data");
			}
		}
