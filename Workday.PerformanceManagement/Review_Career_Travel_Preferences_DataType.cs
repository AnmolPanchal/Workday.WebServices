...
namespace WorkdayWebServices.Performance_ManagementService
{
	...
	[Serializable]
	public class Review_Career_Travel_Preferences_DataType : INotifyPropertyChanged
	{
		private Mobility_ChoiceObjectType mobility_Choice_ReferenceField;
		...
		[XmlElement(Order = 0)]
		public Mobility_ChoiceObjectType Mobility_Choice_Reference
		{
			get
			{
				return this.mobility_Choice_ReferenceField;
			}
			set
			{
				this.mobility_Choice_ReferenceField = value;
				this.RaisePropertyChanged("Mobility_Choice_Reference");
			}
		}
