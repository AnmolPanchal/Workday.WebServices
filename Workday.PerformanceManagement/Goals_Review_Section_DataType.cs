...
namespace WorkdayWebServices.Performance_ManagementService
{
	...
	[Serializable]
	public class Goals_Review_Section_DataType : INotifyPropertyChanged
	{
		private Review_Goal_DataType[] review_Goal_DataField;
		...
		[XmlElement("Review_Goal_Data", Order = 0)]
		public Review_Goal_DataType[] Review_Goal_Data
		{
			get
			{
				return this.review_Goal_DataField;
			}
			set
			{
				this.review_Goal_DataField = value;
				this.RaisePropertyChanged("Review_Goal_Data");
			}
		}
