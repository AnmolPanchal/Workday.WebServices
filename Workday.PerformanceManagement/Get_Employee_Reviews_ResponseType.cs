...
namespace WorkdayWebServices.Performance_ManagementService
{
	...
	[Serializable]
	public class Get_Employee_Reviews_ResponseType : INotifyPropertyChanged
	{
		private Employee_ReviewObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Employee_ReviewType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Employee_Review_Reference", IsNullable = false)]
		public Employee_ReviewObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Employee_Review", IsNullable = false)]
		public Employee_ReviewType[] Response_Data
		{
			get
			{
