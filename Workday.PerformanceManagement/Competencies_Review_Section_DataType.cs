...
namespace WorkdayWebServices.Performance_ManagementService
{
	...
	[Serializable]
	public class Competencies_Review_Section_DataType : INotifyPropertyChanged
	{
		private Review_Competency_DataType[] review_Competency_DataField;
		...
		[XmlElement("Review_Competency_Data", Order = 0)]
		public Review_Competency_DataType[] Review_Competency_Data
		{
			get
			{
				return this.review_Competency_DataField;
			}
			set
			{
				this.review_Competency_DataField = value;
				this.RaisePropertyChanged("Review_Competency_Data");
			}
		}
