...
namespace WorkdayWebServices.Performance_ManagementService
{
	...
	[Serializable]
	public class Accomplishments_Review_Section_DataType : INotifyPropertyChanged
	{
		private Review_Accomplishment_DataType[] review_Accomplishment_DataField;
		...
		[XmlElement("Review_Accomplishment_Data", Order = 0)]
		public Review_Accomplishment_DataType[] Review_Accomplishment_Data
		{
			get
			{
				return this.review_Accomplishment_DataField;
			}
			set
			{
				this.review_Accomplishment_DataField = value;
				this.RaisePropertyChanged("Review_Accomplishment_Data");
			}
		}
