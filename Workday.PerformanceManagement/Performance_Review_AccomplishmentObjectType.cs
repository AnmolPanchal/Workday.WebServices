...
namespace WorkdayWebServices.Performance_ManagementService
{
	...
	[Serializable]
	public class Performance_Review_AccomplishmentObjectType : INotifyPropertyChanged
	{
		private Performance_Review_AccomplishmentObjectIDType[] idField;
		...
		public Performance_Review_AccomplishmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
