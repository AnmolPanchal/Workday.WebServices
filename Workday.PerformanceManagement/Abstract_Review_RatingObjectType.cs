...
namespace WorkdayWebServices.Performance_ManagementService
{
	...
	[Serializable]
	public class Abstract_Review_RatingObjectType : INotifyPropertyChanged
	{
		private Abstract_Review_RatingObjectIDType[] idField;
		...
		public Abstract_Review_RatingObjectIDType[] ID
		{
			get
			{
				return this.idField;
