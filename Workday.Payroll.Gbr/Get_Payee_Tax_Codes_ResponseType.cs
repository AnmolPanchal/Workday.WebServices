...
namespace WorkdayWebServices.Payroll_GBRService
{
	...
	[Serializable]
	public class Get_Payee_Tax_Codes_ResponseType : INotifyPropertyChanged
	{
		private Unique_IdentifierObjectType[] request_ReferencesField;

		private Payee_Tax_Code_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Payee_Tax_Code_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Payee_Tax_CodeType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Payee_Tax_Code_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Payee_Tax_Code_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Payee_Tax_Code_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Payee_Tax_Code", IsNullable = false)]
		public Payee_Tax_CodeType[] Response_Data
		{
			get
			{
