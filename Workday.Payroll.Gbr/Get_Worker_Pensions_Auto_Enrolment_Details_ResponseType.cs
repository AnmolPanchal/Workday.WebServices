...
namespace WorkdayWebServices.Payroll_GBRService
{
	...
	[Serializable]
	public class Get_Worker_Pensions_Auto_Enrolment_Details_ResponseType : INotifyPropertyChanged
	{
		private Unique_IdentifierObjectType[] request_ReferencesField;

		private Worker_Pensions_Auto_Enrolment_Details_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Worker_Pensions_Auto_Enrolment_Details_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Worker_Pensions_Auto_Enrolment_DetailsType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Worker_Pensions_Auto_Enrolment_Details_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Worker_Pensions_Auto_Enrolment_Details_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Worker_Pensions_Auto_Enrolment_Details_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Worker_Pensions_Auto_Enrolment_Details", IsNullable = false)]
		public Worker_Pensions_Auto_Enrolment_DetailsType[] Response_Data
		{
			get
			{
