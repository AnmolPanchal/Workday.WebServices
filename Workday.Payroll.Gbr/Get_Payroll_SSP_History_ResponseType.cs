...
namespace WorkdayWebServices.Payroll_GBRService
{
	...
	[Serializable]
	public class Get_Payroll_SSP_History_ResponseType : INotifyPropertyChanged
	{
		...
		private Payroll_SSP_History_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Payroll_SSP_HistoryType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Payroll_SSP_History_Request_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 3)]
		public Payroll_SSP_History_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Payroll_SSP_History", IsNullable = false)]
		public Payroll_SSP_HistoryType[] Response_Data
		{
			get
			{
