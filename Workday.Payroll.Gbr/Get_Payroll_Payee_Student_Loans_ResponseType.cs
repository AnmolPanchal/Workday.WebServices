...
namespace WorkdayWebServices.Payroll_GBRService
{
	...
	[Serializable]
	public class Get_Payroll_Payee_Student_Loans_ResponseType : INotifyPropertyChanged
	{
		private Unique_IdentifierObjectType[] request_ReferencesField;

		private Payroll_Payee_Student_Loan_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Payroll_Payee_Student_Loan_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Payee_Student_LoanType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Payroll_Payee_Student_Loan_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Payroll_Payee_Student_Loan_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Payroll_Payee_Student_Loan_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Payroll_Payee_Student_Loans", IsNullable = false)]
		public Payee_Student_LoanType[] Response_Data
		{
			get
			{
