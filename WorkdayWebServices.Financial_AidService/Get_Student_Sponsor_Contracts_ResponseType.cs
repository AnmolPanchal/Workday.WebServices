...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Get_Student_Sponsor_Contracts_ResponseType : INotifyPropertyChanged
	{
		private Student_Sponsor_ContractObjectType[] request_ReferencesField;

		private Student_Sponsor_Contract_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Student_Sponsor_ContractType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Student_Sponsor_Contract_Reference", IsNullable = false)]
		public Student_Sponsor_ContractObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Student_Sponsor_Contract_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Student_Sponsor_Contract", IsNullable = false)]
		public Student_Sponsor_ContractType[] Response_Data
		{
			get
			{
