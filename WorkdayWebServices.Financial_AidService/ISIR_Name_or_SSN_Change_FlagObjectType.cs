...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class ISIR_Name_or_SSN_Change_FlagObjectType : INotifyPropertyChanged
	{
		private ISIR_Name_or_SSN_Change_FlagObjectIDType[] idField;
		...
		public ISIR_Name_or_SSN_Change_FlagObjectIDType[] ID
		{
			get
			{
				return this.idField;
