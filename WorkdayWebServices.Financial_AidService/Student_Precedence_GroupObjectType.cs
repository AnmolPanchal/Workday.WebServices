...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Student_Precedence_GroupObjectType : INotifyPropertyChanged
	{
		private Student_Precedence_GroupObjectIDType[] idField;
		...
		public Student_Precedence_GroupObjectIDType[] ID
		{
			get
			{
				return this.idField;
