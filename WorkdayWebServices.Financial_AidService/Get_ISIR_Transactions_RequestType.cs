...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Get_ISIR_Transactions_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(ISIR_Transaction_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(ISIR_Transaction_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
