...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class ISIR_IRS_Display_FlagObjectType : INotifyPropertyChanged
	{
		private ISIR_IRS_Display_FlagObjectIDType[] idField;
		...
		public ISIR_IRS_Display_FlagObjectIDType[] ID
		{
			get
			{
				return this.idField;
