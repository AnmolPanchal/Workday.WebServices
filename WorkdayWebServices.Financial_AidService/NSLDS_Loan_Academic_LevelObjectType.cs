...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class NSLDS_Loan_Academic_LevelObjectType : INotifyPropertyChanged
	{
		private NSLDS_Loan_Academic_LevelObjectIDType[] idField;
		...
		public NSLDS_Loan_Academic_LevelObjectIDType[] ID
		{
			get
			{
				return this.idField;
