...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class NSLDS_Transaction_DataType : INotifyPropertyChanged
	{
		...
		[XmlElement("NSLDS_Pell_Grant_Data", Order = 40)]
		...
		[XmlElement("NSLDS_TEACH_Grant_Data", Order = 41)]
		...
		[XmlElement("NSLDS_Loan_Data", Order = 42)]
