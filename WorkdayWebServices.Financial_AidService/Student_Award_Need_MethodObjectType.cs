...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Student_Award_Need_MethodObjectType : INotifyPropertyChanged
	{
		private Student_Award_Need_MethodObjectIDType[] idField;
		...
		public Student_Award_Need_MethodObjectIDType[] ID
		{
			get
			{
				return this.idField;
