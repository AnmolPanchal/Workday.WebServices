...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class ISIR_VA_Match_FlagObjectType : INotifyPropertyChanged
	{
		private ISIR_VA_Match_FlagObjectIDType[] idField;
		...
		public ISIR_VA_Match_FlagObjectIDType[] ID
		{
			get
			{
				return this.idField;
