...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class ISIR_SSN_Match_FlagObjectType : INotifyPropertyChanged
	{
		private ISIR_SSN_Match_FlagObjectIDType[] idField;
		...
		public ISIR_SSN_Match_FlagObjectIDType[] ID
		{
			get
			{
				return this.idField;
