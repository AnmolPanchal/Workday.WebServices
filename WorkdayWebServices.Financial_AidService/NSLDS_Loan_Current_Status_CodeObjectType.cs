...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class NSLDS_Loan_Current_Status_CodeObjectType : INotifyPropertyChanged
	{
		private NSLDS_Loan_Current_Status_CodeObjectIDType[] idField;
		...
		public NSLDS_Loan_Current_Status_CodeObjectIDType[] ID
		{
			get
			{
				return this.idField;
