...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Student_Sponsor_ContractObjectType : INotifyPropertyChanged
	{
		private Student_Sponsor_ContractObjectIDType[] idField;
		...
		public Student_Sponsor_ContractObjectIDType[] ID
		{
			get
			{
				return this.idField;
