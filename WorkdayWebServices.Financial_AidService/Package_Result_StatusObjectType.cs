...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Package_Result_StatusObjectType : INotifyPropertyChanged
	{
		private Package_Result_StatusObjectIDType[] idField;
		...
		public Package_Result_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
