...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Student_Disbursement_ScheduleObjectType : INotifyPropertyChanged
	{
		private Student_Disbursement_ScheduleObjectIDType[] idField;
		...
		public Student_Disbursement_ScheduleObjectIDType[] ID
		{
			get
			{
				return this.idField;
