...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Financial_Aid_Award_YearObjectType : INotifyPropertyChanged
	{
		private Financial_Aid_Award_YearObjectIDType[] idField;
		...
		public Financial_Aid_Award_YearObjectIDType[] ID
		{
			get
			{
				return this.idField;
