...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Financial_Aid_GenderObjectType : INotifyPropertyChanged
	{
		private Financial_Aid_GenderObjectIDType[] idField;
		...
		public Financial_Aid_GenderObjectIDType[] ID
		{
			get
			{
				return this.idField;
