...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class ISIR_Reject_Reason_CodeObjectType : INotifyPropertyChanged
	{
		private ISIR_Reject_Reason_CodeObjectIDType[] idField;
		...
		public ISIR_Reject_Reason_CodeObjectIDType[] ID
		{
			get
			{
				return this.idField;
