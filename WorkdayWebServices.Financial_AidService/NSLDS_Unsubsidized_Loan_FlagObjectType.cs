...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class NSLDS_Unsubsidized_Loan_FlagObjectType : INotifyPropertyChanged
	{
		private NSLDS_Unsubsidized_Loan_FlagObjectIDType[] idField;
		...
		public NSLDS_Unsubsidized_Loan_FlagObjectIDType[] ID
		{
			get
			{
				return this.idField;
