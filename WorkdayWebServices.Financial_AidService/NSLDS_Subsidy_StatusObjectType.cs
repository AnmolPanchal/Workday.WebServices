...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class NSLDS_Subsidy_StatusObjectType : INotifyPropertyChanged
	{
		private NSLDS_Subsidy_StatusObjectIDType[] idField;
		...
		public NSLDS_Subsidy_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
