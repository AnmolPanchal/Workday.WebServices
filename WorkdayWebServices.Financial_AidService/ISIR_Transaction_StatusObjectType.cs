...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class ISIR_Transaction_StatusObjectType : INotifyPropertyChanged
	{
		private ISIR_Transaction_StatusObjectIDType[] idField;
		...
		public ISIR_Transaction_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
