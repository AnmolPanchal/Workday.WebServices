...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class ISIR_Tax_Return_StatusObjectType : INotifyPropertyChanged
	{
		private ISIR_Tax_Return_StatusObjectIDType[] idField;
		...
		public ISIR_Tax_Return_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
