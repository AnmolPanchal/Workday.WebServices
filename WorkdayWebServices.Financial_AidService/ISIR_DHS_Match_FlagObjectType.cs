...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class ISIR_DHS_Match_FlagObjectType : INotifyPropertyChanged
	{
		private ISIR_DHS_Match_FlagObjectIDType[] idField;
		...
		public ISIR_DHS_Match_FlagObjectIDType[] ID
		{
			get
			{
				return this.idField;
