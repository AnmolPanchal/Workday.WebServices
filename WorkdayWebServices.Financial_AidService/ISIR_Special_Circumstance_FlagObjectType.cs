...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class ISIR_Special_Circumstance_FlagObjectType : INotifyPropertyChanged
	{
		private ISIR_Special_Circumstance_FlagObjectIDType[] idField;
		...
		public ISIR_Special_Circumstance_FlagObjectIDType[] ID
		{
			get
			{
				return this.idField;
