...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Student_Hold__All_ObjectType : INotifyPropertyChanged
	{
		private Student_Hold__All_ObjectIDType[] idField;
		...
		public Student_Hold__All_ObjectIDType[] ID
		{
			get
			{
				return this.idField;
