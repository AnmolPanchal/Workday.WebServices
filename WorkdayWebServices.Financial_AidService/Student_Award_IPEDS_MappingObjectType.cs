...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Student_Award_IPEDS_MappingObjectType : INotifyPropertyChanged
	{
		private Student_Award_IPEDS_MappingObjectIDType[] idField;
		...
		public Student_Award_IPEDS_MappingObjectIDType[] ID
		{
			get
			{
				return this.idField;
