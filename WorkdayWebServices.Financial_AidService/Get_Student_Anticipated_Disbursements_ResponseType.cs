...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Get_Student_Anticipated_Disbursements_ResponseType : INotifyPropertyChanged
	{
		private Student_Anticipated_DisbursementObjectType[] request_ReferencesField;

		private Student_Anticipated_Disbursement_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Student_Anticipated_DisbursementType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Student_Anticipated_Disbursement_Reference", IsNullable = false)]
		public Student_Anticipated_DisbursementObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Student_Anticipated_Disbursement_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Student_Anticipated_Disbursement", IsNullable = false)]
		public Student_Anticipated_DisbursementType[] Response_Data
		{
			get
			{
