...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Student_Waiver_ItemObjectType : INotifyPropertyChanged
	{
		private Student_Waiver_ItemObjectIDType[] idField;
		...
		public Student_Waiver_ItemObjectIDType[] ID
		{
			get
			{
				return this.idField;
