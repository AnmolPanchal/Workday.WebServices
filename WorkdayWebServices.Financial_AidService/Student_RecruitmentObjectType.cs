...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Student_RecruitmentObjectType : INotifyPropertyChanged
	{
		private Student_RecruitmentObjectIDType[] idField;
		...
		public Student_RecruitmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
