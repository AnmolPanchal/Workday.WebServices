...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class NSLDS_Loan_Limit_FlagObjectType : INotifyPropertyChanged
	{
		private NSLDS_Loan_Limit_FlagObjectIDType[] idField;
		...
		public NSLDS_Loan_Limit_FlagObjectIDType[] ID
		{
			get
			{
				return this.idField;
