...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Student_Manual_AwardObjectType : INotifyPropertyChanged
	{
		private Student_Manual_AwardObjectIDType[] idField;
		...
		public Student_Manual_AwardObjectIDType[] ID
		{
			get
			{
				return this.idField;
