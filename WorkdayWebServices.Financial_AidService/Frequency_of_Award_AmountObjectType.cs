...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Frequency_of_Award_AmountObjectType : INotifyPropertyChanged
	{
		private Frequency_of_Award_AmountObjectIDType[] idField;
		...
		public Frequency_of_Award_AmountObjectIDType[] ID
		{
			get
			{
				return this.idField;
