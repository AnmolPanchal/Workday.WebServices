...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Company_Insider_Types_ResponseType : INotifyPropertyChanged
	{
		private Company_Insider_TypeObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Company_Insider_TypeType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Company_Insider_Type_Reference", IsNullable = false)]
		public Company_Insider_TypeObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Company_Insider_Type", IsNullable = false)]
		public Company_Insider_TypeType[] Response_Data
		{
			get
			{
