...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Committee_Membership_TypeObjectType : INotifyPropertyChanged
	{
		private Committee_Membership_TypeObjectIDType[] idField;
		...
		public Committee_Membership_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
