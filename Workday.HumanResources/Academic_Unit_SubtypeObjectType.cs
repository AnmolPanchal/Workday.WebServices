...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Academic_Unit_SubtypeObjectType : INotifyPropertyChanged
	{
		private Academic_Unit_SubtypeObjectIDType[] idField;
		...
		public Academic_Unit_SubtypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
