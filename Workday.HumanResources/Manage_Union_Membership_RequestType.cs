...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Manage_Union_Membership_RequestType : INotifyPropertyChanged
	{
		private Business_Process_ParametersType business_Process_ParametersField;

		private Union_Member_DataType union_Member_DataField;
		...
		[XmlElement(Order = 1)]
		public Union_Member_DataType Union_Member_Data
		{
			get
			{
				return this.union_Member_DataField;
			}
			set
			{
				this.union_Member_DataField = value;
				this.RaisePropertyChanged("Union_Member_Data");
			}
		}
