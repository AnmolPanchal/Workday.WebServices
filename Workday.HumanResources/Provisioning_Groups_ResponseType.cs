...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Provisioning_Groups_ResponseType : INotifyPropertyChanged
	{
		private Provisioning_GroupObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Provisioning_Group_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Provisioning_GroupType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Provisioning_Group_Request_Reference", IsNullable = false)]
		public Provisioning_GroupObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 2)]
		public Provisioning_Group_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Provisioning_Group", IsNullable = false)]
		public Provisioning_GroupType[] Response_Data
		{
			get
			{
