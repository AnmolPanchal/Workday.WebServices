...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Employee_Compensation_Commission_Plan_Assignment_Detail_DataType : INotifyPropertyChanged
	{
		...
		private Draw_Frequency_ReferenceType draw_Frequency_ReferenceField;
		...
		[XmlElement(Order = 5)]
		public Draw_Frequency_ReferenceType Draw_Frequency_Reference
		{
			get
			{
