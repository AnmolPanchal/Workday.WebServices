...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Academic_Track_TypeObjectType : INotifyPropertyChanged
	{
		private Academic_Track_TypeObjectIDType[] idField;
		...
		public Academic_Track_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
