...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Committee_Classification_Groups_ResponseType : INotifyPropertyChanged
	{
		private Committee_Classification_GroupObjectType[] request_ReferencesField;

		private Committee_Classification_Group_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Committee_Classification_Group_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Committee_Classification_GroupType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Committee_Classification_Group_Reference", IsNullable = false)]
		public Committee_Classification_GroupObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Committee_Classification_Group_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Committee_Classification_Group_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Committee_Classification_Group", IsNullable = false)]
		public Committee_Classification_GroupType[] Response_Data
		{
			get
			{
