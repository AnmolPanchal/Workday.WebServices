...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Establishment_Legal_EntityObjectType : INotifyPropertyChanged
	{
		private Establishment_Legal_EntityObjectIDType[] idField;
		...
		public Establishment_Legal_EntityObjectIDType[] ID
		{
			get
			{
				return this.idField;
