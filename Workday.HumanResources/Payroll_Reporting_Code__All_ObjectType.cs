...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Payroll_Reporting_Code__All_ObjectType : INotifyPropertyChanged
	{
		private Payroll_Reporting_Code__All_ObjectIDType[] idField;
		...
		public Payroll_Reporting_Code__All_ObjectIDType[] ID
		{
			get
			{
				return this.idField;
