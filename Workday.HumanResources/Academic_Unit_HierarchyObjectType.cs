...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Academic_Unit_HierarchyObjectType : INotifyPropertyChanged
	{
		private Academic_Unit_HierarchyObjectIDType[] idField;
		...
		public Academic_Unit_HierarchyObjectIDType[] ID
		{
			get
			{
				return this.idField;
