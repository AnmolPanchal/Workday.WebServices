...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Committee_Meeting_TypeObjectType : INotifyPropertyChanged
	{
		private Committee_Meeting_TypeObjectIDType[] idField;
		...
		public Committee_Meeting_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
