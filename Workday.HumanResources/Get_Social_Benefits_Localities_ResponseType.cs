...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Social_Benefits_Localities_ResponseType : INotifyPropertyChanged
	{
		private Social_Benefits_LocalityObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Social_Benefits_LocalityType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Social_Benefits_Locality_Reference", IsNullable = false)]
		public Social_Benefits_LocalityObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("Social_Benefits_Locality", IsNullable = false)]
		public Social_Benefits_LocalityType[] Response_Data
		{
			get
			{
