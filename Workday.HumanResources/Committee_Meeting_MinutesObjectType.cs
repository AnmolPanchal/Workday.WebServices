...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Committee_Meeting_MinutesObjectType : INotifyPropertyChanged
	{
		private Committee_Meeting_MinutesObjectIDType[] idField;
		...
		public Committee_Meeting_MinutesObjectIDType[] ID
		{
			get
			{
				return this.idField;
