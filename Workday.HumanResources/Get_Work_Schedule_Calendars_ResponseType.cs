...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Work_Schedule_Calendars_ResponseType : INotifyPropertyChanged
	{
		private Work_Schedule_CalendarObjectType[] request_ReferencesField;

		private Work_Schedule_Calendar_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Work_Schedule_Calendar_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Work_Schedule_CalendarType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Work_Schedule_Calendar_Request_Reference", IsNullable = false)]
		public Work_Schedule_CalendarObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Work_Schedule_Calendar_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Work_Schedule_Calendar_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Work_Schedule_Calendar", IsNullable = false)]
		public Work_Schedule_CalendarType[] Response_Data
		{
			get
			{
