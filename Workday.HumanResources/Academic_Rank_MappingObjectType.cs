...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Academic_Rank_MappingObjectType : INotifyPropertyChanged
	{
		private Academic_Rank_MappingObjectIDType[] idField;
		...
		public Academic_Rank_MappingObjectIDType[] ID
		{
			get
			{
				return this.idField;
