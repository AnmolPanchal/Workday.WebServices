...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Reference_Letter_TemplateObjectType : INotifyPropertyChanged
	{
		private Reference_Letter_TemplateObjectIDType[] idField;
		...
		public Reference_Letter_TemplateObjectIDType[] ID
		{
			get
			{
				return this.idField;
