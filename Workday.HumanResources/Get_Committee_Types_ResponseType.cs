...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Committee_Types_ResponseType : INotifyPropertyChanged
	{
		private Committee_TypeObjectType[] request_ReferencesField;

		private Committee_Type_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Committee_Type_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Committee_TypeType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Committee_Type_Reference", IsNullable = false)]
		public Committee_TypeObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Committee_Type_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Committee_Type_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Committee_Type", IsNullable = false)]
		public Committee_TypeType[] Response_Data
		{
			get
			{
