...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_LGBT_Identifications_ResponseType : INotifyPropertyChanged
	{
		private LGBT_IdentificationObjectType[] request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private LGBT_IdentificationType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("LGBT_Identification_Reference", IsNullable = false)]
		public LGBT_IdentificationObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 3), XmlArrayItem("LGBT_Identification", IsNullable = false)]
		public LGBT_IdentificationType[] Response_Data
		{
			get
			{
