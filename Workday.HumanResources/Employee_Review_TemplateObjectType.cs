...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Employee_Review_TemplateObjectType : INotifyPropertyChanged
	{
		private Employee_Review_TemplateObjectIDType[] idField;
		...
		public Employee_Review_TemplateObjectIDType[] ID
		{
			get
			{
				return this.idField;
