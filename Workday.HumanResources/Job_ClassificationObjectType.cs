...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Job_ClassificationObjectType : INotifyPropertyChanged
	{
		private Job_ClassificationObjectIDType[] idField;
		...
		public Job_ClassificationObjectIDType[] ID
		{
			get
			{
				return this.idField;
