...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Universal_Identifiers_ResponseType : INotifyPropertyChanged
	{
		private RoleObjectType[] request_ReferencesField;

		private Universal_Identifier_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Universal_IdentifierType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Person_Reference", IsNullable = false)]
		...
		[XmlElement(Order = 1)]
		public Universal_Identifier_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Universal_Identifier", IsNullable = false)]
		public Universal_IdentifierType[] Response_Data
		{
			get
			{
