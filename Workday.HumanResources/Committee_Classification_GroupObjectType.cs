...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Committee_Classification_GroupObjectType : INotifyPropertyChanged
	{
		private Committee_Classification_GroupObjectIDType[] idField;
		...
		public Committee_Classification_GroupObjectIDType[] ID
		{
			get
			{
				return this.idField;
