...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class COBRA_Eligibility_ReasonObjectType : INotifyPropertyChanged
	{
		private COBRA_Eligibility_ReasonObjectIDType[] idField;
		...
		public COBRA_Eligibility_ReasonObjectIDType[] ID
		{
			get
			{
				return this.idField;
