...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Committee_Types_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Committee_Type_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Committee_Type_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
