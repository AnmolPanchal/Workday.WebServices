...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	public class EmployeeType : INotifyPropertyChanged
	{
		...
		private Employee_DataType[] employee_DataField;
		...
		[XmlElement("Employee_Data", Order = 1)]
		public Employee_DataType[] Employee_Data
		{
			get
			{
			...
			set
			{
				...
				this.RaisePropertyChanged("Employee_Data");
			}
		}
