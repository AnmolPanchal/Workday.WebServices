...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Locations_ResponseType : INotifyPropertyChanged
	{
		private Location_Request_ReferencesType request_ReferencesField;

		private Location_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Location_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Location_ResponseType[] response_DataField;
		...
		[XmlElement(Order = 0)]
		public Location_Request_ReferencesType Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Location_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Location_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Location", IsNullable = false)]
		public Location_ResponseType[] Response_Data
		{
			get
			{
