...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Provisioning_Groups_RequestType : INotifyPropertyChanged
	{
		...
		[XmlArray(Order = 0), XmlArrayItem("Provisioning_Group_Request_Reference", typeof(Provisioning_GroupObjectType), IsNullable = false)]
