...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Holiday_Calendars_ResponseType : INotifyPropertyChanged
	{
		private Holiday_CalendarObjectType[] request_ReferencesField;

		private Holiday_Calendar_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Holiday_Calendar_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Holiday_CalendarType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Holiday_Calendar_Request_Reference", IsNullable = false)]
		public Holiday_CalendarObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Holiday_Calendar_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Holiday_Calendar_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Holiday_Calendar", IsNullable = false)]
		public Holiday_CalendarType[] Response_Data
		{
			get
			{
