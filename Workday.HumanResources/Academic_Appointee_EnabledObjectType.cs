...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Academic_Appointee_EnabledObjectType : INotifyPropertyChanged
	{
		private Academic_Appointee_EnabledObjectIDType[] idField;
		...
		public Academic_Appointee_EnabledObjectIDType[] ID
		{
			get
			{
				return this.idField;
