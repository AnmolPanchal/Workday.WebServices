...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Employee_Contribution_DataType : INotifyPropertyChanged
	{
		...
		private Annual_Contribution_DataType annual_Contribution_DataField;
		...
		[XmlElement(Order = 3)]
		public Annual_Contribution_DataType Annual_Contribution_Data
		{
			get
			{
				return this.annual_Contribution_DataField;
			}
			set
			{
				this.annual_Contribution_DataField = value;
				this.RaisePropertyChanged("Annual_Contribution_Data");
			}
		}
