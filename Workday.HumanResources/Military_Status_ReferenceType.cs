...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Military_Status_ReferenceType : INotifyPropertyChanged
	{
		private string military_Status_NameField;
		...
		[XmlElement(Order = 0)]
		public string Military_Status_Name
		{
			get
			{
				return this.military_Status_NameField;
			}
			set
			{
				this.military_Status_NameField = value;
				this.RaisePropertyChanged("Military_Status_Name");
			}
		}
