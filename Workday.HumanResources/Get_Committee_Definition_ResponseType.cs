...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Committee_Definition_ResponseType : INotifyPropertyChanged
	{
		private CommitteeObjectType[] request_ReferencesField;

		private Get_Committee_Defintion_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Get_Committee_Defintion_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Committee_DefinitionType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Committee_Definition_Reference", IsNullable = false)]
		public CommitteeObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Get_Committee_Defintion_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Get_Committee_Defintion_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Committee_Definition", IsNullable = false)]
		public Committee_DefinitionType[] Response_Data
		{
			get
			{
