...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Put_Frequency_RequestType : INotifyPropertyChanged
	{
		private FrequencyObjectType frequency_ReferenceField;

		private Frequency_DataType frequency_DataField;
		...
		[XmlElement(Order = 1)]
		public Frequency_DataType Frequency_Data
		{
			get
			{
				return this.frequency_DataField;
			}
			set
			{
				this.frequency_DataField = value;
				this.RaisePropertyChanged("Frequency_Data");
			}
		}
