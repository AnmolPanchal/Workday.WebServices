...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Committee_AttachmentObjectType : INotifyPropertyChanged
	{
		private Committee_AttachmentObjectIDType[] idField;
		...
		public Committee_AttachmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
