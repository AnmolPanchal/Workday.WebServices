...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Committee_Meeting_AttachmentObjectType : INotifyPropertyChanged
	{
		private Committee_Meeting_AttachmentObjectIDType[] idField;
		...
		public Committee_Meeting_AttachmentObjectIDType[] ID
		{
			get
			{
				return this.idField;
