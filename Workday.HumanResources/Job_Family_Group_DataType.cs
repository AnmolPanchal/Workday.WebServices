...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Job_Family_Group_DataType : INotifyPropertyChanged
	{
		...
		private Job_Family_Group_Job_FamilyType[] job_Family_DataField;
		...
		[XmlElement("Job_Family_Data", Order = 5)]
		public Job_Family_Group_Job_FamilyType[] Job_Family_Data
		{
			get
			{
