...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Additional_Name_TypeObjectType : INotifyPropertyChanged
	{
		private Additional_Name_TypeObjectIDType[] idField;
		...
		public Additional_Name_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
