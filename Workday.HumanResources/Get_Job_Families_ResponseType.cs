...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Job_Families_ResponseType : INotifyPropertyChanged
	{
		private Job_Family_Request_ReferencesType request_ReferencesField;

		private Response_FilterType response_FilterField;

		private Job_Families_Request_CriteriaType request_CriteriaField;

		private Job_Family_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Job_FamilyType[] response_DataField;
		...
		[XmlElement(Order = 0)]
		public Job_Family_Request_ReferencesType Request_References
		{
			get
			{
		...
		[XmlElement(Order = 2)]
		public Job_Families_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Job_Family_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Job_Family", IsNullable = false)]
		public Job_FamilyType[] Response_Data
		{
			get
			{
