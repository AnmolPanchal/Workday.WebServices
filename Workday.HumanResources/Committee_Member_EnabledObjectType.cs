...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Committee_Member_EnabledObjectType : INotifyPropertyChanged
	{
		private Committee_Member_EnabledObjectIDType[] idField;
		...
		public Committee_Member_EnabledObjectIDType[] ID
		{
			get
			{
				return this.idField;
