...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Organization_Reference_IDs_ResponseType : INotifyPropertyChanged
	{
		private OrganizationObjectType[] request_ReferencesField;

		private Organization_Reference_ID_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Organization_Reference_IDType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Organization_Reference_ID_Reference", IsNullable = false)]
		public OrganizationObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Organization_Reference_ID_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Organization_Reference_ID", IsNullable = false)]
		public Organization_Reference_IDType[] Response_Data
		{
			get
			{
