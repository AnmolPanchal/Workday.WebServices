...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Former_Workers_ResponseType : INotifyPropertyChanged
	{
		private Former_WorkerObjectType[] request_ReferencesField;

		private Former_Worker_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Former_Worker_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Former_WorkerType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Former_Worker_Reference", IsNullable = false)]
		public Former_WorkerObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Former_Worker_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Former_Worker_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Former_Worker", IsNullable = false)]
		public Former_WorkerType[] Response_Data
		{
			get
			{
