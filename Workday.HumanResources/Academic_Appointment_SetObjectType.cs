...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Academic_Appointment_SetObjectType : INotifyPropertyChanged
	{
		private Academic_Appointment_SetObjectIDType[] idField;
		...
		public Academic_Appointment_SetObjectIDType[] ID
		{
			get
			{
				return this.idField;
