...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Health_Care_Coverage_TargetObjectType : INotifyPropertyChanged
	{
		private Health_Care_Coverage_TargetObjectIDType[] idField;
		...
		public Health_Care_Coverage_TargetObjectIDType[] ID
		{
			get
			{
				return this.idField;
