...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Union_Membership_TypeObjectType : INotifyPropertyChanged
	{
		private Union_Membership_TypeObjectIDType[] idField;
		...
		public Union_Membership_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
