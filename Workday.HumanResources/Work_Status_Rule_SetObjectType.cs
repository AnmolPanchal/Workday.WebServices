...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Work_Status_Rule_SetObjectType : INotifyPropertyChanged
	{
		private Work_Status_Rule_SetObjectIDType[] idField;
		...
		public Work_Status_Rule_SetObjectIDType[] ID
		{
			get
			{
				return this.idField;
