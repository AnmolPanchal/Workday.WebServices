...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Work_Status_Rule_Sets_ResponseType : INotifyPropertyChanged
	{
		private Work_Status_Rule_SetObjectType[] request_ReferencesField;

		private Work_Status_Rule_Set_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Work_Status_Rule_Set_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Work_Status_Rule_SetType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Work_Status_Rule_Set_Reference", IsNullable = false)]
		public Work_Status_Rule_SetObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Work_Status_Rule_Set_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Work_Status_Rule_Set_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Work_Status_Rule_Set", IsNullable = false)]
		public Work_Status_Rule_SetType[] Response_Data
		{
			get
			{
