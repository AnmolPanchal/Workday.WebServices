...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Period_Reporting_CalendarObjectType : INotifyPropertyChanged
	{
		private Period_Reporting_CalendarObjectIDType[] idField;
		...
		public Period_Reporting_CalendarObjectIDType[] ID
		{
			get
			{
				return this.idField;
