...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Background_Check_StatusObjectType : INotifyPropertyChanged
	{
		private Background_Check_StatusObjectIDType[] idField;
		...
		public Background_Check_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
