...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Company_Insider_TypeObjectType : INotifyPropertyChanged
	{
		private Company_Insider_TypeObjectIDType[] idField;
		...
		public Company_Insider_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
