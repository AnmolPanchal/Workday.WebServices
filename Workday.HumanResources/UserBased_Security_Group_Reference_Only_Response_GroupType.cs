...
{
	[GeneratedCode("System.Xml", "4.6.1590.0"), DesignerCategory("code"), DebuggerStepThrough, XmlType(TypeName = "User-Based_Security_Group_Reference_Only_Response_GroupType", Namespace = "urn:com.workday/bsvc")]
	[Serializable]
	public class UserBased_Security_Group_Reference_Only_Response_GroupType : INotifyPropertyChanged
	{
