...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Instant_Messenger_DataType : INotifyPropertyChanged
	{
		private string instant_Messenger_AddressField;

		private string instant_Messenger_CommentField;

		private Instant_Messenger_Type_ReferenceType instant_Messenger_Type_ReferenceField;
		...
		[XmlElement(Order = 2)]
		public Instant_Messenger_Type_ReferenceType Instant_Messenger_Type_Reference
		{
			get
			{
