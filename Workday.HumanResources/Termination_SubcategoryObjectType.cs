...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Termination_SubcategoryObjectType : INotifyPropertyChanged
	{
		private Termination_SubcategoryObjectIDType[] idField;
		...
		public Termination_SubcategoryObjectIDType[] ID
		{
			get
			{
				return this.idField;
