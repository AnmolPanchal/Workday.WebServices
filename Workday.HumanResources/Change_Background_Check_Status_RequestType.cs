...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Change_Background_Check_Status_RequestType : INotifyPropertyChanged
	{
		private Business_Process_ParametersType business_Process_ParametersField;

		private Background_Check_Event_DataType background_Check_Status_DataField;
		...
		[XmlElement(Order = 1)]
		public Background_Check_Event_DataType Background_Check_Status_Data
		{
			get
			{
