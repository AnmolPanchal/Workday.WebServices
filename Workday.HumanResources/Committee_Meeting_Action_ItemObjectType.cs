...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Committee_Meeting_Action_ItemObjectType : INotifyPropertyChanged
	{
		private Committee_Meeting_Action_ItemObjectIDType[] idField;
		...
		public Committee_Meeting_Action_ItemObjectIDType[] ID
		{
			get
			{
				return this.idField;
