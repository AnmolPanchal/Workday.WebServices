...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Academic_Ranks_ResponseType : INotifyPropertyChanged
	{
		private Academic_RankObjectType[] request_ReferencesField;

		private Academic_Rank_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Academic_RankType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Academic_Rank_Reference", IsNullable = false)]
		public Academic_RankObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Academic_Rank_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Academic_Rank", IsNullable = false)]
		public Academic_RankType[] Response_Data
		{
			get
			{
