...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Work_Status_Rule_RowObjectType : INotifyPropertyChanged
	{
		private Work_Status_Rule_RowObjectIDType[] idField;
		...
		public Work_Status_Rule_RowObjectIDType[] ID
		{
			get
			{
				return this.idField;
