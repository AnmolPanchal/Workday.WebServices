...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Period_Reporting_Calendars_ResponseType : INotifyPropertyChanged
	{
		private Period_Reporting_CalendarObjectType[] request_ReferencesField;

		private Period_Reporting_Calendar_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Period_Reporting_Calendar_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Period_Reporting_CalendarType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Period_Reporting_Calendar_Reference", IsNullable = false)]
		public Period_Reporting_CalendarObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Period_Reporting_Calendar_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Period_Reporting_Calendar_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Period_Reporting_Calendar", IsNullable = false)]
		public Period_Reporting_CalendarType[] Response_Data
		{
			get
			{
