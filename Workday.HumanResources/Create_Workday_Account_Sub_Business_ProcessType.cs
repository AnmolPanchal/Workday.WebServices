...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Create_Workday_Account_Sub_Business_ProcessType : INotifyPropertyChanged
	{
		private Business_Sub_Process_ParametersType business_Sub_Process_ParametersField;

		private System_User_DataType create_Workday_Account_DataField;
		...
		[XmlElement(Order = 1)]
		public System_User_DataType Create_Workday_Account_Data
		{
			get
			{
				return this.create_Workday_Account_DataField;
			}
			set
			{
				this.create_Workday_Account_DataField = value;
				this.RaisePropertyChanged("Create_Workday_Account_Data");
			}
		}
