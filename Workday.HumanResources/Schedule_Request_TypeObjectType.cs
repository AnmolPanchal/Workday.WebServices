...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Schedule_Request_TypeObjectType : INotifyPropertyChanged
	{
		private Schedule_Request_TypeObjectIDType[] idField;
		...
		public Schedule_Request_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
