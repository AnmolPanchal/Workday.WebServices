...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Gender_Identities_RequestType : INotifyPropertyChanged
	{
		...
		[XmlElement("Request_Criteria", typeof(Gender_Identity_Request_CriteriaType), Order = 0), XmlElement("Request_References", typeof(Gender_Identity_Request_ReferencesType), Order = 0)]
		public object Item
		{
			get
			{
