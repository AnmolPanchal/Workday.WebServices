...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Get_Former_Worker_Documents_ResponseType : INotifyPropertyChanged
	{
		private Former_Worker_AttachmentObjectType[] request_ReferencesField;

		private Former_WorkerObjectType[] request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Former_Worker_Attachment_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private Former_Worker_AttachmentType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Former_Worker_Document_Reference", IsNullable = false)]
		public Former_Worker_AttachmentObjectType[] Request_References
		{
			get
			{
		...
		[XmlArray(Order = 1), XmlArrayItem("Former_Worker_Reference", IsNullable = false)]
		public Former_WorkerObjectType[] Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public Former_Worker_Attachment_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("Former_Worker_Document", IsNullable = false)]
		public Former_Worker_AttachmentType[] Response_Data
		{
			get
			{
