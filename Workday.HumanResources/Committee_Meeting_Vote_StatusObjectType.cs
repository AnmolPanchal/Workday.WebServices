...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Committee_Meeting_Vote_StatusObjectType : INotifyPropertyChanged
	{
		private Committee_Meeting_Vote_StatusObjectIDType[] idField;
		...
		public Committee_Meeting_Vote_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
