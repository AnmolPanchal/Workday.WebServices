...
namespace WorkdayWebServices.Human_ResourcesService
{
	...
	[Serializable]
	public class Citizenship_StatusObjectType : INotifyPropertyChanged
	{
		private Citizenship_StatusObjectIDType[] idField;
		...
		public Citizenship_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
