...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class NSLDS_Loan_Program_CodeObjectType : INotifyPropertyChanged
	{
		private NSLDS_Loan_Program_CodeObjectIDType[] idField;
		...
		public NSLDS_Loan_Program_CodeObjectIDType[] ID
		{
			get
			{
				return this.idField;
