...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class ISIR_Selective_Service_FlagObjectType : INotifyPropertyChanged
	{
		private ISIR_Selective_Service_FlagObjectIDType[] idField;
		...
		public ISIR_Selective_Service_FlagObjectIDType[] ID
		{
			get
			{
				return this.idField;
