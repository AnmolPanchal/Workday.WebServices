...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class NSLDS_Overpayment_FlagObjectType : INotifyPropertyChanged
	{
		private NSLDS_Overpayment_FlagObjectIDType[] idField;
		...
		public NSLDS_Overpayment_FlagObjectIDType[] ID
		{
			get
			{
				return this.idField;
