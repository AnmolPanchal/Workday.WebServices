...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Student_Aggregate_AwardObjectType : INotifyPropertyChanged
	{
		private Student_Aggregate_AwardObjectIDType[] idField;
		...
		public Student_Aggregate_AwardObjectIDType[] ID
		{
			get
			{
				return this.idField;
