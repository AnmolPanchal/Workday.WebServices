...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class ISIR_Location_ContextObjectType : INotifyPropertyChanged
	{
		private ISIR_Location_ContextObjectIDType[] idField;
		...
		public ISIR_Location_ContextObjectIDType[] ID
		{
			get
			{
				return this.idField;
