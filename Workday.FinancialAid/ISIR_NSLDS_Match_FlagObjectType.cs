...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class ISIR_NSLDS_Match_FlagObjectType : INotifyPropertyChanged
	{
		private ISIR_NSLDS_Match_FlagObjectIDType[] idField;
		...
		public ISIR_NSLDS_Match_FlagObjectIDType[] ID
		{
			get
			{
				return this.idField;
