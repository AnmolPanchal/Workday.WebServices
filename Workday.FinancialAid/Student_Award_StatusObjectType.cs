...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Student_Award_StatusObjectType : INotifyPropertyChanged
	{
		private Student_Award_StatusObjectIDType[] idField;
		...
		public Student_Award_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
