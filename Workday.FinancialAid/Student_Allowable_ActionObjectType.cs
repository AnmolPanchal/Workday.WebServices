...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Student_Allowable_ActionObjectType : INotifyPropertyChanged
	{
		private Student_Allowable_ActionObjectIDType[] idField;
		...
		public Student_Allowable_ActionObjectIDType[] ID
		{
			get
			{
				return this.idField;
