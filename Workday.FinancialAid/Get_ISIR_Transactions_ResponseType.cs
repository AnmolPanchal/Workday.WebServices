...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Get_ISIR_Transactions_ResponseType : INotifyPropertyChanged
	{
		private ISIR_TransactionObjectType[] request_ReferencesField;

		private ISIR_Transaction_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private ISIR_Response_GroupType response_GroupField;

		private Response_ResultsType response_ResultsField;

		private ISIR_TransactionType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("ISIR_Transaction_Reference", IsNullable = false)]
		public ISIR_TransactionObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public ISIR_Transaction_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlElement(Order = 3)]
		public ISIR_Response_GroupType Response_Group
		{
			get
			{
		...
		[XmlArray(Order = 5), XmlArrayItem("ISIR_Transaction", IsNullable = false)]
		public ISIR_TransactionType[] Response_Data
		{
			get
			{
