...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Get_Financial_Aid_Packages_ResponseType : INotifyPropertyChanged
	{
		private Financial_Aid_PackageObjectType[] request_ReferencesField;

		private Financial_Aid_Package_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Financial_Aid_PackageType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Financial_Aid_Package_Reference", IsNullable = false)]
		public Financial_Aid_PackageObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Financial_Aid_Package_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Financial_Aid_Package", IsNullable = false)]
		public Financial_Aid_PackageType[] Response_Data
		{
			get
			{
