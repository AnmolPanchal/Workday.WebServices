...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class ISIR_SSA_Citizenship_FlagObjectType : INotifyPropertyChanged
	{
		private ISIR_SSA_Citizenship_FlagObjectIDType[] idField;
		...
		public ISIR_SSA_Citizenship_FlagObjectIDType[] ID
		{
			get
			{
				return this.idField;
