...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class ISIR_EFC_Change_FlagObjectType : INotifyPropertyChanged
	{
		private ISIR_EFC_Change_FlagObjectIDType[] idField;
		...
		public ISIR_EFC_Change_FlagObjectIDType[] ID
		{
			get
			{
				return this.idField;
