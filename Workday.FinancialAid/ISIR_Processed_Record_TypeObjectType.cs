...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class ISIR_Processed_Record_TypeObjectType : INotifyPropertyChanged
	{
		private ISIR_Processed_Record_TypeObjectIDType[] idField;
		...
		public ISIR_Processed_Record_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
