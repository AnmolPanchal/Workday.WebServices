...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Financial_Aid_Dependency_StatusObjectType : INotifyPropertyChanged
	{
		private Financial_Aid_Dependency_StatusObjectIDType[] idField;
		...
		public Financial_Aid_Dependency_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
