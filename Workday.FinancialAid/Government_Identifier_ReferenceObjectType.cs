...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Government_Identifier_ReferenceObjectType : INotifyPropertyChanged
	{
		private Government_Identifier_ReferenceObjectIDType[] idField;
		...
		public Government_Identifier_ReferenceObjectIDType[] ID
		{
			get
			{
				return this.idField;
