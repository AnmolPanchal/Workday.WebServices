...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class NSLDS_Discharged_Loan_FlagObjectType : INotifyPropertyChanged
	{
		private NSLDS_Discharged_Loan_FlagObjectIDType[] idField;
		...
		public NSLDS_Discharged_Loan_FlagObjectIDType[] ID
		{
			get
			{
				return this.idField;
