...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class School_Code_Housing_PlanObjectType : INotifyPropertyChanged
	{
		private School_Code_Housing_PlanObjectIDType[] idField;
		...
		public School_Code_Housing_PlanObjectIDType[] ID
		{
			get
			{
				return this.idField;
