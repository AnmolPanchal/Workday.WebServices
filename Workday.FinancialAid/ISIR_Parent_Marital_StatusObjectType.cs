...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class ISIR_Parent_Marital_StatusObjectType : INotifyPropertyChanged
	{
		private ISIR_Parent_Marital_StatusObjectIDType[] idField;
		...
		public ISIR_Parent_Marital_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
