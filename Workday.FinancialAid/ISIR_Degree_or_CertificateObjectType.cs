...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class ISIR_Degree_or_CertificateObjectType : INotifyPropertyChanged
	{
		private ISIR_Degree_or_CertificateObjectIDType[] idField;
		...
		public ISIR_Degree_or_CertificateObjectIDType[] ID
		{
			get
			{
				return this.idField;
