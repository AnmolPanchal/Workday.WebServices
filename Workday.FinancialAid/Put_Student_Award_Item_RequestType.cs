...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Put_Student_Award_Item_RequestType : INotifyPropertyChanged
	{
		private Student_Award_ItemObjectType student_Award_Item_ReferenceField;

		private Student_Award_Item_DataType student_Award_Item_DataField;
		...
		[XmlElement(Order = 1)]
		public Student_Award_Item_DataType Student_Award_Item_Data
		{
			get
			{
				return this.student_Award_Item_DataField;
			}
			set
			{
				this.student_Award_Item_DataField = value;
				this.RaisePropertyChanged("Student_Award_Item_Data");
			}
		}
