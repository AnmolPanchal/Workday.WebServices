...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Get_Student_Manual_Awards_ResponseType : INotifyPropertyChanged
	{
		private Student_Manual_AwardObjectType[] request_ReferencesField;

		private Student_Manual_Award_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Student_Manual_AwardType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Student_Manual_Award_Reference", IsNullable = false)]
		public Student_Manual_AwardObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Student_Manual_Award_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Student_Manual_Award", IsNullable = false)]
		public Student_Manual_AwardType[] Response_Data
		{
			get
			{
