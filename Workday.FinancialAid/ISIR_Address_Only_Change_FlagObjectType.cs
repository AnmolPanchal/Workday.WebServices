...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class ISIR_Address_Only_Change_FlagObjectType : INotifyPropertyChanged
	{
		private ISIR_Address_Only_Change_FlagObjectIDType[] idField;
		...
		public ISIR_Address_Only_Change_FlagObjectIDType[] ID
		{
			get
			{
				return this.idField;
