...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class ISIR_Source_of_CorrectionObjectType : INotifyPropertyChanged
	{
		private ISIR_Source_of_CorrectionObjectIDType[] idField;
		...
		public ISIR_Source_of_CorrectionObjectIDType[] ID
		{
			get
			{
				return this.idField;
