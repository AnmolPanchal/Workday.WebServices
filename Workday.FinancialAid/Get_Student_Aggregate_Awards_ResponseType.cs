...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Get_Student_Aggregate_Awards_ResponseType : INotifyPropertyChanged
	{
		private Student_Aggregate_AwardObjectType[] request_ReferencesField;

		private Student_Aggregate_Award_Request_CriteriaType request_CriteriaField;

		private Response_FilterType response_FilterField;

		private Response_ResultsType response_ResultsField;

		private Student_Aggregate_AwardType[] response_DataField;
		...
		[XmlArray(Order = 0), XmlArrayItem("Student_Aggregate_Award_Reference", IsNullable = false)]
		public Student_Aggregate_AwardObjectType[] Request_References
		{
			get
			{
		...
		[XmlElement(Order = 1)]
		public Student_Aggregate_Award_Request_CriteriaType Request_Criteria
		{
			get
			{
		...
		[XmlArray(Order = 4), XmlArrayItem("Student_Aggregate_Award", IsNullable = false)]
		public Student_Aggregate_AwardType[] Response_Data
		{
			get
			{
