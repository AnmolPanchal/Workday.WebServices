...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Financial_Aid_School_CodeObjectType : INotifyPropertyChanged
	{
		private Financial_Aid_School_CodeObjectIDType[] idField;
		...
		public Financial_Aid_School_CodeObjectIDType[] ID
		{
			get
			{
				return this.idField;
