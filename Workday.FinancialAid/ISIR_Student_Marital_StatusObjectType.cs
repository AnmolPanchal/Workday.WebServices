...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class ISIR_Student_Marital_StatusObjectType : INotifyPropertyChanged
	{
		private ISIR_Student_Marital_StatusObjectIDType[] idField;
		...
		public ISIR_Student_Marital_StatusObjectIDType[] ID
		{
			get
			{
				return this.idField;
