...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Loan_Fee_Deduction_MethodObjectType : INotifyPropertyChanged
	{
		private Loan_Fee_Deduction_MethodObjectIDType[] idField;
		...
		public Loan_Fee_Deduction_MethodObjectIDType[] ID
		{
			get
			{
				return this.idField;
