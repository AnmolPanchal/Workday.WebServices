...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Student_Award_TypeObjectType : INotifyPropertyChanged
	{
		private Student_Award_TypeObjectIDType[] idField;
		...
		public Student_Award_TypeObjectIDType[] ID
		{
			get
			{
				return this.idField;
