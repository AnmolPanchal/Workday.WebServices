...
namespace WorkdayWebServices.Financial_AidService
{
	...
	[Serializable]
	public class Financial_Aid_PackageObjectType : INotifyPropertyChanged
	{
		private Financial_Aid_PackageObjectIDType[] idField;
		...
		public Financial_Aid_PackageObjectIDType[] ID
		{
			get
			{
				return this.idField;
